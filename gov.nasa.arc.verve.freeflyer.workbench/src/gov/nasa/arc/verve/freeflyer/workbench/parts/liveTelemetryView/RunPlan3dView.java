...
public class RunPlan3dView extends LiveTelemetryView {

	@Inject
	public RunPlan3dView(EPartService eps, Shell shell, MApplication application) {
		super(eps, shell, application);
		
		MY_TAB_NAME = TabName.RUN_PLAN;
	}
