...
public class RecordCameraWidget extends AbstractSetCameraStateWidget {

	public RecordCameraWidget(Composite parent, int style) {
		super(parent, style);
	}
	...
	public boolean bindUI(Realm realm) {
		...
		result &= bind("record", startCheckbox);
