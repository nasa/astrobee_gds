...
public class CommandButtonForDock extends CommandButton {

	public CommandButtonForDock(Composite parent, int style) {
		super(parent, style);
	...
	protected void removeFromCorrectRegistry() {
		SmartDockAgentConnectedRegistry.removeListener(this);
	}
}
