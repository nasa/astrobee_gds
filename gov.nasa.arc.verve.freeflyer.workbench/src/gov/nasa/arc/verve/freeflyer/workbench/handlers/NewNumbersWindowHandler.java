...
public class NewNumbersWindowHandler {
	...
	public void execute(MApplication application, EModelService modelService) {
		...
		if (stack == null) { // and create it if not
			...
			if (window == null) { // and create it if it doesn't exist  (expected)
				...
				window.setLabel("Numbers Window");
		...
		part.setContributionURI("bundleclass://gov.nasa.arc.verve.freeflyer.workbench/gov.nasa.arc.verve.freeflyer.workbench.parts.engineering.NumbersView");
