...
public class GuestSciencePlanTraceOne extends AbstractGuestSciencePlanTrace {
	static GuestSciencePlanTraceOne guestScienceInstance;
	
	@Inject
	public GuestSciencePlanTraceOne() {
		super(1);
	...
	public static AbstractGuestSciencePlanTrace getGuestScienceInstance() {
		if(guestScienceInstance == null) {
			System.out.println("No GuestSciencePlanTraceOne created");
		}
	...
	public void acceptGuestScienceRunningPlanInfo(
			@Named(FreeFlyerStrings.GUEST_SCIENCE_PLAN_INFO_1)GuestScienceRunningPlanInfoOne rpi) {
