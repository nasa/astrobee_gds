...
public enum TabName {
	...
	OVERVIEW ("gov.nasa.arc.ff.ocu.compositepart.overviewTab",
			"gov.nasa.arc.verve.freeflyer.workbench.part.liveMap"),
	PLAN_EDITOR ("gov.nasa.arc.ff.ocu.compositepart.planEditorTab"),
	RUN_PLAN ("gov.nasa.arc.ff.ocu.compositepart.runTab",
			"gov.nasa.arc.verve.freeflyer.workbench.part.runPlan3dView"),
	TELEOP ("gov.nasa.arc.ff.ocu.compositepart.teleopTab",
			"gov.nasa.arc.verve.freeflyer.workbench.part.teleop3dView"),
	GUEST_SCIENCE ("gov.nasa.arc.ff.ocu.compositepart.guestScienceTab",
			"gov.nasa.arc.verve.freeflyer.workbench.part.simplifiedGuestScience3dView"),
	ADVANCED_GUEST_SCIENCE ("gov.nasa.arc.ff.ocu.compositepart.advancedGuestScienceTab",
			"gov.nasa.arc.verve.freeflyer.workbench.part.advancedGuestScience3dView"),
	ADVANCED ("gov.nasa.arc.ff.ocu.compositepart.advancedTab",
			"gov.nasa.arc.ff.ocu.compositepart.advanced2Tab"),
	MODELING ("gov.nasa.arc.ff.ocu.compositepart.modelingTab"),
	DEBUGGING ("gov.nasa.arc.ff.ocu.compositepart.debugTab"),
	VIDEO ("gov.nasa.arc.ff.ocu.compositepart.videoTab",
