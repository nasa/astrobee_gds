...
public class StreamCameraWidget extends AbstractSetCameraStateWidget {
	
	public StreamCameraWidget(Composite parent, int style) {
		super(parent, style);
	}
	...
	void setupCustomControls() {
		...
		startCheckbox = new Button(this, SWT.CHECK);
		startCheckbox.setText("Stream");	
	}
	...
	public boolean bindUI(Realm realm) {
		...
		result &= bind("stream", startCheckbox);
