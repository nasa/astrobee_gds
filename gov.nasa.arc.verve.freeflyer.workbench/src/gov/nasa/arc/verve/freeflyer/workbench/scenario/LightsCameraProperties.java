...
public class LightsCameraProperties extends GlobalProperties {
	...
	protected static void configureProperties(){
		...
		try {
			PROPERTIES.load(IOUtils.toBufferedInputStream(new FileInputStream(ConfigFileWrangler.getInstance().getLightsCameraPath())));
