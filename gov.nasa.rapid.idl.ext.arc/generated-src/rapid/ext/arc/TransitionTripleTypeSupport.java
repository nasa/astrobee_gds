...
public class TransitionTripleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::TransitionTriple";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransitionTripleTypeSupport _singleton
    = new TransitionTripleTypeSupport();
    ...
    */
    public static TransitionTripleTypeSupport get_instance() {
        return _singleton;
    }

    public static TransitionTripleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransitionTripleTypeCode.VALUE;
    }

    public Object create_data() {
        return TransitionTriple.create();
    }
    ...
    * <code>this</code> is not a <code>TransitionTriple</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransitionTriple typedDst = (TransitionTriple) destination;
        TransitionTriple typedSrc = (TransitionTriple) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransitionTriple typedSrc = (TransitionTriple) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.sourceState);

            dst.writeByte(typedSrc.event);

            dst.writeByte(typedSrc.targetState);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransitionTriple typedDst = (TransitionTriple) dst;
            typedDst.clear();      
            try{
                typedDst.sourceState = src.readByte();
                typedDst.event = src.readByte();
                typedDst.targetState = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransitionTriple typedDst = (TransitionTriple) sample;
    ...
    int mask) {
        return new TransitionTripleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TransitionTripleDataReader(native_reader, listener, mask, this);   
    ...
    protected TransitionTripleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransitionTripleTypeCode.VALUE,TransitionTriple.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransitionTripleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransitionTripleTypeCode.VALUE,TransitionTriple.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
