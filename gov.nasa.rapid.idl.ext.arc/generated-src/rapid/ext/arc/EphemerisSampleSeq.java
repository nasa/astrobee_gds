...
/**
* A sequence of EphemerisSample instances.
*/
public final class EphemerisSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EphemerisSampleSeq() {
        super(EphemerisSample.class);
    }

    public EphemerisSampleSeq (int initialMaximum) {
        super(EphemerisSample.class, initialMaximum);
    }

    public EphemerisSampleSeq (Collection elements) {
        super(EphemerisSample.class, elements);
    }
