...
/**
* A sequence of GeometryConfig instances.
*/
public final class GeometryConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GeometryConfigSeq() {
        super(GeometryConfig.class);
    }

    public GeometryConfigSeq (int initialMaximum) {
        super(GeometryConfig.class, initialMaximum);
    }

    public GeometryConfigSeq (Collection elements) {
        super(GeometryConfig.class, elements);
    }
