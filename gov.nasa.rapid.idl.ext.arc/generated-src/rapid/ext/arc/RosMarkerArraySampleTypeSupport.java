...
public class RosMarkerArraySampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::RosMarkerArraySample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RosMarkerArraySampleTypeSupport _singleton
    = new RosMarkerArraySampleTypeSupport();
    ...
    */
    public static RosMarkerArraySampleTypeSupport get_instance() {
        return _singleton;
    }

    public static RosMarkerArraySampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RosMarkerArraySampleTypeCode.VALUE;
    }

    public Object create_data() {
        return RosMarkerArraySample.create();
    }
    ...
    public Object create_key() {
        return new RosMarkerArraySample();
    }
    ...
    public Class get_type() {
        return RosMarkerArraySample.class;
    }
    ...
    * <code>this</code> is not a <code>RosMarkerArraySample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RosMarkerArraySample typedDst = (RosMarkerArraySample) destination;
        RosMarkerArraySample typedSrc = (RosMarkerArraySample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RosMarkerArraySample typedSrc = (RosMarkerArraySample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marker_array);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.marker_array, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RosMarkerArraySample typedDst = (RosMarkerArraySample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.marker_array = (rapid.ext.arc.MarkerArraySequence8)rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marker_array, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.MarkerArraySequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RosMarkerArraySample typedDst = (RosMarkerArraySample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RosMarkerArraySample typedDst
        = (RosMarkerArraySample) instance;
        RosMarkerArraySample typedSrc
        = (RosMarkerArraySample) key;
    ...
    */
    ...
    int mask) {
        return new RosMarkerArraySampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RosMarkerArraySampleDataReader(native_reader, listener, mask, this);   
    ...
    protected RosMarkerArraySampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RosMarkerArraySampleTypeCode.VALUE,RosMarkerArraySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RosMarkerArraySampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RosMarkerArraySampleTypeCode.VALUE,RosMarkerArraySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
