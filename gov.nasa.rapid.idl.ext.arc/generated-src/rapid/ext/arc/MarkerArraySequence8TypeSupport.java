...
public class MarkerArraySequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::MarkerArraySequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarkerArraySequence8TypeSupport _singleton
    = new MarkerArraySequence8TypeSupport();
    ...
    */
    public static MarkerArraySequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static MarkerArraySequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarkerArraySequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return MarkerArraySequence8.create();
    }
    ...
    public Object create_key() {
        return new MarkerArraySequence8();
    }
    ...
    public Class get_type() {
        return MarkerArraySequence8.class;
    }
    ...
    * <code>this</code> is not a <code>MarkerArraySequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MarkerArraySequence8 typedDst = (MarkerArraySequence8) destination;
        MarkerArraySequence8 typedSrc = (MarkerArraySequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MarkerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MarkerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MarkerArraySequence8 typedSrc = (MarkerArraySequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.MarkerTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.MarkerTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MarkerArraySequence8 typedDst = (MarkerArraySequence8) dst;
            rapid.ext.arc.MarkerTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.MarkerTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MarkerArraySequence8 typedDst = (MarkerArraySequence8) sample;
    ...
    protected MarkerArraySequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarkerArraySequence8TypeCode.VALUE,MarkerArraySequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarkerArraySequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarkerArraySequence8TypeCode.VALUE,MarkerArraySequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
