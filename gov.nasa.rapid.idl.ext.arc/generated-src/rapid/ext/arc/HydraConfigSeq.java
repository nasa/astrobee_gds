...
/**
* A sequence of HydraConfig instances.
*/
public final class HydraConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HydraConfigSeq() {
        super(HydraConfig.class);
    }

    public HydraConfigSeq (int initialMaximum) {
        super(HydraConfig.class, initialMaximum);
    }

    public HydraConfigSeq (Collection elements) {
        super(HydraConfig.class, elements);
    }
