...
public class GpsConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GpsConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GpsConfigTypeSupport _singleton
    = new GpsConfigTypeSupport();
    ...
    */
    public static GpsConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static GpsConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GpsConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return GpsConfig.create();
    }
    ...
    * <code>this</code> is not a <code>GpsConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GpsConfig typedDst = (GpsConfig) destination;
        GpsConfig typedSrc = (GpsConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GpsConfig typedSrc = (GpsConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.sensorFrame );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.referenceFrame );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.datum );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.undulationDatum );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.sensorFrame,32);

            dst.writeString(typedSrc.referenceFrame,32);

            dst.writeString(typedSrc.datum,16);

            dst.writeString(typedSrc.undulationDatum,16);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GpsConfig typedDst = (GpsConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.sensorFrame = src.readString(32);
                typedDst.referenceFrame = src.readString(32);
                typedDst.datum = src.readString(16);
                typedDst.undulationDatum = src.readString(16);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GpsConfig typedDst = (GpsConfig) sample;
    ...
    */
    ...
    int mask) {
        return new GpsConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GpsConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected GpsConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GpsConfigTypeCode.VALUE,GpsConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GpsConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GpsConfigTypeCode.VALUE,GpsConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
