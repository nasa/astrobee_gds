...
/**
* A sequence of SpectrumSample instances.
*/
public final class SpectrumSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SpectrumSampleSeq() {
        super(SpectrumSample.class);
    }

    public SpectrumSampleSeq (int initialMaximum) {
        super(SpectrumSample.class, initialMaximum);
    }

    public SpectrumSampleSeq (Collection elements) {
        super(SpectrumSample.class, elements);
    }
