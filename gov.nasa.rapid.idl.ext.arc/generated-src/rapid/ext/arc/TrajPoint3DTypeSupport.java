...
public class TrajPoint3DTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::TrajPoint3D";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TrajPoint3DTypeSupport _singleton
    = new TrajPoint3DTypeSupport();
    ...
    */
    public static TrajPoint3DTypeSupport get_instance() {
        return _singleton;
    }

    public static TrajPoint3DTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TrajPoint3DTypeCode.VALUE;
    }

    public Object create_data() {
        return TrajPoint3D.create();
    }
    ...
    * <code>this</code> is not a <code>TrajPoint3D</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TrajPoint3D typedDst = (TrajPoint3D) destination;
        TrajPoint3D typedSrc = (TrajPoint3D) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TrajPoint3D typedSrc = (TrajPoint3D) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TrajPoint3D typedDst = (TrajPoint3D) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TrajPoint3D typedDst = (TrajPoint3D) sample;
    ...
    int mask) {
        return new TrajPoint3DDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TrajPoint3DDataReader(native_reader, listener, mask, this);   
    ...
    protected TrajPoint3DTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TrajPoint3DTypeCode.VALUE,TrajPoint3D.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TrajPoint3DTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TrajPoint3DTypeCode.VALUE,TrajPoint3D.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
