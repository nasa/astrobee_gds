...
public class DlpBoardSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpBoardSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpBoardSampleTypeSupport _singleton
    = new DlpBoardSampleTypeSupport();
    ...
    */
    public static DlpBoardSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpBoardSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpBoardSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpBoardSample.create();
    }
    ...
    * <code>this</code> is not a <code>DlpBoardSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpBoardSample typedDst = (DlpBoardSample) destination;
        DlpBoardSample typedSrc = (DlpBoardSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpChannelSampleTypeSupport.get_instance().get_array_max_size_serialized(endpoint_data, currentAlignment,  (3));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpBoardSample typedSrc = (DlpBoardSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        for(int i1__ = 0; i1__< 3; ++i1__){
            ...
            currentAlignment += rapid.ext.arc.DlpChannelSampleTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                rapid.ext.arc.DlpChannelSampleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.channels[i1__], dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }

            dst.writeFloat(typedSrc.temp);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpBoardSample typedDst = (DlpBoardSample) dst;
            typedDst.clear();      
            try{
                for(int i1__ = 0; i1__< 3; ++i1__){

                    typedDst.channels[i1__] = (rapid.ext.arc.DlpChannelSample)rapid.ext.arc.DlpChannelSampleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.channels[i1__], src, false, true, endpoint_plugin_qos);     
                }

                typedDst.temp = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                rapid.ext.arc.DlpChannelSampleTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpBoardSample typedDst = (DlpBoardSample) sample;
    ...
    int mask) {
        return new DlpBoardSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpBoardSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpBoardSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DlpBoardSampleTypeCode.VALUE,DlpBoardSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpBoardSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpBoardSampleTypeCode.VALUE,DlpBoardSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
