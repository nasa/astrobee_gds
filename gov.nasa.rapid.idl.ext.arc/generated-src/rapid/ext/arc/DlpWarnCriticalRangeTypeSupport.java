...
public class DlpWarnCriticalRangeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpWarnCriticalRange";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpWarnCriticalRangeTypeSupport _singleton
    = new DlpWarnCriticalRangeTypeSupport();
    ...
    */
    public static DlpWarnCriticalRangeTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpWarnCriticalRangeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpWarnCriticalRangeTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpWarnCriticalRange.create();
    }
    ...
    public Object create_key() {
        return new DlpWarnCriticalRange();
    }
    ...
    public Class get_type() {
        return DlpWarnCriticalRange.class;
    }
    ...
    * <code>this</code> is not a <code>DlpWarnCriticalRange</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpWarnCriticalRange typedDst = (DlpWarnCriticalRange) destination;
        DlpWarnCriticalRange typedSrc = (DlpWarnCriticalRange) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpWarnCriticalRange typedSrc = (DlpWarnCriticalRange) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.lowCritical);

            dst.writeFloat(typedSrc.lowWarn);

            dst.writeFloat(typedSrc.highWarn);

            dst.writeFloat(typedSrc.highCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpWarnCriticalRange typedDst = (DlpWarnCriticalRange) dst;
            typedDst.clear();      
            try{
                typedDst.lowCritical = src.readFloat();
                typedDst.lowWarn = src.readFloat();
                typedDst.highWarn = src.readFloat();
                typedDst.highCritical = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpWarnCriticalRange typedDst = (DlpWarnCriticalRange) sample;
    ...
    int mask) {
        return new DlpWarnCriticalRangeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpWarnCriticalRangeDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpWarnCriticalRangeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DlpWarnCriticalRangeTypeCode.VALUE,DlpWarnCriticalRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpWarnCriticalRangeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpWarnCriticalRangeTypeCode.VALUE,DlpWarnCriticalRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
