...
public class GeometryIndexModeSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GeometryIndexModeSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GeometryIndexModeSequence32TypeSupport _singleton
    = new GeometryIndexModeSequence32TypeSupport();
    ...
    */
    public static GeometryIndexModeSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static GeometryIndexModeSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GeometryIndexModeSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return GeometryIndexModeSequence32.create();
    }
    ...
    public Object create_key() {
        return new GeometryIndexModeSequence32();
    }
    ...
    public Class get_type() {
        return GeometryIndexModeSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>GeometryIndexModeSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GeometryIndexModeSequence32 typedDst = (GeometryIndexModeSequence32) destination;
        GeometryIndexModeSequence32 typedSrc = (GeometryIndexModeSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GeometryIndexModeSequence32 typedSrc = (GeometryIndexModeSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GeometryIndexModeSequence32 typedDst = (GeometryIndexModeSequence32) dst;
            rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.GeometryIndexModeTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GeometryIndexModeSequence32 typedDst = (GeometryIndexModeSequence32) sample;
    ...
    protected GeometryIndexModeSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GeometryIndexModeSequence32TypeCode.VALUE,GeometryIndexModeSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GeometryIndexModeSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GeometryIndexModeSequence32TypeCode.VALUE,GeometryIndexModeSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
