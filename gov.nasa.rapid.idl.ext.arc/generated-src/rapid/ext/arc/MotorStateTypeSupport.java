...
public class MotorStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::MotorState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorStateTypeSupport _singleton
    = new MotorStateTypeSupport();
    ...
    */
    public static MotorStateTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorStateTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorState.create();
    }
    ...
    * <code>this</code> is not a <code>MotorState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorState typedDst = (MotorState) destination;
        MotorState typedSrc = (MotorState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MotorProfileTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MotorProfileTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MotorState typedSrc = (MotorState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.MotorProfileTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.MotorProfileTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cmd, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorState typedDst = (MotorState) dst;
            typedDst.clear();      
            try{
                typedDst.cmd = (rapid.ext.arc.MotorProfile)rapid.ext.arc.MotorProfileTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cmd, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.MotorProfileTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorState typedDst = (MotorState) sample;
    ...
    int mask) {
        return new MotorStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorStateDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorStateTypeCode.VALUE,MotorState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorStateTypeCode.VALUE,MotorState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
