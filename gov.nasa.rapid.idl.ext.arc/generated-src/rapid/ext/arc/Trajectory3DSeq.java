...
/**
* A sequence of Trajectory3D instances.
*/
public final class Trajectory3DSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Trajectory3DSeq() {
        super(Trajectory3D.class);
    }

    public Trajectory3DSeq (int initialMaximum) {
        super(Trajectory3D.class, initialMaximum);
    }

    public Trajectory3DSeq (Collection elements) {
        super(Trajectory3D.class, elements);
    }
