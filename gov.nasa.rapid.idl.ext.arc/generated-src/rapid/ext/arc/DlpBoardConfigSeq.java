...
/**
* A sequence of DlpBoardConfig instances.
*/
public final class DlpBoardConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpBoardConfigSeq() {
        super(DlpBoardConfig.class);
    }

    public DlpBoardConfigSeq (int initialMaximum) {
        super(DlpBoardConfig.class, initialMaximum);
    }

    public DlpBoardConfigSeq (Collection elements) {
        super(DlpBoardConfig.class, elements);
    }
