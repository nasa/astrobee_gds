...
public class DlpSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpSampleTypeSupport _singleton
    = new DlpSampleTypeSupport();
    ...
    */
    public static DlpSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpSample.create();
    }
    ...
    * <code>this</code> is not a <code>DlpSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpSample typedDst = (DlpSample) destination;
        DlpSample typedSrc = (DlpSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpSample typedSrc = (DlpSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.dlpBoards);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.dlpBoards, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpSample typedDst = (DlpSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.dlpBoards = (rapid.ext.arc.DlpBoardSampleSequence32)rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.dlpBoards, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.DlpBoardSampleSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpSample typedDst = (DlpSample) sample;
    ...
    */
    ...
    int mask) {
        return new DlpSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DlpSampleTypeCode.VALUE,DlpSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpSampleTypeCode.VALUE,DlpSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
