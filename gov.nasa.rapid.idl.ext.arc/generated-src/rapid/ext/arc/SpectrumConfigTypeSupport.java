...
public class SpectrumConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::SpectrumConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SpectrumConfigTypeSupport _singleton
    = new SpectrumConfigTypeSupport();
    ...
    */
    public static SpectrumConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static SpectrumConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SpectrumConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return SpectrumConfig.create();
    }
    ...
    * <code>this</code> is not a <code>SpectrumConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SpectrumConfig typedDst = (SpectrumConfig) destination;
        SpectrumConfig typedSrc = (SpectrumConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SpectrumConfig typedSrc = (SpectrumConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.indexRanges);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.indexRanges, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SpectrumConfig typedDst = (SpectrumConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.indexRanges = (rapid.ext.arc.NamedIndexRangeSequence16)rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.indexRanges, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.NamedIndexRangeSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SpectrumConfig typedDst = (SpectrumConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SpectrumConfig typedDst
        = (SpectrumConfig) instance;
        SpectrumConfig typedSrc
        = (SpectrumConfig) key;
    ...
    */
    ...
    int mask) {
        return new SpectrumConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SpectrumConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected SpectrumConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SpectrumConfigTypeCode.VALUE,SpectrumConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SpectrumConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SpectrumConfigTypeCode.VALUE,SpectrumConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
