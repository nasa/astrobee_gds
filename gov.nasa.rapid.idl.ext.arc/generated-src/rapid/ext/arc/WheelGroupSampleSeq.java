...
/**
* A sequence of WheelGroupSample instances.
*/
public final class WheelGroupSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WheelGroupSampleSeq() {
        super(WheelGroupSample.class);
    }

    public WheelGroupSampleSeq (int initialMaximum) {
        super(WheelGroupSample.class, initialMaximum);
    }

    public WheelGroupSampleSeq (Collection elements) {
        super(WheelGroupSample.class, elements);
    }
