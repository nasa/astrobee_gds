...
public class StateMachineStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::StateMachineState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StateMachineStateTypeSupport _singleton
    = new StateMachineStateTypeSupport();
    ...
    */
    public static StateMachineStateTypeSupport get_instance() {
        return _singleton;
    }

    public static StateMachineStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StateMachineStateTypeCode.VALUE;
    }

    public Object create_data() {
        return StateMachineState.create();
    }
    ...
    public Class get_type() {
        return StateMachineState.class;
    }
    ...
    * <code>this</code> is not a <code>StateMachineState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StateMachineState typedDst = (StateMachineState) destination;
        StateMachineState typedSrc = (StateMachineState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        StateMachineState typedSrc = (StateMachineState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.currentState);

            dst.writeByte(typedSrc.previousState);

            dst.writeByte(typedSrc.lastEvent);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StateMachineState typedDst = (StateMachineState) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.currentState = src.readByte();
                typedDst.previousState = src.readByte();
                typedDst.lastEvent = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StateMachineState typedDst = (StateMachineState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        StateMachineState typedDst
        = (StateMachineState) instance;
        StateMachineState typedSrc
        = (StateMachineState) key;
    ...
    */
    ...
    int mask) {
        return new StateMachineStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new StateMachineStateDataReader(native_reader, listener, mask, this);   
    ...
    protected StateMachineStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,StateMachineStateTypeCode.VALUE,StateMachineState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StateMachineStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StateMachineStateTypeCode.VALUE,StateMachineState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
