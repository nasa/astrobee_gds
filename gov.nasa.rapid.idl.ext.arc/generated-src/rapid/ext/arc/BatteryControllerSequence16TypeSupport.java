...
public class BatteryControllerSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::BatteryControllerSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryControllerSequence16TypeSupport _singleton
    = new BatteryControllerSequence16TypeSupport();
    ...
    */
    public static BatteryControllerSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryControllerSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryControllerSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryControllerSequence16.create();
    }
    ...
    public Object create_key() {
        return new BatteryControllerSequence16();
    }
    ...
    public Class get_type() {
        return BatteryControllerSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryControllerSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryControllerSequence16 typedDst = (BatteryControllerSequence16) destination;
        BatteryControllerSequence16 typedSrc = (BatteryControllerSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryControllerSequence16 typedSrc = (BatteryControllerSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.BatteryControllerTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryControllerSequence16 typedDst = (BatteryControllerSequence16) dst;
            rapid.ext.arc.BatteryControllerTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.BatteryControllerTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryControllerSequence16 typedDst = (BatteryControllerSequence16) sample;
    ...
    protected BatteryControllerSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryControllerSequence16TypeCode.VALUE,BatteryControllerSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryControllerSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryControllerSequence16TypeCode.VALUE,BatteryControllerSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
