...
public class ActionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::Action";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ActionTypeSupport _singleton
    = new ActionTypeSupport();
    ...
    */
    public static ActionTypeSupport get_instance() {
        return _singleton;
    }

    public static ActionTypeSupport getInstance() {
        return get_instance();
    }
    ...
    * <code>this</code> is not a <code>Action</code>
    * type.
    */
    ...
    protected ActionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ActionTypeCode.VALUE,Action.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
