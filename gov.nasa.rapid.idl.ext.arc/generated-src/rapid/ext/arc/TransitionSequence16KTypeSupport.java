...
public class TransitionSequence16KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::TransitionSequence16K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransitionSequence16KTypeSupport _singleton
    = new TransitionSequence16KTypeSupport();
    ...
    */
    public static TransitionSequence16KTypeSupport get_instance() {
        return _singleton;
    }

    public static TransitionSequence16KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransitionSequence16KTypeCode.VALUE;
    }

    public Object create_data() {
        return TransitionSequence16K.create();
    }
    ...
    public Object create_key() {
        return new TransitionSequence16K();
    }
    ...
    public Class get_type() {
        return TransitionSequence16K.class;
    }
    ...
    * <code>this</code> is not a <code>TransitionSequence16K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransitionSequence16K typedDst = (TransitionSequence16K) destination;
        TransitionSequence16K typedSrc = (TransitionSequence16K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.TransitionTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.TransitionTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransitionSequence16K typedSrc = (TransitionSequence16K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.TransitionTripleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.TransitionTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransitionSequence16K typedDst = (TransitionSequence16K) dst;
            rapid.ext.arc.TransitionTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 100, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.TransitionTripleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransitionSequence16K typedDst = (TransitionSequence16K) sample;
    ...
    protected TransitionSequence16KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransitionSequence16KTypeCode.VALUE,TransitionSequence16K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransitionSequence16KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransitionSequence16KTypeCode.VALUE,TransitionSequence16K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
