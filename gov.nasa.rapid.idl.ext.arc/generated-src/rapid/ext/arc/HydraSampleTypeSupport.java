...
public class HydraSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::HydraSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HydraSampleTypeSupport _singleton
    = new HydraSampleTypeSupport();
    ...
    */
    public static HydraSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static HydraSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HydraSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return HydraSample.create();
    }
    ...
    * <code>this</code> is not a <code>HydraSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HydraSample typedDst = (HydraSample) destination;
        HydraSample typedSrc = (HydraSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 32);
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 32);
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 89);
        currentAlignment += rapid.ValueSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment,  0);
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment,  0);
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment,  0);
        currentAlignment += rapid.ValueSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HydraSample typedSrc = (HydraSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=   CdrPrimitiveType.SHORT.getSequenceSerializedSize(
            currentAlignment , typedSrc.sn );      
        currentAlignment  +=   CdrPrimitiveType.SHORT.getSequenceSerializedSize(
            currentAlignment , typedSrc.cd );      
        currentAlignment  +=   CdrPrimitiveType.SHORT.getSequenceSerializedSize(
            currentAlignment , typedSrc.reading );      
        currentAlignment += rapid.ValueSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShort(typedSrc.soh);

            dst.writeShort(typedSrc.sns);

            dst.writeShort(typedSrc.cds);

            dst.writeShort(typedSrc.cmr);

            dst.writeShortSeq(typedSrc.sn,32);

            dst.writeShortSeq(typedSrc.cd,32);

            dst.writeShortSeq(typedSrc.reading,89);

            rapid.ValueSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.values, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HydraSample typedDst = (HydraSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.soh = src.readShort();
                typedDst.sns = src.readShort();
                typedDst.cds = src.readShort();
                typedDst.cmr = src.readShort();
                src.readShortSequence(typedDst.sn, 32);
                src.readShortSequence(typedDst.cd, 32);
                src.readShortSequence(typedDst.reading, 89);
                typedDst.values = (rapid.ValueSequence32)rapid.ValueSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.values, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            src.skipShortSequence();

            src.skipShortSequence();

            src.skipShortSequence();

            rapid.ValueSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HydraSample typedDst = (HydraSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        HydraSample typedDst
        = (HydraSample) instance;
        HydraSample typedSrc
        = (HydraSample) key;
    ...
    */
    ...
    int mask) {
        return new HydraSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HydraSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected HydraSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,HydraSampleTypeCode.VALUE,HydraSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HydraSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HydraSampleTypeCode.VALUE,HydraSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
