...
/**
* A sequence of Battery instances.
*/
public final class BatterySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatterySeq (int initialMaximum) {
        super(Battery.class, initialMaximum);
    }

    public BatterySeq (Collection elements) {
        super(Battery.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, Battery.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' Battery objects (beyond the original size of this object)
