...
public class DlpChannelConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpChannelConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpChannelConfigTypeSupport _singleton
    = new DlpChannelConfigTypeSupport();
    ...
    */
    public static DlpChannelConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpChannelConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpChannelConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpChannelConfig.create();
    }
    ...
    * <code>this</code> is not a <code>DlpChannelConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpChannelConfig typedDst = (DlpChannelConfig) destination;
        DlpChannelConfig typedSrc = (DlpChannelConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpChannelConfig typedSrc = (DlpChannelConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.voltageRange);
        currentAlignment += rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.currentRange);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.voltageRange, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.currentRange, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpChannelConfig typedDst = (DlpChannelConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.voltageRange = (rapid.ext.arc.DlpWarnCriticalRange)rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.voltageRange, src, false, true, endpoint_plugin_qos);     
                typedDst.currentRange = (rapid.ext.arc.DlpWarnCriticalRange)rapid.ext.arc.DlpWarnCriticalRangeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.currentRange, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpChannelConfig typedDst = (DlpChannelConfig) sample;
    ...
    int mask) {
        return new DlpChannelConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpChannelConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpChannelConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DlpChannelConfigTypeCode.VALUE,DlpChannelConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpChannelConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpChannelConfigTypeCode.VALUE,DlpChannelConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
