...
/**
* A sequence of DlpConfig instances.
*/
public final class DlpConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpConfigSeq() {
        super(DlpConfig.class);
    }

    public DlpConfigSeq (int initialMaximum) {
        super(DlpConfig.class, initialMaximum);
    }

    public DlpConfigSeq (Collection elements) {
        super(DlpConfig.class, elements);
    }
