...
public class WheelGroupSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::WheelGroupSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WheelGroupSampleTypeSupport _singleton
    = new WheelGroupSampleTypeSupport();
    ...
    */
    public static WheelGroupSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static WheelGroupSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WheelGroupSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return WheelGroupSample.create();
    }
    ...
    * <code>this</code> is not a <code>WheelGroupSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WheelGroupSample typedDst = (WheelGroupSample) destination;
        WheelGroupSample typedSrc = (WheelGroupSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WheelGroupSample typedSrc = (WheelGroupSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motors);
        currentAlignment += rapid.LongSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.motorStatus);
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.currents);
        currentAlignment += rapid.FloatSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.targetTime);

            dst.writeFloat(typedSrc.curvature);

            dst.writeFloat(typedSrc.curvatureRate);

            dst.writeFloat(typedSrc.speed);

            dst.writeFloat(typedSrc.crabAngle);

            dst.writeFloat(typedSrc.crabRate);

            dst.writeFloat(typedSrc.targetCurvature);

            dst.writeFloat(typedSrc.targetCurvatureRate);

            dst.writeFloat(typedSrc.targetCrabRate);

            dst.writeFloat(typedSrc.targetSpeed);

            dst.writeFloat(typedSrc.targetCrabAngle);

            rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.motors, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.LongSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.motorStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.FloatSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.currents, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.FloatSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.temperatures, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WheelGroupSample typedDst = (WheelGroupSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.targetTime = src.readLong();
                typedDst.curvature = src.readFloat();
                typedDst.curvatureRate = src.readFloat();
                typedDst.speed = src.readFloat();
                typedDst.crabAngle = src.readFloat();
                typedDst.crabRate = src.readFloat();
                typedDst.targetCurvature = src.readFloat();
                typedDst.targetCurvatureRate = src.readFloat();
                typedDst.targetCrabRate = src.readFloat();
                typedDst.targetSpeed = src.readFloat();
                typedDst.targetCrabAngle = src.readFloat();
                typedDst.motors = (rapid.ext.arc.MotorStateSequence32)rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motors, src, false, true, endpoint_plugin_qos);     
                typedDst.motorStatus = (rapid.LongSequence32)rapid.LongSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.motorStatus, src, false, true, endpoint_plugin_qos);     
                typedDst.currents = (rapid.FloatSequence32)rapid.FloatSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.currents, src, false, true, endpoint_plugin_qos);     
                typedDst.temperatures = (rapid.FloatSequence32)rapid.FloatSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.temperatures, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.MotorStateSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.LongSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.FloatSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WheelGroupSample typedDst = (WheelGroupSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        WheelGroupSample typedDst
        = (WheelGroupSample) instance;
        WheelGroupSample typedSrc
        = (WheelGroupSample) key;
    ...
    */
    ...
    int mask) {
        return new WheelGroupSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WheelGroupSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected WheelGroupSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,WheelGroupSampleTypeCode.VALUE,WheelGroupSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WheelGroupSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WheelGroupSampleTypeCode.VALUE,WheelGroupSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
