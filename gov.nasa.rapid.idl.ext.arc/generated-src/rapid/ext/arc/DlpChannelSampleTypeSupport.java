...
public class DlpChannelSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpChannelSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpChannelSampleTypeSupport _singleton
    = new DlpChannelSampleTypeSupport();
    ...
    */
    public static DlpChannelSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpChannelSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpChannelSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpChannelSample.create();
    }
    ...
    * <code>this</code> is not a <code>DlpChannelSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpChannelSample typedDst = (DlpChannelSample) destination;
        DlpChannelSample typedSrc = (DlpChannelSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpChannelSample typedSrc = (DlpChannelSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpChannelSample typedDst = (DlpChannelSample) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpChannelSample typedDst = (DlpChannelSample) sample;
    ...
    int mask) {
        return new DlpChannelSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpChannelSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpChannelSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DlpChannelSampleTypeCode.VALUE,DlpChannelSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpChannelSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpChannelSampleTypeCode.VALUE,DlpChannelSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
