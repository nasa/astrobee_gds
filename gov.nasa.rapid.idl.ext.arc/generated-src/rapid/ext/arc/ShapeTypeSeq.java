...
/**
* A sequence of ShapeType instances.
*/
public final class ShapeTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShapeTypeSeq (int initialMaximum) {
        super(ShapeType.class, initialMaximum);
    }

    public ShapeTypeSeq (Collection elements) {
        super(ShapeType.class, elements);
    }
