...
/**
* A sequence of Marker instances.
*/
public final class MarkerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarkerSeq (int initialMaximum) {
        super(Marker.class, initialMaximum);
    }

    public MarkerSeq (Collection elements) {
        super(Marker.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Marker objects (beyond the original size of this object)
