...
public class Float32ConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::Float32Config";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Float32ConfigTypeSupport _singleton
    = new Float32ConfigTypeSupport();
    ...
    */
    public static Float32ConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static Float32ConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Float32ConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return Float32Config.create();
    }
    ...
    * <code>this</code> is not a <code>Float32Config</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Float32Config typedDst = (Float32Config) destination;
        Float32Config typedSrc = (Float32Config) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String32Sequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String32Sequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Float32Config typedSrc = (Float32Config) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.category );
        ...
        currentAlignment += rapid.String32Sequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.dataKeys);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.category,32);
            ...
            rapid.String32Sequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.dataKeys, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Float32Config typedDst = (Float32Config) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.category = src.readString(32);
                ...
                typedDst.dataKeys = (rapid.String32Sequence32)rapid.String32Sequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.dataKeys, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.String32Sequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Float32Config typedDst = (Float32Config) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        Float32Config typedDst
        = (Float32Config) instance;
        Float32Config typedSrc
        = (Float32Config) key;
    ...
    */
    ...
    int mask) {
        return new Float32ConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new Float32ConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected Float32ConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,Float32ConfigTypeCode.VALUE,Float32Config.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Float32ConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Float32ConfigTypeCode.VALUE,Float32Config.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
