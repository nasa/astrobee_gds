...
/**
* A sequence of GpsSample instances.
*/
public final class GpsSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GpsSampleSeq() {
        super(GpsSample.class);
    }

    public GpsSampleSeq (int initialMaximum) {
        super(GpsSample.class, initialMaximum);
    }

    public GpsSampleSeq (Collection elements) {
        super(GpsSample.class, elements);
    }
