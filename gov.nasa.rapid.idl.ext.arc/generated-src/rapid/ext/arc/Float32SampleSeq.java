...
/**
* A sequence of Float32Sample instances.
*/
public final class Float32SampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Float32SampleSeq() {
        super(Float32Sample.class);
    }

    public Float32SampleSeq (int initialMaximum) {
        super(Float32Sample.class, initialMaximum);
    }

    public Float32SampleSeq (Collection elements) {
        super(Float32Sample.class, elements);
    }
