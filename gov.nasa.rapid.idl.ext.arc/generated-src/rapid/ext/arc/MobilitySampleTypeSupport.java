...
public class MobilitySampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::MobilitySample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MobilitySampleTypeSupport _singleton
    = new MobilitySampleTypeSupport();
    ...
    */
    public static MobilitySampleTypeSupport get_instance() {
        return _singleton;
    }

    public static MobilitySampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MobilitySampleTypeCode.VALUE;
    }

    public Object create_data() {
        return MobilitySample.create();
    }
    ...
    * <code>this</code> is not a <code>MobilitySample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MobilitySample typedDst = (MobilitySample) destination;
        MobilitySample typedSrc = (MobilitySample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (32)+1);
        currentAlignment += rapid.KeyTypeValueSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += rapid.KeyTypeValueSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MobilitySample typedSrc = (MobilitySample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.goalName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.commandFrame );
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.xyt);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.xytTolerance);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.navAlgo );
        currentAlignment += rapid.KeyTypeValueSequence8TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.keyedValues);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.goalName,32);

            dst.writeString(typedSrc.commandFrame,128);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.xyt, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.xytTolerance, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.hintedSpeed);

            dst.writeString(typedSrc.navAlgo,32);

            rapid.KeyTypeValueSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.keyedValues, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MobilitySample typedDst = (MobilitySample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.goalName = src.readString(32);
                typedDst.commandFrame = src.readString(128);
                typedDst.xyt = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.xyt, src, false, true, endpoint_plugin_qos);     
                typedDst.xytTolerance = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.xytTolerance, src, false, true, endpoint_plugin_qos);     
                typedDst.hintedSpeed = src.readFloat();
                typedDst.navAlgo = src.readString(32);
                typedDst.keyedValues = (rapid.KeyTypeValueSequence8)rapid.KeyTypeValueSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.keyedValues, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.KeyTypeValueSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MobilitySample typedDst = (MobilitySample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MobilitySample typedDst
        = (MobilitySample) instance;
        MobilitySample typedSrc
        = (MobilitySample) key;
    ...
    */
    ...
    int mask) {
        return new MobilitySampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MobilitySampleDataReader(native_reader, listener, mask, this);   
    ...
    protected MobilitySampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MobilitySampleTypeCode.VALUE,MobilitySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MobilitySampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MobilitySampleTypeCode.VALUE,MobilitySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
