...
/**
* A sequence of DlpBoardSample instances.
*/
public final class DlpBoardSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpBoardSampleSeq() {
        super(DlpBoardSample.class);
    }

    public DlpBoardSampleSeq (int initialMaximum) {
        super(DlpBoardSample.class, initialMaximum);
    }

    public DlpBoardSampleSeq (Collection elements) {
        super(DlpBoardSample.class, elements);
    }
