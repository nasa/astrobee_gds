...
public class GeometryIndexModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GeometryIndexMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GeometryIndexModeTypeSupport _singleton
    = new GeometryIndexModeTypeSupport();
    ...
    */
    public static GeometryIndexModeTypeSupport get_instance() {
        return _singleton;
    }

    public static GeometryIndexModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GeometryIndexModeTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GeometryIndexMode.class;
    }
    ...
    * <code>this</code> is not a <code>GeometryIndexMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        GeometryIndexMode typedSrc = (GeometryIndexMode) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = GeometryIndexMode.valueOf(ordinal);
            if (dst == null) {
    ...
    protected GeometryIndexModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GeometryIndexModeTypeCode.VALUE,GeometryIndexMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
