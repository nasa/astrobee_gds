...
public class BatteryControllerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::BatteryController";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryControllerTypeSupport _singleton
    = new BatteryControllerTypeSupport();
    ...
    */
    public static BatteryControllerTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryControllerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryControllerTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryController.create();
    }
    ...
    * <code>this</code> is not a <code>BatteryController</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryController typedDst = (BatteryController) destination;
        BatteryController typedSrc = (BatteryController) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.BatterySlotTypeSupport.get_instance().get_array_max_size_serialized(endpoint_data, currentAlignment,  (8));
        currentAlignment += rapid.ext.arc.BatteryTypeSupport.get_instance().get_array_max_size_serialized(endpoint_data, currentAlignment,  (8));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryController typedSrc = (BatteryController) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        for(int i1__ = 0; i1__< 8; ++i1__){
            ...
            currentAlignment += rapid.ext.arc.BatterySlotTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.batterySlots[i1__]);
        }

        for(int i1__ = 0; i1__< 8; ++i1__){

            currentAlignment += rapid.ext.arc.BatteryTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.batteries[i1__]);
        }
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 8; ++i1__){
                ...
                rapid.ext.arc.BatterySlotTypeSupport.get_instance().serialize(endpoint_data, typedSrc.batterySlots[i1__], dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }

            for(int i1__ = 0; i1__< 8; ++i1__){

                rapid.ext.arc.BatteryTypeSupport.get_instance().serialize(endpoint_data, typedSrc.batteries[i1__], dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryController typedDst = (BatteryController) dst;
            typedDst.clear();      
            try{
                for(int i1__ = 0; i1__< 8; ++i1__){

                    typedDst.batterySlots[i1__] = (rapid.ext.arc.BatterySlot)rapid.ext.arc.BatterySlotTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batterySlots[i1__], src, false, true, endpoint_plugin_qos);     
                }

                for(int i1__ = 0; i1__< 8; ++i1__){

                    typedDst.batteries[i1__] = (rapid.ext.arc.Battery)rapid.ext.arc.BatteryTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batteries[i1__], src, false, true, endpoint_plugin_qos);     
                }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            for(int i1__ = 0; i1__< 8; ++i1__){
                ...
                rapid.ext.arc.BatterySlotTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }

            for(int i1__ = 0; i1__< 8; ++i1__){

                rapid.ext.arc.BatteryTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryController typedDst = (BatteryController) sample;
    ...
    int mask) {
        return new BatteryControllerDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryControllerDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryControllerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryControllerTypeCode.VALUE,BatteryController.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryControllerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryControllerTypeCode.VALUE,BatteryController.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
