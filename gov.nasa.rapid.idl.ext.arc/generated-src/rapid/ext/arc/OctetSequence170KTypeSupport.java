...
public class OctetSequence170KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::OctetSequence170K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence170KTypeSupport _singleton
    = new OctetSequence170KTypeSupport();
    ...
    */
    public static OctetSequence170KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence170KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence170KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence170K.create();
    }
    ...
    public Class get_type() {
        return OctetSequence170K.class;
    }
    ...
    * <code>this</code> is not a <code>OctetSequence170K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence170K typedDst = (OctetSequence170K) destination;
        OctetSequence170K typedSrc = (OctetSequence170K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 174760);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence170K typedSrc = (OctetSequence170K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,174760);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence170K typedDst = (OctetSequence170K) dst;
            src.readByteSequence(typedDst.userData, 174760);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence170K typedDst = (OctetSequence170K) sample;
    ...
    protected OctetSequence170KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence170KTypeCode.VALUE,OctetSequence170K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence170KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence170KTypeCode.VALUE,OctetSequence170K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
