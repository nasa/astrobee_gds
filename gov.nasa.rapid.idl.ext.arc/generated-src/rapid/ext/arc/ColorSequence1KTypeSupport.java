...
public class ColorSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::ColorSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ColorSequence1KTypeSupport _singleton
    = new ColorSequence1KTypeSupport();
    ...
    */
    public static ColorSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static ColorSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ColorSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return ColorSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>ColorSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ColorSequence1K typedDst = (ColorSequence1K) destination;
        ColorSequence1K typedSrc = (ColorSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ColorSequence1K typedSrc = (ColorSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Color4fTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,1024, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ColorSequence1K typedDst = (ColorSequence1K) dst;
            rapid.Color4fTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 1024, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.Color4fTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ColorSequence1K typedDst = (ColorSequence1K) sample;
    ...
    protected ColorSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ColorSequence1KTypeCode.VALUE,ColorSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ColorSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ColorSequence1KTypeCode.VALUE,ColorSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
