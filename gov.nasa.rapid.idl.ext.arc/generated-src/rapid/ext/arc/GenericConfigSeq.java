...
/**
* A sequence of GenericConfig instances.
*/
public final class GenericConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GenericConfigSeq() {
        super(GenericConfig.class);
    }

    public GenericConfigSeq (int initialMaximum) {
        super(GenericConfig.class, initialMaximum);
    }

    public GenericConfigSeq (Collection elements) {
        super(GenericConfig.class, elements);
    }
