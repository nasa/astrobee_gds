...
public class EphemerisSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::EphemerisSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EphemerisSampleTypeSupport _singleton
    = new EphemerisSampleTypeSupport();
    ...
    */
    public static EphemerisSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static EphemerisSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EphemerisSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return EphemerisSample.create();
    }
    ...
    * <code>this</code> is not a <code>EphemerisSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EphemerisSample typedDst = (EphemerisSample) destination;
        EphemerisSample typedSrc = (EphemerisSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EphemerisSample typedSrc = (EphemerisSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Vec3fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.vec);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.configIdx);

            dst.writeLong(typedSrc.solutionTime);

            dst.writeDouble(typedSrc.lat);

            dst.writeDouble(typedSrc.lon);

            rapid.Vec3fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.vec, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EphemerisSample typedDst = (EphemerisSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.configIdx = src.readInt();
                typedDst.solutionTime = src.readLong();
                typedDst.lat = src.readDouble();
                typedDst.lon = src.readDouble();
                typedDst.vec = (rapid.Vec3f)rapid.Vec3fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.vec, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EphemerisSample typedDst = (EphemerisSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        EphemerisSample typedDst
        = (EphemerisSample) instance;
        EphemerisSample typedSrc
        = (EphemerisSample) key;
    ...
    */
    ...
    int mask) {
        return new EphemerisSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EphemerisSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected EphemerisSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,EphemerisSampleTypeCode.VALUE,EphemerisSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EphemerisSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EphemerisSampleTypeCode.VALUE,EphemerisSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
