...
public class BatteryPackSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::BatteryPackSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryPackSampleTypeSupport _singleton
    = new BatteryPackSampleTypeSupport();
    ...
    */
    public static BatteryPackSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryPackSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryPackSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryPackSample.create();
    }
    ...
    public Class get_type() {
        return BatteryPackSample.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryPackSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryPackSample typedDst = (BatteryPackSample) destination;
        BatteryPackSample typedSrc = (BatteryPackSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryPackSample typedSrc = (BatteryPackSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.controllers);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.controllers, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.message,128);

            dst.writeShort(typedSrc.minutesToEmpty);

            dst.writeShort(typedSrc.overallCharge);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryPackSample typedDst = (BatteryPackSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.controllers = (rapid.ext.arc.BatteryControllerSequence16)rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.controllers, src, false, true, endpoint_plugin_qos);     
                typedDst.message = src.readString(128);
                typedDst.minutesToEmpty = src.readShort();
                typedDst.overallCharge = src.readShort();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.BatteryControllerSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryPackSample typedDst = (BatteryPackSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryPackSample typedDst
        = (BatteryPackSample) instance;
        BatteryPackSample typedSrc
        = (BatteryPackSample) key;
    ...
    */
    ...
    int mask) {
        return new BatteryPackSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryPackSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryPackSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryPackSampleTypeCode.VALUE,BatteryPackSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryPackSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryPackSampleTypeCode.VALUE,BatteryPackSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
