...
/**
* A sequence of ColorSequence1K instances.
*/
public final class ColorSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ColorSequence1KSeq() {
        super(ColorSequence1K.class);
    }

    public ColorSequence1KSeq (int initialMaximum) {
        super(ColorSequence1K.class, initialMaximum);
    }

    public ColorSequence1KSeq (Collection elements) {
        super(ColorSequence1K.class, elements);
    }
