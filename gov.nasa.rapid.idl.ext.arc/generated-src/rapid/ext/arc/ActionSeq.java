...
/**
* A sequence of Action instances.
*/
public final class ActionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ActionSeq (int initialMaximum) {
        super(Action.class, initialMaximum);
    }

    public ActionSeq (Collection elements) {
        super(Action.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Action objects (beyond the original size of this object)
