...
/**
* A sequence of PointSequence1K instances.
*/
public final class PointSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PointSequence1KSeq() {
        super(PointSequence1K.class);
    }

    public PointSequence1KSeq (int initialMaximum) {
        super(PointSequence1K.class, initialMaximum);
    }

    public PointSequence1KSeq (Collection elements) {
        super(PointSequence1K.class, elements);
    }
