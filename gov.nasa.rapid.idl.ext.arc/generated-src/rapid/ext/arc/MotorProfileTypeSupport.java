...
public class MotorProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::MotorProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorProfileTypeSupport _singleton
    = new MotorProfileTypeSupport();
    ...
    */
    public static MotorProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static MotorProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return MotorProfile.create();
    }
    ...
    * <code>this</code> is not a <code>MotorProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorProfile typedDst = (MotorProfile) destination;
        MotorProfile typedSrc = (MotorProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.CtrlModeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.arc.PositionModeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.CtrlModeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.arc.PositionModeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MotorProfile typedSrc = (MotorProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.CtrlModeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.ctrlMode);
        currentAlignment += rapid.ext.arc.PositionModeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.posMode);
        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.CtrlModeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.ctrlMode, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.arc.PositionModeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.posMode, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeDouble(typedSrc.position);

            dst.writeFloat(typedSrc.speed);

            dst.writeFloat(typedSrc.acc);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorProfile typedDst = (MotorProfile) dst;
            typedDst.clear();      
            try{
                typedDst.ctrlMode = (rapid.ext.arc.CtrlMode)rapid.ext.arc.CtrlModeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.ctrlMode, src, false, true, endpoint_plugin_qos);     
                typedDst.posMode = (rapid.ext.arc.PositionMode)rapid.ext.arc.PositionModeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.posMode, src, false, true, endpoint_plugin_qos);     
                typedDst.position = src.readDouble();
                typedDst.speed = src.readFloat();
                typedDst.acc = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.CtrlModeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.arc.PositionModeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorProfile typedDst = (MotorProfile) sample;
    ...
    int mask) {
        return new MotorProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MotorProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected MotorProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorProfileTypeCode.VALUE,MotorProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorProfileTypeCode.VALUE,MotorProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
