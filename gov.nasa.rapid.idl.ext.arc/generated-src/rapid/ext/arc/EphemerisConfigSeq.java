...
/**
* A sequence of EphemerisConfig instances.
*/
public final class EphemerisConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EphemerisConfigSeq() {
        super(EphemerisConfig.class);
    }

    public EphemerisConfigSeq (int initialMaximum) {
        super(EphemerisConfig.class, initialMaximum);
    }

    public EphemerisConfigSeq (Collection elements) {
        super(EphemerisConfig.class, elements);
    }
