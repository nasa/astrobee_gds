...
public class PositionModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::PositionMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PositionModeTypeSupport _singleton
    = new PositionModeTypeSupport();
    ...
    */
    public static PositionModeTypeSupport get_instance() {
        return _singleton;
    }

    public static PositionModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PositionModeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>PositionMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PositionMode typedSrc = (PositionMode) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PositionMode.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PositionModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PositionModeTypeCode.VALUE,PositionMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
