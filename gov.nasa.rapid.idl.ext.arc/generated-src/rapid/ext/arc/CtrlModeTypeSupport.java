...
public class CtrlModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::CtrlMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CtrlModeTypeSupport _singleton
    = new CtrlModeTypeSupport();
    ...
    */
    public static CtrlModeTypeSupport get_instance() {
        return _singleton;
    }

    public static CtrlModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CtrlModeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CtrlMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        CtrlMode typedSrc = (CtrlMode) src;
    ...
    protected CtrlModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CtrlModeTypeCode.VALUE,CtrlMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
