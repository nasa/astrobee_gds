...
/**
* A sequence of NamedIndexRange instances.
*/
public final class NamedIndexRangeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public NamedIndexRangeSeq() {
        super(NamedIndexRange.class);
    }

    public NamedIndexRangeSeq (int initialMaximum) {
        super(NamedIndexRange.class, initialMaximum);
    }

    public NamedIndexRangeSeq (Collection elements) {
        super(NamedIndexRange.class, elements);
    }
