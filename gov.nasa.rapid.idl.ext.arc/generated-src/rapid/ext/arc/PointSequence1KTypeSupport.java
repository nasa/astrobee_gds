...
public class PointSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::PointSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointSequence1KTypeSupport _singleton
    = new PointSequence1KTypeSupport();
    ...
    */
    public static PointSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static PointSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return PointSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>PointSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PointSequence1K typedDst = (PointSequence1K) destination;
        PointSequence1K typedSrc = (PointSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Vec3fTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Vec3fTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PointSequence1K typedSrc = (PointSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Vec3fTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Vec3fTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,1024, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PointSequence1K typedDst = (PointSequence1K) dst;
            rapid.Vec3fTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 1024, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.Vec3fTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PointSequence1K typedDst = (PointSequence1K) sample;
    ...
    protected PointSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointSequence1KTypeCode.VALUE,PointSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PointSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PointSequence1KTypeCode.VALUE,PointSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
