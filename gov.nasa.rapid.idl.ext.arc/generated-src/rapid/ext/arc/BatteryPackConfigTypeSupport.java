...
public class BatteryPackConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::BatteryPackConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryPackConfigTypeSupport _singleton
    = new BatteryPackConfigTypeSupport();
    ...
    */
    public static BatteryPackConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryPackConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryPackConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryPackConfig.create();
    }
    ...
    public Class get_type() {
        return BatteryPackConfig.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryPackConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryPackConfig typedDst = (BatteryPackConfig) destination;
        BatteryPackConfig typedSrc = (BatteryPackConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryPackConfig typedSrc = (BatteryPackConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.String32Sequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.controllerNames);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.String32Sequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.controllerNames, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryPackConfig typedDst = (BatteryPackConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.controllerNames = (rapid.String32Sequence16)rapid.String32Sequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.controllerNames, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryPackConfig typedDst = (BatteryPackConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryPackConfig typedDst
        = (BatteryPackConfig) instance;
        BatteryPackConfig typedSrc
        = (BatteryPackConfig) key;
    ...
    */
    ...
    int mask) {
        return new BatteryPackConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryPackConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryPackConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryPackConfigTypeCode.VALUE,BatteryPackConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryPackConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryPackConfigTypeCode.VALUE,BatteryPackConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
