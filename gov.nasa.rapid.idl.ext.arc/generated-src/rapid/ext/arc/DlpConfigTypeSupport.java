...
public class DlpConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpConfigTypeSupport _singleton
    = new DlpConfigTypeSupport();
    ...
    */
    public static DlpConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static DlpConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return DlpConfig.create();
    }
    ...
    * <code>this</code> is not a <code>DlpConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpConfig typedDst = (DlpConfig) destination;
        DlpConfig typedSrc = (DlpConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpConfig typedSrc = (DlpConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.dlpBoards, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpConfig typedDst = (DlpConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.dlpBoards = (rapid.ext.arc.DlpBoardConfigSequence32)rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.dlpBoards, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.DlpBoardConfigSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpConfig typedDst = (DlpConfig) sample;
    ...
    */
    ...
    int mask) {
        return new DlpConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DlpConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected DlpConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DlpConfigTypeCode.VALUE,DlpConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpConfigTypeCode.VALUE,DlpConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
