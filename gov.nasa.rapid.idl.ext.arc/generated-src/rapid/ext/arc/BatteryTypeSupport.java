...
public class BatteryTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::Battery";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryTypeSupport _singleton
    = new BatteryTypeSupport();
    ...
    */
    public static BatteryTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Battery</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Battery typedDst = (Battery) destination;
        Battery typedSrc = (Battery) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Battery typedSrc = (Battery) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.serialNumber);

            dst.writeFloat(typedSrc.voltage);

            dst.writeFloat(typedSrc.averageCurrent);

            dst.writeFloat(typedSrc.temperature);

            dst.writeFloat(typedSrc.relativeState);

            dst.writeFloat(typedSrc.absoluteState);

            dst.writeFloat(typedSrc.remainingCapacity);

            dst.writeFloat(typedSrc.fullChargeCapacity);

            dst.writeLong(typedSrc.remainingTime);

            dst.writeLong(typedSrc.averageRemainingTime);

            dst.writeLong(typedSrc.averageRemainingChargeTime);

            dst.writeInt(typedSrc.numberOfChargeCycles);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Battery typedDst = (Battery) dst;
            typedDst.clear();      
            try{
                typedDst.serialNumber = src.readInt();
                typedDst.voltage = src.readFloat();
                typedDst.averageCurrent = src.readFloat();
                typedDst.temperature = src.readFloat();
                typedDst.relativeState = src.readFloat();
                typedDst.absoluteState = src.readFloat();
                typedDst.remainingCapacity = src.readFloat();
                typedDst.fullChargeCapacity = src.readFloat();
                typedDst.remainingTime = src.readLong();
                typedDst.averageRemainingTime = src.readLong();
                typedDst.averageRemainingChargeTime = src.readLong();
                typedDst.numberOfChargeCycles = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Battery typedDst = (Battery) sample;
    ...
    int mask) {
        return new BatteryDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryTypeCode.VALUE,Battery.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryTypeCode.VALUE,Battery.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
