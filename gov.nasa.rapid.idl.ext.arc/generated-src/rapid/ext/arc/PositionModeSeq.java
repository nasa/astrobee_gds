...
/**
* A sequence of PositionMode instances.
*/
public final class PositionModeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PositionModeSeq() {
        super(PositionMode.class);
    }

    public PositionModeSeq (int initialMaximum) {
        super(PositionMode.class, initialMaximum);
    }

    public PositionModeSeq (Collection elements) {
        super(PositionMode.class, elements);
    }
