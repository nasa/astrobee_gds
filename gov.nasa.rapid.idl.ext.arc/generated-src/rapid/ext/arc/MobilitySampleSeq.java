...
/**
* A sequence of MobilitySample instances.
*/
public final class MobilitySampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MobilitySampleSeq() {
        super(MobilitySample.class);
    }

    public MobilitySampleSeq (int initialMaximum) {
        super(MobilitySample.class, initialMaximum);
    }

    public MobilitySampleSeq (Collection elements) {
        super(MobilitySample.class, elements);
    }
