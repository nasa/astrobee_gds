...
public class SpectrumSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::SpectrumSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SpectrumSampleTypeSupport _singleton
    = new SpectrumSampleTypeSupport();
    ...
    */
    public static SpectrumSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static SpectrumSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SpectrumSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return SpectrumSample.create();
    }
    ...
    * <code>this</code> is not a <code>SpectrumSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SpectrumSample typedDst = (SpectrumSample) destination;
        SpectrumSample typedSrc = (SpectrumSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.LongSequence1KTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.LongSequence1KTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SpectrumSample typedSrc = (SpectrumSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.LongSequence1KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.spectrumData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.LongSequence1KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.spectrumData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SpectrumSample typedDst = (SpectrumSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.spectrumData = (rapid.LongSequence1K)rapid.LongSequence1KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.spectrumData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.LongSequence1KTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SpectrumSample typedDst = (SpectrumSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SpectrumSample typedDst
        = (SpectrumSample) instance;
        SpectrumSample typedSrc
        = (SpectrumSample) key;
    ...
    */
    ...
    int mask) {
        return new SpectrumSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SpectrumSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected SpectrumSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SpectrumSampleTypeCode.VALUE,SpectrumSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SpectrumSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SpectrumSampleTypeCode.VALUE,SpectrumSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
