...
public class StateMachineConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::StateMachineConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StateMachineConfigTypeSupport _singleton
    = new StateMachineConfigTypeSupport();
    ...
    */
    public static StateMachineConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static StateMachineConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StateMachineConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return StateMachineConfig.create();
    }
    ...
    public Class get_type() {
        return StateMachineConfig.class;
    }
    ...
    * <code>this</code> is not a <code>StateMachineConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StateMachineConfig typedDst = (StateMachineConfig) destination;
        StateMachineConfig typedSrc = (StateMachineConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String32Sequence128TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String32Sequence128TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        StateMachineConfig typedSrc = (StateMachineConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.subsystem );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.stateMachine );
        currentAlignment += rapid.String32Sequence128TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.states);
        currentAlignment += rapid.String32Sequence128TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.events);
        currentAlignment += rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.transitions);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.subsystem,32);

            dst.writeString(typedSrc.stateMachine,32);

            rapid.String32Sequence128TypeSupport.get_instance().serialize(endpoint_data, typedSrc.states, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.String32Sequence128TypeSupport.get_instance().serialize(endpoint_data, typedSrc.events, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.transitions, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StateMachineConfig typedDst = (StateMachineConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.subsystem = src.readString(32);
                typedDst.stateMachine = src.readString(32);
                typedDst.states = (rapid.String32Sequence128)rapid.String32Sequence128TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.states, src, false, true, endpoint_plugin_qos);     
                typedDst.events = (rapid.String32Sequence128)rapid.String32Sequence128TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.events, src, false, true, endpoint_plugin_qos);     
                typedDst.transitions = (rapid.ext.arc.TransitionSequence16K)rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.transitions, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.TransitionSequence16KTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StateMachineConfig typedDst = (StateMachineConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        StateMachineConfig typedDst
        = (StateMachineConfig) instance;
        StateMachineConfig typedSrc
        = (StateMachineConfig) key;
    ...
    */
    ...
    int mask) {
        return new StateMachineConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new StateMachineConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected StateMachineConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,StateMachineConfigTypeCode.VALUE,StateMachineConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StateMachineConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StateMachineConfigTypeCode.VALUE,StateMachineConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
