...
public class GeometryConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GeometryConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GeometryConfigTypeSupport _singleton
    = new GeometryConfigTypeSupport();
    ...
    */
    public static GeometryConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static GeometryConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GeometryConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>GeometryConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GeometryConfig typedDst = (GeometryConfig) destination;
        GeometryConfig typedSrc = (GeometryConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GeometryConfig typedSrc = (GeometryConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        /** each distinct geometry must have a unique identifier */
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.geometryName );
        /** reference frame for geometry - must be a valid FrameStore */
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.refFrame );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.geometryName,128);
            /** reference frame for geometry - must be a valid FrameStore */

            dst.writeString(typedSrc.refFrame,32);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GeometryConfig typedDst = (GeometryConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.geometryName = src.readString(128);
                /** reference frame for geometry - must be a valid FrameStore */
                typedDst.refFrame = src.readString(32);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GeometryConfig typedDst = (GeometryConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GeometryConfig typedDst
        = (GeometryConfig) instance;
        GeometryConfig typedSrc
        = (GeometryConfig) key;
    ...
    */
    ...
    int mask) {
        return new GeometryConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GeometryConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected GeometryConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GeometryConfigTypeCode.VALUE,GeometryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GeometryConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GeometryConfigTypeCode.VALUE,GeometryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
