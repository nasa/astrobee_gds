...
/**
* A sequence of TransitionTriple instances.
*/
public final class TransitionTripleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TransitionTripleSeq() {
        super(TransitionTriple.class);
    }

    public TransitionTripleSeq (int initialMaximum) {
        super(TransitionTriple.class, initialMaximum);
    }

    public TransitionTripleSeq (Collection elements) {
        super(TransitionTriple.class, elements);
    }
