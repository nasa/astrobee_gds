...
public class BatterySlotTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::BatterySlot";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatterySlotTypeSupport _singleton
    = new BatterySlotTypeSupport();
    ...
    */
    public static BatterySlotTypeSupport get_instance() {
        return _singleton;
    }

    public static BatterySlotTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatterySlotTypeCode.VALUE;
    }

    public Object create_data() {
        return BatterySlot.create();
    }
    ...
    * <code>this</code> is not a <code>BatterySlot</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatterySlot typedDst = (BatterySlot) destination;
        BatterySlot typedSrc = (BatterySlot) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatterySlot typedSrc = (BatterySlot) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.charging);

            dst.writeBoolean(typedSrc.supplyingPower);

            dst.writeBoolean(typedSrc.chargePowerPresent);

            dst.writeBoolean(typedSrc.powerNoGood);

            dst.writeBoolean(typedSrc.chargeInhibited);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatterySlot typedDst = (BatterySlot) dst;
            typedDst.clear();      
            try{
                typedDst.present = src.readBoolean();
                typedDst.charging = src.readBoolean();
                typedDst.supplyingPower = src.readBoolean();
                typedDst.chargePowerPresent = src.readBoolean();
                typedDst.powerNoGood = src.readBoolean();
                typedDst.chargeInhibited = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatterySlot typedDst = (BatterySlot) sample;
    ...
    int mask) {
        return new BatterySlotDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatterySlotDataReader(native_reader, listener, mask, this);   
    ...
    protected BatterySlotTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatterySlotTypeCode.VALUE,BatterySlot.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatterySlotTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatterySlotTypeCode.VALUE,BatterySlot.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
