...
/**
* A sequence of GpsConfig instances.
*/
public final class GpsConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GpsConfigSeq() {
        super(GpsConfig.class);
    }

    public GpsConfigSeq (int initialMaximum) {
        super(GpsConfig.class, initialMaximum);
    }

    public GpsConfigSeq (Collection elements) {
        super(GpsConfig.class, elements);
    }
