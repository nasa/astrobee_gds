...
public class EphemerisConfigEntryTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::EphemerisConfigEntry";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EphemerisConfigEntryTypeSupport _singleton
    = new EphemerisConfigEntryTypeSupport();
    ...
    */
    public static EphemerisConfigEntryTypeSupport get_instance() {
        return _singleton;
    }

    public static EphemerisConfigEntryTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EphemerisConfigEntryTypeCode.VALUE;
    }

    public Object create_data() {
        return EphemerisConfigEntry.create();
    }
    ...
    public Object create_key() {
        return new EphemerisConfigEntry();
    }
    ...
    public Class get_type() {
        return EphemerisConfigEntry.class;
    }
    ...
    * <code>this</code> is not a <code>EphemerisConfigEntry</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EphemerisConfigEntry typedDst = (EphemerisConfigEntry) destination;
        EphemerisConfigEntry typedSrc = (EphemerisConfigEntry) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EphemerisConfigEntry typedSrc = (EphemerisConfigEntry) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.solutionName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.referenceFrame );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.sourceBody );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.targetBody );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.solutionName,255);

            dst.writeString(typedSrc.referenceFrame,255);

            dst.writeString(typedSrc.sourceBody,255);

            dst.writeString(typedSrc.targetBody,255);

            dst.writeLong(typedSrc.timeOffset);

            dst.writeLong(typedSrc.period);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EphemerisConfigEntry typedDst = (EphemerisConfigEntry) dst;
            typedDst.clear();      
            try{
                typedDst.solutionName = src.readString(255);
                typedDst.referenceFrame = src.readString(255);
                typedDst.sourceBody = src.readString(255);
                typedDst.targetBody = src.readString(255);
                typedDst.timeOffset = src.readLong();
                typedDst.period = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EphemerisConfigEntry typedDst = (EphemerisConfigEntry) sample;
    ...
    int mask) {
        return new EphemerisConfigEntryDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EphemerisConfigEntryDataReader(native_reader, listener, mask, this);   
    ...
    protected EphemerisConfigEntryTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EphemerisConfigEntryTypeCode.VALUE,EphemerisConfigEntry.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EphemerisConfigEntryTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EphemerisConfigEntryTypeCode.VALUE,EphemerisConfigEntry.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
