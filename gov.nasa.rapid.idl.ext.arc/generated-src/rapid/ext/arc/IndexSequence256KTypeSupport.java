...
public class IndexSequence256KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::IndexSequence256K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final IndexSequence256KTypeSupport _singleton
    = new IndexSequence256KTypeSupport();
    ...
    */
    public static IndexSequence256KTypeSupport get_instance() {
        return _singleton;
    }

    public static IndexSequence256KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return IndexSequence256KTypeCode.VALUE;
    }

    public Object create_data() {
        return IndexSequence256K.create();
    }
    ...
    public Class get_type() {
        return IndexSequence256K.class;
    }
    ...
    * <code>this</code> is not a <code>IndexSequence256K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        IndexSequence256K typedDst = (IndexSequence256K) destination;
        IndexSequence256K typedSrc = (IndexSequence256K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 262144);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        IndexSequence256K typedSrc = (IndexSequence256K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,262144);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            IndexSequence256K typedDst = (IndexSequence256K) dst;
            src.readShortSequence(typedDst.userData, 262144);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            IndexSequence256K typedDst = (IndexSequence256K) sample;
    ...
    protected IndexSequence256KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,IndexSequence256KTypeCode.VALUE,IndexSequence256K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected IndexSequence256KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,IndexSequence256KTypeCode.VALUE,IndexSequence256K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
