...
/**
* A sequence of MotorProfile instances.
*/
public final class MotorProfileSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MotorProfileSeq() {
        super(MotorProfile.class);
    }

    public MotorProfileSeq (int initialMaximum) {
        super(MotorProfile.class, initialMaximum);
    }

    public MotorProfileSeq (Collection elements) {
        super(MotorProfile.class, elements);
    }
