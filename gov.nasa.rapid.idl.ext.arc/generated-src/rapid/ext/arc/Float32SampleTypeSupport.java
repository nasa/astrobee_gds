...
public class Float32SampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::Float32Sample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Float32SampleTypeSupport _singleton
    = new Float32SampleTypeSupport();
    ...
    */
    public static Float32SampleTypeSupport get_instance() {
        return _singleton;
    }

    public static Float32SampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Float32SampleTypeCode.VALUE;
    }

    public Object create_data() {
        return Float32Sample.create();
    }
    ...
    * <code>this</code> is not a <code>Float32Sample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Float32Sample typedDst = (Float32Sample) destination;
        Float32Sample typedSrc = (Float32Sample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Float32Sample typedSrc = (Float32Sample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.FloatSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.data, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Float32Sample typedDst = (Float32Sample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.data = (rapid.FloatSequence32)rapid.FloatSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.data, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Float32Sample typedDst = (Float32Sample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        Float32Sample typedDst
        = (Float32Sample) instance;
        Float32Sample typedSrc
        = (Float32Sample) key;
    ...
    */
    ...
    int mask) {
        return new Float32SampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new Float32SampleDataReader(native_reader, listener, mask, this);   
    ...
    protected Float32SampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,Float32SampleTypeCode.VALUE,Float32Sample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Float32SampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Float32SampleTypeCode.VALUE,Float32Sample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
