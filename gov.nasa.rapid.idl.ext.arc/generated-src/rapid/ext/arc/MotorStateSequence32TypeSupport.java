...
public class MotorStateSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::MotorStateSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MotorStateSequence32TypeSupport _singleton
    = new MotorStateSequence32TypeSupport();
    ...
    */
    public static MotorStateSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static MotorStateSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MotorStateSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return MotorStateSequence32.create();
    }
    ...
    public Object create_key() {
        return new MotorStateSequence32();
    }
    ...
    public Class get_type() {
        return MotorStateSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>MotorStateSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MotorStateSequence32 typedDst = (MotorStateSequence32) destination;
        MotorStateSequence32 typedSrc = (MotorStateSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MotorStateTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.MotorStateTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MotorStateSequence32 typedSrc = (MotorStateSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.MotorStateTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.MotorStateTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MotorStateSequence32 typedDst = (MotorStateSequence32) dst;
            rapid.ext.arc.MotorStateTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.MotorStateTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MotorStateSequence32 typedDst = (MotorStateSequence32) sample;
    ...
    protected MotorStateSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MotorStateSequence32TypeCode.VALUE,MotorStateSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MotorStateSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MotorStateSequence32TypeCode.VALUE,MotorStateSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
