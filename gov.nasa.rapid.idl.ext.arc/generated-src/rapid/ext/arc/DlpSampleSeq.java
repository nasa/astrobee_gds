...
/**
* A sequence of DlpSample instances.
*/
public final class DlpSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpSampleSeq() {
        super(DlpSample.class);
    }

    public DlpSampleSeq (int initialMaximum) {
        super(DlpSample.class, initialMaximum);
    }

    public DlpSampleSeq (Collection elements) {
        super(DlpSample.class, elements);
    }
