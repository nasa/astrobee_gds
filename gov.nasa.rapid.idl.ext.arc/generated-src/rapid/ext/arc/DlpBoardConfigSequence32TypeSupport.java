...
public class DlpBoardConfigSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::DlpBoardConfigSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DlpBoardConfigSequence32TypeSupport _singleton
    = new DlpBoardConfigSequence32TypeSupport();
    ...
    */
    public static DlpBoardConfigSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static DlpBoardConfigSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DlpBoardConfigSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return DlpBoardConfigSequence32.create();
    }
    ...
    public Object create_key() {
        return new DlpBoardConfigSequence32();
    }
    ...
    public Class get_type() {
        return DlpBoardConfigSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>DlpBoardConfigSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DlpBoardConfigSequence32 typedDst = (DlpBoardConfigSequence32) destination;
        DlpBoardConfigSequence32 typedSrc = (DlpBoardConfigSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DlpBoardConfigSequence32 typedSrc = (DlpBoardConfigSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DlpBoardConfigSequence32 typedDst = (DlpBoardConfigSequence32) dst;
            rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.DlpBoardConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DlpBoardConfigSequence32 typedDst = (DlpBoardConfigSequence32) sample;
    ...
    protected DlpBoardConfigSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DlpBoardConfigSequence32TypeCode.VALUE,DlpBoardConfigSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DlpBoardConfigSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DlpBoardConfigSequence32TypeCode.VALUE,DlpBoardConfigSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
