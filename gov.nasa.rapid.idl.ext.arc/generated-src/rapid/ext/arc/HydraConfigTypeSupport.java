...
public class HydraConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::HydraConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HydraConfigTypeSupport _singleton
    = new HydraConfigTypeSupport();
    ...
    */
    public static HydraConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static HydraConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HydraConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return HydraConfig.create();
    }
    ...
    * <code>this</code> is not a <code>HydraConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HydraConfig typedDst = (HydraConfig) destination;
        HydraConfig typedSrc = (HydraConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HydraConfig typedSrc = (HydraConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.valueKeys, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HydraConfig typedDst = (HydraConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.valueKeys = (rapid.KeyTypeValueSequence32)rapid.KeyTypeValueSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.valueKeys, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HydraConfig typedDst = (HydraConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        HydraConfig typedDst
        = (HydraConfig) instance;
        HydraConfig typedSrc
        = (HydraConfig) key;
    ...
    */
    ...
    int mask) {
        return new HydraConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HydraConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected HydraConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,HydraConfigTypeCode.VALUE,HydraConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HydraConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HydraConfigTypeCode.VALUE,HydraConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
