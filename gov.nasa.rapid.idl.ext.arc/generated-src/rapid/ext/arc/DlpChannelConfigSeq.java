...
/**
* A sequence of DlpChannelConfig instances.
*/
public final class DlpChannelConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpChannelConfigSeq() {
        super(DlpChannelConfig.class);
    }

    public DlpChannelConfigSeq (int initialMaximum) {
        super(DlpChannelConfig.class, initialMaximum);
    }

    public DlpChannelConfigSeq (Collection elements) {
        super(DlpChannelConfig.class, elements);
    }
