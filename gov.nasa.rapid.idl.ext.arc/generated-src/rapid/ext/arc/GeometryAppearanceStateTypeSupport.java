...
public class GeometryAppearanceStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GeometryAppearanceState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GeometryAppearanceStateTypeSupport _singleton
    = new GeometryAppearanceStateTypeSupport();
    ...
    */
    public static GeometryAppearanceStateTypeSupport get_instance() {
        return _singleton;
    }

    public static GeometryAppearanceStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GeometryAppearanceStateTypeCode.VALUE;
    }

    public Object create_data() {
        return GeometryAppearanceState.create();
    }
    ...
    public Object create_key() {
        return new GeometryAppearanceState();
    }
    ...
    public Class get_type() {
        return GeometryAppearanceState.class;
    }
    ...
    * <code>this</code> is not a <code>GeometryAppearanceState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GeometryAppearanceState typedDst = (GeometryAppearanceState) destination;
        GeometryAppearanceState typedSrc = (GeometryAppearanceState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GeometryAppearanceState typedSrc = (GeometryAppearanceState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.diffuse);
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.ambient);
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.specular);
        currentAlignment += rapid.Color4fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.emissive);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.texImage0Url );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.hasMaterial);

            rapid.Color4fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.diffuse, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Color4fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.ambient, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Color4fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.specular, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Color4fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.emissive, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.shininess);

            dst.writeBoolean(typedSrc.hasTexture);

            dst.writeString(typedSrc.texImage0Url,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GeometryAppearanceState typedDst = (GeometryAppearanceState) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.hasMaterial = src.readBoolean();
                typedDst.diffuse = (rapid.Color4f)rapid.Color4fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.diffuse, src, false, true, endpoint_plugin_qos);     
                typedDst.ambient = (rapid.Color4f)rapid.Color4fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.ambient, src, false, true, endpoint_plugin_qos);     
                typedDst.specular = (rapid.Color4f)rapid.Color4fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.specular, src, false, true, endpoint_plugin_qos);     
                typedDst.emissive = (rapid.Color4f)rapid.Color4fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.emissive, src, false, true, endpoint_plugin_qos);     
                typedDst.shininess = src.readFloat();
                typedDst.hasTexture = src.readBoolean();
                typedDst.texImage0Url = src.readString(128);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GeometryAppearanceState typedDst = (GeometryAppearanceState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GeometryAppearanceState typedDst
        = (GeometryAppearanceState) instance;
        GeometryAppearanceState typedSrc
        = (GeometryAppearanceState) key;
    ...
    */
    ...
    int mask) {
        return new GeometryAppearanceStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GeometryAppearanceStateDataReader(native_reader, listener, mask, this);   
    ...
    protected GeometryAppearanceStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GeometryAppearanceStateTypeCode.VALUE,GeometryAppearanceState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GeometryAppearanceStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GeometryAppearanceStateTypeCode.VALUE,GeometryAppearanceState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
