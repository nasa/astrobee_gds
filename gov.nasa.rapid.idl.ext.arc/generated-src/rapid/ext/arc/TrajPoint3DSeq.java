...
/**
* A sequence of TrajPoint3D instances.
*/
public final class TrajPoint3DSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TrajPoint3DSeq() {
        super(TrajPoint3D.class);
    }

    public TrajPoint3DSeq (int initialMaximum) {
        super(TrajPoint3D.class, initialMaximum);
    }

    public TrajPoint3DSeq (Collection elements) {
        super(TrajPoint3D.class, elements);
    }
