...
/**
* A sequence of Float32Config instances.
*/
public final class Float32ConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Float32ConfigSeq() {
        super(Float32Config.class);
    }

    public Float32ConfigSeq (int initialMaximum) {
        super(Float32Config.class, initialMaximum);
    }

    public Float32ConfigSeq (Collection elements) {
        super(Float32Config.class, elements);
    }
