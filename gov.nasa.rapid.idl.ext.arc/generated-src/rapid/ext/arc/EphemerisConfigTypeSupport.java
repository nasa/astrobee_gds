...
public class EphemerisConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::EphemerisConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EphemerisConfigTypeSupport _singleton
    = new EphemerisConfigTypeSupport();
    ...
    */
    public static EphemerisConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static EphemerisConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EphemerisConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return EphemerisConfig.create();
    }
    ...
    * <code>this</code> is not a <code>EphemerisConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EphemerisConfig typedDst = (EphemerisConfig) destination;
        EphemerisConfig typedSrc = (EphemerisConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EphemerisConfig typedSrc = (EphemerisConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.entries);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.entries, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EphemerisConfig typedDst = (EphemerisConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.entries = (rapid.ext.arc.EphemerisConfigVector32)rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.entries, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.EphemerisConfigVector32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EphemerisConfig typedDst = (EphemerisConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        EphemerisConfig typedDst
        = (EphemerisConfig) instance;
        EphemerisConfig typedSrc
        = (EphemerisConfig) key;
    ...
    */
    ...
    int mask) {
        return new EphemerisConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EphemerisConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected EphemerisConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,EphemerisConfigTypeCode.VALUE,EphemerisConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EphemerisConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EphemerisConfigTypeCode.VALUE,EphemerisConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
