...
public class NamedIndexRangeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::NamedIndexRange";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedIndexRangeTypeSupport _singleton
    = new NamedIndexRangeTypeSupport();
    ...
    */
    public static NamedIndexRangeTypeSupport get_instance() {
        return _singleton;
    }

    public static NamedIndexRangeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedIndexRangeTypeCode.VALUE;
    }

    public Object create_data() {
        return NamedIndexRange.create();
    }
    ...
    * <code>this</code> is not a <code>NamedIndexRange</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedIndexRange typedDst = (NamedIndexRange) destination;
        NamedIndexRange typedSrc = (NamedIndexRange) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedIndexRange typedSrc = (NamedIndexRange) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShort(typedSrc.start);

            dst.writeShort(typedSrc.end);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedIndexRange typedDst = (NamedIndexRange) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.start = src.readShort();
                typedDst.end = src.readShort();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedIndexRange typedDst = (NamedIndexRange) sample;
    ...
    int mask) {
        return new NamedIndexRangeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NamedIndexRangeDataReader(native_reader, listener, mask, this);   
    ...
    protected NamedIndexRangeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedIndexRangeTypeCode.VALUE,NamedIndexRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedIndexRangeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedIndexRangeTypeCode.VALUE,NamedIndexRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
