...
public class TrajPoint3DSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::TrajPoint3DSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TrajPoint3DSequenceTypeSupport _singleton
    = new TrajPoint3DSequenceTypeSupport();
    ...
    */
    public static TrajPoint3DSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static TrajPoint3DSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TrajPoint3DSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return TrajPoint3DSequence.create();
    }
    ...
    public Object create_key() {
        return new TrajPoint3DSequence();
    }
    ...
    public Class get_type() {
        return TrajPoint3DSequence.class;
    }
    ...
    * <code>this</code> is not a <code>TrajPoint3DSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TrajPoint3DSequence typedDst = (TrajPoint3DSequence) destination;
        TrajPoint3DSequence typedSrc = (TrajPoint3DSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TrajPoint3DSequence typedSrc = (TrajPoint3DSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TrajPoint3DSequence typedDst = (TrajPoint3DSequence) dst;
            rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.TrajPoint3DTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TrajPoint3DSequence typedDst = (TrajPoint3DSequence) sample;
    ...
    protected TrajPoint3DSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TrajPoint3DSequenceTypeCode.VALUE,TrajPoint3DSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TrajPoint3DSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TrajPoint3DSequenceTypeCode.VALUE,TrajPoint3DSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
