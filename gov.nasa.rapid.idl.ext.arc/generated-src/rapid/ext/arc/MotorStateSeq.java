...
/**
* A sequence of MotorState instances.
*/
public final class MotorStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MotorStateSeq() {
        super(MotorState.class);
    }

    public MotorStateSeq (int initialMaximum) {
        super(MotorState.class, initialMaximum);
    }

    public MotorStateSeq (Collection elements) {
        super(MotorState.class, elements);
    }
