...
/**
* A sequence of DlpChannelSample instances.
*/
public final class DlpChannelSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DlpChannelSampleSeq() {
        super(DlpChannelSample.class);
    }

    public DlpChannelSampleSeq (int initialMaximum) {
        super(DlpChannelSample.class, initialMaximum);
    }

    public DlpChannelSampleSeq (Collection elements) {
        super(DlpChannelSample.class, elements);
    }
