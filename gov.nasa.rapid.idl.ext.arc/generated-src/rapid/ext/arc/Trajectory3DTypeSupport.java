...
public class Trajectory3DTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::Trajectory3D";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Trajectory3DTypeSupport _singleton
    = new Trajectory3DTypeSupport();
    ...
    */
    public static Trajectory3DTypeSupport get_instance() {
        return _singleton;
    }

    public static Trajectory3DTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Trajectory3DTypeCode.VALUE;
    }

    public Object create_data() {
        return Trajectory3D.create();
    }
    ...
    * <code>this</code> is not a <code>Trajectory3D</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Trajectory3D typedDst = (Trajectory3D) destination;
        Trajectory3D typedSrc = (Trajectory3D) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Trajectory3D typedSrc = (Trajectory3D) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.weight);

            dst.writeString(typedSrc.name,32);

            dst.writeLong(typedSrc.t0);

            dst.writeLong(typedSrc.tsep);

            rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.points, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Trajectory3D typedDst = (Trajectory3D) dst;
            typedDst.clear();      
            try{
                typedDst.weight = src.readFloat();
                typedDst.name = src.readString(32);
                typedDst.t0 = src.readLong();
                typedDst.tsep = src.readLong();
                typedDst.points = (rapid.ext.arc.TrajPoint3DSequence)rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.points, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.TrajPoint3DSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Trajectory3D typedDst = (Trajectory3D) sample;
    ...
    int mask) {
        return new Trajectory3DDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new Trajectory3DDataReader(native_reader, listener, mask, this);   
    ...
    protected Trajectory3DTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Trajectory3DTypeCode.VALUE,Trajectory3D.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Trajectory3DTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Trajectory3DTypeCode.VALUE,Trajectory3D.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
