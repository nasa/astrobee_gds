...
/**
* A sequence of SpectrumConfig instances.
*/
public final class SpectrumConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SpectrumConfigSeq() {
        super(SpectrumConfig.class);
    }

    public SpectrumConfigSeq (int initialMaximum) {
        super(SpectrumConfig.class, initialMaximum);
    }

    public SpectrumConfigSeq (Collection elements) {
        super(SpectrumConfig.class, elements);
    }
