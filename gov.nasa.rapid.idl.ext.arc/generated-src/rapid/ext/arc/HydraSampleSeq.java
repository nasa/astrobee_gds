...
/**
* A sequence of HydraSample instances.
*/
public final class HydraSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HydraSampleSeq() {
        super(HydraSample.class);
    }

    public HydraSampleSeq (int initialMaximum) {
        super(HydraSample.class, initialMaximum);
    }

    public HydraSampleSeq (Collection elements) {
        super(HydraSample.class, elements);
    }
