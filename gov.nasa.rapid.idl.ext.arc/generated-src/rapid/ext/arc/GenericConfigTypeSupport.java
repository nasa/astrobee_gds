...
public class GenericConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::GenericConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenericConfigTypeSupport _singleton
    = new GenericConfigTypeSupport();
    ...
    */
    public static GenericConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static GenericConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenericConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>GenericConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenericConfig typedDst = (GenericConfig) destination;
        GenericConfig typedSrc = (GenericConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenericConfig typedSrc = (GenericConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.KeyTypeValueSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.metaData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenericConfig typedDst = (GenericConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.metaData = (rapid.KeyTypeValueSequence32)rapid.KeyTypeValueSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.metaData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.KeyTypeValueSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenericConfig typedDst = (GenericConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenericConfig typedDst
        = (GenericConfig) instance;
        GenericConfig typedSrc
        = (GenericConfig) key;
    ...
    */
    ...
    int mask) {
        return new GenericConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenericConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected GenericConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenericConfigTypeCode.VALUE,GenericConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenericConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenericConfigTypeCode.VALUE,GenericConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
