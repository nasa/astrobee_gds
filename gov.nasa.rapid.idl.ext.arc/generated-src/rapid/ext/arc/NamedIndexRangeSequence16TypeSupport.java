...
public class NamedIndexRangeSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::arc::NamedIndexRangeSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedIndexRangeSequence16TypeSupport _singleton
    = new NamedIndexRangeSequence16TypeSupport();
    ...
    */
    public static NamedIndexRangeSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static NamedIndexRangeSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedIndexRangeSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return NamedIndexRangeSequence16.create();
    }
    ...
    public Object create_key() {
        return new NamedIndexRangeSequence16();
    }
    ...
    public Class get_type() {
        return NamedIndexRangeSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>NamedIndexRangeSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedIndexRangeSequence16 typedDst = (NamedIndexRangeSequence16) destination;
        NamedIndexRangeSequence16 typedSrc = (NamedIndexRangeSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedIndexRangeSequence16 typedSrc = (NamedIndexRangeSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedIndexRangeSequence16 typedDst = (NamedIndexRangeSequence16) dst;
            rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.arc.NamedIndexRangeTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedIndexRangeSequence16 typedDst = (NamedIndexRangeSequence16) sample;
    ...
    protected NamedIndexRangeSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedIndexRangeSequence16TypeCode.VALUE,NamedIndexRangeSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedIndexRangeSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedIndexRangeSequence16TypeCode.VALUE,NamedIndexRangeSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
