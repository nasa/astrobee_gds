 ...
 *
 */
public class RobotPartPoseHistory extends AbstractRobotPart {
     ...
     */
    //=========================================================================
    public RobotPartPoseHistory(String partName, AbstractRobot parent) {
    ...
    public void attachToNodesIn(Node model) throws IllegalStateException {
        ...
        m_pathHistoryPath = new DirectionalPath("posePathHistory");
        m_node.attachChild(m_pathHistoryPath);
        //m_pathHistoryPath.setSpeed(0.5);
        m_pathHistoryPath.setDefaultColor(getRobot().getIconColor());
...
//        xxx m_pathHistoryPath.setTexture(DirectionalPath.Texture.ChaseDashHalf, MagnificationFilter.NearestNeighbor);
