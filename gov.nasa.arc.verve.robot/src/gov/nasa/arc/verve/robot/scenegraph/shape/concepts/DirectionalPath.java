 ...
 * @author mallan
 */
public class DirectionalPath extends Line {
    ...
    DirectionalPathController m_controller = new DirectionalPathController();
    ...
    public DirectionalPath(String name) {
        super(name);
    ...
    public void setSpeed(double mps) {
        m_speedMps = mps;
        m_texOffsetSpeed = (int)(1000.0/m_speedMps);
    }

    /**
     * @return speed of texture shift in meters per second
     */
