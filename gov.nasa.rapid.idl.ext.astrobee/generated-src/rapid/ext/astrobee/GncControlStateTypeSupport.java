...
public class GncControlStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GncControlState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GncControlStateTypeSupport _singleton
    = new GncControlStateTypeSupport();
    ...
    */
    public static GncControlStateTypeSupport get_instance() {
        return _singleton;
    }

    public static GncControlStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GncControlStateTypeCode.VALUE;
    }

    public Object create_data() {
        return GncControlState.create();
    }
    ...
    * <code>this</code> is not a <code>GncControlState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GncControlState typedDst = (GncControlState) destination;
        GncControlState typedSrc = (GncControlState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GncControlState typedSrc = (GncControlState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.twist);
        currentAlignment += rapid.ext.astrobee.TwistTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.TwistTypeSupport.get_instance().serialize(endpoint_data, typedSrc.twist, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.TwistTypeSupport.get_instance().serialize(endpoint_data, typedSrc.accel, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GncControlState typedDst = (GncControlState) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.twist = (rapid.ext.astrobee.Twist)rapid.ext.astrobee.TwistTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.twist, src, false, true, endpoint_plugin_qos);     
                typedDst.accel = (rapid.ext.astrobee.Twist)rapid.ext.astrobee.TwistTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.accel, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.TwistTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GncControlState typedDst = (GncControlState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GncControlState typedDst
        = (GncControlState) instance;
        GncControlState typedSrc
        = (GncControlState) key;
    ...
    */
    ...
    int mask) {
        return new GncControlStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GncControlStateDataReader(native_reader, listener, mask, this);   
    ...
    protected GncControlStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GncControlStateTypeCode.VALUE,GncControlState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GncControlStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GncControlStateTypeCode.VALUE,GncControlState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
