...
/**
* A sequence of FaultConfig instances.
*/
public final class FaultConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FaultConfigSeq() {
        super(FaultConfig.class);
    }

    public FaultConfigSeq (int initialMaximum) {
        super(FaultConfig.class, initialMaximum);
    }

    public FaultConfigSeq (Collection elements) {
        super(FaultConfig.class, elements);
    }
