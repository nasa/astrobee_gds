...
public class BatteryInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::BatteryInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryInfoTypeSupport _singleton
    = new BatteryInfoTypeSupport();
    ...
    */
    public static BatteryInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryInfoTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryInfo.create();
    }
    ...
    * <code>this</code> is not a <code>BatteryInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryInfo typedDst = (BatteryInfo) destination;
        BatteryInfo typedSrc = (BatteryInfo) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryInfo typedSrc = (BatteryInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryInfo typedDst = (BatteryInfo) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryInfo typedDst = (BatteryInfo) sample;
    ...
    int mask) {
        return new BatteryInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryInfoTypeCode.VALUE,BatteryInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryInfoTypeCode.VALUE,BatteryInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
