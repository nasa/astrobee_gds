...
public class SaveSettingSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::SaveSettingSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SaveSettingSequence64TypeSupport _singleton
    = new SaveSettingSequence64TypeSupport();
    ...
    */
    public static SaveSettingSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static SaveSettingSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SaveSettingSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return SaveSettingSequence64.create();
    }
    ...
    public Object create_key() {
        return new SaveSettingSequence64();
    }
    ...
    public Class get_type() {
        return SaveSettingSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>SaveSettingSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SaveSettingSequence64 typedDst = (SaveSettingSequence64) destination;
        SaveSettingSequence64 typedSrc = (SaveSettingSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SaveSettingSequence64 typedSrc = (SaveSettingSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SaveSettingSequence64 typedDst = (SaveSettingSequence64) dst;
            rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.SaveSettingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SaveSettingSequence64 typedDst = (SaveSettingSequence64) sample;
    ...
    protected SaveSettingSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SaveSettingSequence64TypeCode.VALUE,SaveSettingSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SaveSettingSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SaveSettingSequence64TypeCode.VALUE,SaveSettingSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
