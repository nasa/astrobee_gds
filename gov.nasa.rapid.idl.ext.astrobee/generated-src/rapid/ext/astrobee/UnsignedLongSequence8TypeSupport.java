...
* UnsignedLongSequence8
*/

public class UnsignedLongSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::UnsignedLongSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UnsignedLongSequence8TypeSupport _singleton
    = new UnsignedLongSequence8TypeSupport();
    ...
    */
    public static UnsignedLongSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static UnsignedLongSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UnsignedLongSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return UnsignedLongSequence8.create();
    }
    ...
    public Object create_key() {
        return new UnsignedLongSequence8();
    }
    ...
    public Class get_type() {
        return UnsignedLongSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>UnsignedLongSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UnsignedLongSequence8 typedDst = (UnsignedLongSequence8) destination;
        UnsignedLongSequence8 typedSrc = (UnsignedLongSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment,  0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        UnsignedLongSequence8 typedSrc = (UnsignedLongSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.INT.getSequenceSerializedSize(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,8);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UnsignedLongSequence8 typedDst = (UnsignedLongSequence8) dst;
            src.readIntSequence(typedDst.userData, 8);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UnsignedLongSequence8 typedDst = (UnsignedLongSequence8) sample;
    ...
    protected UnsignedLongSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UnsignedLongSequence8TypeCode.VALUE,UnsignedLongSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UnsignedLongSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UnsignedLongSequence8TypeCode.VALUE,UnsignedLongSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
