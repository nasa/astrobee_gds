...
/**
* A sequence of TelemetryState instances.
*/
public final class TelemetryStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TelemetryStateSeq() {
        super(TelemetryState.class);
    }

    public TelemetryStateSeq (int initialMaximum) {
        super(TelemetryState.class, initialMaximum);
    }

    public TelemetryStateSeq (Collection elements) {
        super(TelemetryState.class, elements);
    }
