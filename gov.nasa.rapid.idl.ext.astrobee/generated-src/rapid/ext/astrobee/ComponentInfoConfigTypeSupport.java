...
public class ComponentInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentInfoConfigTypeSupport _singleton
    = new ComponentInfoConfigTypeSupport();
    ...
    */
    public static ComponentInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return ComponentInfoConfig.create();
    }
    ...
    public Object create_key() {
        return new ComponentInfoConfig();
    }
    ...
    public Class get_type() {
        return ComponentInfoConfig.class;
    }
    ...
    * <code>this</code> is not a <code>ComponentInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentInfoConfig typedDst = (ComponentInfoConfig) destination;
        ComponentInfoConfig typedSrc = (ComponentInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentInfoConfig typedSrc = (ComponentInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.metadata, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentInfoConfig typedDst = (ComponentInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.metadata = (rapid.KeyTypeSequence16)rapid.KeyTypeSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.metadata, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentInfoConfig typedDst = (ComponentInfoConfig) sample;
    ...
    int mask) {
        return new ComponentInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ComponentInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ComponentInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ComponentInfoConfigTypeCode.VALUE,ComponentInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentInfoConfigTypeCode.VALUE,ComponentInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
