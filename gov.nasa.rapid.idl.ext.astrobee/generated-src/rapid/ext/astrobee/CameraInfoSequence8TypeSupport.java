...
public class CameraInfoSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraInfoSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraInfoSequence8TypeSupport _singleton
    = new CameraInfoSequence8TypeSupport();
    ...
    */
    public static CameraInfoSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static CameraInfoSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraInfoSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return CameraInfoSequence8.create();
    }
    ...
    public Object create_key() {
        return new CameraInfoSequence8();
    }
    ...
    public Class get_type() {
        return CameraInfoSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>CameraInfoSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CameraInfoSequence8 typedDst = (CameraInfoSequence8) destination;
        CameraInfoSequence8 typedSrc = (CameraInfoSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CameraInfoSequence8 typedSrc = (CameraInfoSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CameraInfoSequence8 typedDst = (CameraInfoSequence8) dst;
            rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CameraInfoSequence8 typedDst = (CameraInfoSequence8) sample;
    ...
    protected CameraInfoSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraInfoSequence8TypeCode.VALUE,CameraInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CameraInfoSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CameraInfoSequence8TypeCode.VALUE,CameraInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
