...
public class GuestScienceStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceStateTypeSupport _singleton
    = new GuestScienceStateTypeSupport();
    ...
    */
    public static GuestScienceStateTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceStateTypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceState.create();
    }
    ...
    public Class get_type() {
        return GuestScienceState.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceState typedDst = (GuestScienceState) destination;
        GuestScienceState typedSrc = (GuestScienceState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceState typedSrc = (GuestScienceState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.runningApks);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.runningApks, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceState typedDst = (GuestScienceState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.runningApks = (rapid.ext.astrobee.BooleanSequence32)rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.runningApks, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BooleanSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceState typedDst = (GuestScienceState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GuestScienceState typedDst
        = (GuestScienceState) instance;
        GuestScienceState typedSrc
        = (GuestScienceState) key;
    ...
    */
    ...
    int mask) {
        return new GuestScienceStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GuestScienceStateDataReader(native_reader, listener, mask, this);   
    ...
    protected GuestScienceStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GuestScienceStateTypeCode.VALUE,GuestScienceState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceStateTypeCode.VALUE,GuestScienceState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
