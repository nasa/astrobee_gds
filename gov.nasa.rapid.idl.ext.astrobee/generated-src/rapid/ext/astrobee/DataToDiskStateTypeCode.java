...
public class  DataToDiskStateTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  ValueMember("topicSaveSettings", false, (short)-1,  false,PUBLIC_MEMBER.VALUE,(TypeCode) rapid.ext.astrobee.SaveSettingSequence64TypeCode.VALUE,2 , false);__i++;
