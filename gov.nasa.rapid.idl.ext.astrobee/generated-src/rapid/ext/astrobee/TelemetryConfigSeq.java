...
/**
* A sequence of TelemetryConfig instances.
*/
public final class TelemetryConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TelemetryConfigSeq() {
        super(TelemetryConfig.class);
    }

    public TelemetryConfigSeq (int initialMaximum) {
        super(TelemetryConfig.class, initialMaximum);
    }

    public TelemetryConfigSeq (Collection elements) {
        super(TelemetryConfig.class, elements);
    }
