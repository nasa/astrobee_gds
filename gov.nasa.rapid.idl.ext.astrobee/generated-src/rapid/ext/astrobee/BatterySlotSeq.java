...
/**
* A sequence of BatterySlot instances.
*/
public final class BatterySlotSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatterySlotSeq() {
        super(BatterySlot.class);
    }

    public BatterySlotSeq (int initialMaximum) {
        super(BatterySlot.class, initialMaximum);
    }

    public BatterySlotSeq (Collection elements) {
        super(BatterySlot.class, elements);
    }
