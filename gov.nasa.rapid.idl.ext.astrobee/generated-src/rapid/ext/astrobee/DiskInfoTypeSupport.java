...
public class DiskInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DiskInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiskInfoTypeSupport _singleton
    = new DiskInfoTypeSupport();
    ...
    */
    public static DiskInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static DiskInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiskInfoTypeCode.VALUE;
    }

    public Object create_data() {
        return DiskInfo.create();
    }
    ...
    * <code>this</code> is not a <code>DiskInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiskInfo typedDst = (DiskInfo) destination;
        DiskInfo typedSrc = (DiskInfo) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiskInfo typedSrc = (DiskInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiskInfo typedDst = (DiskInfo) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiskInfo typedDst = (DiskInfo) sample;
    ...
    int mask) {
        return new DiskInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DiskInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected DiskInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiskInfoTypeCode.VALUE,DiskInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiskInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiskInfoTypeCode.VALUE,DiskInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
