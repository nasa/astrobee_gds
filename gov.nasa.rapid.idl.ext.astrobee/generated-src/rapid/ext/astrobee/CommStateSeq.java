...
/**
* A sequence of CommState instances.
*/
public final class CommStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CommStateSeq() {
        super(CommState.class);
    }

    public CommStateSeq (int initialMaximum) {
        super(CommState.class, initialMaximum);
    }

    public CommStateSeq (Collection elements) {
        super(CommState.class, elements);
    }
