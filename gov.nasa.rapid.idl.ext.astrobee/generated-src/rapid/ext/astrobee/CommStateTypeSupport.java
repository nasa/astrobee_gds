...
public class CommStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CommState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CommStateTypeSupport _singleton
    = new CommStateTypeSupport();
    ...
    */
    public static CommStateTypeSupport get_instance() {
        return _singleton;
    }

    public static CommStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CommStateTypeCode.VALUE;
    }

    public Object create_data() {
        return CommState.create();
    }
    ...
    * <code>this</code> is not a <code>CommState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CommState typedDst = (CommState) destination;
        CommState typedSrc = (CommState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CommState typedSrc = (CommState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.apName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.bssid );
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.wirelessConnected);

            dst.writeString(typedSrc.apName,64);

            dst.writeString(typedSrc.bssid,32);

            dst.writeFloat(typedSrc.rssi);

            dst.writeFloat(typedSrc.frequency);

            dst.writeInt(typedSrc.channel);

            dst.writeBoolean(typedSrc.lanConnected);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CommState typedDst = (CommState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.wirelessConnected = src.readBoolean();
                typedDst.apName = src.readString(64);
                typedDst.bssid = src.readString(32);
                typedDst.rssi = src.readFloat();
                typedDst.frequency = src.readFloat();
                typedDst.channel = src.readInt();
                typedDst.lanConnected = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CommState typedDst = (CommState) sample;
    ...
    */
    ...
    int mask) {
        return new CommStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CommStateDataReader(native_reader, listener, mask, this);   
    ...
    protected CommStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CommStateTypeCode.VALUE,CommState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CommStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CommStateTypeCode.VALUE,CommState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
