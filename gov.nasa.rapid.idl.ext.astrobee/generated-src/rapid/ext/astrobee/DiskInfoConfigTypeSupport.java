...
public class DiskInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DiskInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiskInfoConfigTypeSupport _singleton
    = new DiskInfoConfigTypeSupport();
    ...
    */
    public static DiskInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static DiskInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiskInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return DiskInfoConfig.create();
    }
    ...
    * <code>this</code> is not a <code>DiskInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiskInfoConfig typedDst = (DiskInfoConfig) destination;
        DiskInfoConfig typedSrc = (DiskInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiskInfoConfig typedSrc = (DiskInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiskInfoConfig typedDst = (DiskInfoConfig) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiskInfoConfig typedDst = (DiskInfoConfig) sample;
    ...
    int mask) {
        return new DiskInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DiskInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected DiskInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiskInfoConfigTypeCode.VALUE,DiskInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiskInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiskInfoConfigTypeCode.VALUE,DiskInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
