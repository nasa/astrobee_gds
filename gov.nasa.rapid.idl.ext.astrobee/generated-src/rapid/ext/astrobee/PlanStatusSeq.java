...
/**
* A sequence of PlanStatus instances.
*/
public final class PlanStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PlanStatusSeq() {
        super(PlanStatus.class);
    }

    public PlanStatusSeq (int initialMaximum) {
        super(PlanStatus.class, initialMaximum);
    }

    public PlanStatusSeq (Collection elements) {
        super(PlanStatus.class, elements);
    }
