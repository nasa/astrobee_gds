...
/**
* A sequence of StatusSequence instances.
*/
public final class StatusSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public StatusSequenceSeq() {
        super(StatusSequence.class);
    }

    public StatusSequenceSeq (int initialMaximum) {
        super(StatusSequence.class, initialMaximum);
    }

    public StatusSequenceSeq (Collection elements) {
        super(StatusSequence.class, elements);
    }
