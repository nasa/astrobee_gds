...
public class FaultInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FaultInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FaultInfoTypeSupport _singleton
    = new FaultInfoTypeSupport();
    ...
    */
    public static FaultInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static FaultInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FaultInfoTypeCode.VALUE;
    }

    public Object create_data() {
        return FaultInfo.create();
    }
    ...
    * <code>this</code> is not a <code>FaultInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FaultInfo typedDst = (FaultInfo) destination;
        FaultInfo typedSrc = (FaultInfo) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FaultInfo typedSrc = (FaultInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.faultDescription );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShort(typedSrc.subsystem);

            dst.writeShort(typedSrc.node);

            dst.writeInt(typedSrc.faultId);

            dst.writeBoolean(typedSrc.warning);

            dst.writeString(typedSrc.faultDescription,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FaultInfo typedDst = (FaultInfo) dst;
            typedDst.clear();      
            try{
                typedDst.subsystem = src.readShort();
                typedDst.node = src.readShort();
                typedDst.faultId = src.readInt();
                typedDst.warning = src.readBoolean();
                typedDst.faultDescription = src.readString(64);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FaultInfo typedDst = (FaultInfo) sample;
    ...
    int mask) {
        return new FaultInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FaultInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected FaultInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FaultInfoTypeCode.VALUE,FaultInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FaultInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FaultInfoTypeCode.VALUE,FaultInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
