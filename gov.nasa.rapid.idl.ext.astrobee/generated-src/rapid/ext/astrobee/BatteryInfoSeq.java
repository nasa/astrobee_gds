...
/**
* A sequence of BatteryInfo instances.
*/
public final class BatteryInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatteryInfoSeq() {
        super(BatteryInfo.class);
    }

    public BatteryInfoSeq (int initialMaximum) {
        super(BatteryInfo.class, initialMaximum);
    }

    public BatteryInfoSeq (Collection elements) {
        super(BatteryInfo.class, elements);
    }
