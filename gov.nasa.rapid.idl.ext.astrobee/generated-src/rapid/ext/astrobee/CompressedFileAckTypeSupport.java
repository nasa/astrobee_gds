...
public class CompressedFileAckTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CompressedFileAck";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CompressedFileAckTypeSupport _singleton
    = new CompressedFileAckTypeSupport();
    ...
    */
    public static CompressedFileAckTypeSupport get_instance() {
        return _singleton;
    }

    public static CompressedFileAckTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CompressedFileAckTypeCode.VALUE;
    }

    public Object create_data() {
        return CompressedFileAck.create();
    }
    ...
    public Class get_type() {
        return CompressedFileAck.class;
    }
    ...
    * <code>this</code> is not a <code>CompressedFileAck</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CompressedFileAck typedDst = (CompressedFileAck) destination;
        CompressedFileAck typedSrc = (CompressedFileAck) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CompressedFileAck typedSrc = (CompressedFileAck) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CompressedFileAck typedDst = (CompressedFileAck) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CompressedFileAck typedDst = (CompressedFileAck) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        CompressedFileAck typedDst
        = (CompressedFileAck) instance;
        CompressedFileAck typedSrc
        = (CompressedFileAck) key;
    ...
    */
    ...
    int mask) {
        return new CompressedFileAckDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CompressedFileAckDataReader(native_reader, listener, mask, this);   
    ...
    protected CompressedFileAckTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CompressedFileAckTypeCode.VALUE,CompressedFileAck.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CompressedFileAckTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CompressedFileAckTypeCode.VALUE,CompressedFileAck.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
