...
/**
* A sequence of ArmJointState instances.
*/
public final class ArmJointStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ArmJointStateSeq() {
        super(ArmJointState.class);
    }

    public ArmJointStateSeq (int initialMaximum) {
        super(ArmJointState.class, initialMaximum);
    }

    public ArmJointStateSeq (Collection elements) {
        super(ArmJointState.class, elements);
    }
