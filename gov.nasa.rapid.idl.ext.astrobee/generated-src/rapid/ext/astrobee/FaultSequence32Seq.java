...
/**
* A sequence of FaultSequence32 instances.
*/
public final class FaultSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FaultSequence32Seq() {
        super(FaultSequence32.class);
    }

    public FaultSequence32Seq (int initialMaximum) {
        super(FaultSequence32.class, initialMaximum);
    }

    public FaultSequence32Seq (Collection elements) {
        super(FaultSequence32.class, elements);
    }
