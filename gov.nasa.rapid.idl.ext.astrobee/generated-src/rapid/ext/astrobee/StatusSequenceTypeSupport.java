...
public class StatusSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::StatusSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StatusSequenceTypeSupport _singleton
    = new StatusSequenceTypeSupport();
    ...
    */
    public static StatusSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static StatusSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StatusSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return StatusSequence.create();
    }
    ...
    * <code>this</code> is not a <code>StatusSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StatusSequence typedDst = (StatusSequence) destination;
        StatusSequence typedSrc = (StatusSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.StatusTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.StatusTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        StatusSequence typedSrc = (StatusSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.StatusTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.StatusTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StatusSequence typedDst = (StatusSequence) dst;
            rapid.ext.astrobee.StatusTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.StatusTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StatusSequence typedDst = (StatusSequence) sample;
    ...
    protected StatusSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,StatusSequenceTypeCode.VALUE,StatusSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StatusSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StatusSequenceTypeCode.VALUE,StatusSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
