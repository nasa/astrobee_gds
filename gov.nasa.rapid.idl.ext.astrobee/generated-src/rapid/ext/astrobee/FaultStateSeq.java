...
/**
* A sequence of FaultState instances.
*/
public final class FaultStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FaultStateSeq() {
        super(FaultState.class);
    }

    public FaultStateSeq (int initialMaximum) {
        super(FaultState.class, initialMaximum);
    }

    public FaultStateSeq (Collection elements) {
        super(FaultState.class, elements);
    }
