...
public class ComponentStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentStateTypeSupport _singleton
    = new ComponentStateTypeSupport();
    ...
    */
    public static ComponentStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentStateTypeCode.VALUE;
    }

    public Object create_data() {
        return ComponentState.create();
    }
    ...
    * <code>this</code> is not a <code>ComponentState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentState typedDst = (ComponentState) destination;
        ComponentState typedSrc = (ComponentState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentState typedSrc = (ComponentState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.components, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentState typedDst = (ComponentState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.components = (rapid.ext.astrobee.ComponentInfoSequence16)rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.components, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentState typedDst = (ComponentState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ComponentState typedDst
        = (ComponentState) instance;
        ComponentState typedSrc
        = (ComponentState) key;
    ...
    */
    ...
    int mask) {
        return new ComponentStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ComponentStateDataReader(native_reader, listener, mask, this);   
    ...
    protected ComponentStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ComponentStateTypeCode.VALUE,ComponentState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentStateTypeCode.VALUE,ComponentState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
