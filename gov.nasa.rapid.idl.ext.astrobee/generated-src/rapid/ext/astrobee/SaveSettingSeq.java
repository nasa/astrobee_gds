...
/**
* A sequence of SaveSetting instances.
*/
public final class SaveSettingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SaveSettingSeq() {
        super(SaveSetting.class);
    }

    public SaveSettingSeq (int initialMaximum) {
        super(SaveSetting.class, initialMaximum);
    }

    public SaveSettingSeq (Collection elements) {
        super(SaveSetting.class, elements);
    }
