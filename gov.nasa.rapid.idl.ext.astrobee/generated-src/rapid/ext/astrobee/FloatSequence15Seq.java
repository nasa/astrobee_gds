...
/**
* A sequence of FloatSequence15 instances.
*/
public final class FloatSequence15Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence15Seq() {
        super(FloatSequence15.class);
    }

    public FloatSequence15Seq (int initialMaximum) {
        super(FloatSequence15.class, initialMaximum);
    }

    public FloatSequence15Seq (Collection elements) {
        super(FloatSequence15.class, elements);
    }
