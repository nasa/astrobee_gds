...
/**
* A sequence of GncControlState instances.
*/
public final class GncControlStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GncControlStateSeq() {
        super(GncControlState.class);
    }

    public GncControlStateSeq (int initialMaximum) {
        super(GncControlState.class, initialMaximum);
    }

    public GncControlStateSeq (Collection elements) {
        super(GncControlState.class, elements);
    }
