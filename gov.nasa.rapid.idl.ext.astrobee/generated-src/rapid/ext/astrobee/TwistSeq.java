...
/**
* A sequence of Twist instances.
*/
public final class TwistSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TwistSeq (int initialMaximum) {
        super(Twist.class, initialMaximum);
    }

    public TwistSeq (Collection elements) {
        super(Twist.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Twist objects (beyond the original size of this object)
