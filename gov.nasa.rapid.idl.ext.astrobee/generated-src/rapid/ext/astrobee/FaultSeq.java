...
/**
* A sequence of Fault instances.
*/
public final class FaultSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FaultSeq (int initialMaximum) {
        super(Fault.class, initialMaximum);
    }

    public FaultSeq (Collection elements) {
        super(Fault.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Fault objects (beyond the original size of this object)
