...
/**
* A sequence of CpuInfoSequence8 instances.
*/
public final class CpuInfoSequence8Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CpuInfoSequence8Seq() {
        super(CpuInfoSequence8.class);
    }

    public CpuInfoSequence8Seq (int initialMaximum) {
        super(CpuInfoSequence8.class, initialMaximum);
    }

    public CpuInfoSequence8Seq (Collection elements) {
        super(CpuInfoSequence8.class, elements);
    }
