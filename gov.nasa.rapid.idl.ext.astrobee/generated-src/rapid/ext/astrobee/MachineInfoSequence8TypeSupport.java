...
* MachineInfoSequence8
*/

public class MachineInfoSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::MachineInfoSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MachineInfoSequence8TypeSupport _singleton
    = new MachineInfoSequence8TypeSupport();
    ...
    */
    public static MachineInfoSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static MachineInfoSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MachineInfoSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return MachineInfoSequence8.create();
    }
    ...
    public Object create_key() {
        return new MachineInfoSequence8();
    }
    ...
    public Class get_type() {
        return MachineInfoSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>MachineInfoSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MachineInfoSequence8 typedDst = (MachineInfoSequence8) destination;
        MachineInfoSequence8 typedSrc = (MachineInfoSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MachineInfoSequence8 typedSrc = (MachineInfoSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MachineInfoSequence8 typedDst = (MachineInfoSequence8) dst;
            rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.MachineInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MachineInfoSequence8 typedDst = (MachineInfoSequence8) sample;
    ...
    protected MachineInfoSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MachineInfoSequence8TypeCode.VALUE,MachineInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MachineInfoSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MachineInfoSequence8TypeCode.VALUE,MachineInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
