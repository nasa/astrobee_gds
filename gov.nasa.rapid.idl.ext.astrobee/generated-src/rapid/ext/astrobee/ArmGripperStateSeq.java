...
/**
* A sequence of ArmGripperState instances.
*/
public final class ArmGripperStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ArmGripperStateSeq() {
        super(ArmGripperState.class);
    }

    public ArmGripperStateSeq (int initialMaximum) {
        super(ArmGripperState.class, initialMaximum);
    }

    public ArmGripperStateSeq (Collection elements) {
        super(ArmGripperState.class, elements);
    }
