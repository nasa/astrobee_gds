...
public class GuestScienceCommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceCommand";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceCommandTypeSupport _singleton
    = new GuestScienceCommandTypeSupport();
    ...
    */
    public static GuestScienceCommandTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceCommandTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceCommandTypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceCommand.create();
    }
    ...
    public Object create_key() {
        return new GuestScienceCommand();
    }
    ...
    public Class get_type() {
        return GuestScienceCommand.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceCommand</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceCommand typedDst = (GuestScienceCommand) destination;
        GuestScienceCommand typedSrc = (GuestScienceCommand) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceCommand typedSrc = (GuestScienceCommand) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.command );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.command,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceCommand typedDst = (GuestScienceCommand) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.command = src.readString(128);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceCommand typedDst = (GuestScienceCommand) sample;
    ...
    int mask) {
        return new GuestScienceCommandDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GuestScienceCommandDataReader(native_reader, listener, mask, this);   
    ...
    protected GuestScienceCommandTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GuestScienceCommandTypeCode.VALUE,GuestScienceCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceCommandTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceCommandTypeCode.VALUE,GuestScienceCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
