...
public class DataTopicsListTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DataTopicsList";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataTopicsListTypeSupport _singleton
    = new DataTopicsListTypeSupport();
    ...
    */
    public static DataTopicsListTypeSupport get_instance() {
        return _singleton;
    }

    public static DataTopicsListTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataTopicsListTypeCode.VALUE;
    }

    public Object create_data() {
        return DataTopicsList.create();
    }
    ...
    * <code>this</code> is not a <code>DataTopicsList</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataTopicsList typedDst = (DataTopicsList) destination;
        DataTopicsList typedSrc = (DataTopicsList) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataTopicsList typedSrc = (DataTopicsList) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().serialize(endpoint_data, typedSrc.topics, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataTopicsList typedDst = (DataTopicsList) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.topics = (rapid.ext.astrobee.String128Sequence256)rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.topics, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.String128Sequence256TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataTopicsList typedDst = (DataTopicsList) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        DataTopicsList typedDst
        = (DataTopicsList) instance;
        DataTopicsList typedSrc
        = (DataTopicsList) key;
    ...
    */
    ...
    int mask) {
        return new DataTopicsListDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DataTopicsListDataReader(native_reader, listener, mask, this);   
    ...
    protected DataTopicsListTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DataTopicsListTypeCode.VALUE,DataTopicsList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataTopicsListTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataTopicsListTypeCode.VALUE,DataTopicsList.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
