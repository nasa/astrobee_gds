...
/**
* A sequence of ComponentInfo instances.
*/
public final class ComponentInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ComponentInfoSeq() {
        super(ComponentInfo.class);
    }

    public ComponentInfoSeq (int initialMaximum) {
        super(ComponentInfo.class, initialMaximum);
    }

    public ComponentInfoSeq (Collection elements) {
        super(ComponentInfo.class, elements);
    }
