...
* FaultInfoSequence256
*/

public class FaultInfoSequence256TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FaultInfoSequence256";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FaultInfoSequence256TypeSupport _singleton
    = new FaultInfoSequence256TypeSupport();
    ...
    */
    public static FaultInfoSequence256TypeSupport get_instance() {
        return _singleton;
    }

    public static FaultInfoSequence256TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FaultInfoSequence256TypeCode.VALUE;
    }

    public Object create_data() {
        return FaultInfoSequence256.create();
    }
    ...
    public Object create_key() {
        return new FaultInfoSequence256();
    }
    ...
    public Class get_type() {
        return FaultInfoSequence256.class;
    }
    ...
    * <code>this</code> is not a <code>FaultInfoSequence256</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FaultInfoSequence256 typedDst = (FaultInfoSequence256) destination;
        FaultInfoSequence256 typedSrc = (FaultInfoSequence256) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FaultInfoSequence256 typedSrc = (FaultInfoSequence256) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,256, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FaultInfoSequence256 typedDst = (FaultInfoSequence256) dst;
            rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 256, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.FaultInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FaultInfoSequence256 typedDst = (FaultInfoSequence256) sample;
    ...
    protected FaultInfoSequence256TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FaultInfoSequence256TypeCode.VALUE,FaultInfoSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FaultInfoSequence256TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FaultInfoSequence256TypeCode.VALUE,FaultInfoSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
