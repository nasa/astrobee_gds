...
public class AgentStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::AgentState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AgentStateTypeSupport _singleton
    = new AgentStateTypeSupport();
    ...
    */
    public static AgentStateTypeSupport get_instance() {
        return _singleton;
    }

    public static AgentStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AgentStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>AgentState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AgentState typedDst = (AgentState) destination;
        AgentState typedSrc = (AgentState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AgentState typedSrc = (AgentState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.operatingState);
        currentAlignment += rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.executionState);
        currentAlignment += rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.mobilityState);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.guestScienceState);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.profileName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.flightMode );
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.operatingState, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.executionState, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.mobilityState, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.subMobilityState);

            rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.guestScienceState, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.proximity);

            dst.writeString(typedSrc.profileName,32);

            dst.writeString(typedSrc.flightMode,32);

            dst.writeFloat(typedSrc.targetLinearVelocity);

            dst.writeFloat(typedSrc.targetLinearAccel);

            dst.writeFloat(typedSrc.targetAngularVelocity);

            dst.writeFloat(typedSrc.targetAngularAccel);

            dst.writeFloat(typedSrc.collisionDistance);

            dst.writeBoolean(typedSrc.enableHolonomic);

            dst.writeBoolean(typedSrc.checkObstacles);

            dst.writeBoolean(typedSrc.checkKeepouts);

            dst.writeBoolean(typedSrc.enableAutoReturn);

            dst.writeInt(typedSrc.bootTime);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AgentState typedDst = (AgentState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.operatingState = (rapid.ext.astrobee.OperatingState)rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.operatingState, src, false, true, endpoint_plugin_qos);     
                typedDst.executionState = (rapid.ext.astrobee.ExecutionState)rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.executionState, src, false, true, endpoint_plugin_qos);     
                typedDst.mobilityState = (rapid.ext.astrobee.MobilityState)rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.mobilityState, src, false, true, endpoint_plugin_qos);     
                typedDst.subMobilityState = src.readInt();
                typedDst.guestScienceState = (rapid.ext.astrobee.ExecutionState)rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.guestScienceState, src, false, true, endpoint_plugin_qos);     
                typedDst.proximity = src.readFloat();
                typedDst.profileName = src.readString(32);
                typedDst.flightMode = src.readString(32);
                typedDst.targetLinearVelocity = src.readFloat();
                typedDst.targetLinearAccel = src.readFloat();
                typedDst.targetAngularVelocity = src.readFloat();
                typedDst.targetAngularAccel = src.readFloat();
                typedDst.collisionDistance = src.readFloat();
                typedDst.enableHolonomic = src.readBoolean();
                typedDst.checkObstacles = src.readBoolean();
                typedDst.checkKeepouts = src.readBoolean();
                typedDst.enableAutoReturn = src.readBoolean();
                typedDst.bootTime = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.OperatingStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.astrobee.ExecutionStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.astrobee.MobilityStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AgentState typedDst = (AgentState) sample;
    ...
    */
    ...
    int mask) {
        return new AgentStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AgentStateDataReader(native_reader, listener, mask, this);   
    ...
    protected AgentStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,AgentStateTypeCode.VALUE,AgentState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AgentStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AgentStateTypeCode.VALUE,AgentState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
