...
public class CpuStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CpuState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuStateTypeSupport _singleton
    = new CpuStateTypeSupport();
    ...
    */
    public static CpuStateTypeSupport get_instance() {
        return _singleton;
    }

    public static CpuStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuStateTypeCode.VALUE;
    }

    public Object create_data() {
        return CpuState.create();
    }
    ...
    * <code>this</code> is not a <code>CpuState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuState typedDst = (CpuState) destination;
        CpuState typedSrc = (CpuState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuState typedSrc = (CpuState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.machines, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuState typedDst = (CpuState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.machines = (rapid.ext.astrobee.MachineInfoSequence8)rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.machines, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.MachineInfoSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuState typedDst = (CpuState) sample;
    ...
    */
    ...
    int mask) {
        return new CpuStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CpuStateDataReader(native_reader, listener, mask, this);   
    ...
    protected CpuStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CpuStateTypeCode.VALUE,CpuState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuStateTypeCode.VALUE,CpuState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
