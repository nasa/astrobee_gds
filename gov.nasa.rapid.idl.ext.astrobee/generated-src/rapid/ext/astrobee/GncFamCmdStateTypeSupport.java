...
public class GncFamCmdStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GncFamCmdState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GncFamCmdStateTypeSupport _singleton
    = new GncFamCmdStateTypeSupport();
    ...
    */
    public static GncFamCmdStateTypeSupport get_instance() {
        return _singleton;
    }

    public static GncFamCmdStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GncFamCmdStateTypeCode.VALUE;
    }

    public Object create_data() {
        return GncFamCmdState.create();
    }
    ...
    * <code>this</code> is not a <code>GncFamCmdState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GncFamCmdState typedDst = (GncFamCmdState) destination;
        GncFamCmdState typedSrc = (GncFamCmdState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.WrenchTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.WrenchTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GncFamCmdState typedSrc = (GncFamCmdState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.WrenchTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.wrench);
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.alpha);
        currentAlignment  +=  CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.position_error);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.position_error_integrated);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.attitude_error);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.attitude_error_integrated);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.WrenchTypeSupport.get_instance().serialize(endpoint_data, typedSrc.wrench, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            ...
            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.alpha, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeShort(typedSrc.status);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.position_error, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.position_error_integrated, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.attitude_error, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.attitude_error_integrated, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.attitude_error_mag);

            dst.writeShort(typedSrc.control_mode);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GncFamCmdState typedDst = (GncFamCmdState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.wrench = (rapid.ext.astrobee.Wrench)rapid.ext.astrobee.WrenchTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.wrench, src, false, true, endpoint_plugin_qos);     
                ...
                typedDst.alpha = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.alpha, src, false, true, endpoint_plugin_qos);     
                typedDst.status = src.readShort();
                typedDst.position_error = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position_error, src, false, true, endpoint_plugin_qos);     
                typedDst.position_error_integrated = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position_error_integrated, src, false, true, endpoint_plugin_qos);     
                typedDst.attitude_error = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.attitude_error, src, false, true, endpoint_plugin_qos);     
                typedDst.attitude_error_integrated = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.attitude_error_integrated, src, false, true, endpoint_plugin_qos);     
                typedDst.attitude_error_mag = src.readFloat();
                typedDst.control_mode = src.readShort();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.WrenchTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GncFamCmdState typedDst = (GncFamCmdState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GncFamCmdState typedDst
        = (GncFamCmdState) instance;
        GncFamCmdState typedSrc
        = (GncFamCmdState) key;
    ...
    */
    ...
    int mask) {
        return new GncFamCmdStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GncFamCmdStateDataReader(native_reader, listener, mask, this);   
    ...
    protected GncFamCmdStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GncFamCmdStateTypeCode.VALUE,GncFamCmdState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GncFamCmdStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GncFamCmdStateTypeCode.VALUE,GncFamCmdState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
