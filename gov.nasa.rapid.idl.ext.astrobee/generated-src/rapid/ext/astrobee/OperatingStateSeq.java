...
/**
* A sequence of OperatingState instances.
*/
public final class OperatingStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OperatingStateSeq() {
        super(OperatingState.class);
    }

    public OperatingStateSeq (int initialMaximum) {
        super(OperatingState.class, initialMaximum);
    }

    public OperatingStateSeq (Collection elements) {
        super(OperatingState.class, elements);
    }
