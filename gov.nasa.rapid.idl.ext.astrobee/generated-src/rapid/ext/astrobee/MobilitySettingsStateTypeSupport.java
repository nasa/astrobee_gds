...
* MobilitySettingsState
*/

public class MobilitySettingsStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::MobilitySettingsState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MobilitySettingsStateTypeSupport _singleton
    = new MobilitySettingsStateTypeSupport();
    ...
    */
    public static MobilitySettingsStateTypeSupport get_instance() {
        return _singleton;
    }

    public static MobilitySettingsStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MobilitySettingsStateTypeCode.VALUE;
    }

    public Object create_data() {
        return MobilitySettingsState.create();
    }
    ...
    public Object create_key() {
        return new MobilitySettingsState();
    }
    ...
    public Class get_type() {
        return MobilitySettingsState.class;
    }
    ...
    * <code>this</code> is not a <code>MobilitySettingsState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MobilitySettingsState typedDst = (MobilitySettingsState) destination;
        MobilitySettingsState typedSrc = (MobilitySettingsState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MobilitySettingsState typedSrc = (MobilitySettingsState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.planner );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.timeSyncEnabled);

            dst.writeBoolean(typedSrc.immediateEnabled);

            dst.writeString(typedSrc.planner,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MobilitySettingsState typedDst = (MobilitySettingsState) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.timeSyncEnabled = src.readBoolean();
                typedDst.immediateEnabled = src.readBoolean();
                typedDst.planner = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MobilitySettingsState typedDst = (MobilitySettingsState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MobilitySettingsState typedDst
        = (MobilitySettingsState) instance;
        MobilitySettingsState typedSrc
        = (MobilitySettingsState) key;
    ...
    */
    ...
    int mask) {
        return new MobilitySettingsStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MobilitySettingsStateDataReader(native_reader, listener, mask, this);   
    ...
    protected MobilitySettingsStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MobilitySettingsStateTypeCode.VALUE,MobilitySettingsState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MobilitySettingsStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MobilitySettingsStateTypeCode.VALUE,MobilitySettingsState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
