...
/**
* A sequence of CpuInfoConfig instances.
*/
public final class CpuInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CpuInfoConfigSeq() {
        super(CpuInfoConfig.class);
    }

    public CpuInfoConfigSeq (int initialMaximum) {
        super(CpuInfoConfig.class, initialMaximum);
    }

    public CpuInfoConfigSeq (Collection elements) {
        super(CpuInfoConfig.class, elements);
    }
