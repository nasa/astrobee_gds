...
public class FileCompressionTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FileCompressionType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileCompressionTypeTypeSupport _singleton
    = new FileCompressionTypeTypeSupport();
    ...
    */
    public static FileCompressionTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static FileCompressionTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileCompressionTypeTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return FileCompressionType.class;
    }
    ...
    * <code>this</code> is not a <code>FileCompressionType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        FileCompressionType typedSrc = (FileCompressionType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = FileCompressionType.valueOf(ordinal);
            if (dst == null) {
    ...
    protected FileCompressionTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FileCompressionTypeTypeCode.VALUE,FileCompressionType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
