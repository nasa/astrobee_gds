...
/**
* A sequence of AgentState instances.
*/
public final class AgentStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AgentStateSeq() {
        super(AgentState.class);
    }

    public AgentStateSeq (int initialMaximum) {
        super(AgentState.class, initialMaximum);
    }

    public AgentStateSeq (Collection elements) {
        super(AgentState.class, elements);
    }
