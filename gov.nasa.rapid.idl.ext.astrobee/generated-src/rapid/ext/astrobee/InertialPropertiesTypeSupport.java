...
public class InertialPropertiesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::InertialProperties";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InertialPropertiesTypeSupport _singleton
    = new InertialPropertiesTypeSupport();
    ...
    */
    public static InertialPropertiesTypeSupport get_instance() {
        return _singleton;
    }

    public static InertialPropertiesTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InertialPropertiesTypeCode.VALUE;
    }

    public Object create_data() {
        return InertialProperties.create();
    }
    ...
    public Class get_type() {
        return InertialProperties.class;
    }
    ...
    * <code>this</code> is not a <code>InertialProperties</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InertialProperties typedDst = (InertialProperties) destination;
        InertialProperties typedSrc = (InertialProperties) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        InertialProperties typedSrc = (InertialProperties) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.centerOfMass);
        currentAlignment += rapid.Mat33fTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.matrix);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.mass);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.centerOfMass, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Mat33fTypeSupport.get_instance().serialize(endpoint_data, typedSrc.matrix, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InertialProperties typedDst = (InertialProperties) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.mass = src.readFloat();
                typedDst.centerOfMass = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.centerOfMass, src, false, true, endpoint_plugin_qos);     
                typedDst.matrix = (rapid.Mat33f)rapid.Mat33fTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.matrix, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InertialProperties typedDst = (InertialProperties) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        InertialProperties typedDst
        = (InertialProperties) instance;
        InertialProperties typedSrc
        = (InertialProperties) key;
    ...
    */
    ...
    int mask) {
        return new InertialPropertiesDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new InertialPropertiesDataReader(native_reader, listener, mask, this);   
    ...
    protected InertialPropertiesTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,InertialPropertiesTypeCode.VALUE,InertialProperties.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InertialPropertiesTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InertialPropertiesTypeCode.VALUE,InertialProperties.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
