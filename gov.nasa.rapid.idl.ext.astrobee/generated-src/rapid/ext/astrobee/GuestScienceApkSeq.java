...
/**
* A sequence of GuestScienceApk instances.
*/
public final class GuestScienceApkSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GuestScienceApkSeq() {
        super(GuestScienceApk.class);
    }

    public GuestScienceApkSeq (int initialMaximum) {
        super(GuestScienceApk.class, initialMaximum);
    }

    public GuestScienceApkSeq (Collection elements) {
        super(GuestScienceApk.class, elements);
    }
