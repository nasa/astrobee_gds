...
/**
* A sequence of CpuConfig instances.
*/
public final class CpuConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CpuConfigSeq() {
        super(CpuConfig.class);
    }

    public CpuConfigSeq (int initialMaximum) {
        super(CpuConfig.class, initialMaximum);
    }

    public CpuConfigSeq (Collection elements) {
        super(CpuConfig.class, elements);
    }
