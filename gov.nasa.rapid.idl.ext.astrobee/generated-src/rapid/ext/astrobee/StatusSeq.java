...
/**
* A sequence of Status instances.
*/
public final class StatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public StatusSeq (int initialMaximum) {
        super(Status.class, initialMaximum);
    }

    public StatusSeq (Collection elements) {
        super(Status.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Status objects (beyond the original size of this object)
