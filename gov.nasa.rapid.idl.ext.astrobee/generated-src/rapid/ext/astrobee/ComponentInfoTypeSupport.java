...
public class ComponentInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentInfoTypeSupport _singleton
    = new ComponentInfoTypeSupport();
    ...
    */
    public static ComponentInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentInfoTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ComponentInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentInfo typedDst = (ComponentInfo) destination;
        ComponentInfo typedSrc = (ComponentInfo) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ValueSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ValueSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentInfo typedSrc = (ComponentInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ValueSequence16TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.present);

            dst.writeBoolean(typedSrc.powered);

            dst.writeFloat(typedSrc.temperature);

            dst.writeFloat(typedSrc.current);

            rapid.ValueSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.metadata, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentInfo typedDst = (ComponentInfo) dst;
            typedDst.clear();      
            try{
                typedDst.present = src.readBoolean();
                typedDst.powered = src.readBoolean();
                typedDst.temperature = src.readFloat();
                typedDst.current = src.readFloat();
                typedDst.metadata = (rapid.ValueSequence16)rapid.ValueSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.metadata, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ValueSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentInfo typedDst = (ComponentInfo) sample;
    ...
    int mask) {
        return new ComponentInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ComponentInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected ComponentInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ComponentInfoTypeCode.VALUE,ComponentInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentInfoTypeCode.VALUE,ComponentInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
