...
public class CameraResolutionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraResolution";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraResolutionTypeSupport _singleton
    = new CameraResolutionTypeSupport();
    ...
    */
    public static CameraResolutionTypeSupport get_instance() {
        return _singleton;
    }

    public static CameraResolutionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraResolutionTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CameraResolution</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        CameraResolution typedSrc = (CameraResolution) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CameraResolution.valueOf(ordinal);
            if (dst == null) {
    ...
    protected CameraResolutionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraResolutionTypeCode.VALUE,CameraResolution.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
