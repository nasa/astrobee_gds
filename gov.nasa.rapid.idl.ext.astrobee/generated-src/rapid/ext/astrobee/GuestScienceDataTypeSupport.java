...
public class GuestScienceDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceDataTypeSupport _singleton
    = new GuestScienceDataTypeSupport();
    ...
    */
    public static GuestScienceDataTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceDataTypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceData.create();
    }
    ...
    * <code>this</code> is not a <code>GuestScienceData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceData typedDst = (GuestScienceData) destination;
        GuestScienceData typedSrc = (GuestScienceData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceData typedSrc = (GuestScienceData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.apkName );
        currentAlignment += rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.type);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.topic );
        currentAlignment += rapid.OctetSequence2KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.data);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.apkName,128);

            rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.topic,32);

            rapid.OctetSequence2KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.data, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceData typedDst = (GuestScienceData) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.apkName = src.readString(128);
                typedDst.type = (rapid.ext.astrobee.GuestScienceDataType)rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
                typedDst.topic = src.readString(32);
                typedDst.data = (rapid.OctetSequence2K)rapid.OctetSequence2KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.data, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.GuestScienceDataTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceData typedDst = (GuestScienceData) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GuestScienceData typedDst
        = (GuestScienceData) instance;
        GuestScienceData typedSrc
        = (GuestScienceData) key;
    ...
    */
    ...
    int mask) {
        return new GuestScienceDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GuestScienceDataDataReader(native_reader, listener, mask, this);   
    ...
    protected GuestScienceDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GuestScienceDataTypeCode.VALUE,GuestScienceData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceDataTypeCode.VALUE,GuestScienceData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
