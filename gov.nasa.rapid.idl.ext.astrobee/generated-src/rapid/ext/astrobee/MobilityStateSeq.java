...
/**
* A sequence of MobilityState instances.
*/
public final class MobilityStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MobilityStateSeq() {
        super(MobilityState.class);
    }

    public MobilityStateSeq (int initialMaximum) {
        super(MobilityState.class, initialMaximum);
    }

    public MobilityStateSeq (Collection elements) {
        super(MobilityState.class, elements);
    }
