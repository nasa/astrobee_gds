...
public class CameraInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraInfoConfigTypeSupport _singleton
    = new CameraInfoConfigTypeSupport();
    ...
    */
    public static CameraInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static CameraInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return CameraInfoConfig.create();
    }
    ...
    * <code>this</code> is not a <code>CameraInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CameraInfoConfig typedDst = (CameraInfoConfig) destination;
        CameraInfoConfig typedSrc = (CameraInfoConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.CameraModeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.CameraModeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CameraInfoConfig typedSrc = (CameraInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.availResolutions);
        currentAlignment += rapid.ext.astrobee.CameraModeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.mode);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.availResolutions, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.CameraModeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.mode, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.maxFrameRate);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CameraInfoConfig typedDst = (CameraInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.availResolutions = (rapid.ext.astrobee.CameraResolutionSequence8)rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.availResolutions, src, false, true, endpoint_plugin_qos);     
                typedDst.mode = (rapid.ext.astrobee.CameraMode)rapid.ext.astrobee.CameraModeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.mode, src, false, true, endpoint_plugin_qos);     
                typedDst.maxFrameRate = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraResolutionSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.astrobee.CameraModeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CameraInfoConfig typedDst = (CameraInfoConfig) sample;
    ...
    int mask) {
        return new CameraInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CameraInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected CameraInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraInfoConfigTypeCode.VALUE,CameraInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CameraInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CameraInfoConfigTypeCode.VALUE,CameraInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
