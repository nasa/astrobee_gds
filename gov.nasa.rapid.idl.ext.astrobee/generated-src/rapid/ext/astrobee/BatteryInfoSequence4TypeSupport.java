...
public class BatteryInfoSequence4TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::BatteryInfoSequence4";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryInfoSequence4TypeSupport _singleton
    = new BatteryInfoSequence4TypeSupport();
    ...
    */
    public static BatteryInfoSequence4TypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryInfoSequence4TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryInfoSequence4TypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryInfoSequence4.create();
    }
    ...
    public Object create_key() {
        return new BatteryInfoSequence4();
    }
    ...
    public Class get_type() {
        return BatteryInfoSequence4.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryInfoSequence4</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryInfoSequence4 typedDst = (BatteryInfoSequence4) destination;
        BatteryInfoSequence4 typedSrc = (BatteryInfoSequence4) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryInfoSequence4 typedSrc = (BatteryInfoSequence4) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,4, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryInfoSequence4 typedDst = (BatteryInfoSequence4) dst;
            rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 4, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryInfoSequence4 typedDst = (BatteryInfoSequence4) sample;
    ...
    protected BatteryInfoSequence4TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryInfoSequence4TypeCode.VALUE,BatteryInfoSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryInfoSequence4TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryInfoSequence4TypeCode.VALUE,BatteryInfoSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
