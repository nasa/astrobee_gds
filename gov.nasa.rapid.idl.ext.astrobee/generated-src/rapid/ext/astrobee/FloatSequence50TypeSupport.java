...
public class FloatSequence50TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FloatSequence50";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence50TypeSupport _singleton
    = new FloatSequence50TypeSupport();
    ...
    */
    public static FloatSequence50TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence50TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence50TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence50.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence50</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence50 typedDst = (FloatSequence50) destination;
        FloatSequence50 typedSrc = (FloatSequence50) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 50);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence50 typedSrc = (FloatSequence50) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,50);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence50 typedDst = (FloatSequence50) dst;
            src.readFloatSequence(typedDst.userData, 50);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence50 typedDst = (FloatSequence50) sample;
    ...
    protected FloatSequence50TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence50TypeCode.VALUE,FloatSequence50.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence50TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence50TypeCode.VALUE,FloatSequence50.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
