...
/**
* A sequence of ComponentState instances.
*/
public final class ComponentStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ComponentStateSeq() {
        super(ComponentState.class);
    }

    public ComponentStateSeq (int initialMaximum) {
        super(ComponentState.class, initialMaximum);
    }

    public ComponentStateSeq (Collection elements) {
        super(ComponentState.class, elements);
    }
