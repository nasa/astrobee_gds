...
* BatteryInfoConfigSequence4
*/

public class BatteryInfoConfigSequence4TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::BatteryInfoConfigSequence4";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryInfoConfigSequence4TypeSupport _singleton
    = new BatteryInfoConfigSequence4TypeSupport();
    ...
    */
    public static BatteryInfoConfigSequence4TypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryInfoConfigSequence4TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryInfoConfigSequence4TypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryInfoConfigSequence4.create();
    }
    ...
    public Object create_key() {
        return new BatteryInfoConfigSequence4();
    }
    ...
    public Class get_type() {
        return BatteryInfoConfigSequence4.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryInfoConfigSequence4</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryInfoConfigSequence4 typedDst = (BatteryInfoConfigSequence4) destination;
        BatteryInfoConfigSequence4 typedSrc = (BatteryInfoConfigSequence4) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryInfoConfigSequence4 typedSrc = (BatteryInfoConfigSequence4) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,4, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryInfoConfigSequence4 typedDst = (BatteryInfoConfigSequence4) dst;
            rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 4, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryInfoConfigSequence4 typedDst = (BatteryInfoConfigSequence4) sample;
    ...
    protected BatteryInfoConfigSequence4TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryInfoConfigSequence4TypeCode.VALUE,BatteryInfoConfigSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryInfoConfigSequence4TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryInfoConfigSequence4TypeCode.VALUE,BatteryInfoConfigSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
