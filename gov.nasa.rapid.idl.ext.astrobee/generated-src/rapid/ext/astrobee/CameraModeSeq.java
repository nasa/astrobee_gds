...
/**
* A sequence of CameraMode instances.
*/
public final class CameraModeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CameraModeSeq() {
        super(CameraMode.class);
    }

    public CameraModeSeq (int initialMaximum) {
        super(CameraMode.class, initialMaximum);
    }

    public CameraModeSeq (Collection elements) {
        super(CameraMode.class, elements);
    }
