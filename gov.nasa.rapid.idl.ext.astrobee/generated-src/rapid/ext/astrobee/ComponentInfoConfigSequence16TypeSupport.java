...
* ComponentInfoConfigSequence16
*/

public class ComponentInfoConfigSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentInfoConfigSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentInfoConfigSequence16TypeSupport _singleton
    = new ComponentInfoConfigSequence16TypeSupport();
    ...
    */
    public static ComponentInfoConfigSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentInfoConfigSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentInfoConfigSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return ComponentInfoConfigSequence16.create();
    }
    ...
    public Object create_key() {
        return new ComponentInfoConfigSequence16();
    }
    ...
    public Class get_type() {
        return ComponentInfoConfigSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>ComponentInfoConfigSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentInfoConfigSequence16 typedDst = (ComponentInfoConfigSequence16) destination;
        ComponentInfoConfigSequence16 typedSrc = (ComponentInfoConfigSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentInfoConfigSequence16 typedSrc = (ComponentInfoConfigSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentInfoConfigSequence16 typedDst = (ComponentInfoConfigSequence16) dst;
            rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentInfoConfigSequence16 typedDst = (ComponentInfoConfigSequence16) sample;
    ...
    protected ComponentInfoConfigSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ComponentInfoConfigSequence16TypeCode.VALUE,ComponentInfoConfigSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentInfoConfigSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentInfoConfigSequence16TypeCode.VALUE,ComponentInfoConfigSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
