...
public class CpuInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CpuInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuInfoTypeSupport _singleton
    = new CpuInfoTypeSupport();
    ...
    */
    public static CpuInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static CpuInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuInfoTypeCode.VALUE;
    }

    public Object create_data() {
        return CpuInfo.create();
    }
    ...
    * <code>this</code> is not a <code>CpuInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuInfo typedDst = (CpuInfo) destination;
        CpuInfo typedSrc = (CpuInfo) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuInfo typedSrc = (CpuInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.total_load);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuInfo typedDst = (CpuInfo) dst;
            typedDst.clear();      
            try{
                typedDst.total_load = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuInfo typedDst = (CpuInfo) sample;
    ...
    int mask) {
        return new CpuInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CpuInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected CpuInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CpuInfoTypeCode.VALUE,CpuInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuInfoTypeCode.VALUE,CpuInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
