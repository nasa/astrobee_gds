...
public class GuestScienceApkTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceApk";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceApkTypeSupport _singleton
    = new GuestScienceApkTypeSupport();
    ...
    */
    public static GuestScienceApkTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceApkTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceApkTypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceApk.create();
    }
    ...
    * <code>this</code> is not a <code>GuestScienceApk</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceApk typedDst = (GuestScienceApk) destination;
        GuestScienceApk typedSrc = (GuestScienceApk) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceApk typedSrc = (GuestScienceApk) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.shortName );
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.shortName,32);

            dst.writeBoolean(typedSrc.primary);

            rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.commands, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceApk typedDst = (GuestScienceApk) dst;
            typedDst.clear();      
            try{
                typedDst.apkName = src.readString(128);
                typedDst.shortName = src.readString(32);
                typedDst.primary = src.readBoolean();
                typedDst.commands = (rapid.ext.astrobee.GuestScienceCommandSequence32)rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.commands, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.GuestScienceCommandSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceApk typedDst = (GuestScienceApk) sample;
    ...
    int mask) {
        return new GuestScienceApkDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GuestScienceApkDataReader(native_reader, listener, mask, this);   
    ...
    protected GuestScienceApkTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GuestScienceApkTypeCode.VALUE,GuestScienceApk.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceApkTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceApkTypeCode.VALUE,GuestScienceApk.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
