...
/**
* A sequence of DataTopicsList instances.
*/
public final class DataTopicsListSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataTopicsListSeq() {
        super(DataTopicsList.class);
    }

    public DataTopicsListSeq (int initialMaximum) {
        super(DataTopicsList.class, initialMaximum);
    }

    public DataTopicsListSeq (Collection elements) {
        super(DataTopicsList.class, elements);
    }
