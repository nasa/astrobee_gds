...
/**
* A sequence of MachineInfo instances.
*/
public final class MachineInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MachineInfoSeq() {
        super(MachineInfo.class);
    }

    public MachineInfoSeq (int initialMaximum) {
        super(MachineInfo.class, initialMaximum);
    }

    public MachineInfoSeq (Collection elements) {
        super(MachineInfo.class, elements);
    }
