...
/**
* A sequence of ComponentConfig instances.
*/
public final class ComponentConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ComponentConfigSeq() {
        super(ComponentConfig.class);
    }

    public ComponentConfigSeq (int initialMaximum) {
        super(ComponentConfig.class, initialMaximum);
    }

    public ComponentConfigSeq (Collection elements) {
        super(ComponentConfig.class, elements);
    }
