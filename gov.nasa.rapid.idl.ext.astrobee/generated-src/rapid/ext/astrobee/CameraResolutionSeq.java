...
/**
* A sequence of CameraResolution instances.
*/
public final class CameraResolutionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CameraResolutionSeq() {
        super(CameraResolution.class);
    }

    public CameraResolutionSeq (int initialMaximum) {
        super(CameraResolution.class, initialMaximum);
    }

    public CameraResolutionSeq (Collection elements) {
        super(CameraResolution.class, elements);
    }
