...
public class ArmStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ArmState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ArmStateTypeSupport _singleton
    = new ArmStateTypeSupport();
    ...
    */
    public static ArmStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ArmStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ArmStateTypeCode.VALUE;
    }

    public Object create_data() {
        return ArmState.create();
    }
    ...
    * <code>this</code> is not a <code>ArmState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ArmState typedDst = (ArmState) destination;
        ArmState typedSrc = (ArmState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ArmState typedSrc = (ArmState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.jointState);
        currentAlignment += rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.gripperState);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.jointState, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.gripperState, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ArmState typedDst = (ArmState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.jointState = (rapid.ext.astrobee.ArmJointState)rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.jointState, src, false, true, endpoint_plugin_qos);     
                typedDst.gripperState = (rapid.ext.astrobee.ArmGripperState)rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.gripperState, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.ArmJointStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.astrobee.ArmGripperStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ArmState typedDst = (ArmState) sample;
    ...
    */
    ...
    int mask) {
        return new ArmStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ArmStateDataReader(native_reader, listener, mask, this);   
    ...
    protected ArmStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ArmStateTypeCode.VALUE,ArmState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ArmStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ArmStateTypeCode.VALUE,ArmState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
