...
public class EpsStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::EpsState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EpsStateTypeSupport _singleton
    = new EpsStateTypeSupport();
    ...
    */
    public static EpsStateTypeSupport get_instance() {
        return _singleton;
    }

    public static EpsStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EpsStateTypeCode.VALUE;
    }

    public Object create_data() {
        return EpsState.create();
    }
    ...
    * <code>this</code> is not a <code>EpsState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EpsState typedDst = (EpsState) destination;
        EpsState typedSrc = (EpsState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EpsState typedSrc = (EpsState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().serialize(endpoint_data, typedSrc.batteries, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.batteryTotal);

            dst.writeInt(typedSrc.estimatedMinutesRemaining);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EpsState typedDst = (EpsState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.batteries = (rapid.ext.astrobee.BatteryInfoSequence4)rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batteries, src, false, true, endpoint_plugin_qos);     
                typedDst.batteryTotal = src.readFloat();
                typedDst.estimatedMinutesRemaining = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoSequence4TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EpsState typedDst = (EpsState) sample;
    ...
    */
    ...
    int mask) {
        return new EpsStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EpsStateDataReader(native_reader, listener, mask, this);   
    ...
    protected EpsStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,EpsStateTypeCode.VALUE,EpsState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EpsStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EpsStateTypeCode.VALUE,EpsState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
