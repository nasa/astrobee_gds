...
/**
* A sequence of DiskState instances.
*/
public final class DiskStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DiskStateSeq (int initialMaximum) {
        super(DiskState.class, initialMaximum);
    }

    public DiskStateSeq (Collection elements) {
        super(DiskState.class, elements);
    }
