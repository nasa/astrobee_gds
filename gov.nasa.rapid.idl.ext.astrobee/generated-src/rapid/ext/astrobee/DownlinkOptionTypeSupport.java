...
public class DownlinkOptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DownlinkOption";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DownlinkOptionTypeSupport _singleton
    = new DownlinkOptionTypeSupport();
    ...
    */
    public static DownlinkOptionTypeSupport get_instance() {
        return _singleton;
    }

    public static DownlinkOptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DownlinkOptionTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>DownlinkOption</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DownlinkOption typedSrc = (DownlinkOption) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DownlinkOption.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DownlinkOptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DownlinkOptionTypeCode.VALUE,DownlinkOption.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
