...
public class ArmGripperStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ArmGripperState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ArmGripperStateTypeSupport _singleton
    = new ArmGripperStateTypeSupport();
    ...
    */
    public static ArmGripperStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ArmGripperStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ArmGripperStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ArmGripperState</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ArmGripperState typedSrc = (ArmGripperState) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ArmGripperState.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ArmGripperStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ArmGripperStateTypeCode.VALUE,ArmGripperState.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
