...
public class DiskConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DiskConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiskConfigTypeSupport _singleton
    = new DiskConfigTypeSupport();
    ...
    */
    public static DiskConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static DiskConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiskConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return DiskConfig.create();
    }
    ...
    * <code>this</code> is not a <code>DiskConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiskConfig typedDst = (DiskConfig) destination;
        DiskConfig typedSrc = (DiskConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiskConfig typedSrc = (DiskConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.filesystems, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiskConfig typedDst = (DiskConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.filesystems = (rapid.ext.astrobee.DiskInfoConfigSequence8)rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.filesystems, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.DiskInfoConfigSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiskConfig typedDst = (DiskConfig) sample;
    ...
    */
    ...
    int mask) {
        return new DiskConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DiskConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected DiskConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DiskConfigTypeCode.VALUE,DiskConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiskConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiskConfigTypeCode.VALUE,DiskConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
