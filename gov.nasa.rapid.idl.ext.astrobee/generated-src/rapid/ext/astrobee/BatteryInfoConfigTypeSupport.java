...
public class BatteryInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::BatteryInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryInfoConfigTypeSupport _singleton
    = new BatteryInfoConfigTypeSupport();
    ...
    */
    public static BatteryInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryInfoConfig.create();
    }
    ...
    public Class get_type() {
        return BatteryInfoConfig.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryInfoConfig typedDst = (BatteryInfoConfig) destination;
        BatteryInfoConfig typedSrc = (BatteryInfoConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryInfoConfig typedSrc = (BatteryInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.slot);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().serialize(endpoint_data, typedSrc.slot, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.designedCapacity);

            dst.writeFloat(typedSrc.currentMaxCapacity);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryInfoConfig typedDst = (BatteryInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.slot = (rapid.ext.astrobee.BatterySlot)rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.slot, src, false, true, endpoint_plugin_qos);     
                typedDst.designedCapacity = src.readFloat();
                typedDst.currentMaxCapacity = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BatterySlotTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryInfoConfig typedDst = (BatteryInfoConfig) sample;
    ...
    int mask) {
        return new BatteryInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryInfoConfigTypeCode.VALUE,BatteryInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryInfoConfigTypeCode.VALUE,BatteryInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
