...
public class TwistTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::Twist";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TwistTypeSupport _singleton
    = new TwistTypeSupport();
    ...
    */
    public static TwistTypeSupport get_instance() {
        return _singleton;
    }

    public static TwistTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TwistTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Twist</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Twist typedDst = (Twist) destination;
        Twist typedSrc = (Twist) source;
        ...
        Object sample) 
    {
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.linear);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.angular);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.linear, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.angular, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Twist typedDst = (Twist) dst;
            typedDst.clear();      
            try{
                typedDst.linear = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.linear, src, false, true, endpoint_plugin_qos);     
                typedDst.angular = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.angular, src, false, true, endpoint_plugin_qos);     
    ...
    int mask) {
        return new TwistDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TwistDataReader(native_reader, listener, mask, this);   
    ...
    protected TwistTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TwistTypeCode.VALUE,Twist.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TwistTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TwistTypeCode.VALUE,Twist.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
