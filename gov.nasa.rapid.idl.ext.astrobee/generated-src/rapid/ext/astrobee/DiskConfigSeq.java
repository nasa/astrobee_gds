...
/**
* A sequence of DiskConfig instances.
*/
public final class DiskConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DiskConfigSeq() {
        super(DiskConfig.class);
    }

    public DiskConfigSeq (int initialMaximum) {
        super(DiskConfig.class, initialMaximum);
    }

    public DiskConfigSeq (Collection elements) {
        super(DiskConfig.class, elements);
    }
