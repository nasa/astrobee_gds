...
public class ExecutionStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ExecutionState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ExecutionStateTypeSupport _singleton
    = new ExecutionStateTypeSupport();
    ...
    */
    public static ExecutionStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ExecutionStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ExecutionStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ExecutionState</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ExecutionState typedSrc = (ExecutionState) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ExecutionState.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ExecutionStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ExecutionStateTypeCode.VALUE,ExecutionState.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
