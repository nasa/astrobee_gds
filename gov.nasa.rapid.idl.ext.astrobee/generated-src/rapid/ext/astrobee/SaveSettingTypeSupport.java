...
public class SaveSettingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::SaveSetting";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SaveSettingTypeSupport _singleton
    = new SaveSettingTypeSupport();
    ...
    */
    public static SaveSettingTypeSupport get_instance() {
        return _singleton;
    }

    public static SaveSettingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SaveSettingTypeCode.VALUE;
    }

    public Object create_data() {
        return SaveSetting.create();
    }
    ...
    * <code>this</code> is not a <code>SaveSetting</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SaveSetting typedDst = (SaveSetting) destination;
        SaveSetting typedSrc = (SaveSetting) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SaveSetting typedSrc = (SaveSetting) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.topicName );
        currentAlignment += rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.downlinkOption);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.topicName,128);

            rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.downlinkOption, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.frequency);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SaveSetting typedDst = (SaveSetting) dst;
            typedDst.clear();      
            try{
                typedDst.topicName = src.readString(128);
                typedDst.downlinkOption = (rapid.ext.astrobee.DownlinkOption)rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.downlinkOption, src, false, true, endpoint_plugin_qos);     
                typedDst.frequency = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.DownlinkOptionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SaveSetting typedDst = (SaveSetting) sample;
    ...
    int mask) {
        return new SaveSettingDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SaveSettingDataReader(native_reader, listener, mask, this);   
    ...
    protected SaveSettingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SaveSettingTypeCode.VALUE,SaveSetting.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SaveSettingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SaveSettingTypeCode.VALUE,SaveSetting.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
