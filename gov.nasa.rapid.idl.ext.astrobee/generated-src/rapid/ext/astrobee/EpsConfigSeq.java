...
/**
* A sequence of EpsConfig instances.
*/
public final class EpsConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EpsConfigSeq() {
        super(EpsConfig.class);
    }

    public EpsConfigSeq (int initialMaximum) {
        super(EpsConfig.class, initialMaximum);
    }

    public EpsConfigSeq (Collection elements) {
        super(EpsConfig.class, elements);
    }
