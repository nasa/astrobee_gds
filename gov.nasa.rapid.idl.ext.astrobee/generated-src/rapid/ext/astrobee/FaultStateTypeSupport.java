...
public class FaultStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FaultState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FaultStateTypeSupport _singleton
    = new FaultStateTypeSupport();
    ...
    */
    public static FaultStateTypeSupport get_instance() {
        return _singleton;
    }

    public static FaultStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FaultStateTypeCode.VALUE;
    }

    public Object create_data() {
        return FaultState.create();
    }
    ...
    * <code>this</code> is not a <code>FaultState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FaultState typedDst = (FaultState) destination;
        FaultState typedSrc = (FaultState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FaultState typedSrc = (FaultState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.faults, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FaultState typedDst = (FaultState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.faults = (rapid.ext.astrobee.FaultSequence32)rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.faults, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.FaultSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FaultState typedDst = (FaultState) sample;
    ...
    */
    ...
    int mask) {
        return new FaultStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FaultStateDataReader(native_reader, listener, mask, this);   
    ...
    protected FaultStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FaultStateTypeCode.VALUE,FaultState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FaultStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FaultStateTypeCode.VALUE,FaultState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
