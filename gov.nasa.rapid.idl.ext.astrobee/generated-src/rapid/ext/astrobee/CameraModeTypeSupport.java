...
public class CameraModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraModeTypeSupport _singleton
    = new CameraModeTypeSupport();
    ...
    */
    public static CameraModeTypeSupport get_instance() {
        return _singleton;
    }

    public static CameraModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraModeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CameraMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        CameraMode typedSrc = (CameraMode) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CameraMode.valueOf(ordinal);
            if (dst == null) {
    ...
    protected CameraModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraModeTypeCode.VALUE,CameraMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
