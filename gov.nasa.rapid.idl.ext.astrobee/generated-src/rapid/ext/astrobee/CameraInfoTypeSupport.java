...
public class CameraInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraInfoTypeSupport _singleton
    = new CameraInfoTypeSupport();
    ...
    */
    public static CameraInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static CameraInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraInfoTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CameraInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CameraInfo typedDst = (CameraInfo) destination;
        CameraInfo typedSrc = (CameraInfo) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CameraInfo typedSrc = (CameraInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.resolution);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.streaming);

            dst.writeBoolean(typedSrc.recording);

            rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.resolution, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.frameRate);

            dst.writeFloat(typedSrc.bandwidth);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CameraInfo typedDst = (CameraInfo) dst;
            typedDst.clear();      
            try{
                typedDst.streaming = src.readBoolean();
                typedDst.recording = src.readBoolean();
                typedDst.resolution = (rapid.ext.astrobee.CameraResolution)rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.resolution, src, false, true, endpoint_plugin_qos);     
                typedDst.frameRate = src.readFloat();
                typedDst.bandwidth = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CameraInfo typedDst = (CameraInfo) sample;
    ...
    int mask) {
        return new CameraInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CameraInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected CameraInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraInfoTypeCode.VALUE,CameraInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CameraInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CameraInfoTypeCode.VALUE,CameraInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
