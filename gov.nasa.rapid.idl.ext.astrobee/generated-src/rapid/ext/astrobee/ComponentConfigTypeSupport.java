...
public class ComponentConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentConfigTypeSupport _singleton
    = new ComponentConfigTypeSupport();
    ...
    */
    public static ComponentConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return ComponentConfig.create();
    }
    ...
    * <code>this</code> is not a <code>ComponentConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentConfig typedDst = (ComponentConfig) destination;
        ComponentConfig typedSrc = (ComponentConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentConfig typedSrc = (ComponentConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.components);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.components, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentConfig typedDst = (ComponentConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.components = (rapid.ext.astrobee.ComponentInfoConfigSequence16)rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.components, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoConfigSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentConfig typedDst = (ComponentConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ComponentConfig typedDst
        = (ComponentConfig) instance;
        ComponentConfig typedSrc
        = (ComponentConfig) key;
    ...
    */
    ...
    int mask) {
        return new ComponentConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ComponentConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ComponentConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ComponentConfigTypeCode.VALUE,ComponentConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentConfigTypeCode.VALUE,ComponentConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
