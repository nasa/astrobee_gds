...
public class DiskInfoSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DiskInfoSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiskInfoSequence8TypeSupport _singleton
    = new DiskInfoSequence8TypeSupport();
    ...
    */
    public static DiskInfoSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static DiskInfoSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiskInfoSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return DiskInfoSequence8.create();
    }
    ...
    public Class get_type() {
        return DiskInfoSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>DiskInfoSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiskInfoSequence8 typedDst = (DiskInfoSequence8) destination;
        DiskInfoSequence8 typedSrc = (DiskInfoSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiskInfoSequence8 typedSrc = (DiskInfoSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiskInfoSequence8 typedDst = (DiskInfoSequence8) dst;
            rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.DiskInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiskInfoSequence8 typedDst = (DiskInfoSequence8) sample;
    ...
    protected DiskInfoSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiskInfoSequence8TypeCode.VALUE,DiskInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiskInfoSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiskInfoSequence8TypeCode.VALUE,DiskInfoSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
