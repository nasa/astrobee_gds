...
/**
* A sequence of FloatSequence50 instances.
*/
public final class FloatSequence50Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence50Seq() {
        super(FloatSequence50.class);
    }

    public FloatSequence50Seq (int initialMaximum) {
        super(FloatSequence50.class, initialMaximum);
    }

    public FloatSequence50Seq (Collection elements) {
        super(FloatSequence50.class, elements);
    }
