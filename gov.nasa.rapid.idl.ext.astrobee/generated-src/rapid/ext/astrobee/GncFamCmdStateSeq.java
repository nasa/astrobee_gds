...
/**
* A sequence of GncFamCmdState instances.
*/
public final class GncFamCmdStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GncFamCmdStateSeq() {
        super(GncFamCmdState.class);
    }

    public GncFamCmdStateSeq (int initialMaximum) {
        super(GncFamCmdState.class, initialMaximum);
    }

    public GncFamCmdStateSeq (Collection elements) {
        super(GncFamCmdState.class, elements);
    }
