...
public class TelemetryStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::TelemetryState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TelemetryStateTypeSupport _singleton
    = new TelemetryStateTypeSupport();
    ...
    */
    public static TelemetryStateTypeSupport get_instance() {
        return _singleton;
    }

    public static TelemetryStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TelemetryStateTypeCode.VALUE;
    }

    public Object create_data() {
        return TelemetryState.create();
    }
    ...
    * <code>this</code> is not a <code>TelemetryState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TelemetryState typedDst = (TelemetryState) destination;
        TelemetryState typedSrc = (TelemetryState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TelemetryState typedSrc = (TelemetryState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cameras);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.commStatusRate);

            dst.writeFloat(typedSrc.cpuStateRate);

            dst.writeFloat(typedSrc.diskStateRate);

            dst.writeFloat(typedSrc.ekfStateRate);

            dst.writeFloat(typedSrc.gncStateRate);

            dst.writeFloat(typedSrc.pmcCmdStateRate);

            dst.writeFloat(typedSrc.positionRate);

            rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.cameras, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TelemetryState typedDst = (TelemetryState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.commStatusRate = src.readFloat();
                typedDst.cpuStateRate = src.readFloat();
                typedDst.diskStateRate = src.readFloat();
                typedDst.ekfStateRate = src.readFloat();
                typedDst.gncStateRate = src.readFloat();
                typedDst.pmcCmdStateRate = src.readFloat();
                typedDst.positionRate = src.readFloat();
                typedDst.cameras = (rapid.ext.astrobee.CameraInfoSequence8)rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cameras, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraInfoSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TelemetryState typedDst = (TelemetryState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TelemetryState typedDst
        = (TelemetryState) instance;
        TelemetryState typedSrc
        = (TelemetryState) key;
    ...
    */
    ...
    int mask) {
        return new TelemetryStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TelemetryStateDataReader(native_reader, listener, mask, this);   
    ...
    protected TelemetryStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TelemetryStateTypeCode.VALUE,TelemetryState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TelemetryStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TelemetryStateTypeCode.VALUE,TelemetryState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
