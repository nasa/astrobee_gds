...
public class StatusTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::ext::astrobee::Status";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.point);

            dst.writeInt(typedSrc.command);

            dst.writeInt(typedSrc.duration);

            rapid.AckCompletedStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.point = src.readInt();
                typedDst.command = src.readInt();
                typedDst.duration = src.readInt();
                typedDst.status = (rapid.AckCompletedStatus)rapid.AckCompletedStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
    ...
    int mask) {
        return new StatusDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new StatusDataReader(native_reader, listener, mask, this);   
