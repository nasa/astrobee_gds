...
/**
* A sequence of DataToDiskState instances.
*/
public final class DataToDiskStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataToDiskStateSeq() {
        super(DataToDiskState.class);
    }

    public DataToDiskStateSeq (int initialMaximum) {
        super(DataToDiskState.class, initialMaximum);
    }

    public DataToDiskStateSeq (Collection elements) {
        super(DataToDiskState.class, elements);
    }
