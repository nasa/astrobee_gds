...
/**
* A sequence of BerthState instances.
*/
public final class BerthStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BerthStateSeq() {
        super(BerthState.class);
    }

    public BerthStateSeq (int initialMaximum) {
        super(BerthState.class, initialMaximum);
    }

    public BerthStateSeq (Collection elements) {
        super(BerthState.class, elements);
    }
