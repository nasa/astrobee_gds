...
/**
* A sequence of CameraInfoConfig instances.
*/
public final class CameraInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CameraInfoConfigSeq() {
        super(CameraInfoConfig.class);
    }

    public CameraInfoConfigSeq (int initialMaximum) {
        super(CameraInfoConfig.class, initialMaximum);
    }

    public CameraInfoConfigSeq (Collection elements) {
        super(CameraInfoConfig.class, elements);
    }
