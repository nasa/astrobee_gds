...
public class EpsConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::EpsConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EpsConfigTypeSupport _singleton
    = new EpsConfigTypeSupport();
    ...
    */
    public static EpsConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static EpsConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EpsConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return EpsConfig.create();
    }
    ...
    * <code>this</code> is not a <code>EpsConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EpsConfig typedDst = (EpsConfig) destination;
        EpsConfig typedSrc = (EpsConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EpsConfig typedSrc = (EpsConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().serialize(endpoint_data, typedSrc.batteries, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EpsConfig typedDst = (EpsConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.batteries = (rapid.ext.astrobee.BatteryInfoConfigSequence4)rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batteries, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BatteryInfoConfigSequence4TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EpsConfig typedDst = (EpsConfig) sample;
    ...
    */
    ...
    int mask) {
        return new EpsConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EpsConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected EpsConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,EpsConfigTypeCode.VALUE,EpsConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EpsConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EpsConfigTypeCode.VALUE,EpsConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
