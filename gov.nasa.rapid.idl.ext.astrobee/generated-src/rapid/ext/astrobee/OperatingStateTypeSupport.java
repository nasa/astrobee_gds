...
public class OperatingStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::OperatingState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OperatingStateTypeSupport _singleton
    = new OperatingStateTypeSupport();
    ...
    */
    public static OperatingStateTypeSupport get_instance() {
        return _singleton;
    }

    public static OperatingStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OperatingStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>OperatingState</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        OperatingState typedSrc = (OperatingState) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = OperatingState.valueOf(ordinal);
            if (dst == null) {
    ...
    protected OperatingStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OperatingStateTypeCode.VALUE,OperatingState.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
