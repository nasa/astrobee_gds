...
public class ArmJointStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ArmJointState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ArmJointStateTypeSupport _singleton
    = new ArmJointStateTypeSupport();
    ...
    */
    public static ArmJointStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ArmJointStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ArmJointStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ArmJointState</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ArmJointState typedSrc = (ArmJointState) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ArmJointState.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ArmJointStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ArmJointStateTypeCode.VALUE,ArmJointState.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
