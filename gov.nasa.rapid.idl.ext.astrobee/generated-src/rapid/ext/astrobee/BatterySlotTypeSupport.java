...
public class BatterySlotTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::ext::astrobee::BatterySlot";
    ...
    */
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = BatterySlot.valueOf(ordinal);
            if (dst == null) {
    ...
    protected BatterySlotTypeSupport() {
        ...
        super(TYPE_NAME, false,BatterySlotTypeCode.VALUE,BatterySlot.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
