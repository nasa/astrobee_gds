...
public class MachineInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::MachineInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MachineInfoTypeSupport _singleton
    = new MachineInfoTypeSupport();
    ...
    */
    public static MachineInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static MachineInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MachineInfoTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>MachineInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MachineInfo typedDst = (MachineInfo) destination;
        MachineInfo typedSrc = (MachineInfo) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MachineInfo typedSrc = (MachineInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.avg_total_load);

            dst.writeFloat(typedSrc.temperature);

            rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.cpus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MachineInfo typedDst = (MachineInfo) dst;
            typedDst.clear();      
            try{
                typedDst.avg_total_load = src.readFloat();
                typedDst.temperature = src.readFloat();
                typedDst.cpus = (rapid.ext.astrobee.CpuInfoSequence8)rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cpus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CpuInfoSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MachineInfo typedDst = (MachineInfo) sample;
    ...
    int mask) {
        return new MachineInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MachineInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected MachineInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MachineInfoTypeCode.VALUE,MachineInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MachineInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MachineInfoTypeCode.VALUE,MachineInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
