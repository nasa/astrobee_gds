...
public class CpuConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CpuConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuConfigTypeSupport _singleton
    = new CpuConfigTypeSupport();
    ...
    */
    public static CpuConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static CpuConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return CpuConfig.create();
    }
    ...
    * <code>this</code> is not a <code>CpuConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuConfig typedDst = (CpuConfig) destination;
        CpuConfig typedSrc = (CpuConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuConfig typedSrc = (CpuConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.machines);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.machines, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuConfig typedDst = (CpuConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.machines = (rapid.ext.astrobee.CpuInfoConfigSequence8)rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.machines, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CpuInfoConfigSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuConfig typedDst = (CpuConfig) sample;
    ...
    */
    ...
    int mask) {
        return new CpuConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CpuConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected CpuConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CpuConfigTypeCode.VALUE,CpuConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuConfigTypeCode.VALUE,CpuConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
