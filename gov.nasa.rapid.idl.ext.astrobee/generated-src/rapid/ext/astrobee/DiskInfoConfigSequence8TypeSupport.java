...
* DiskInfoConfigSequence8
*/

public class DiskInfoConfigSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DiskInfoConfigSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiskInfoConfigSequence8TypeSupport _singleton
    = new DiskInfoConfigSequence8TypeSupport();
    ...
    */
    public static DiskInfoConfigSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static DiskInfoConfigSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiskInfoConfigSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return DiskInfoConfigSequence8.create();
    }
    ...
    public Object create_key() {
        return new DiskInfoConfigSequence8();
    }
    ...
    public Class get_type() {
        return DiskInfoConfigSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>DiskInfoConfigSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiskInfoConfigSequence8 typedDst = (DiskInfoConfigSequence8) destination;
        DiskInfoConfigSequence8 typedSrc = (DiskInfoConfigSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiskInfoConfigSequence8 typedSrc = (DiskInfoConfigSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiskInfoConfigSequence8 typedDst = (DiskInfoConfigSequence8) dst;
            rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.DiskInfoConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiskInfoConfigSequence8 typedDst = (DiskInfoConfigSequence8) sample;
    ...
    protected DiskInfoConfigSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiskInfoConfigSequence8TypeCode.VALUE,DiskInfoConfigSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiskInfoConfigSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiskInfoConfigSequence8TypeCode.VALUE,DiskInfoConfigSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
