...
/**
* A sequence of CompressedFile instances.
*/
public final class CompressedFileSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CompressedFileSeq() {
        super(CompressedFile.class);
    }

    public CompressedFileSeq (int initialMaximum) {
        super(CompressedFile.class, initialMaximum);
    }

    public CompressedFileSeq (Collection elements) {
        super(CompressedFile.class, elements);
    }
