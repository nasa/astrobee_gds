...
* CpuInfoConfigSequence8
*/

public class CpuInfoConfigSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CpuInfoConfigSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuInfoConfigSequence8TypeSupport _singleton
    = new CpuInfoConfigSequence8TypeSupport();
    ...
    */
    public static CpuInfoConfigSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static CpuInfoConfigSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuInfoConfigSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return CpuInfoConfigSequence8.create();
    }
    ...
    public Object create_key() {
        return new CpuInfoConfigSequence8();
    }
    ...
    public Class get_type() {
        return CpuInfoConfigSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>CpuInfoConfigSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuInfoConfigSequence8 typedDst = (CpuInfoConfigSequence8) destination;
        CpuInfoConfigSequence8 typedSrc = (CpuInfoConfigSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuInfoConfigSequence8 typedSrc = (CpuInfoConfigSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuInfoConfigSequence8 typedDst = (CpuInfoConfigSequence8) dst;
            rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CpuInfoConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuInfoConfigSequence8 typedDst = (CpuInfoConfigSequence8) sample;
    ...
    protected CpuInfoConfigSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CpuInfoConfigSequence8TypeCode.VALUE,CpuInfoConfigSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuInfoConfigSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuInfoConfigSequence8TypeCode.VALUE,CpuInfoConfigSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
