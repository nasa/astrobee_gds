...
/**
* A sequence of DockState instances.
*/
public final class DockStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DockStateSeq() {
        super(DockState.class);
    }

    public DockStateSeq (int initialMaximum) {
        super(DockState.class, initialMaximum);
    }

    public DockStateSeq (Collection elements) {
        super(DockState.class, elements);
    }
