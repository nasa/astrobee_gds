...
public class GuestScienceConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceConfigTypeSupport _singleton
    = new GuestScienceConfigTypeSupport();
    ...
    */
    public static GuestScienceConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceConfig.create();
    }
    ...
    public Class get_type() {
        return GuestScienceConfig.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceConfig typedDst = (GuestScienceConfig) destination;
        GuestScienceConfig typedSrc = (GuestScienceConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceConfig typedSrc = (GuestScienceConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.apkStates);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().serialize(endpoint_data, typedSrc.apkStates, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceConfig typedDst = (GuestScienceConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.apkStates = (rapid.ext.astrobee.GuestScienceApkSequence32)rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.apkStates, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.GuestScienceApkSequence32TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceConfig typedDst = (GuestScienceConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GuestScienceConfig typedDst
        = (GuestScienceConfig) instance;
        GuestScienceConfig typedSrc
        = (GuestScienceConfig) key;
    ...
    */
    ...
    int mask) {
        return new GuestScienceConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GuestScienceConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected GuestScienceConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GuestScienceConfigTypeCode.VALUE,GuestScienceConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceConfigTypeCode.VALUE,GuestScienceConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
