...
/**
* A sequence of DownlinkOption instances.
*/
public final class DownlinkOptionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DownlinkOptionSeq() {
        super(DownlinkOption.class);
    }

    public DownlinkOptionSeq (int initialMaximum) {
        super(DownlinkOption.class, initialMaximum);
    }

    public DownlinkOptionSeq (Collection elements) {
        super(DownlinkOption.class, elements);
    }
