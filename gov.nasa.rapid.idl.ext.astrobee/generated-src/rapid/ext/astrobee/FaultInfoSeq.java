...
/**
* A sequence of FaultInfo instances.
*/
public final class FaultInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FaultInfoSeq() {
        super(FaultInfo.class);
    }

    public FaultInfoSeq (int initialMaximum) {
        super(FaultInfo.class, initialMaximum);
    }

    public FaultInfoSeq (Collection elements) {
        super(FaultInfo.class, elements);
    }
