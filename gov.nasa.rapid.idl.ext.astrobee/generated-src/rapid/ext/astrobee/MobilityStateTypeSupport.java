...
public class MobilityStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::MobilityState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MobilityStateTypeSupport _singleton
    = new MobilityStateTypeSupport();
    ...
    */
    public static MobilityStateTypeSupport get_instance() {
        return _singleton;
    }

    public static MobilityStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MobilityStateTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>MobilityState</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        MobilityState typedSrc = (MobilityState) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MobilityState.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MobilityStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MobilityStateTypeCode.VALUE,MobilityState.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
