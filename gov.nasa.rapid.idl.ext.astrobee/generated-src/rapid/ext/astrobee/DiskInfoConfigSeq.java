...
/**
* A sequence of DiskInfoConfig instances.
*/
public final class DiskInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DiskInfoConfigSeq() {
        super(DiskInfoConfig.class);
    }

    public DiskInfoConfigSeq (int initialMaximum) {
        super(DiskInfoConfig.class, initialMaximum);
    }

    public DiskInfoConfigSeq (Collection elements) {
        super(DiskInfoConfig.class, elements);
    }
