...
* CameraResolutionSequence8
*/

public class CameraResolutionSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CameraResolutionSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CameraResolutionSequence8TypeSupport _singleton
    = new CameraResolutionSequence8TypeSupport();
    ...
    */
    public static CameraResolutionSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static CameraResolutionSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CameraResolutionSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return CameraResolutionSequence8.create();
    }
    ...
    public Object create_key() {
        return new CameraResolutionSequence8();
    }
    ...
    public Class get_type() {
        return CameraResolutionSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>CameraResolutionSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CameraResolutionSequence8 typedDst = (CameraResolutionSequence8) destination;
        CameraResolutionSequence8 typedSrc = (CameraResolutionSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CameraResolutionSequence8 typedSrc = (CameraResolutionSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CameraResolutionSequence8 typedDst = (CameraResolutionSequence8) dst;
            rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraResolutionTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CameraResolutionSequence8 typedDst = (CameraResolutionSequence8) sample;
    ...
    protected CameraResolutionSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CameraResolutionSequence8TypeCode.VALUE,CameraResolutionSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CameraResolutionSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CameraResolutionSequence8TypeCode.VALUE,CameraResolutionSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
