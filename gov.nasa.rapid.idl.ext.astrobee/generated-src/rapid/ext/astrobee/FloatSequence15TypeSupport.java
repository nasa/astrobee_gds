...
public class FloatSequence15TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FloatSequence15";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence15TypeSupport _singleton
    = new FloatSequence15TypeSupport();
    ...
    */
    public static FloatSequence15TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence15TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence15TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence15.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence15</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence15 typedDst = (FloatSequence15) destination;
        FloatSequence15 typedSrc = (FloatSequence15) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 15);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence15 typedSrc = (FloatSequence15) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,15);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence15 typedDst = (FloatSequence15) dst;
            src.readFloatSequence(typedDst.userData, 15);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence15 typedDst = (FloatSequence15) sample;
    ...
    protected FloatSequence15TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence15TypeCode.VALUE,FloatSequence15.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence15TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence15TypeCode.VALUE,FloatSequence15.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
