...
* ComponentInfoSequence16
*/

public class ComponentInfoSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::ComponentInfoSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ComponentInfoSequence16TypeSupport _singleton
    = new ComponentInfoSequence16TypeSupport();
    ...
    */
    public static ComponentInfoSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static ComponentInfoSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ComponentInfoSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return ComponentInfoSequence16.create();
    }
    ...
    public Object create_key() {
        return new ComponentInfoSequence16();
    }
    ...
    public Class get_type() {
        return ComponentInfoSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>ComponentInfoSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ComponentInfoSequence16 typedDst = (ComponentInfoSequence16) destination;
        ComponentInfoSequence16 typedSrc = (ComponentInfoSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ComponentInfoSequence16 typedSrc = (ComponentInfoSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ComponentInfoSequence16 typedDst = (ComponentInfoSequence16) dst;
            rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.ComponentInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ComponentInfoSequence16 typedDst = (ComponentInfoSequence16) sample;
    ...
    protected ComponentInfoSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ComponentInfoSequence16TypeCode.VALUE,ComponentInfoSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ComponentInfoSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ComponentInfoSequence16TypeCode.VALUE,ComponentInfoSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
