...
* GuestScienceCommandSequence32
*/

public class GuestScienceCommandSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceCommandSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceCommandSequence32TypeSupport _singleton
    = new GuestScienceCommandSequence32TypeSupport();
    ...
    */
    public static GuestScienceCommandSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceCommandSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceCommandSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceCommandSequence32.create();
    }
    ...
    public Object create_key() {
        return new GuestScienceCommandSequence32();
    }
    ...
    public Class get_type() {
        return GuestScienceCommandSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceCommandSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceCommandSequence32 typedDst = (GuestScienceCommandSequence32) destination;
        GuestScienceCommandSequence32 typedSrc = (GuestScienceCommandSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceCommandSequence32 typedSrc = (GuestScienceCommandSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceCommandSequence32 typedDst = (GuestScienceCommandSequence32) dst;
            rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.GuestScienceCommandTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceCommandSequence32 typedDst = (GuestScienceCommandSequence32) sample;
    ...
    protected GuestScienceCommandSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GuestScienceCommandSequence32TypeCode.VALUE,GuestScienceCommandSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceCommandSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceCommandSequence32TypeCode.VALUE,GuestScienceCommandSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
