...
* GuestScienceApkSequence32
*/

public class GuestScienceApkSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceApkSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceApkSequence32TypeSupport _singleton
    = new GuestScienceApkSequence32TypeSupport();
    ...
    */
    public static GuestScienceApkSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceApkSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceApkSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return GuestScienceApkSequence32.create();
    }
    ...
    public Object create_key() {
        return new GuestScienceApkSequence32();
    }
    ...
    public Class get_type() {
        return GuestScienceApkSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceApkSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GuestScienceApkSequence32 typedDst = (GuestScienceApkSequence32) destination;
        GuestScienceApkSequence32 typedSrc = (GuestScienceApkSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GuestScienceApkSequence32 typedSrc = (GuestScienceApkSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GuestScienceApkSequence32 typedDst = (GuestScienceApkSequence32) dst;
            rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.GuestScienceApkTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GuestScienceApkSequence32 typedDst = (GuestScienceApkSequence32) sample;
    ...
    protected GuestScienceApkSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GuestScienceApkSequence32TypeCode.VALUE,GuestScienceApkSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GuestScienceApkSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GuestScienceApkSequence32TypeCode.VALUE,GuestScienceApkSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
