...
/**
* A sequence of CameraInfo instances.
*/
public final class CameraInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CameraInfoSeq() {
        super(CameraInfo.class);
    }

    public CameraInfoSeq (int initialMaximum) {
        super(CameraInfo.class, initialMaximum);
    }

    public CameraInfoSeq (Collection elements) {
        super(CameraInfo.class, elements);
    }
