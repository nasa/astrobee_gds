...
/**
* A sequence of CpuInfo instances.
*/
public final class CpuInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CpuInfoSeq (int initialMaximum) {
        super(CpuInfo.class, initialMaximum);
    }

    public CpuInfoSeq (Collection elements) {
        super(CpuInfo.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, CpuInfo.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' CpuInfo objects (beyond the original size of this object)
