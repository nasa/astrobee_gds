...
/**
* A sequence of GuestScienceData instances.
*/
public final class GuestScienceDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GuestScienceDataSeq() {
        super(GuestScienceData.class);
    }

    public GuestScienceDataSeq (int initialMaximum) {
        super(GuestScienceData.class, initialMaximum);
    }

    public GuestScienceDataSeq (Collection elements) {
        super(GuestScienceData.class, elements);
    }
