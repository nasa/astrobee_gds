...
public class PlanStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::PlanStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PlanStatusTypeSupport _singleton
    = new PlanStatusTypeSupport();
    ...
    */
    public static PlanStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static PlanStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PlanStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return PlanStatus.create();
    }
    ...
    * <code>this</code> is not a <code>PlanStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PlanStatus typedDst = (PlanStatus) destination;
        PlanStatus typedSrc = (PlanStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.AckStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.AckStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PlanStatus typedSrc = (PlanStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.planName );
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.AckStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.currentStatus);
        currentAlignment += rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.statusHistory);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.planName,32);

            dst.writeInt(typedSrc.currentPoint);

            dst.writeInt(typedSrc.currentCommand);

            rapid.AckStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.currentStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.statusHistory, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PlanStatus typedDst = (PlanStatus) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.planName = src.readString(32);
                typedDst.currentPoint = src.readInt();
                typedDst.currentCommand = src.readInt();
                typedDst.currentStatus = (rapid.AckStatus)rapid.AckStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.currentStatus, src, false, true, endpoint_plugin_qos);     
                typedDst.statusHistory = (rapid.ext.astrobee.StatusSequence)rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.statusHistory, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.AckStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.astrobee.StatusSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PlanStatus typedDst = (PlanStatus) sample;
    ...
    */
    ...
    int mask) {
        return new PlanStatusDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PlanStatusDataReader(native_reader, listener, mask, this);   
    ...
    protected PlanStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PlanStatusTypeCode.VALUE,PlanStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PlanStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PlanStatusTypeCode.VALUE,PlanStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
