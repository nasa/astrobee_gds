...
/**
* A sequence of Wrench instances.
*/
public final class WrenchSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WrenchSeq (int initialMaximum) {
        super(Wrench.class, initialMaximum);
    }

    public WrenchSeq (Collection elements) {
        super(Wrench.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Wrench objects (beyond the original size of this object)
