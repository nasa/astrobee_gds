...
public class BooleanSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::BooleanSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BooleanSequence32TypeSupport _singleton
    = new BooleanSequence32TypeSupport();
    ...
    */
    public static BooleanSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static BooleanSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BooleanSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return BooleanSequence32.create();
    }
    ...
    public Class get_type() {
        return BooleanSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>BooleanSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BooleanSequence32 typedDst = (BooleanSequence32) destination;
        BooleanSequence32 typedSrc = (BooleanSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BOOLEAN.getSequenceMaxSizeSerialized(currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BOOLEAN.getSequenceMaxSizeSerialized(currentAlignment,  0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BooleanSequence32 typedSrc = (BooleanSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.BOOLEAN.getSequenceSerializedSize(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBooleanSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BooleanSequence32 typedDst = (BooleanSequence32) dst;
            src.readBooleanSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BooleanSequence32 typedDst = (BooleanSequence32) sample;
    ...
    protected BooleanSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BooleanSequence32TypeCode.VALUE,BooleanSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BooleanSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BooleanSequence32TypeCode.VALUE,BooleanSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
