...
public class TelemetryConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::TelemetryConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TelemetryConfigTypeSupport _singleton
    = new TelemetryConfigTypeSupport();
    ...
    */
    public static TelemetryConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static TelemetryConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TelemetryConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return TelemetryConfig.create();
    }
    ...
    * <code>this</code> is not a <code>TelemetryConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TelemetryConfig typedDst = (TelemetryConfig) destination;
        TelemetryConfig typedSrc = (TelemetryConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TelemetryConfig typedSrc = (TelemetryConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.cameras, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TelemetryConfig typedDst = (TelemetryConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.cameras = (rapid.ext.astrobee.CameraInfoConfigSequence8)rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cameras, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.CameraInfoConfigSequence8TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TelemetryConfig typedDst = (TelemetryConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TelemetryConfig typedDst
        = (TelemetryConfig) instance;
        TelemetryConfig typedSrc
        = (TelemetryConfig) key;
    ...
    */
    ...
    int mask) {
        return new TelemetryConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TelemetryConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected TelemetryConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TelemetryConfigTypeCode.VALUE,TelemetryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TelemetryConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TelemetryConfigTypeCode.VALUE,TelemetryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
