...
public class CompressedFileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::CompressedFile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CompressedFileTypeSupport _singleton
    = new CompressedFileTypeSupport();
    ...
    */
    public static CompressedFileTypeSupport get_instance() {
        return _singleton;
    }

    public static CompressedFileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CompressedFileTypeCode.VALUE;
    }

    public Object create_data() {
        return CompressedFile.create();
    }
    ...
    * <code>this</code> is not a <code>CompressedFile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CompressedFile typedDst = (CompressedFile) destination;
        CompressedFile typedSrc = (CompressedFile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CompressedFile typedSrc = (CompressedFile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.OctetSequence128KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.compressedFile);
        currentAlignment += rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.compressionType);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.OctetSequence128KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.compressedFile, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.compressionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CompressedFile typedDst = (CompressedFile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.compressedFile = (rapid.OctetSequence128K)rapid.OctetSequence128KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.compressedFile, src, false, true, endpoint_plugin_qos);     
                typedDst.compressionType = (rapid.ext.astrobee.FileCompressionType)rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.compressionType, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.FileCompressionTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CompressedFile typedDst = (CompressedFile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        CompressedFile typedDst
        = (CompressedFile) instance;
        CompressedFile typedSrc
        = (CompressedFile) key;
    ...
    */
    ...
    int mask) {
        return new CompressedFileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CompressedFileDataReader(native_reader, listener, mask, this);   
    ...
    protected CompressedFileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CompressedFileTypeCode.VALUE,CompressedFile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CompressedFileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CompressedFileTypeCode.VALUE,CompressedFile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
