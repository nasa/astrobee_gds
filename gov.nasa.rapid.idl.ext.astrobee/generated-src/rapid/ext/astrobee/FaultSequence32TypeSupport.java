...
public class FaultSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::FaultSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FaultSequence32TypeSupport _singleton
    = new FaultSequence32TypeSupport();
    ...
    */
    public static FaultSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static FaultSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FaultSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return FaultSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>FaultSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FaultSequence32 typedDst = (FaultSequence32) destination;
        FaultSequence32 typedSrc = (FaultSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.FaultTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FaultSequence32 typedSrc = (FaultSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.FaultTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.FaultTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FaultSequence32 typedDst = (FaultSequence32) dst;
            rapid.ext.astrobee.FaultTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.FaultTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FaultSequence32 typedDst = (FaultSequence32) sample;
    ...
    protected FaultSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FaultSequence32TypeCode.VALUE,FaultSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FaultSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FaultSequence32TypeCode.VALUE,FaultSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
