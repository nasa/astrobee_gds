...
public class DockStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::DockState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DockStateTypeSupport _singleton
    = new DockStateTypeSupport();
    ...
    */
    public static DockStateTypeSupport get_instance() {
        return _singleton;
    }

    public static DockStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DockStateTypeCode.VALUE;
    }

    public Object create_data() {
        return DockState.create();
    }
    ...
    * <code>this</code> is not a <code>DockState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DockState typedDst = (DockState) destination;
        DockState typedSrc = (DockState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DockState typedSrc = (DockState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.berthOne);
        currentAlignment += rapid.ext.astrobee.BerthStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.berthTwo);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.astrobee.BerthStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.berthOne, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.astrobee.BerthStateTypeSupport.get_instance().serialize(endpoint_data, typedSrc.berthTwo, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DockState typedDst = (DockState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.berthOne = (rapid.ext.astrobee.BerthState)rapid.ext.astrobee.BerthStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.berthOne, src, false, true, endpoint_plugin_qos);     
                typedDst.berthTwo = (rapid.ext.astrobee.BerthState)rapid.ext.astrobee.BerthStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.berthTwo, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.astrobee.BerthStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DockState typedDst = (DockState) sample;
    ...
    */
    ...
    int mask) {
        return new DockStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DockStateDataReader(native_reader, listener, mask, this);   
    ...
    protected DockStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DockStateTypeCode.VALUE,DockState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DockStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DockStateTypeCode.VALUE,DockState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
