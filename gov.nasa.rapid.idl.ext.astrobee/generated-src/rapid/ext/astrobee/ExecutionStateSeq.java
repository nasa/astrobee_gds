...
/**
* A sequence of ExecutionState instances.
*/
public final class ExecutionStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ExecutionStateSeq() {
        super(ExecutionState.class);
    }

    public ExecutionStateSeq (int initialMaximum) {
        super(ExecutionState.class, initialMaximum);
    }

    public ExecutionStateSeq (Collection elements) {
        super(ExecutionState.class, elements);
    }
