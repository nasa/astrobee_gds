...
* GuestScienceDataType
*/

public class GuestScienceDataTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::astrobee::GuestScienceDataType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GuestScienceDataTypeTypeSupport _singleton
    = new GuestScienceDataTypeTypeSupport();
    ...
    */
    public static GuestScienceDataTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static GuestScienceDataTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GuestScienceDataTypeTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return GuestScienceDataType.class;
    }
    ...
    * <code>this</code> is not a <code>GuestScienceDataType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        GuestScienceDataType typedSrc = (GuestScienceDataType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = GuestScienceDataType.valueOf(ordinal);
            if (dst == null) {
    ...
    protected GuestScienceDataTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GuestScienceDataTypeTypeCode.VALUE,GuestScienceDataType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
