...
public class DdsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	public DdsPreferencePage() {
		super(GRID);
		setPreferenceStore(RtiDdsUiActivator.getDefault().getPreferenceStore());
	    setDescription("Expand the tree to set preferences for RTI DDS.");
	}
