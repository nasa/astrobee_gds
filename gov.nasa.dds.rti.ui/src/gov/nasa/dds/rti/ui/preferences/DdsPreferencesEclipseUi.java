...
public class DdsPreferencesEclipseUi implements IDdsPreferences {
	private static String prefString(String str) {
		return RtiDdsUiActivator.getDefault().getPreferenceStore().getString(str);
	}
    private static boolean prefBool(String str) {
        return RtiDdsUiActivator.getDefault().getPreferenceStore().getBoolean(str);
    }
    private static int prefInt(String str) {
        return RtiDdsUiActivator.getDefault().getPreferenceStore().getInt(str);
    }
