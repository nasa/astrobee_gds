...
public class PickWorkspaceDialog extends TitleAreaDialog {
    ...
    private static final String _StrMsg                = "Your workspace is where settings and cached files will be stored.\n" +
    		"Changing a workspace while you are running will cause a restart.";
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        try {
            ...
            // label on left
            Label label = new Label(inner, SWT.TRAIL);
            label.setText("Workspace Root:");
            ...
            Label spacer = new Label(inner, SWT.TRAIL);
