...
public class KeyTypeValueSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueSequence16TypeSupport _singleton
    = new KeyTypeValueSequence16TypeSupport();
    ...
    */
    public static KeyTypeValueSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueSequence16.create();
    }
    ...
    public Object create_key() {
        return new KeyTypeValueSequence16();
    }
    ...
    public Class get_type() {
        return KeyTypeValueSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueSequence16 typedDst = (KeyTypeValueSequence16) destination;
        KeyTypeValueSequence16 typedSrc = (KeyTypeValueSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueSequence16 typedSrc = (KeyTypeValueSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueSequence16 typedDst = (KeyTypeValueSequence16) dst;
            rapid.KeyTypeValueTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueSequence16 typedDst = (KeyTypeValueSequence16) sample;
    ...
    protected KeyTypeValueSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueSequence16TypeCode.VALUE,KeyTypeValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueSequence16TypeCode.VALUE,KeyTypeValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
