...
public class Vec3d   implements Copyable, Serializable{

    public double [] userData=  new double [3];
    ...
    * This method could be placed into <code>Vec3dTypeSupport</code>
