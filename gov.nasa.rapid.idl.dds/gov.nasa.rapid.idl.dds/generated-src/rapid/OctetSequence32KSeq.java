...
/**
* A sequence of OctetSequence32K instances.
*/
public final class OctetSequence32KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence32KSeq() {
        super(OctetSequence32K.class);
    }

    public OctetSequence32KSeq (int initialMaximum) {
        super(OctetSequence32K.class, initialMaximum);
    }

    public OctetSequence32KSeq (Collection elements) {
        super(OctetSequence32K.class, elements);
    }
