...
public class PointSampleAttributeModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointSampleAttributeMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointSampleAttributeModeTypeSupport _singleton
    = new PointSampleAttributeModeTypeSupport();
    ...
    */
    public static PointSampleAttributeModeTypeSupport get_instance() {
        return _singleton;
    }

    public static PointSampleAttributeModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointSampleAttributeModeTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return PointSampleAttributeMode.class;
    }
    ...
    * <code>this</code> is not a <code>PointSampleAttributeMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PointSampleAttributeMode typedSrc = (PointSampleAttributeMode) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PointSampleAttributeMode.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PointSampleAttributeModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointSampleAttributeModeTypeCode.VALUE,PointSampleAttributeMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
