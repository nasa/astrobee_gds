...
/**
* A sequence of CommandDef instances.
*/
public final class CommandDefSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CommandDefSeq() {
        super(CommandDef.class);
    }

    public CommandDefSeq (int initialMaximum) {
        super(CommandDef.class, initialMaximum);
    }

    public CommandDefSeq (Collection elements) {
        super(CommandDef.class, elements);
    }
