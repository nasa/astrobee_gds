...
public class OctetSequence128KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence128K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence128KTypeSupport _singleton
    = new OctetSequence128KTypeSupport();
    ...
    */
    public static OctetSequence128KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence128KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence128KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence128K.create();
    }
    ...
    public Class get_type() {
        return OctetSequence128K.class;
    }
    ...
    * <code>this</code> is not a <code>OctetSequence128K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence128K typedDst = (OctetSequence128K) destination;
        OctetSequence128K typedSrc = (OctetSequence128K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 131072);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence128K typedSrc = (OctetSequence128K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,131072);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence128K typedDst = (OctetSequence128K) dst;
            src.readByteSequence(typedDst.userData, 131072);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence128K typedDst = (OctetSequence128K) sample;
    ...
    protected OctetSequence128KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence128KTypeCode.VALUE,OctetSequence128K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence128KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence128KTypeCode.VALUE,OctetSequence128K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
