...
public class FileQueueConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileQueueConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileQueueConfigTypeSupport _singleton
    = new FileQueueConfigTypeSupport();
    ...
    */
    public static FileQueueConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static FileQueueConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileQueueConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return FileQueueConfig.create();
    }
    ...
    * <code>this</code> is not a <code>FileQueueConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileQueueConfig typedDst = (FileQueueConfig) destination;
        FileQueueConfig typedSrc = (FileQueueConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelConfigSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelConfigSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileQueueConfig typedSrc = (FileQueueConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ChannelConfigSequenceTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ChannelConfigSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.channels, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileQueueConfig typedDst = (FileQueueConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.channels = (rapid.ChannelConfigSequence)rapid.ChannelConfigSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.channels, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ChannelConfigSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileQueueConfig typedDst = (FileQueueConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileQueueConfig typedDst
        = (FileQueueConfig) instance;
        FileQueueConfig typedSrc
        = (FileQueueConfig) key;
    ...
    */
    ...
    int mask) {
        return new FileQueueConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileQueueConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected FileQueueConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileQueueConfigTypeCode.VALUE,FileQueueConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileQueueConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileQueueConfigTypeCode.VALUE,FileQueueConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
