...
public class KeyTypeSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeSequence16TypeSupport _singleton
    = new KeyTypeSequence16TypeSupport();
    ...
    */
    public static KeyTypeSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeSequence16.create();
    }
    ...
    public Class get_type() {
        return KeyTypeSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeSequence16 typedDst = (KeyTypeSequence16) destination;
        KeyTypeSequence16 typedSrc = (KeyTypeSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypePairTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeSequence16 typedSrc = (KeyTypeSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypePairTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeSequence16 typedDst = (KeyTypeSequence16) dst;
            rapid.KeyTypePairTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeSequence16 typedDst = (KeyTypeSequence16) sample;
    ...
    protected KeyTypeSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeSequence16TypeCode.VALUE,KeyTypeSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeSequence16TypeCode.VALUE,KeyTypeSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
