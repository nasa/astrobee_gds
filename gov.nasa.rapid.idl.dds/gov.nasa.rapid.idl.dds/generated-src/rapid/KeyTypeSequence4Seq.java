...
/**
* A sequence of KeyTypeSequence4 instances.
*/
public final class KeyTypeSequence4Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public KeyTypeSequence4Seq() {
        super(KeyTypeSequence4.class);
    }

    public KeyTypeSequence4Seq (int initialMaximum) {
        super(KeyTypeSequence4.class, initialMaximum);
    }

    public KeyTypeSequence4Seq (Collection elements) {
        super(KeyTypeSequence4.class, elements);
    }
