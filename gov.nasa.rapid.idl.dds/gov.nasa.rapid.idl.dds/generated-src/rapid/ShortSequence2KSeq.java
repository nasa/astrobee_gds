...
/**
* A sequence of ShortSequence2K instances.
*/
public final class ShortSequence2KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence2KSeq() {
        super(ShortSequence2K.class);
    }

    public ShortSequence2KSeq (int initialMaximum) {
        super(ShortSequence2K.class, initialMaximum);
    }

    public ShortSequence2KSeq (Collection elements) {
        super(ShortSequence2K.class, elements);
    }
