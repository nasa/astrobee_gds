...
public class KeyTypeValueSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueSequence8TypeSupport _singleton
    = new KeyTypeValueSequence8TypeSupport();
    ...
    */
    public static KeyTypeValueSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueSequence8.create();
    }
    ...
    public Object create_key() {
        return new KeyTypeValueSequence8();
    }
    ...
    public Class get_type() {
        return KeyTypeValueSequence8.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueSequence8 typedDst = (KeyTypeValueSequence8) destination;
        KeyTypeValueSequence8 typedSrc = (KeyTypeValueSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueSequence8 typedSrc = (KeyTypeValueSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueSequence8 typedDst = (KeyTypeValueSequence8) dst;
            rapid.KeyTypeValueTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueSequence8 typedDst = (KeyTypeValueSequence8) sample;
    ...
    protected KeyTypeValueSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueSequence8TypeCode.VALUE,KeyTypeValueSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueSequence8TypeCode.VALUE,KeyTypeValueSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
