...
public class ShortSequence96KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence96K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence96KTypeSupport _singleton
    = new ShortSequence96KTypeSupport();
    ...
    */
    public static ShortSequence96KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence96KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence96KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence96K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence96K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence96K typedDst = (ShortSequence96K) destination;
        ShortSequence96K typedSrc = (ShortSequence96K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 98304);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence96K typedSrc = (ShortSequence96K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,98304);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence96K typedDst = (ShortSequence96K) dst;
            src.readShortSequence(typedDst.userData, 98304);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence96K typedDst = (ShortSequence96K) sample;
    ...
    protected ShortSequence96KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence96KTypeCode.VALUE,ShortSequence96K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence96KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence96KTypeCode.VALUE,ShortSequence96K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
