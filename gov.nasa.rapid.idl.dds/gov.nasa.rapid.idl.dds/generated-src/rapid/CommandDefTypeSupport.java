...
public class CommandDefTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::CommandDef";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CommandDefTypeSupport _singleton
    = new CommandDefTypeSupport();
    ...
    */
    public static CommandDefTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandDefTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CommandDefTypeCode.VALUE;
    }

    public Object create_data() {
        return CommandDef.create();
    }
    ...
    * <code>this</code> is not a <code>CommandDef</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CommandDef typedDst = (CommandDef) destination;
        CommandDef typedSrc = (CommandDef) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CommandDef typedSrc = (CommandDef) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.KeyTypeSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.parameters);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.abortable);

            dst.writeBoolean(typedSrc.suspendable);

            rapid.KeyTypeSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.parameters, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CommandDef typedDst = (CommandDef) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(64);
                typedDst.abortable = src.readBoolean();
                typedDst.suspendable = src.readBoolean();
                typedDst.parameters = (rapid.KeyTypeSequence16)rapid.KeyTypeSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.parameters, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CommandDef typedDst = (CommandDef) sample;
    ...
    int mask) {
        return new CommandDefDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CommandDefDataReader(native_reader, listener, mask, this);   
    ...
    protected CommandDefTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandDefTypeCode.VALUE,CommandDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CommandDefTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CommandDefTypeCode.VALUE,CommandDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
