...
public class String32Sequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String32Sequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String32Sequence128TypeSupport _singleton
    = new String32Sequence128TypeSupport();
    ...
    */
    public static String32Sequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static String32Sequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String32Sequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return String32Sequence128.create();
    }
    ...
    public Object create_key() {
        return new String32Sequence128();
    }
    ...
    public Class get_type() {
        return String32Sequence128.class;
    }
    ...
    * <code>this</code> is not a <code>String32Sequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String32Sequence128 typedDst = (String32Sequence128) destination;
        String32Sequence128 typedSrc = (String32Sequence128) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String32Sequence128 typedSrc = (String32Sequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(32),128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String32Sequence128 typedDst = (String32Sequence128) dst;
            src.readStringSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String32Sequence128 typedDst = (String32Sequence128) sample;
    ...
    protected String32Sequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String32Sequence128TypeCode.VALUE,String32Sequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String32Sequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String32Sequence128TypeCode.VALUE,String32Sequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
