...
public class AccessControlStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::AccessControlState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AccessControlStateTypeSupport _singleton
    = new AccessControlStateTypeSupport();
    ...
    */
    public static AccessControlStateTypeSupport get_instance() {
        return _singleton;
    }

    public static AccessControlStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AccessControlStateTypeCode.VALUE;
    }

    public Object create_data() {
        return AccessControlState.create();
    }
    ...
    public Class get_type() {
        return AccessControlState.class;
    }
    ...
    * <code>this</code> is not a <code>AccessControlState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AccessControlState typedDst = (AccessControlState) destination;
        AccessControlState typedSrc = (AccessControlState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AccessControlState typedSrc = (AccessControlState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.controller );
        currentAlignment += rapid.String32Sequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.requestors);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.controller,32);

            rapid.String32Sequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.requestors, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AccessControlState typedDst = (AccessControlState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.controller = src.readString(32);
                typedDst.requestors = (rapid.String32Sequence16)rapid.String32Sequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.requestors, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AccessControlState typedDst = (AccessControlState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        AccessControlState typedDst
        = (AccessControlState) instance;
        AccessControlState typedSrc
        = (AccessControlState) key;
    ...
    */
    ...
    int mask) {
        return new AccessControlStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AccessControlStateDataReader(native_reader, listener, mask, this);   
    ...
    protected AccessControlStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,AccessControlStateTypeCode.VALUE,AccessControlState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AccessControlStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AccessControlStateTypeCode.VALUE,AccessControlState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
