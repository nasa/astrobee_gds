...
public class MessageLevelTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MessageLevel";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MessageLevelTypeSupport _singleton
    = new MessageLevelTypeSupport();
    ...
    */
    public static MessageLevelTypeSupport get_instance() {
        return _singleton;
    }

    public static MessageLevelTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MessageLevelTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>MessageLevel</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        MessageLevel typedSrc = (MessageLevel) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MessageLevel.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MessageLevelTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MessageLevelTypeCode.VALUE,MessageLevel.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
