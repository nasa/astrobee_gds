...
/**
* A sequence of Vec2d instances.
*/
public final class Vec2dSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Vec2dSeq (int initialMaximum) {
        super(Vec2d.class, initialMaximum);
    }

    public Vec2dSeq (Collection elements) {
        super(Vec2d.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Vec2d objects (beyond the original size of this object)
