...
public class PointSampleSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointSampleSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointSampleSequenceTypeSupport _singleton
    = new PointSampleSequenceTypeSupport();
    ...
    */
    public static PointSampleSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static PointSampleSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointSampleSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return PointSampleSequence.create();
    }
    ...
    public Object create_key() {
        return new PointSampleSequence();
    }
    ...
    public Class get_type() {
        return PointSampleSequence.class;
    }
    ...
    * <code>this</code> is not a <code>PointSampleSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PointSampleSequence typedDst = (PointSampleSequence) destination;
        PointSampleSequence typedSrc = (PointSampleSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.PointSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (rapid.POINTCLOUD_SAMPLE_MAX_POINTS.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.PointSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PointSampleSequence typedSrc = (PointSampleSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.PointSampleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.PointSampleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(rapid.POINTCLOUD_SAMPLE_MAX_POINTS.VALUE), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PointSampleSequence typedDst = (PointSampleSequence) dst;
            rapid.PointSampleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, (rapid.POINTCLOUD_SAMPLE_MAX_POINTS.VALUE), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.PointSampleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PointSampleSequence typedDst = (PointSampleSequence) sample;
    ...
    protected PointSampleSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointSampleSequenceTypeCode.VALUE,PointSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PointSampleSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PointSampleSequenceTypeCode.VALUE,PointSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
