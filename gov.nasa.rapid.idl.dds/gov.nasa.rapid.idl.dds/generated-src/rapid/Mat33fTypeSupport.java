...
public class Mat33fTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Mat33f";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Mat33fTypeSupport _singleton
    = new Mat33fTypeSupport();
    ...
    */
    public static Mat33fTypeSupport get_instance() {
        return _singleton;
    }

    public static Mat33fTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Mat33fTypeCode.VALUE;
    }

    public Object create_data() {
        return Mat33f.create();
    }
    ...
    * <code>this</code> is not a <code>Mat33f</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Mat33f typedDst = (Mat33f) destination;
        Mat33f typedSrc = (Mat33f) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (9));
        if (include_encapsulation) {
    ...
    protected Mat33fTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Mat33fTypeCode.VALUE,Mat33f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Mat33fTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Mat33fTypeCode.VALUE,Mat33f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
