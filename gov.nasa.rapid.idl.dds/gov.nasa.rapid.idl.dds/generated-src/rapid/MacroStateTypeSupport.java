...
public class MacroStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroStateTypeSupport _singleton
    = new MacroStateTypeSupport();
    ...
    */
    public static MacroStateTypeSupport get_instance() {
        return _singleton;
    }

    public static MacroStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroStateTypeCode.VALUE;
    }

    public Object create_data() {
        return MacroState.create();
    }
    ...
    * <code>this</code> is not a <code>MacroState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroState typedDst = (MacroState) destination;
        MacroState typedSrc = (MacroState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroInfoSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroInfoSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroState typedSrc = (MacroState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.MacroInfoSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.macros);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.MacroInfoSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.macros, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroState typedDst = (MacroState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.macros = (rapid.MacroInfoSequence)rapid.MacroInfoSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.macros, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.MacroInfoSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroState typedDst = (MacroState) sample;
    ...
    */
    ...
    int mask) {
        return new MacroStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MacroStateDataReader(native_reader, listener, mask, this);   
    ...
    protected MacroStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MacroStateTypeCode.VALUE,MacroState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroStateTypeCode.VALUE,MacroState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
