...
public class KeyTypeSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeSequence64TypeSupport _singleton
    = new KeyTypeSequence64TypeSupport();
    ...
    */
    public static KeyTypeSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeSequence64.create();
    }
    ...
    public Class get_type() {
        return KeyTypeSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeSequence64 typedDst = (KeyTypeSequence64) destination;
        KeyTypeSequence64 typedSrc = (KeyTypeSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypePairTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypePairTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeSequence64 typedSrc = (KeyTypeSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.KeyTypePairTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypePairTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeSequence64 typedDst = (KeyTypeSequence64) dst;
            rapid.KeyTypePairTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.KeyTypePairTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeSequence64 typedDst = (KeyTypeSequence64) sample;
    ...
    protected KeyTypeSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeSequence64TypeCode.VALUE,KeyTypeSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeSequence64TypeCode.VALUE,KeyTypeSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
