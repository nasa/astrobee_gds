...
/**
* A sequence of ChannelState instances.
*/
public final class ChannelStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ChannelStateSeq() {
        super(ChannelState.class);
    }

    public ChannelStateSeq (int initialMaximum) {
        super(ChannelState.class, initialMaximum);
    }

    public ChannelStateSeq (Collection elements) {
        super(ChannelState.class, elements);
    }
