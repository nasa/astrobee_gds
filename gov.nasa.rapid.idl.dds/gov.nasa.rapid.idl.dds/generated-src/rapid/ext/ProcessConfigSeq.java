...
/**
* A sequence of ProcessConfig instances.
*/
public final class ProcessConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProcessConfigSeq() {
        super(ProcessConfig.class);
    }

    public ProcessConfigSeq (int initialMaximum) {
        super(ProcessConfig.class, initialMaximum);
    }

    public ProcessConfigSeq (Collection elements) {
        super(ProcessConfig.class, elements);
    }
