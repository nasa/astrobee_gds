...
public class WifiInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::WifiInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WifiInfoConfigTypeSupport _singleton
    = new WifiInfoConfigTypeSupport();
    ...
    */
    public static WifiInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static WifiInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WifiInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return WifiInfoConfig.create();
    }
    ...
    * <code>this</code> is not a <code>WifiInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WifiInfoConfig typedDst = (WifiInfoConfig) destination;
        WifiInfoConfig typedSrc = (WifiInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WifiInfoConfig typedSrc = (WifiInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.qualityLow);

            dst.writeInt(typedSrc.qualityCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WifiInfoConfig typedDst = (WifiInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.qualityLow = src.readInt();
                typedDst.qualityCritical = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WifiInfoConfig typedDst = (WifiInfoConfig) sample;
    ...
    int mask) {
        return new WifiInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WifiInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected WifiInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WifiInfoConfigTypeCode.VALUE,WifiInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WifiInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WifiInfoConfigTypeCode.VALUE,WifiInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
