...
public class NavMapConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::NavMapConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NavMapConfigTypeSupport _singleton
    = new NavMapConfigTypeSupport();
    ...
    */
    public static NavMapConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static NavMapConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NavMapConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return NavMapConfig.create();
    }
    ...
    * <code>this</code> is not a <code>NavMapConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NavMapConfig typedDst = (NavMapConfig) destination;
        NavMapConfig typedSrc = (NavMapConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += CdrPrimitiveType.SHORT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += CdrPrimitiveType.SHORT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NavMapConfig typedSrc = (NavMapConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment  +=  CdrPrimitiveType.SHORT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        currentAlignment += rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.shortLayerNames);
        currentAlignment += rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.octetLayerNames);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 2; ++i1__){
                ...
                dst.writeFloat(typedSrc.offset[i1__]);
            }

            for(int i1__ = 0; i1__< 2; ++i1__){

                dst.writeFloat(typedSrc.cellSize[i1__]);
            }

            for(int i1__ = 0; i1__< 2; ++i1__){

                dst.writeShort(typedSrc.numCells[i1__]);
            }

            rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shortLayerNames, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.octetLayerNames, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NavMapConfig typedDst = (NavMapConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                for(int i1__ = 0; i1__< 2; ++i1__){
                    ...
                    typedDst.offset[i1__] = src.readFloat();
                }

                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.cellSize[i1__] = src.readFloat();
                }

                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.numCells[i1__] = src.readShort();
                }

                typedDst.shortLayerNames = (rapid.ext.ShortMapLayerNameSequence)rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shortLayerNames, src, false, true, endpoint_plugin_qos);     
                typedDst.octetLayerNames = (rapid.ext.OctetMapLayerNameSequence)rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.octetLayerNames, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ShortMapLayerNameSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.OctetMapLayerNameSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NavMapConfig typedDst = (NavMapConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        NavMapConfig typedDst
        = (NavMapConfig) instance;
        NavMapConfig typedSrc
        = (NavMapConfig) key;
    ...
    */
    ...
    int mask) {
        return new NavMapConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NavMapConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected NavMapConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,NavMapConfigTypeCode.VALUE,NavMapConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NavMapConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NavMapConfigTypeCode.VALUE,NavMapConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
