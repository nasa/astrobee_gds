...
public class SingleSegmentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::SingleSegment";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SingleSegmentTypeSupport _singleton
    = new SingleSegmentTypeSupport();
    ...
    */
    public static SingleSegmentTypeSupport get_instance() {
        return _singleton;
    }

    public static SingleSegmentTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SingleSegmentTypeCode.VALUE;
    }

    public Object create_data() {
        return SingleSegment.create();
    }
    ...
    * <code>this</code> is not a <code>SingleSegment</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SingleSegment typedDst = (SingleSegment) destination;
        SingleSegment typedSrc = (SingleSegment) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SegmentTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SegmentTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SingleSegment typedSrc = (SingleSegment) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.SegmentTypeTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.start);
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.end);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.SegmentTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.distance);

            dst.writeFloat(typedSrc.length);

            dst.writeFloat(typedSrc.angleOffset);

            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.start, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.end, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.velocity);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SingleSegment typedDst = (SingleSegment) dst;
            typedDst.clear();      
            try{
                typedDst.type = (rapid.ext.SegmentType)rapid.ext.SegmentTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
                typedDst.distance = src.readFloat();
                typedDst.length = src.readFloat();
                typedDst.angleOffset = src.readFloat();
                typedDst.start = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.start, src, false, true, endpoint_plugin_qos);     
                typedDst.end = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.end, src, false, true, endpoint_plugin_qos);     
                typedDst.velocity = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.SegmentTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SingleSegment typedDst = (SingleSegment) sample;
    ...
    int mask) {
        return new SingleSegmentDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SingleSegmentDataReader(native_reader, listener, mask, this);   
    ...
    protected SingleSegmentTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SingleSegmentTypeCode.VALUE,SingleSegment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SingleSegmentTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SingleSegmentTypeCode.VALUE,SingleSegment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
