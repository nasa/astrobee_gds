...
/**
* A sequence of ShortMapLayer instances.
*/
public final class ShortMapLayerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortMapLayerSeq() {
        super(ShortMapLayer.class);
    }

    public ShortMapLayerSeq (int initialMaximum) {
        super(ShortMapLayer.class, initialMaximum);
    }

    public ShortMapLayerSeq (Collection elements) {
        super(ShortMapLayer.class, elements);
    }
