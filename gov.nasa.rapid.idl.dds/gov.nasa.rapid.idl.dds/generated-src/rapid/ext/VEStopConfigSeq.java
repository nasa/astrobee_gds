...
/**
* A sequence of VEStopConfig instances.
*/
public final class VEStopConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public VEStopConfigSeq() {
        super(VEStopConfig.class);
    }

    public VEStopConfigSeq (int initialMaximum) {
        super(VEStopConfig.class, initialMaximum);
    }

    public VEStopConfigSeq (Collection elements) {
        super(VEStopConfig.class, elements);
    }
