...
public class ProcessConfigSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessConfigSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessConfigSequenceTypeSupport _singleton
    = new ProcessConfigSequenceTypeSupport();
    ...
    */
    public static ProcessConfigSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessConfigSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessConfigSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessConfigSequence.create();
    }
    ...
    public Object create_key() {
        return new ProcessConfigSequence();
    }
    ...
    public Class get_type() {
        return ProcessConfigSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ProcessConfigSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessConfigSequence typedDst = (ProcessConfigSequence) destination;
        ProcessConfigSequence typedSrc = (ProcessConfigSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessConfigSequence typedSrc = (ProcessConfigSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.ProcessConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.ProcessConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessConfigSequence typedDst = (ProcessConfigSequence) dst;
            rapid.ext.ProcessConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ProcessConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessConfigSequence typedDst = (ProcessConfigSequence) sample;
    ...
    protected ProcessConfigSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessConfigSequenceTypeCode.VALUE,ProcessConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessConfigSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessConfigSequenceTypeCode.VALUE,ProcessConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
