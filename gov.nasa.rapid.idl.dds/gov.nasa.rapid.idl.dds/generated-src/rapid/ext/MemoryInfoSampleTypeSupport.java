...
public class MemoryInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::MemoryInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MemoryInfoSampleTypeSupport _singleton
    = new MemoryInfoSampleTypeSupport();
    ...
    */
    public static MemoryInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static MemoryInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MemoryInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return MemoryInfoSample.create();
    }
    ...
    * <code>this</code> is not a <code>MemoryInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MemoryInfoSample typedDst = (MemoryInfoSample) destination;
        MemoryInfoSample typedSrc = (MemoryInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MemoryInfoSample typedSrc = (MemoryInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.buffers);

            dst.writeInt(typedSrc.cached);

            dst.writeInt(typedSrc.free);

            dst.writeInt(typedSrc.swap);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MemoryInfoSample typedDst = (MemoryInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.buffers = src.readInt();
                typedDst.cached = src.readInt();
                typedDst.free = src.readInt();
                typedDst.swap = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MemoryInfoSample typedDst = (MemoryInfoSample) sample;
    ...
    int mask) {
        return new MemoryInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MemoryInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected MemoryInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MemoryInfoSampleTypeCode.VALUE,MemoryInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MemoryInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MemoryInfoSampleTypeCode.VALUE,MemoryInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
