...
public class OctetMapLayerSequence   implements Copyable, Serializable{

    public rapid.ext.OctetMapLayerSeq userData =  new rapid.ext.OctetMapLayerSeq((rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE));

    public OctetMapLayerSequence() {

    }
    public OctetMapLayerSequence (OctetMapLayerSequence other) {
    ...
    public static Object create() {
        ...
        self = new  OctetMapLayerSequence();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        OctetMapLayerSequence otherObj = (OctetMapLayerSequence)o;
    ...
    * This method could be placed into <code>OctetMapLayerSequenceTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        OctetMapLayerSequence typedSrc = (OctetMapLayerSequence) src;
        OctetMapLayerSequence typedDst = this;
    ...
    public String toString(String desc, int indent) {
        ...
        for(int i__ = 0; i__ < userData.size(); ++i__) {
            strBuffer.append(((rapid.ext.OctetMapLayer)userData.get(i__)).toString(Integer.toString(i__),indent+2));
        }
