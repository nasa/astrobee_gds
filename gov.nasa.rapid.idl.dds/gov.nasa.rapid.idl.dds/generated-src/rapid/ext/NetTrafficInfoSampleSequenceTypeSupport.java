...
public class NetTrafficInfoSampleSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::NetTrafficInfoSampleSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NetTrafficInfoSampleSequenceTypeSupport _singleton
    = new NetTrafficInfoSampleSequenceTypeSupport();
    ...
    */
    public static NetTrafficInfoSampleSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static NetTrafficInfoSampleSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NetTrafficInfoSampleSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return NetTrafficInfoSampleSequence.create();
    }
    ...
    public Object create_key() {
        return new NetTrafficInfoSampleSequence();
    }
    ...
    public Class get_type() {
        return NetTrafficInfoSampleSequence.class;
    }
    ...
    * <code>this</code> is not a <code>NetTrafficInfoSampleSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NetTrafficInfoSampleSequence typedDst = (NetTrafficInfoSampleSequence) destination;
        NetTrafficInfoSampleSequence typedSrc = (NetTrafficInfoSampleSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NetTrafficInfoSampleSequence typedSrc = (NetTrafficInfoSampleSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NetTrafficInfoSampleSequence typedDst = (NetTrafficInfoSampleSequence) dst;
            rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.NetTrafficInfoSampleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NetTrafficInfoSampleSequence typedDst = (NetTrafficInfoSampleSequence) sample;
    ...
    protected NetTrafficInfoSampleSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NetTrafficInfoSampleSequenceTypeCode.VALUE,NetTrafficInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NetTrafficInfoSampleSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NetTrafficInfoSampleSequenceTypeCode.VALUE,NetTrafficInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
