...
public class VEStopStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::VEStopState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final VEStopStateTypeSupport _singleton
    = new VEStopStateTypeSupport();
    ...
    */
    public static VEStopStateTypeSupport get_instance() {
        return _singleton;
    }

    public static VEStopStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return VEStopStateTypeCode.VALUE;
    }

    public Object create_data() {
        return VEStopState.create();
    }
    ...
    * <code>this</code> is not a <code>VEStopState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        VEStopState typedDst = (VEStopState) destination;
        VEStopState typedSrc = (VEStopState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        VEStopState typedSrc = (VEStopState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.active);

            dst.writeBoolean(typedSrc.advisoryOnly);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            VEStopState typedDst = (VEStopState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.active = src.readBoolean();
                typedDst.advisoryOnly = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            VEStopState typedDst = (VEStopState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        VEStopState typedDst
        = (VEStopState) instance;
        VEStopState typedSrc
        = (VEStopState) key;
    ...
    */
    ...
    int mask) {
        return new VEStopStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new VEStopStateDataReader(native_reader, listener, mask, this);   
    ...
    protected VEStopStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,VEStopStateTypeCode.VALUE,VEStopState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected VEStopStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,VEStopStateTypeCode.VALUE,VEStopState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
