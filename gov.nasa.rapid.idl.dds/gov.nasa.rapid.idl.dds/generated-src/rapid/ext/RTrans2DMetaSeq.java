...
/**
* A sequence of RTrans2DMeta instances.
*/
public final class RTrans2DMetaSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RTrans2DMetaSeq() {
        super(RTrans2DMeta.class);
    }

    public RTrans2DMetaSeq (int initialMaximum) {
        super(RTrans2DMeta.class, initialMaximum);
    }

    public RTrans2DMetaSeq (Collection elements) {
        super(RTrans2DMeta.class, elements);
    }
