...
public class CpuInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::CpuInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuInfoSampleTypeSupport _singleton
    = new CpuInfoSampleTypeSupport();
    ...
    */
    public static CpuInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static CpuInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return CpuInfoSample.create();
    }
    ...
    * <code>this</code> is not a <code>CpuInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuInfoSample typedDst = (CpuInfoSample) destination;
        CpuInfoSample typedSrc = (CpuInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuInfoSample typedSrc = (CpuInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.busy);

            dst.writeFloat(typedSrc.idle);

            dst.writeFloat(typedSrc.nice);

            dst.writeFloat(typedSrc.system);

            dst.writeFloat(typedSrc.user);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuInfoSample typedDst = (CpuInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.busy = src.readFloat();
                typedDst.idle = src.readFloat();
                typedDst.nice = src.readFloat();
                typedDst.system = src.readFloat();
                typedDst.user = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuInfoSample typedDst = (CpuInfoSample) sample;
    ...
    int mask) {
        return new CpuInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CpuInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected CpuInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CpuInfoSampleTypeCode.VALUE,CpuInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuInfoSampleTypeCode.VALUE,CpuInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
