...
public class OctetMapLayerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::OctetMapLayer";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetMapLayerTypeSupport _singleton
    = new OctetMapLayerTypeSupport();
    ...
    */
    public static OctetMapLayerTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetMapLayerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetMapLayerTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetMapLayer.create();
    }
    ...
    * <code>this</code> is not a <code>OctetMapLayer</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetMapLayer typedDst = (OctetMapLayer) destination;
        OctetMapLayer typedSrc = (OctetMapLayer) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetMapLayer typedSrc = (OctetMapLayer) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.offset);

            dst.writeFloat(typedSrc.scale);

            dst.writeShort(typedSrc.density);

            rapid.OctetSequence128KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.data, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetMapLayer typedDst = (OctetMapLayer) dst;
            typedDst.clear();      
            try{
                typedDst.offset = src.readDouble();
                typedDst.scale = src.readFloat();
                typedDst.density = src.readShort();
                typedDst.data = (rapid.OctetSequence128K)rapid.OctetSequence128KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.data, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetMapLayer typedDst = (OctetMapLayer) sample;
    ...
    int mask) {
        return new OctetMapLayerDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new OctetMapLayerDataReader(native_reader, listener, mask, this);   
    ...
    protected OctetMapLayerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetMapLayerTypeCode.VALUE,OctetMapLayer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetMapLayerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetMapLayerTypeCode.VALUE,OctetMapLayer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
