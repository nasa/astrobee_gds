...
public class ProcessIoStreamTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessIoStream";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessIoStreamTypeSupport _singleton
    = new ProcessIoStreamTypeSupport();
    ...
    */
    public static ProcessIoStreamTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessIoStreamTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessIoStreamTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ProcessIoStream</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ProcessIoStream typedSrc = (ProcessIoStream) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ProcessIoStream.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ProcessIoStreamTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessIoStreamTypeCode.VALUE,ProcessIoStream.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
