...
/**
* A sequence of OctetMapLayer instances.
*/
public final class OctetMapLayerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetMapLayerSeq() {
        super(OctetMapLayer.class);
    }

    public OctetMapLayerSeq (int initialMaximum) {
        super(OctetMapLayer.class, initialMaximum);
    }

    public OctetMapLayerSeq (Collection elements) {
        super(OctetMapLayer.class, elements);
    }
