...
public class RangeScanSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RangeScanSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RangeScanSampleTypeSupport _singleton
    = new RangeScanSampleTypeSupport();
    ...
    */
    public static RangeScanSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static RangeScanSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RangeScanSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return RangeScanSample.create();
    }
    ...
    * <code>this</code> is not a <code>RangeScanSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RangeScanSample typedDst = (RangeScanSample) destination;
        RangeScanSample typedSrc = (RangeScanSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence2KTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.OctetSequence2KTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence2KTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.OctetSequence2KTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RangeScanSample typedSrc = (RangeScanSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ShortSequence2KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.rangeData);
        currentAlignment += rapid.OctetSequence2KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.intensityData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ShortSequence2KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.rangeData, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.OctetSequence2KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.intensityData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RangeScanSample typedDst = (RangeScanSample) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.rangeData = (rapid.ShortSequence2K)rapid.ShortSequence2KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rangeData, src, false, true, endpoint_plugin_qos);     
                typedDst.intensityData = (rapid.OctetSequence2K)rapid.OctetSequence2KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.intensityData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ShortSequence2KTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.OctetSequence2KTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RangeScanSample typedDst = (RangeScanSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RangeScanSample typedDst
        = (RangeScanSample) instance;
        RangeScanSample typedSrc
        = (RangeScanSample) key;
    ...
    */
    ...
    int mask) {
        return new RangeScanSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RangeScanSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected RangeScanSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RangeScanSampleTypeCode.VALUE,RangeScanSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RangeScanSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RangeScanSampleTypeCode.VALUE,RangeScanSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
