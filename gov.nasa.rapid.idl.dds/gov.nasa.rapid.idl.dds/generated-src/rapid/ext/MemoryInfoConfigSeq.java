...
/**
* A sequence of MemoryInfoConfig instances.
*/
public final class MemoryInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MemoryInfoConfigSeq() {
        super(MemoryInfoConfig.class);
    }

    public MemoryInfoConfigSeq (int initialMaximum) {
        super(MemoryInfoConfig.class, initialMaximum);
    }

    public MemoryInfoConfigSeq (Collection elements) {
        super(MemoryInfoConfig.class, elements);
    }
