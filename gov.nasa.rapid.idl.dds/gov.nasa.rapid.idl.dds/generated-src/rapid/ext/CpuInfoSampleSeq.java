...
/**
* A sequence of CpuInfoSample instances.
*/
public final class CpuInfoSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CpuInfoSampleSeq() {
        super(CpuInfoSample.class);
    }

    public CpuInfoSampleSeq (int initialMaximum) {
        super(CpuInfoSample.class, initialMaximum);
    }

    public CpuInfoSampleSeq (Collection elements) {
        super(CpuInfoSample.class, elements);
    }
