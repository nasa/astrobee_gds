...
public class SegmentTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::SegmentType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SegmentTypeTypeSupport _singleton
    = new SegmentTypeTypeSupport();
    ...
    */
    public static SegmentTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static SegmentTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SegmentTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SegmentType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        SegmentType typedSrc = (SegmentType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SegmentType.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SegmentTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SegmentTypeTypeCode.VALUE,SegmentType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
