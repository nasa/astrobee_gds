...
/**
* A sequence of TrajectorySample instances.
*/
public final class TrajectorySampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TrajectorySampleSeq() {
        super(TrajectorySample.class);
    }

    public TrajectorySampleSeq (int initialMaximum) {
        super(TrajectorySample.class, initialMaximum);
    }

    public TrajectorySampleSeq (Collection elements) {
        super(TrajectorySample.class, elements);
    }
