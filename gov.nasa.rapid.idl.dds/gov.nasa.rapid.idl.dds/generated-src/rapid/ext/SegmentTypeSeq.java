...
/**
* A sequence of SegmentType instances.
*/
public final class SegmentTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SegmentTypeSeq() {
        super(SegmentType.class);
    }

    public SegmentTypeSeq (int initialMaximum) {
        super(SegmentType.class, initialMaximum);
    }

    public SegmentTypeSeq (Collection elements) {
        super(SegmentType.class, elements);
    }
