...
/**
* A sequence of SystemInfoSample instances.
*/
public final class SystemInfoSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SystemInfoSampleSeq() {
        super(SystemInfoSample.class);
    }

    public SystemInfoSampleSeq (int initialMaximum) {
        super(SystemInfoSample.class, initialMaximum);
    }

    public SystemInfoSampleSeq (Collection elements) {
        super(SystemInfoSample.class, elements);
    }
