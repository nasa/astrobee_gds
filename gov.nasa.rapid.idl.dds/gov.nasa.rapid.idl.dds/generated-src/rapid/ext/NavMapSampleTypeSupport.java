...
public class NavMapSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::NavMapSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NavMapSampleTypeSupport _singleton
    = new NavMapSampleTypeSupport();
    ...
    */
    public static NavMapSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static NavMapSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NavMapSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return NavMapSample.create();
    }
    ...
    * <code>this</code> is not a <code>NavMapSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NavMapSample typedDst = (NavMapSample) destination;
        NavMapSample typedSrc = (NavMapSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getArrayMaxSizeSerialized(currentAlignment,  (2));
        ...
        currentAlignment += rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NavMapSample typedSrc = (NavMapSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.shortLayers);
        currentAlignment += rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.octetLayers);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 2; ++i1__){
                ...
                dst.writeInt(typedSrc.tileId[i1__]);
            }

            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.location, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shortLayers, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.octetLayers, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NavMapSample typedDst = (NavMapSample) dst;
            typedDst.clear();      
            ...
            try{
                for(int i1__ = 0; i1__< 2; ++i1__){
                    ...
                    typedDst.tileId[i1__] = src.readInt();
                }

                typedDst.location = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.location, src, false, true, endpoint_plugin_qos);     
                typedDst.shortLayers = (rapid.ext.ShortMapLayerSequence)rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shortLayers, src, false, true, endpoint_plugin_qos);     
                typedDst.octetLayers = (rapid.ext.OctetMapLayerSequence)rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.octetLayers, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ShortMapLayerSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.OctetMapLayerSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NavMapSample typedDst = (NavMapSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        NavMapSample typedDst
        = (NavMapSample) instance;
        NavMapSample typedSrc
        = (NavMapSample) key;
    ...
    */
    ...
    int mask) {
        return new NavMapSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NavMapSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected NavMapSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,NavMapSampleTypeCode.VALUE,NavMapSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NavMapSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NavMapSampleTypeCode.VALUE,NavMapSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
