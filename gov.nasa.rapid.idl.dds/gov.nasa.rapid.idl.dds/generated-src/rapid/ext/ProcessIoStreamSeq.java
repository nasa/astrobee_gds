...
/**
* A sequence of ProcessIoStream instances.
*/
public final class ProcessIoStreamSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProcessIoStreamSeq() {
        super(ProcessIoStream.class);
    }

    public ProcessIoStreamSeq (int initialMaximum) {
        super(ProcessIoStream.class, initialMaximum);
    }

    public ProcessIoStreamSeq (Collection elements) {
        super(ProcessIoStream.class, elements);
    }
