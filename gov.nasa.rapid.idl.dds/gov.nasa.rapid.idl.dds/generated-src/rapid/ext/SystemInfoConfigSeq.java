...
/**
* A sequence of SystemInfoConfig instances.
*/
public final class SystemInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SystemInfoConfigSeq() {
        super(SystemInfoConfig.class);
    }

    public SystemInfoConfigSeq (int initialMaximum) {
        super(SystemInfoConfig.class, initialMaximum);
    }

    public SystemInfoConfigSeq (Collection elements) {
        super(SystemInfoConfig.class, elements);
    }
