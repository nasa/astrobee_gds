...
public class NetTrafficInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::NetTrafficInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NetTrafficInfoConfigTypeSupport _singleton
    = new NetTrafficInfoConfigTypeSupport();
    ...
    */
    public static NetTrafficInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static NetTrafficInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NetTrafficInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return NetTrafficInfoConfig.create();
    }
    ...
    public Object create_key() {
        return new NetTrafficInfoConfig();
    }
    ...
    public Class get_type() {
        return NetTrafficInfoConfig.class;
    }
    ...
    * <code>this</code> is not a <code>NetTrafficInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NetTrafficInfoConfig typedDst = (NetTrafficInfoConfig) destination;
        NetTrafficInfoConfig typedSrc = (NetTrafficInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NetTrafficInfoConfig typedSrc = (NetTrafficInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.rxBandwidth);

            dst.writeInt(typedSrc.txBandwidth);

            dst.writeInt(typedSrc.rxHigh);

            dst.writeInt(typedSrc.rxCritical);

            dst.writeInt(typedSrc.txHigh);

            dst.writeInt(typedSrc.txCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NetTrafficInfoConfig typedDst = (NetTrafficInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.rxBandwidth = src.readInt();
                typedDst.txBandwidth = src.readInt();
                typedDst.rxHigh = src.readInt();
                typedDst.rxCritical = src.readInt();
                typedDst.txHigh = src.readInt();
                typedDst.txCritical = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NetTrafficInfoConfig typedDst = (NetTrafficInfoConfig) sample;
    ...
    int mask) {
        return new NetTrafficInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NetTrafficInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected NetTrafficInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NetTrafficInfoConfigTypeCode.VALUE,NetTrafficInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NetTrafficInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NetTrafficInfoConfigTypeCode.VALUE,NetTrafficInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
