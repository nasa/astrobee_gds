...
public class BatteryInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::BatteryInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryInfoSampleTypeSupport _singleton
    = new BatteryInfoSampleTypeSupport();
    ...
    */
    public static BatteryInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryInfoSample.create();
    }
    ...
    public Class get_type() {
        return BatteryInfoSample.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryInfoSample typedDst = (BatteryInfoSample) destination;
        BatteryInfoSample typedSrc = (BatteryInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryInfoSample typedSrc = (BatteryInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.acStatus);

            dst.writeInt(typedSrc.batteryStatus);

            dst.writeFloat(typedSrc.percentage);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryInfoSample typedDst = (BatteryInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.acStatus = src.readInt();
                typedDst.batteryStatus = src.readInt();
                typedDst.percentage = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryInfoSample typedDst = (BatteryInfoSample) sample;
    ...
    int mask) {
        return new BatteryInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryInfoSampleTypeCode.VALUE,BatteryInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryInfoSampleTypeCode.VALUE,BatteryInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
