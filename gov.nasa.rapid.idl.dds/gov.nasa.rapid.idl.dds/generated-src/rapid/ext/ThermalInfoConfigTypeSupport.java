...
public class ThermalInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ThermalInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThermalInfoConfigTypeSupport _singleton
    = new ThermalInfoConfigTypeSupport();
    ...
    */
    public static ThermalInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ThermalInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThermalInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return ThermalInfoConfig.create();
    }
    ...
    public Class get_type() {
        return ThermalInfoConfig.class;
    }
    ...
    * <code>this</code> is not a <code>ThermalInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ThermalInfoConfig typedDst = (ThermalInfoConfig) destination;
        ThermalInfoConfig typedSrc = (ThermalInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ThermalInfoConfig typedSrc = (ThermalInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.location );
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.location,32);

            dst.writeFloat(typedSrc.temperatureLow);

            dst.writeFloat(typedSrc.temperatureHigh);

            dst.writeFloat(typedSrc.temperatureLowCritical);

            dst.writeFloat(typedSrc.temperatureHighCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ThermalInfoConfig typedDst = (ThermalInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.location = src.readString(32);
                typedDst.temperatureLow = src.readFloat();
                typedDst.temperatureHigh = src.readFloat();
                typedDst.temperatureLowCritical = src.readFloat();
                typedDst.temperatureHighCritical = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ThermalInfoConfig typedDst = (ThermalInfoConfig) sample;
    ...
    int mask) {
        return new ThermalInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ThermalInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ThermalInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThermalInfoConfigTypeCode.VALUE,ThermalInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ThermalInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ThermalInfoConfigTypeCode.VALUE,ThermalInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
