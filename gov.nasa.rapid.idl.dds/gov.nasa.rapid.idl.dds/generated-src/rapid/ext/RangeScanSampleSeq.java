...
/**
* A sequence of RangeScanSample instances.
*/
public final class RangeScanSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RangeScanSampleSeq() {
        super(RangeScanSample.class);
    }

    public RangeScanSampleSeq (int initialMaximum) {
        super(RangeScanSample.class, initialMaximum);
    }

    public RangeScanSampleSeq (Collection elements) {
        super(RangeScanSample.class, elements);
    }
