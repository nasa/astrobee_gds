...
public class CpuInfoConfigTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::ext::CpuInfoConfig";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.numCpus);

            dst.writeFloat(typedSrc.busyHigh);

            dst.writeFloat(typedSrc.busyCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.numCpus = src.readInt();
                typedDst.busyHigh = src.readFloat();
                typedDst.busyCritical = src.readFloat();
