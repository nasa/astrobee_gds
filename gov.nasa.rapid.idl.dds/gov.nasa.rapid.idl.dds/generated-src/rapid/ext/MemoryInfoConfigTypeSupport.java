...
public class MemoryInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::MemoryInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MemoryInfoConfigTypeSupport _singleton
    = new MemoryInfoConfigTypeSupport();
    ...
    */
    public static MemoryInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static MemoryInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MemoryInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return MemoryInfoConfig.create();
    }
    ...
    * <code>this</code> is not a <code>MemoryInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MemoryInfoConfig typedDst = (MemoryInfoConfig) destination;
        MemoryInfoConfig typedSrc = (MemoryInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MemoryInfoConfig typedSrc = (MemoryInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.total);

            dst.writeInt(typedSrc.memoryLow);

            dst.writeInt(typedSrc.memoryCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MemoryInfoConfig typedDst = (MemoryInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.total = src.readInt();
                typedDst.memoryLow = src.readInt();
                typedDst.memoryCritical = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MemoryInfoConfig typedDst = (MemoryInfoConfig) sample;
    ...
    int mask) {
        return new MemoryInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MemoryInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected MemoryInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MemoryInfoConfigTypeCode.VALUE,MemoryInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MemoryInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MemoryInfoConfigTypeCode.VALUE,MemoryInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
