...
/**
* A sequence of WifiInfoSample instances.
*/
public final class WifiInfoSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WifiInfoSampleSeq() {
        super(WifiInfoSample.class);
    }

    public WifiInfoSampleSeq (int initialMaximum) {
        super(WifiInfoSample.class, initialMaximum);
    }

    public WifiInfoSampleSeq (Collection elements) {
        super(WifiInfoSample.class, elements);
    }
