...
public class RTransMetaSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RTransMetaSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RTransMetaSequenceTypeSupport _singleton
    = new RTransMetaSequenceTypeSupport();
    ...
    */
    public static RTransMetaSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static RTransMetaSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RTransMetaSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return RTransMetaSequence.create();
    }
    ...
    public Class get_type() {
        return RTransMetaSequence.class;
    }
    ...
    * <code>this</code> is not a <code>RTransMetaSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RTransMetaSequence typedDst = (RTransMetaSequence) destination;
        RTransMetaSequence typedSrc = (RTransMetaSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RTransMetaSequence typedSrc = (RTransMetaSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,4, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RTransMetaSequence typedDst = (RTransMetaSequence) dst;
            rapid.ParameterUnionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 4, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RTransMetaSequence typedDst = (RTransMetaSequence) sample;
    ...
    protected RTransMetaSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RTransMetaSequenceTypeCode.VALUE,RTransMetaSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RTransMetaSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RTransMetaSequenceTypeCode.VALUE,RTransMetaSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
