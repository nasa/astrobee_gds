...
/**
* A sequence of NavMapSample instances.
*/
public final class NavMapSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public NavMapSampleSeq() {
        super(NavMapSample.class);
    }

    public NavMapSampleSeq (int initialMaximum) {
        super(NavMapSample.class, initialMaximum);
    }

    public NavMapSampleSeq (Collection elements) {
        super(NavMapSample.class, elements);
    }
