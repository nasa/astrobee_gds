...
public class ProcessConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessConfigTypeSupport _singleton
    = new ProcessConfigTypeSupport();
    ...
    */
    public static ProcessConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ProcessConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessConfig typedDst = (ProcessConfig) destination;
        ProcessConfig typedSrc = (ProcessConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (64)+1);
        currentAlignment += rapid.String256Sequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += rapid.String256Sequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessConfig typedSrc = (ProcessConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.comment );
        currentAlignment += rapid.String256Sequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.environment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.workingDirectory );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.binaryName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.commandLineParams );
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.runningMatch );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.aliveInterface );
        /** Number of times of automatic restart on unexpected shutdown */
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.comment,64);

            rapid.String256Sequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.environment, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.workingDirectory,256);

            dst.writeString(typedSrc.binaryName,32);

            dst.writeString(typedSrc.commandLineParams,256);

            dst.writeBoolean(typedSrc.selfTerminating);

            dst.writeBoolean(typedSrc.startOnInit);

            dst.writeBoolean(typedSrc.waitOnInit);

            dst.writeInt(typedSrc.startupTimeout);

            dst.writeString(typedSrc.runningMatch,256);

            dst.writeString(typedSrc.aliveInterface,32);
            /** Number of times of automatic restart on unexpected shutdown */

            dst.writeInt(typedSrc.restartsOnFailure);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessConfig typedDst = (ProcessConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(64);
                typedDst.comment = src.readString(64);
                typedDst.environment = (rapid.String256Sequence64)rapid.String256Sequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.environment, src, false, true, endpoint_plugin_qos);     
                typedDst.workingDirectory = src.readString(256);
                typedDst.binaryName = src.readString(32);
                typedDst.commandLineParams = src.readString(256);
                typedDst.selfTerminating = src.readBoolean();
                typedDst.startOnInit = src.readBoolean();
                typedDst.waitOnInit = src.readBoolean();
                typedDst.startupTimeout = src.readInt();
                typedDst.runningMatch = src.readString(256);
                typedDst.aliveInterface = src.readString(32);
                /** Number of times of automatic restart on unexpected shutdown */
                typedDst.restartsOnFailure = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.String256Sequence64TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessConfig typedDst = (ProcessConfig) sample;
    ...
    int mask) {
        return new ProcessConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ProcessConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ProcessConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessConfigTypeCode.VALUE,ProcessConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessConfigTypeCode.VALUE,ProcessConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
