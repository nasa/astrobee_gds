...
public class RTrans2DInterpretationTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RTrans2DInterpretation";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RTrans2DInterpretationTypeSupport _singleton
    = new RTrans2DInterpretationTypeSupport();
    ...
    */
    public static RTrans2DInterpretationTypeSupport get_instance() {
        return _singleton;
    }

    public static RTrans2DInterpretationTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RTrans2DInterpretationTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RTrans2DInterpretation.class;
    }
    ...
    * <code>this</code> is not a <code>RTrans2DInterpretation</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        RTrans2DInterpretation typedSrc = (RTrans2DInterpretation) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RTrans2DInterpretation.valueOf(ordinal);
            if (dst == null) {
    ...
    protected RTrans2DInterpretationTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RTrans2DInterpretationTypeCode.VALUE,RTrans2DInterpretation.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
