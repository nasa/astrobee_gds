...
public class RangeScanDirectionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RangeScanDirection";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RangeScanDirectionTypeSupport _singleton
    = new RangeScanDirectionTypeSupport();
    ...
    */
    public static RangeScanDirectionTypeSupport get_instance() {
        return _singleton;
    }

    public static RangeScanDirectionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RangeScanDirectionTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RangeScanDirection.class;
    }
    ...
    * <code>this</code> is not a <code>RangeScanDirection</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        RangeScanDirection typedSrc = (RangeScanDirection) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RangeScanDirection.valueOf(ordinal);
            if (dst == null) {
    ...
    protected RangeScanDirectionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RangeScanDirectionTypeCode.VALUE,RangeScanDirection.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
