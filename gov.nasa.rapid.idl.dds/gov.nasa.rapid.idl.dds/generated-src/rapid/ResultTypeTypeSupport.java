...
public class ResultTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ResultType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResultTypeTypeSupport _singleton
    = new ResultTypeTypeSupport();
    ...
    */
    public static ResultTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static ResultTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResultTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ResultType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ResultType typedSrc = (ResultType) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ResultType.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ResultTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ResultTypeTypeCode.VALUE,ResultType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
