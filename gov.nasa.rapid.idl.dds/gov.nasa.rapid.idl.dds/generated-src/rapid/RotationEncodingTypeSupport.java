...
public class RotationEncodingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::RotationEncoding";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RotationEncodingTypeSupport _singleton
    = new RotationEncodingTypeSupport();
    ...
    */
    public static RotationEncodingTypeSupport get_instance() {
        return _singleton;
    }

    public static RotationEncodingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RotationEncodingTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>RotationEncoding</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        RotationEncoding typedSrc = (RotationEncoding) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RotationEncoding.valueOf(ordinal);
            if (dst == null) {
    ...
    protected RotationEncodingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RotationEncodingTypeCode.VALUE,RotationEncoding.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
