...
/**
* A sequence of LongSequence32 instances.
*/
public final class LongSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence32Seq() {
        super(LongSequence32.class);
    }

    public LongSequence32Seq (int initialMaximum) {
        super(LongSequence32.class, initialMaximum);
    }

    public LongSequence32Seq (Collection elements) {
        super(LongSequence32.class, elements);
    }
