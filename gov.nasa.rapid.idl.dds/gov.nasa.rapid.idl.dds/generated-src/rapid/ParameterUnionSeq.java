...
/**
* A sequence of ParameterUnion instances.
*/
public final class ParameterUnionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ParameterUnionSeq() {
        super(ParameterUnion.class);
    }

    public ParameterUnionSeq (int initialMaximum) {
        super(ParameterUnion.class, initialMaximum);
    }

    public ParameterUnionSeq (Collection elements) {
        super(ParameterUnion.class, elements);
    }
