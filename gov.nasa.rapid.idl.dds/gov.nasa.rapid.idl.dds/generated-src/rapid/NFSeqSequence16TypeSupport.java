...
public class NFSeqSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NFSeqSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NFSeqSequence16TypeSupport _singleton
    = new NFSeqSequence16TypeSupport();
    ...
    */
    public static NFSeqSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static NFSeqSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NFSeqSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return NFSeqSequence16.create();
    }
    ...
    * <code>this</code> is not a <code>NFSeqSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NFSeqSequence16 typedDst = (NFSeqSequence16) destination;
        NFSeqSequence16 typedSrc = (NFSeqSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatSequenceTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NFSeqSequence16 typedSrc = (NFSeqSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedFloatSequenceTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NFSeqSequence16 typedDst = (NFSeqSequence16) dst;
            rapid.NamedFloatSequenceTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NFSeqSequence16 typedDst = (NFSeqSequence16) sample;
    ...
    protected NFSeqSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NFSeqSequence16TypeCode.VALUE,NFSeqSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NFSeqSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NFSeqSequence16TypeCode.VALUE,NFSeqSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
