...
/**
* A sequence of OctetSequence1K instances.
*/
public final class OctetSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence1KSeq() {
        super(OctetSequence1K.class);
    }

    public OctetSequence1KSeq (int initialMaximum) {
        super(OctetSequence1K.class, initialMaximum);
    }

    public OctetSequence1KSeq (Collection elements) {
        super(OctetSequence1K.class, elements);
    }
