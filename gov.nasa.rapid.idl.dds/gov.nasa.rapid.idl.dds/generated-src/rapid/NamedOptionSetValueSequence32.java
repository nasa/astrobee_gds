...
public class NamedOptionSetValueSequence32   implements Copyable, Serializable{

    public rapid.NamedOptionSetValueSeq userData =  new rapid.NamedOptionSetValueSeq(32);

    public NamedOptionSetValueSequence32() {

    }
    public NamedOptionSetValueSequence32 (NamedOptionSetValueSequence32 other) {
    ...
    public static Object create() {
        ...
        self = new  NamedOptionSetValueSequence32();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        NamedOptionSetValueSequence32 otherObj = (NamedOptionSetValueSequence32)o;
    ...
    * This method could be placed into <code>NamedOptionSetValueSequence32TypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        NamedOptionSetValueSequence32 typedSrc = (NamedOptionSetValueSequence32) src;
        NamedOptionSetValueSequence32 typedDst = this;
    ...
    public String toString(String desc, int indent) {
        ...
        for(int i__ = 0; i__ < userData.size(); ++i__) {
            strBuffer.append(((rapid.NamedOptionSetValue)userData.get(i__)).toString(Integer.toString(i__),indent+2));
        }
