...
public class Color4fTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Color4f";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Color4fTypeSupport _singleton
    = new Color4fTypeSupport();
    ...
    */
    public static Color4fTypeSupport get_instance() {
        return _singleton;
    }

    public static Color4fTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Color4fTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Color4f</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Color4f typedDst = (Color4f) destination;
        Color4f typedSrc = (Color4f) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (4));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Color4f typedSrc = (Color4f) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Color4f typedDst = (Color4f) sample;
    ...
    protected Color4fTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Color4fTypeCode.VALUE,Color4f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Color4fTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Color4fTypeCode.VALUE,Color4f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
