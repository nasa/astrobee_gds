...
public class Vec2fTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Vec2f";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Vec2fTypeSupport _singleton
    = new Vec2fTypeSupport();
    ...
    */
    public static Vec2fTypeSupport get_instance() {
        return _singleton;
    }

    public static Vec2fTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Vec2fTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Vec2f</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Vec2f typedDst = (Vec2f) destination;
        Vec2f typedSrc = (Vec2f) source;
    ...
    protected Vec2fTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Vec2fTypeCode.VALUE,Vec2f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Vec2fTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Vec2fTypeCode.VALUE,Vec2f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
