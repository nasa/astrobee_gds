...
/**
* A sequence of PositionSample instances.
*/
public final class PositionSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PositionSampleSeq() {
        super(PositionSample.class);
    }

    public PositionSampleSeq (int initialMaximum) {
        super(PositionSample.class, initialMaximum);
    }

    public PositionSampleSeq (Collection elements) {
        super(PositionSample.class, elements);
    }
