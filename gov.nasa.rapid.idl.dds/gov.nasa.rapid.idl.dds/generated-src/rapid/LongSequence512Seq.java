...
/**
* A sequence of LongSequence512 instances.
*/
public final class LongSequence512Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence512Seq() {
        super(LongSequence512.class);
    }

    public LongSequence512Seq (int initialMaximum) {
        super(LongSequence512.class, initialMaximum);
    }

    public LongSequence512Seq (Collection elements) {
        super(LongSequence512.class, elements);
    }
