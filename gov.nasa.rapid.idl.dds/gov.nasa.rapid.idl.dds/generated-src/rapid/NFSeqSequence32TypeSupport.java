...
public class NFSeqSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NFSeqSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NFSeqSequence32TypeSupport _singleton
    = new NFSeqSequence32TypeSupport();
    ...
    */
    public static NFSeqSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static NFSeqSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NFSeqSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return NFSeqSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>NFSeqSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NFSeqSequence32 typedDst = (NFSeqSequence32) destination;
        NFSeqSequence32 typedSrc = (NFSeqSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatSequenceTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatSequenceTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NFSeqSequence32 typedSrc = (NFSeqSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.NamedFloatSequenceTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedFloatSequenceTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NFSeqSequence32 typedDst = (NFSeqSequence32) dst;
            rapid.NamedFloatSequenceTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.NamedFloatSequenceTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NFSeqSequence32 typedDst = (NFSeqSequence32) sample;
    ...
    protected NFSeqSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NFSeqSequence32TypeCode.VALUE,NFSeqSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NFSeqSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NFSeqSequence32TypeCode.VALUE,NFSeqSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
