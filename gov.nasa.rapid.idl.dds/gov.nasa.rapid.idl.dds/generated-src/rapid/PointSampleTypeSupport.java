...
public class PointSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointSampleTypeSupport _singleton
    = new PointSampleTypeSupport();
    ...
    */
    public static PointSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static PointSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return PointSample.create();
    }
    ...
    * <code>this</code> is not a <code>PointSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PointSample typedDst = (PointSample) destination;
        PointSample typedSrc = (PointSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getArrayMaxSizeSerialized(currentAlignment,  (3));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PointSample typedSrc = (PointSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeShort(typedSrc.xyz[i1__]);
            }

            for(int i1__ = 0; i1__< 2; ++i1__){

                dst.writeByte(typedSrc.attributes[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PointSample typedDst = (PointSample) dst;
            typedDst.clear();      
            try{
                for(int i1__ = 0; i1__< 3; ++i1__){

                    typedDst.xyz[i1__] = src.readShort();
                }

                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.attributes[i1__] = src.readByte();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PointSample typedDst = (PointSample) sample;
    ...
    int mask) {
        return new PointSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PointSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected PointSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointSampleTypeCode.VALUE,PointSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PointSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PointSampleTypeCode.VALUE,PointSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
