...
public class AckStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::AckStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AckStatusTypeSupport _singleton
    = new AckStatusTypeSupport();
    ...
    */
    public static AckStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static AckStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AckStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>AckStatus</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        AckStatus typedSrc = (AckStatus) src;
    ...
    protected AckStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AckStatusTypeCode.VALUE,AckStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
