...
/**
* A sequence of DoubleSequence64 instances.
*/
public final class DoubleSequence64Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DoubleSequence64Seq() {
        super(DoubleSequence64.class);
    }

    public DoubleSequence64Seq (int initialMaximum) {
        super(DoubleSequence64.class, initialMaximum);
    }

    public DoubleSequence64Seq (Collection elements) {
        super(DoubleSequence64.class, elements);
    }
