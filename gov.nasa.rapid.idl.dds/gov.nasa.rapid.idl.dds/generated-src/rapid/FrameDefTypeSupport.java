...
public class FrameDefTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FrameDef";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FrameDefTypeSupport _singleton
    = new FrameDefTypeSupport();
    ...
    */
    public static FrameDefTypeSupport get_instance() {
        return _singleton;
    }

    public static FrameDefTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FrameDefTypeCode.VALUE;
    }

    public Object create_data() {
        return FrameDef.create();
    }
    ...
    * <code>this</code> is not a <code>FrameDef</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FrameDef typedDst = (FrameDef) destination;
        FrameDef typedSrc = (FrameDef) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FrameDef typedSrc = (FrameDef) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.parent );
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.transform);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.parent,256);

            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.transform, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.KeyTypeValueSequence8TypeSupport.get_instance().serialize(endpoint_data, typedSrc.extras, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FrameDef typedDst = (FrameDef) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.parent = src.readString(256);
                typedDst.transform = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.transform, src, false, true, endpoint_plugin_qos);     
                typedDst.extras = (rapid.KeyTypeValueSequence8)rapid.KeyTypeValueSequence8TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.extras, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FrameDef typedDst = (FrameDef) sample;
    ...
    int mask) {
        return new FrameDefDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FrameDefDataReader(native_reader, listener, mask, this);   
    ...
    protected FrameDefTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FrameDefTypeCode.VALUE,FrameDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FrameDefTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FrameDefTypeCode.VALUE,FrameDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
