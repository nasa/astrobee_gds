...
public class String128Sequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String128Sequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String128Sequence32TypeSupport _singleton
    = new String128Sequence32TypeSupport();
    ...
    */
    public static String128Sequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static String128Sequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String128Sequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return String128Sequence32.create();
    }
    ...
    public Object create_key() {
        return new String128Sequence32();
    }
    ...
    public Class get_type() {
        return String128Sequence32.class;
    }
    ...
    * <code>this</code> is not a <code>String128Sequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String128Sequence32 typedDst = (String128Sequence32) destination;
        String128Sequence32 typedSrc = (String128Sequence32) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String128Sequence32 typedSrc = (String128Sequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(128),32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String128Sequence32 typedDst = (String128Sequence32) dst;
            src.readStringSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String128Sequence32 typedDst = (String128Sequence32) sample;
    ...
    protected String128Sequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String128Sequence32TypeCode.VALUE,String128Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String128Sequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String128Sequence32TypeCode.VALUE,String128Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
