...
public class String32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String32TypeSupport _singleton
    = new String32TypeSupport();
    ...
    */
    public static String32TypeSupport get_instance() {
        return _singleton;
    }

    public static String32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String32TypeCode.VALUE;
    }

    public Object create_data() {
        return String32.create();
    }
    ...
    * <code>this</code> is not a <code>String32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String32 typedDst = (String32) destination;
        String32 typedSrc = (String32) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String32 typedSrc = (String32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String32 typedDst = (String32) dst;
            typedDst.userData = src.readString(32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String32 typedDst = (String32) sample;
    ...
    protected String32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String32TypeCode.VALUE,String32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String32TypeCode.VALUE,String32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
