...
/**
* A sequence of Vec3d instances.
*/
public final class Vec3dSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Vec3dSeq (int initialMaximum) {
        super(Vec3d.class, initialMaximum);
    }

    public Vec3dSeq (Collection elements) {
        super(Vec3d.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Vec3d objects (beyond the original size of this object)
