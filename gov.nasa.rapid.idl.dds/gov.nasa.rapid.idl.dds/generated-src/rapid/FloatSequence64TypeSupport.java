...
public class FloatSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence64TypeSupport _singleton
    = new FloatSequence64TypeSupport();
    ...
    */
    public static FloatSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence64.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence64 typedDst = (FloatSequence64) destination;
        FloatSequence64 typedSrc = (FloatSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence64 typedSrc = (FloatSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence64 typedDst = (FloatSequence64) dst;
            src.readFloatSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence64 typedDst = (FloatSequence64) sample;
    ...
    protected FloatSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence64TypeCode.VALUE,FloatSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence64TypeCode.VALUE,FloatSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
