...
/**
* A sequence of DoubleSequence32 instances.
*/
public final class DoubleSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DoubleSequence32Seq() {
        super(DoubleSequence32.class);
    }

    public DoubleSequence32Seq (int initialMaximum) {
        super(DoubleSequence32.class, initialMaximum);
    }

    public DoubleSequence32Seq (Collection elements) {
        super(DoubleSequence32.class, elements);
    }
