...
public class FloatRangeValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatRangeValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatRangeValueTypeSupport _singleton
    = new FloatRangeValueTypeSupport();
    ...
    */
    public static FloatRangeValueTypeSupport get_instance() {
        return _singleton;
    }

    public static FloatRangeValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatRangeValueTypeCode.VALUE;
    }

    public Object create_data() {
        return FloatRangeValue.create();
    }
    ...
    * <code>this</code> is not a <code>FloatRangeValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatRangeValue typedDst = (FloatRangeValue) destination;
        FloatRangeValue typedSrc = (FloatRangeValue) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatRangeValue typedSrc = (FloatRangeValue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.min);

            dst.writeFloat(typedSrc.max);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatRangeValue typedDst = (FloatRangeValue) dst;
            typedDst.clear();      
            try{
                typedDst.min = src.readFloat();
                typedDst.max = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatRangeValue typedDst = (FloatRangeValue) sample;
    ...
    int mask) {
        return new FloatRangeValueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FloatRangeValueDataReader(native_reader, listener, mask, this);   
    ...
    protected FloatRangeValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatRangeValueTypeCode.VALUE,FloatRangeValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatRangeValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatRangeValueTypeCode.VALUE,FloatRangeValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
