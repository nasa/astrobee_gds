...
/**
* A sequence of FloatRange instances.
*/
public final class FloatRangeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatRangeSeq() {
        super(FloatRange.class);
    }

    public FloatRangeSeq (int initialMaximum) {
        super(FloatRange.class, initialMaximum);
    }

    public FloatRangeSeq (Collection elements) {
        super(FloatRange.class, elements);
    }
