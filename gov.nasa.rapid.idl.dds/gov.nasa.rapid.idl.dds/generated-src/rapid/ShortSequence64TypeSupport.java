...
public class ShortSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence64TypeSupport _singleton
    = new ShortSequence64TypeSupport();
    ...
    */
    public static ShortSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence64.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence64 typedDst = (ShortSequence64) destination;
        ShortSequence64 typedSrc = (ShortSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence64 typedSrc = (ShortSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence64 typedDst = (ShortSequence64) dst;
            src.readShortSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence64 typedDst = (ShortSequence64) sample;
    ...
    protected ShortSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence64TypeCode.VALUE,ShortSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence64TypeCode.VALUE,ShortSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
