...
public class DoubleSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence32TypeSupport _singleton
    = new DoubleSequence32TypeSupport();
    ...
    */
    public static DoubleSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence32 typedDst = (DoubleSequence32) destination;
        DoubleSequence32 typedSrc = (DoubleSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence32 typedSrc = (DoubleSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence32 typedDst = (DoubleSequence32) dst;
            src.readDoubleSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence32 typedDst = (DoubleSequence32) sample;
    ...
    protected DoubleSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence32TypeCode.VALUE,DoubleSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence32TypeCode.VALUE,DoubleSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
