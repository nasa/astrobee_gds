...
/**
* A sequence of ResultType instances.
*/
public final class ResultTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ResultTypeSeq() {
        super(ResultType.class);
    }

    public ResultTypeSeq (int initialMaximum) {
        super(ResultType.class, initialMaximum);
    }

    public ResultTypeSeq (Collection elements) {
        super(ResultType.class, elements);
    }
