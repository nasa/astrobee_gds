...
public class DoubleSequence512TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence512";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence512TypeSupport _singleton
    = new DoubleSequence512TypeSupport();
    ...
    */
    public static DoubleSequence512TypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence512TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence512TypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence512.create();
    }
    ...
    public Class get_type() {
        return DoubleSequence512.class;
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence512</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence512 typedDst = (DoubleSequence512) destination;
        DoubleSequence512 typedSrc = (DoubleSequence512) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 512);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment,  0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence512 typedSrc = (DoubleSequence512) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.DOUBLE.getSequenceSerializedSize(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,512);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence512 typedDst = (DoubleSequence512) dst;
            src.readDoubleSequence(typedDst.userData, 512);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence512 typedDst = (DoubleSequence512) sample;
    ...
    protected DoubleSequence512TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence512TypeCode.VALUE,DoubleSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence512TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence512TypeCode.VALUE,DoubleSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
