...
/**
* A sequence of ValueSequence128 instances.
*/
public final class ValueSequence128Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ValueSequence128Seq() {
        super(ValueSequence128.class);
    }

    public ValueSequence128Seq (int initialMaximum) {
        super(ValueSequence128.class, initialMaximum);
    }

    public ValueSequence128Seq (Collection elements) {
        super(ValueSequence128.class, elements);
    }
