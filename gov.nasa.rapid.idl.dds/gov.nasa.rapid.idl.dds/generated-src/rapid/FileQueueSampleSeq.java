...
/**
* A sequence of FileQueueSample instances.
*/
public final class FileQueueSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileQueueSampleSeq() {
        super(FileQueueSample.class);
    }

    public FileQueueSampleSeq (int initialMaximum) {
        super(FileQueueSample.class, initialMaximum);
    }

    public FileQueueSampleSeq (Collection elements) {
        super(FileQueueSample.class, elements);
    }
