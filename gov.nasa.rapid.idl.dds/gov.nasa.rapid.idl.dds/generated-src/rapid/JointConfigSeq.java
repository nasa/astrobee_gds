...
/**
* A sequence of JointConfig instances.
*/
public final class JointConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointConfigSeq() {
        super(JointConfig.class);
    }

    public JointConfigSeq (int initialMaximum) {
        super(JointConfig.class, initialMaximum);
    }

    public JointConfigSeq (Collection elements) {
        super(JointConfig.class, elements);
    }
