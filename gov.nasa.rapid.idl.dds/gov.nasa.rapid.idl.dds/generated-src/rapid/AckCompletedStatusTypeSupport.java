...
public class AckCompletedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::AckCompletedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AckCompletedStatusTypeSupport _singleton
    = new AckCompletedStatusTypeSupport();
    ...
    */
    public static AckCompletedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static AckCompletedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AckCompletedStatusTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return AckCompletedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>AckCompletedStatus</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        AckCompletedStatus typedSrc = (AckCompletedStatus) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = AckCompletedStatus.valueOf(ordinal);
            if (dst == null) {
    ...
    protected AckCompletedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AckCompletedStatusTypeCode.VALUE,AckCompletedStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
