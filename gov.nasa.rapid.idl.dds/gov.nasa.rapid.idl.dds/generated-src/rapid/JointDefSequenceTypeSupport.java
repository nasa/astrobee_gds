...
public class JointDefSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::JointDefSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointDefSequenceTypeSupport _singleton
    = new JointDefSequenceTypeSupport();
    ...
    */
    public static JointDefSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static JointDefSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointDefSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return JointDefSequence.create();
    }
    ...
    * <code>this</code> is not a <code>JointDefSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        JointDefSequence typedDst = (JointDefSequence) destination;
        JointDefSequence typedSrc = (JointDefSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.JointDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.JointDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        JointDefSequence typedSrc = (JointDefSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.JointDefTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.JointDefTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            JointDefSequence typedDst = (JointDefSequence) dst;
            rapid.JointDefTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.JointDefTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            JointDefSequence typedDst = (JointDefSequence) sample;
    ...
    protected JointDefSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,JointDefSequenceTypeCode.VALUE,JointDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected JointDefSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,JointDefSequenceTypeCode.VALUE,JointDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
