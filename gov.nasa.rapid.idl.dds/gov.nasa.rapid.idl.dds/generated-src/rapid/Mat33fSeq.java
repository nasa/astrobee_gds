...
/**
* A sequence of Mat33f instances.
*/
public final class Mat33fSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Mat33fSeq (int initialMaximum) {
        super(Mat33f.class, initialMaximum);
    }

    public Mat33fSeq (Collection elements) {
        super(Mat33f.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Mat33f objects (beyond the original size of this object)
