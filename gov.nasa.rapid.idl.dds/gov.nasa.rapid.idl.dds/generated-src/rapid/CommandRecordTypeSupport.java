...
public class CommandRecordTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::CommandRecord";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CommandRecordTypeSupport _singleton
    = new CommandRecordTypeSupport();
    ...
    */
    public static CommandRecordTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandRecordTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CommandRecordTypeCode.VALUE;
    }

    public Object create_data() {
        return CommandRecord.create();
    }
    ...
    * <code>this</code> is not a <code>CommandRecord</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CommandRecord typedDst = (CommandRecord) destination;
        CommandRecord typedSrc = (CommandRecord) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ResultTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.StatusTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ResultTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.StatusTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CommandRecord typedSrc = (CommandRecord) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.CommandTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cmd);
        currentAlignment += rapid.ResultTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.trResult);
        currentAlignment += rapid.StatusTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.trStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.CommandTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cmd, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ResultTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.trResult, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.StatusTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.trStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CommandRecord typedDst = (CommandRecord) dst;
            typedDst.clear();      
            try{
                typedDst.cmd = (rapid.Command)rapid.CommandTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cmd, src, false, true, endpoint_plugin_qos);     
                typedDst.trResult = (rapid.ResultType)rapid.ResultTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trResult, src, false, true, endpoint_plugin_qos);     
                typedDst.trStatus = (rapid.StatusType)rapid.StatusTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.CommandTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ResultTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.StatusTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CommandRecord typedDst = (CommandRecord) sample;
    ...
    int mask) {
        return new CommandRecordDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CommandRecordDataReader(native_reader, listener, mask, this);   
    ...
    protected CommandRecordTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandRecordTypeCode.VALUE,CommandRecord.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CommandRecordTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CommandRecordTypeCode.VALUE,CommandRecord.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
