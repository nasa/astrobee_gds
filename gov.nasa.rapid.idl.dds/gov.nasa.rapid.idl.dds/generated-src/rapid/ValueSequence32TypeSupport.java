...
public class ValueSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ValueSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ValueSequence32TypeSupport _singleton
    = new ValueSequence32TypeSupport();
    ...
    */
    public static ValueSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static ValueSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ValueSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return ValueSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>ValueSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ValueSequence32 typedDst = (ValueSequence32) destination;
        ValueSequence32 typedSrc = (ValueSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ValueSequence32 typedSrc = (ValueSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ValueSequence32 typedDst = (ValueSequence32) dst;
            rapid.ParameterUnionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ValueSequence32 typedDst = (ValueSequence32) sample;
    ...
    protected ValueSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValueSequence32TypeCode.VALUE,ValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ValueSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ValueSequence32TypeCode.VALUE,ValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
