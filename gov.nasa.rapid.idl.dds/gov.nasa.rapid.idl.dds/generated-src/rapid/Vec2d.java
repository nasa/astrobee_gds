...
public class Vec2d   implements Copyable, Serializable{

    public double [] userData=  new double [2];
    ...
    * This method could be placed into <code>Vec2dTypeSupport</code>
