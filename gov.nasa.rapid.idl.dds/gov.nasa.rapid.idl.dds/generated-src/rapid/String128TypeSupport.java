...
public class String128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String128TypeSupport _singleton
    = new String128TypeSupport();
    ...
    */
    public static String128TypeSupport get_instance() {
        return _singleton;
    }

    public static String128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String128TypeCode.VALUE;
    }

    public Object create_data() {
        return String128.create();
    }
    ...
    * <code>this</code> is not a <code>String128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String128 typedDst = (String128) destination;
        String128 typedSrc = (String128) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String128 typedSrc = (String128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String128 typedDst = (String128) dst;
            typedDst.userData = src.readString(128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String128 typedDst = (String128) sample;
    ...
    protected String128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String128TypeCode.VALUE,String128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String128TypeCode.VALUE,String128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
