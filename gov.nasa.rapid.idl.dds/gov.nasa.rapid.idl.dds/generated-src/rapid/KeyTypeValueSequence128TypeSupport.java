...
public class KeyTypeValueSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueSequence128TypeSupport _singleton
    = new KeyTypeValueSequence128TypeSupport();
    ...
    */
    public static KeyTypeValueSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueSequence128.create();
    }
    ...
    public Object create_key() {
        return new KeyTypeValueSequence128();
    }
    ...
    public Class get_type() {
        return KeyTypeValueSequence128.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueSequence128 typedDst = (KeyTypeValueSequence128) destination;
        KeyTypeValueSequence128 typedSrc = (KeyTypeValueSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueSequence128 typedSrc = (KeyTypeValueSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,128, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueSequence128 typedDst = (KeyTypeValueSequence128) dst;
            rapid.KeyTypeValueTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 128, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueSequence128 typedDst = (KeyTypeValueSequence128) sample;
    ...
    protected KeyTypeValueSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueSequence128TypeCode.VALUE,KeyTypeValueSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueSequence128TypeCode.VALUE,KeyTypeValueSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
