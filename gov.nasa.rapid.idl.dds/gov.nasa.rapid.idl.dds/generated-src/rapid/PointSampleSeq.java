...
/**
* A sequence of PointSample instances.
*/
public final class PointSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PointSampleSeq() {
        super(PointSample.class);
    }

    public PointSampleSeq (int initialMaximum) {
        super(PointSample.class, initialMaximum);
    }

    public PointSampleSeq (Collection elements) {
        super(PointSample.class, elements);
    }
