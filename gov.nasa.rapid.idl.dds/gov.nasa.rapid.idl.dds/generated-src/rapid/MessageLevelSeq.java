...
/**
* A sequence of MessageLevel instances.
*/
public final class MessageLevelSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MessageLevelSeq() {
        super(MessageLevel.class);
    }

    public MessageLevelSeq (int initialMaximum) {
        super(MessageLevel.class, initialMaximum);
    }

    public MessageLevelSeq (Collection elements) {
        super(MessageLevel.class, elements);
    }
