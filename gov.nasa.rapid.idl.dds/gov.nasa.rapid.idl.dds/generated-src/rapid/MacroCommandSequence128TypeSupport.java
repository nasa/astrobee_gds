...
public class MacroCommandSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroCommandSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroCommandSequence128TypeSupport _singleton
    = new MacroCommandSequence128TypeSupport();
    ...
    */
    public static MacroCommandSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static MacroCommandSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroCommandSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return MacroCommandSequence128.create();
    }
    ...
    public Object create_key() {
        return new MacroCommandSequence128();
    }
    ...
    public Class get_type() {
        return MacroCommandSequence128.class;
    }
    ...
    * <code>this</code> is not a <code>MacroCommandSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroCommandSequence128 typedDst = (MacroCommandSequence128) destination;
        MacroCommandSequence128 typedSrc = (MacroCommandSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroCommandTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroCommandTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroCommandSequence128 typedSrc = (MacroCommandSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.MacroCommandTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.MacroCommandTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,128, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroCommandSequence128 typedDst = (MacroCommandSequence128) dst;
            rapid.MacroCommandTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 128, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.MacroCommandTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroCommandSequence128 typedDst = (MacroCommandSequence128) sample;
    ...
    protected MacroCommandSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MacroCommandSequence128TypeCode.VALUE,MacroCommandSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroCommandSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroCommandSequence128TypeCode.VALUE,MacroCommandSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
