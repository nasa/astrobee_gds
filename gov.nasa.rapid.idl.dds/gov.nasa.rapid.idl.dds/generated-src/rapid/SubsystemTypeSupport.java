...
public class SubsystemTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Subsystem";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubsystemTypeSupport _singleton
    = new SubsystemTypeSupport();
    ...
    */
    public static SubsystemTypeSupport get_instance() {
        return _singleton;
    }

    public static SubsystemTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubsystemTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Subsystem</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Subsystem typedDst = (Subsystem) destination;
        Subsystem typedSrc = (Subsystem) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Subsystem typedSrc = (Subsystem) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.subsystemTypeName );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.subsystemTypeName,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Subsystem typedDst = (Subsystem) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.subsystemTypeName = src.readString(32);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Subsystem typedDst = (Subsystem) sample;
    ...
    int mask) {
        return new SubsystemDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SubsystemDataReader(native_reader, listener, mask, this);   
    ...
    protected SubsystemTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubsystemTypeCode.VALUE,Subsystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubsystemTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubsystemTypeCode.VALUE,Subsystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
