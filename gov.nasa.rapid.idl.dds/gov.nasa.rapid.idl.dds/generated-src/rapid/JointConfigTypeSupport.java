...
public class JointConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::JointConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointConfigTypeSupport _singleton
    = new JointConfigTypeSupport();
    ...
    */
    public static JointConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static JointConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return JointConfig.create();
    }
    ...
    * <code>this</code> is not a <code>JointConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        JointConfig typedDst = (JointConfig) destination;
        JointConfig typedSrc = (JointConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.JointDefSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.JointDefSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        JointConfig typedSrc = (JointConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.jointGroupName );
        currentAlignment += rapid.JointDefSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.jointDefinitions);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.jointGroupName,32);

            rapid.JointDefSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.jointDefinitions, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            JointConfig typedDst = (JointConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.jointGroupName = src.readString(32);
                typedDst.jointDefinitions = (rapid.JointDefSequence)rapid.JointDefSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.jointDefinitions, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.JointDefSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            JointConfig typedDst = (JointConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        JointConfig typedDst
        = (JointConfig) instance;
        JointConfig typedSrc
        = (JointConfig) key;
    ...
    */
    ...
    int mask) {
        return new JointConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new JointConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected JointConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,JointConfigTypeCode.VALUE,JointConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected JointConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,JointConfigTypeCode.VALUE,JointConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
