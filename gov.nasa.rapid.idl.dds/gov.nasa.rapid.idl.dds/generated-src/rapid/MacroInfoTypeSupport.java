...
public class MacroInfoTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroInfo";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroInfoTypeSupport _singleton
    = new MacroInfoTypeSupport();
    ...
    */
    public static MacroInfoTypeSupport get_instance() {
        return _singleton;
    }

    public static MacroInfoTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroInfoTypeCode.VALUE;
    }

    public Object create_data() {
        return MacroInfo.create();
    }
    ...
    * <code>this</code> is not a <code>MacroInfo</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroInfo typedDst = (MacroInfo) destination;
        MacroInfo typedSrc = (MacroInfo) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroInfo typedSrc = (MacroInfo) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.accepted);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroInfo typedDst = (MacroInfo) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(64);
                typedDst.serial = src.readInt();
                typedDst.accepted = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroInfo typedDst = (MacroInfo) sample;
    ...
    int mask) {
        return new MacroInfoDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MacroInfoDataReader(native_reader, listener, mask, this);   
    ...
    protected MacroInfoTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MacroInfoTypeCode.VALUE,MacroInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroInfoTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroInfoTypeCode.VALUE,MacroInfo.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
