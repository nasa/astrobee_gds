...
/**
* A sequence of FloatRangeValue instances.
*/
public final class FloatRangeValueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatRangeValueSeq() {
        super(FloatRangeValue.class);
    }

    public FloatRangeValueSeq (int initialMaximum) {
        super(FloatRangeValue.class, initialMaximum);
    }

    public FloatRangeValueSeq (Collection elements) {
        super(FloatRangeValue.class, elements);
    }
