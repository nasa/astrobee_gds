...
public class AgentConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::AgentConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AgentConfigTypeSupport _singleton
    = new AgentConfigTypeSupport();
    ...
    */
    public static AgentConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static AgentConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AgentConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>AgentConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AgentConfig typedDst = (AgentConfig) destination;
        AgentConfig typedSrc = (AgentConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String16Sequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.String128Sequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.KeyTypeValueSequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.String16Sequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.String128Sequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.KeyTypeValueSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AgentConfig typedSrc = (AgentConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.String16Sequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.agentTags);
        currentAlignment += rapid.String128Sequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.topics);
        currentAlignment += rapid.KeyTypeValueSequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.valueKeys);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.String16Sequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.agentTags, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.String128Sequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.topics, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.KeyTypeValueSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.valueKeys, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AgentConfig typedDst = (AgentConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.agentTags = (rapid.String16Sequence16)rapid.String16Sequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.agentTags, src, false, true, endpoint_plugin_qos);     
                typedDst.topics = (rapid.String128Sequence64)rapid.String128Sequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.topics, src, false, true, endpoint_plugin_qos);     
                typedDst.valueKeys = (rapid.KeyTypeValueSequence64)rapid.KeyTypeValueSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.valueKeys, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.String16Sequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.String128Sequence64TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.KeyTypeValueSequence64TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AgentConfig typedDst = (AgentConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        AgentConfig typedDst
        = (AgentConfig) instance;
        AgentConfig typedSrc
        = (AgentConfig) key;
    ...
    */
    ...
    int mask) {
        return new AgentConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AgentConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected AgentConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,AgentConfigTypeCode.VALUE,AgentConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AgentConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AgentConfigTypeCode.VALUE,AgentConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
