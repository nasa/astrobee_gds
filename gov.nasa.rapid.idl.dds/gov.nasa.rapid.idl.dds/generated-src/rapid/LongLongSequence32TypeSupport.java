...
public class LongLongSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongLongSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongLongSequence32TypeSupport _singleton
    = new LongLongSequence32TypeSupport();
    ...
    */
    public static LongLongSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static LongLongSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongLongSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return LongLongSequence32.create();
    }
    ...
    public Class get_type() {
        return LongLongSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>LongLongSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongLongSequence32 typedDst = (LongLongSequence32) destination;
        LongLongSequence32 typedSrc = (LongLongSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getSequenceMaxSizeSerialized(currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongLongSequence32 typedSrc = (LongLongSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLongSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongLongSequence32 typedDst = (LongLongSequence32) dst;
            src.readLongSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongLongSequence32 typedDst = (LongLongSequence32) sample;
    ...
    protected LongLongSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongLongSequence32TypeCode.VALUE,LongLongSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongLongSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongLongSequence32TypeCode.VALUE,LongLongSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
