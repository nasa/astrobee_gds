...
public class FileTransferStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileTransferStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileTransferStatusTypeSupport _singleton
    = new FileTransferStatusTypeSupport();
    ...
    */
    public static FileTransferStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static FileTransferStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileTransferStatusTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return FileTransferStatus.class;
    }
    ...
    * <code>this</code> is not a <code>FileTransferStatus</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        FileTransferStatus typedSrc = (FileTransferStatus) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = FileTransferStatus.valueOf(ordinal);
            if (dst == null) {
    ...
    protected FileTransferStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FileTransferStatusTypeCode.VALUE,FileTransferStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
