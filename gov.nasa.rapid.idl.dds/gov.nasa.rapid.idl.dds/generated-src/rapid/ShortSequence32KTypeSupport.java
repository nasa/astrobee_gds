...
public class ShortSequence32KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence32K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence32KTypeSupport _singleton
    = new ShortSequence32KTypeSupport();
    ...
    */
    public static ShortSequence32KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence32KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence32KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence32K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence32K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence32K typedDst = (ShortSequence32K) destination;
        ShortSequence32K typedSrc = (ShortSequence32K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 32768);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence32K typedSrc = (ShortSequence32K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,32768);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence32K typedDst = (ShortSequence32K) dst;
            src.readShortSequence(typedDst.userData, 32768);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence32K typedDst = (ShortSequence32K) sample;
    ...
    protected ShortSequence32KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence32KTypeCode.VALUE,ShortSequence32K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence32KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence32KTypeCode.VALUE,ShortSequence32K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
