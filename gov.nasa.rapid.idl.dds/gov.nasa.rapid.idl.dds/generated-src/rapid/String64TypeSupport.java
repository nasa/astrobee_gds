...
public class String64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String64TypeSupport _singleton
    = new String64TypeSupport();
    ...
    */
    public static String64TypeSupport get_instance() {
        return _singleton;
    }

    public static String64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String64TypeCode.VALUE;
    }

    public Object create_data() {
        return String64.create();
    }
    ...
    * <code>this</code> is not a <code>String64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String64 typedDst = (String64) destination;
        String64 typedSrc = (String64) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String64 typedSrc = (String64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String64 typedDst = (String64) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String64 typedDst = (String64) sample;
    ...
    protected String64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String64TypeCode.VALUE,String64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String64TypeCode.VALUE,String64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
