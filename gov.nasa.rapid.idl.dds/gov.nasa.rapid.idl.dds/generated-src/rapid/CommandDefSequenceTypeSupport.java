...
public class CommandDefSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::CommandDefSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CommandDefSequenceTypeSupport _singleton
    = new CommandDefSequenceTypeSupport();
    ...
    */
    public static CommandDefSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandDefSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CommandDefSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return CommandDefSequence.create();
    }
    ...
    public Class get_type() {
        return CommandDefSequence.class;
    }
    ...
    * <code>this</code> is not a <code>CommandDefSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CommandDefSequence typedDst = (CommandDefSequence) destination;
        CommandDefSequence typedSrc = (CommandDefSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CommandDefSequence typedSrc = (CommandDefSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.CommandDefTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.CommandDefTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CommandDefSequence typedDst = (CommandDefSequence) dst;
            rapid.CommandDefTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 100, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.CommandDefTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CommandDefSequence typedDst = (CommandDefSequence) sample;
    ...
    protected CommandDefSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CommandDefSequenceTypeCode.VALUE,CommandDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CommandDefSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CommandDefSequenceTypeCode.VALUE,CommandDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
