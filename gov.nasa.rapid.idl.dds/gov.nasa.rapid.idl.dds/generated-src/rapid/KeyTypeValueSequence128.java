...
public class KeyTypeValueSequence128   implements Copyable, Serializable{

    public rapid.KeyTypeValueTripleSeq userData =  new rapid.KeyTypeValueTripleSeq(128);

    public KeyTypeValueSequence128() {

    }
    public KeyTypeValueSequence128 (KeyTypeValueSequence128 other) {
    ...
    public static Object create() {
        ...
        self = new  KeyTypeValueSequence128();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        KeyTypeValueSequence128 otherObj = (KeyTypeValueSequence128)o;
    ...
    * This method could be placed into <code>KeyTypeValueSequence128TypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        KeyTypeValueSequence128 typedSrc = (KeyTypeValueSequence128) src;
        KeyTypeValueSequence128 typedDst = this;
    ...
    public String toString(String desc, int indent) {
        ...
        for(int i__ = 0; i__ < userData.size(); ++i__) {
            strBuffer.append(((rapid.KeyTypeValueTriple)userData.get(i__)).toString(Integer.toString(i__),indent+2));
        }
