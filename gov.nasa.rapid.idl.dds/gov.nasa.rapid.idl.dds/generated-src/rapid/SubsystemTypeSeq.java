...
/**
* A sequence of SubsystemType instances.
*/
public final class SubsystemTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SubsystemTypeSeq() {
        super(SubsystemType.class);
    }

    public SubsystemTypeSeq (int initialMaximum) {
        super(SubsystemType.class, initialMaximum);
    }

    public SubsystemTypeSeq (Collection elements) {
        super(SubsystemType.class, elements);
    }
