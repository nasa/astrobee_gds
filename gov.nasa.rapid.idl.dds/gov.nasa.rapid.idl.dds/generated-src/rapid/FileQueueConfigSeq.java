...
/**
* A sequence of FileQueueConfig instances.
*/
public final class FileQueueConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileQueueConfigSeq() {
        super(FileQueueConfig.class);
    }

    public FileQueueConfigSeq (int initialMaximum) {
        super(FileQueueConfig.class, initialMaximum);
    }

    public FileQueueConfigSeq (Collection elements) {
        super(FileQueueConfig.class, elements);
    }
