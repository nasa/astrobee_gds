...
/**
* A sequence of ShortSequence4K instances.
*/
public final class ShortSequence4KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence4KSeq() {
        super(ShortSequence4K.class);
    }

    public ShortSequence4KSeq (int initialMaximum) {
        super(ShortSequence4K.class, initialMaximum);
    }

    public ShortSequence4KSeq (Collection elements) {
        super(ShortSequence4K.class, elements);
    }
