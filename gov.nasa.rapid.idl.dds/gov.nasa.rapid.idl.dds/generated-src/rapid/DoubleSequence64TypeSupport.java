...
public class DoubleSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence64TypeSupport _singleton
    = new DoubleSequence64TypeSupport();
    ...
    */
    public static DoubleSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence64.create();
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence64 typedDst = (DoubleSequence64) destination;
        DoubleSequence64 typedSrc = (DoubleSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence64 typedSrc = (DoubleSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence64 typedDst = (DoubleSequence64) dst;
            src.readDoubleSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence64 typedDst = (DoubleSequence64) sample;
    ...
    protected DoubleSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence64TypeCode.VALUE,DoubleSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence64TypeCode.VALUE,DoubleSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
