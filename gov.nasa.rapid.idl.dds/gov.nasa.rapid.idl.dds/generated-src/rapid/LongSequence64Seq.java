...
/**
* A sequence of LongSequence64 instances.
*/
public final class LongSequence64Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence64Seq() {
        super(LongSequence64.class);
    }

    public LongSequence64Seq (int initialMaximum) {
        super(LongSequence64.class, initialMaximum);
    }

    public LongSequence64Seq (Collection elements) {
        super(LongSequence64.class, elements);
    }
