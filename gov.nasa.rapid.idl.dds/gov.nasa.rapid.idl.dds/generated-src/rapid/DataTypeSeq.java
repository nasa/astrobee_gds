...
/**
* A sequence of DataType instances.
*/
public final class DataTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataTypeSeq (int initialMaximum) {
        super(DataType.class, initialMaximum);
    }

    public DataTypeSeq (Collection elements) {
        super(DataType.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, DataType.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' DataType objects (beyond the original size of this object)
