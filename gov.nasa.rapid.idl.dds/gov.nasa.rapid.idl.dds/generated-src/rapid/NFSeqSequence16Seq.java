...
/**
* A sequence of NFSeqSequence16 instances.
*/
public final class NFSeqSequence16Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public NFSeqSequence16Seq() {
        super(NFSeqSequence16.class);
    }

    public NFSeqSequence16Seq (int initialMaximum) {
        super(NFSeqSequence16.class, initialMaximum);
    }

    public NFSeqSequence16Seq (Collection elements) {
        super(NFSeqSequence16.class, elements);
    }
