...
public class OctetSequence2KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence2K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence2KTypeSupport _singleton
    = new OctetSequence2KTypeSupport();
    ...
    */
    public static OctetSequence2KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence2KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence2KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence2K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence2K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence2K typedDst = (OctetSequence2K) destination;
        OctetSequence2K typedSrc = (OctetSequence2K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 2048);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence2K typedSrc = (OctetSequence2K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,2048);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence2K typedDst = (OctetSequence2K) dst;
            src.readByteSequence(typedDst.userData, 2048);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence2K typedDst = (OctetSequence2K) sample;
    ...
    protected OctetSequence2KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence2KTypeCode.VALUE,OctetSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence2KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence2KTypeCode.VALUE,OctetSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
