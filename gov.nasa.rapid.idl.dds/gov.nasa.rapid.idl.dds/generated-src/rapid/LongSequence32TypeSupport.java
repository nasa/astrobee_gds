...
public class LongSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence32TypeSupport _singleton
    = new LongSequence32TypeSupport();
    ...
    */
    public static LongSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence32 typedDst = (LongSequence32) destination;
        LongSequence32 typedSrc = (LongSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence32 typedSrc = (LongSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence32 typedDst = (LongSequence32) dst;
            src.readIntSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence32 typedDst = (LongSequence32) sample;
    ...
    protected LongSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence32TypeCode.VALUE,LongSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence32TypeCode.VALUE,LongSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
