...
public class SingleQueueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::SingleQueue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SingleQueueTypeSupport _singleton
    = new SingleQueueTypeSupport();
    ...
    */
    public static SingleQueueTypeSupport get_instance() {
        return _singleton;
    }

    public static SingleQueueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SingleQueueTypeCode.VALUE;
    }

    public Object create_data() {
        return SingleQueue.create();
    }
    ...
    * <code>this</code> is not a <code>SingleQueue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SingleQueue typedDst = (SingleQueue) destination;
        SingleQueue typedSrc = (SingleQueue) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandRecordTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandRecordTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SingleQueue typedSrc = (SingleQueue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.CommandRecordTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.queue);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.CommandRecordTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.queue,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SingleQueue typedDst = (SingleQueue) dst;
            typedDst.clear();      
            try{
                rapid.CommandRecordTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.queue, src, 64, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.CommandRecordTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SingleQueue typedDst = (SingleQueue) sample;
    ...
    int mask) {
        return new SingleQueueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SingleQueueDataReader(native_reader, listener, mask, this);   
    ...
    protected SingleQueueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SingleQueueTypeCode.VALUE,SingleQueue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SingleQueueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SingleQueueTypeCode.VALUE,SingleQueue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
