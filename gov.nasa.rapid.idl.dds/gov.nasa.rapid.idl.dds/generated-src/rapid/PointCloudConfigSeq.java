...
/**
* A sequence of PointCloudConfig instances.
*/
public final class PointCloudConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PointCloudConfigSeq() {
        super(PointCloudConfig.class);
    }

    public PointCloudConfigSeq (int initialMaximum) {
        super(PointCloudConfig.class, initialMaximum);
    }

    public PointCloudConfigSeq (Collection elements) {
        super(PointCloudConfig.class, elements);
    }
