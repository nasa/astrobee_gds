...
public class KeyTypePair   implements Copyable, Serializable{

    public String key=  "" ; /* maximum length = (32) */
    public rapid.DataType type = (rapid.DataType)rapid.DataType.create();

    public KeyTypePair() {

    }
    public KeyTypePair (KeyTypePair other) {
    ...
    public boolean equals(Object o) {
        ...
        KeyTypePair otherObj = (KeyTypePair)o;
    ...
    * This method could be placed into <code>KeyTypePairTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        KeyTypePair typedSrc = (KeyTypePair) src;
        KeyTypePair typedDst = this;

        typedDst.key = typedSrc.key;
        typedDst.type = (rapid.DataType) typedDst.type.copy_from(typedSrc.type);
