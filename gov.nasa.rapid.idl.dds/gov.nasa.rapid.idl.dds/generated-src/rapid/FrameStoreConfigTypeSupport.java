...
public class FrameStoreConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FrameStoreConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FrameStoreConfigTypeSupport _singleton
    = new FrameStoreConfigTypeSupport();
    ...
    */
    public static FrameStoreConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static FrameStoreConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FrameStoreConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return FrameStoreConfig.create();
    }
    ...
    * <code>this</code> is not a <code>FrameStoreConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FrameStoreConfig typedDst = (FrameStoreConfig) destination;
        FrameStoreConfig typedSrc = (FrameStoreConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FrameDefSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FrameDefSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FrameStoreConfig typedSrc = (FrameStoreConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.FrameDefSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.frames);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.FrameDefSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.frames, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FrameStoreConfig typedDst = (FrameStoreConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.frames = (rapid.FrameDefSequence)rapid.FrameDefSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.frames, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.FrameDefSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FrameStoreConfig typedDst = (FrameStoreConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FrameStoreConfig typedDst
        = (FrameStoreConfig) instance;
        FrameStoreConfig typedSrc
        = (FrameStoreConfig) key;
    ...
    */
    ...
    int mask) {
        return new FrameStoreConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FrameStoreConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected FrameStoreConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FrameStoreConfigTypeCode.VALUE,FrameStoreConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FrameStoreConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FrameStoreConfigTypeCode.VALUE,FrameStoreConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
