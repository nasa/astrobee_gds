...
/**
* A sequence of Vec3f instances.
*/
public final class Vec3fSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Vec3fSeq (int initialMaximum) {
        super(Vec3f.class, initialMaximum);
    }

    public Vec3fSeq (Collection elements) {
        super(Vec3f.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Vec3f objects (beyond the original size of this object)
