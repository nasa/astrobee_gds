...
public class TextMessageTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::TextMessage";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TextMessageTypeSupport _singleton
    = new TextMessageTypeSupport();
    ...
    */
    public static TextMessageTypeSupport get_instance() {
        return _singleton;
    }

    public static TextMessageTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TextMessageTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>TextMessage</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TextMessage typedDst = (TextMessage) destination;
        TextMessage typedSrc = (TextMessage) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MessageLevelTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (64)+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (2048)+1);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MessageLevelTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TextMessage typedSrc = (TextMessage) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.MessageLevelTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.level);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.MessageLevelTypeSupport.get_instance().serialize(endpoint_data, typedSrc.level, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.category,64);

            dst.writeString(typedSrc.message,2048);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TextMessage typedDst = (TextMessage) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.level = (rapid.MessageLevel)rapid.MessageLevelTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.level, src, false, true, endpoint_plugin_qos);     
                typedDst.category = src.readString(64);
                typedDst.message = src.readString(2048);
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.MessageLevelTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TextMessage typedDst = (TextMessage) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TextMessage typedDst
        = (TextMessage) instance;
        TextMessage typedSrc
        = (TextMessage) key;
    ...
    */
    ...
    int mask) {
        return new TextMessageDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TextMessageDataReader(native_reader, listener, mask, this);   
    ...
    protected TextMessageTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TextMessageTypeCode.VALUE,TextMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TextMessageTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TextMessageTypeCode.VALUE,TextMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
