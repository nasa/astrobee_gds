...
public class NamedFloatSequence   implements Copyable, Serializable{

    public String name=  "" ; /* maximum length = (16) */
    public rapid.FloatSequence64 values = (rapid.FloatSequence64)rapid.FloatSequence64.create();

    public NamedFloatSequence() {

    }
    public NamedFloatSequence (NamedFloatSequence other) {
    ...
    public boolean equals(Object o) {
        ...
        NamedFloatSequence otherObj = (NamedFloatSequence)o;
    ...
    * This method could be placed into <code>NamedFloatSequenceTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        NamedFloatSequence typedSrc = (NamedFloatSequence) src;
        NamedFloatSequence typedDst = this;

        typedDst.name = typedSrc.name;
        typedDst.values = (rapid.FloatSequence64) typedDst.values.copy_from(typedSrc.values);
