...
public class OctetSequence4KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence4K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence4KTypeSupport _singleton
    = new OctetSequence4KTypeSupport();
    ...
    */
    public static OctetSequence4KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence4KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence4KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence4K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence4K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence4K typedDst = (OctetSequence4K) destination;
        OctetSequence4K typedSrc = (OctetSequence4K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 4096);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence4K typedSrc = (OctetSequence4K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,4096);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence4K typedDst = (OctetSequence4K) dst;
            src.readByteSequence(typedDst.userData, 4096);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence4K typedDst = (OctetSequence4K) sample;
    ...
    protected OctetSequence4KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence4KTypeCode.VALUE,OctetSequence4K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence4KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence4KTypeCode.VALUE,OctetSequence4K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
