...
/**
* A sequence of MacroConfig instances.
*/
public final class MacroConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MacroConfigSeq() {
        super(MacroConfig.class);
    }

    public MacroConfigSeq (int initialMaximum) {
        super(MacroConfig.class, initialMaximum);
    }

    public MacroConfigSeq (Collection elements) {
        super(MacroConfig.class, elements);
    }
