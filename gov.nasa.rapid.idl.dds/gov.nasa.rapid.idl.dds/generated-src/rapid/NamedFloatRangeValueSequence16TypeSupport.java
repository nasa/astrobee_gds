...
public class NamedFloatRangeValueSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedFloatRangeValueSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedFloatRangeValueSequence16TypeSupport _singleton
    = new NamedFloatRangeValueSequence16TypeSupport();
    ...
    */
    public static NamedFloatRangeValueSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static NamedFloatRangeValueSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedFloatRangeValueSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return NamedFloatRangeValueSequence16.create();
    }
    ...
    public Object create_key() {
        return new NamedFloatRangeValueSequence16();
    }
    ...
    public Class get_type() {
        return NamedFloatRangeValueSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>NamedFloatRangeValueSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedFloatRangeValueSequence16 typedDst = (NamedFloatRangeValueSequence16) destination;
        NamedFloatRangeValueSequence16 typedSrc = (NamedFloatRangeValueSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatRangeValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatRangeValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedFloatRangeValueSequence16 typedSrc = (NamedFloatRangeValueSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.NamedFloatRangeValueTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedFloatRangeValueTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedFloatRangeValueSequence16 typedDst = (NamedFloatRangeValueSequence16) dst;
            rapid.NamedFloatRangeValueTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.NamedFloatRangeValueTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedFloatRangeValueSequence16 typedDst = (NamedFloatRangeValueSequence16) sample;
    ...
    protected NamedFloatRangeValueSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedFloatRangeValueSequence16TypeCode.VALUE,NamedFloatRangeValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedFloatRangeValueSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedFloatRangeValueSequence16TypeCode.VALUE,NamedFloatRangeValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
