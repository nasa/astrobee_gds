...
public class NamedFloatSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedFloatSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedFloatSequenceTypeSupport _singleton
    = new NamedFloatSequenceTypeSupport();
    ...
    */
    public static NamedFloatSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static NamedFloatSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedFloatSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return NamedFloatSequence.create();
    }
    ...
    public Class get_type() {
        return NamedFloatSequence.class;
    }
    ...
    * <code>this</code> is not a <code>NamedFloatSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedFloatSequence typedDst = (NamedFloatSequence) destination;
        NamedFloatSequence typedSrc = (NamedFloatSequence) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedFloatSequence typedSrc = (NamedFloatSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.FloatSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.values, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedFloatSequence typedDst = (NamedFloatSequence) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(16);
                typedDst.values = (rapid.FloatSequence64)rapid.FloatSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.values, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedFloatSequence typedDst = (NamedFloatSequence) sample;
    ...
    int mask) {
        return new NamedFloatSequenceDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NamedFloatSequenceDataReader(native_reader, listener, mask, this);   
    ...
    protected NamedFloatSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedFloatSequenceTypeCode.VALUE,NamedFloatSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedFloatSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedFloatSequenceTypeCode.VALUE,NamedFloatSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
