...
/**
* A sequence of MacroCommand instances.
*/
public final class MacroCommandSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MacroCommandSeq() {
        super(MacroCommand.class);
    }

    public MacroCommandSeq (int initialMaximum) {
        super(MacroCommand.class, initialMaximum);
    }

    public MacroCommandSeq (Collection elements) {
        super(MacroCommand.class, elements);
    }
