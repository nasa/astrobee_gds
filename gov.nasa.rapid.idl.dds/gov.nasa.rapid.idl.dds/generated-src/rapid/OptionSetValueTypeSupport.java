...
public class OptionSetValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OptionSetValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OptionSetValueTypeSupport _singleton
    = new OptionSetValueTypeSupport();
    ...
    */
    public static OptionSetValueTypeSupport get_instance() {
        return _singleton;
    }

    public static OptionSetValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OptionSetValueTypeCode.VALUE;
    }

    public Object create_data() {
        return OptionSetValue.create();
    }
    ...
    * <code>this</code> is not a <code>OptionSetValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OptionSetValue typedDst = (OptionSetValue) destination;
        OptionSetValue typedSrc = (OptionSetValue) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OptionSetValue typedSrc = (OptionSetValue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.String32Sequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.options);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.index);

            rapid.String32Sequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.options, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OptionSetValue typedDst = (OptionSetValue) dst;
            typedDst.clear();      
            try{
                typedDst.index = src.readInt();
                typedDst.options = (rapid.String32Sequence16)rapid.String32Sequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.options, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OptionSetValue typedDst = (OptionSetValue) sample;
    ...
    int mask) {
        return new OptionSetValueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new OptionSetValueDataReader(native_reader, listener, mask, this);   
    ...
    protected OptionSetValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OptionSetValueTypeCode.VALUE,OptionSetValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OptionSetValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OptionSetValueTypeCode.VALUE,OptionSetValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
