...
/**
* A sequence of OptionSetValue instances.
*/
public final class OptionSetValueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OptionSetValueSeq() {
        super(OptionSetValue.class);
    }

    public OptionSetValueSeq (int initialMaximum) {
        super(OptionSetValue.class, initialMaximum);
    }

    public OptionSetValueSeq (Collection elements) {
        super(OptionSetValue.class, elements);
    }
