...
/**
* A sequence of OctetSequence64K instances.
*/
public final class OctetSequence64KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence64KSeq() {
        super(OctetSequence64K.class);
    }

    public OctetSequence64KSeq (int initialMaximum) {
        super(OctetSequence64K.class, initialMaximum);
    }

    public OctetSequence64KSeq (Collection elements) {
        super(OctetSequence64K.class, elements);
    }
