...
public class ChannelStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ChannelStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelStatusTypeSupport _singleton
    = new ChannelStatusTypeSupport();
    ...
    */
    public static ChannelStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ChannelStatus</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ChannelStatus typedSrc = (ChannelStatus) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ChannelStatus.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ChannelStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelStatusTypeCode.VALUE,ChannelStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
