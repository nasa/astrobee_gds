...
public class Vec3fTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Vec3f";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Vec3fTypeSupport _singleton
    = new Vec3fTypeSupport();
    ...
    */
    public static Vec3fTypeSupport get_instance() {
        return _singleton;
    }

    public static Vec3fTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Vec3fTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Vec3f</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Vec3f typedDst = (Vec3f) destination;
        Vec3f typedSrc = (Vec3f) source;
    ...
    protected Vec3fTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Vec3fTypeCode.VALUE,Vec3f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Vec3fTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Vec3fTypeCode.VALUE,Vec3f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
