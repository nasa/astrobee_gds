...
public class OptionSetValue   implements Copyable, Serializable{

    public int index= 0;
    public rapid.String32Sequence16 options = (rapid.String32Sequence16)rapid.String32Sequence16.create();

    public OptionSetValue() {

    }
    public OptionSetValue (OptionSetValue other) {
    ...
    public boolean equals(Object o) {
        ...
        OptionSetValue otherObj = (OptionSetValue)o;

        if(index != otherObj.index) {
            return false;
        }
        if(!options.equals(otherObj.options)) {
            return false;
        }
    ...
    * This method could be placed into <code>OptionSetValueTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        OptionSetValue typedSrc = (OptionSetValue) src;
        OptionSetValue typedDst = this;

        typedDst.index = typedSrc.index;
        typedDst.options = (rapid.String32Sequence16) typedDst.options.copy_from(typedSrc.options);
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append("index: ").append(index).append("\n");  
        strBuffer.append(options.toString("options ", indent+1));
