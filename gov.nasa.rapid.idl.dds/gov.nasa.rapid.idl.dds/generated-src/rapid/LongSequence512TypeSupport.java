...
public class LongSequence512TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence512";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence512TypeSupport _singleton
    = new LongSequence512TypeSupport();
    ...
    */
    public static LongSequence512TypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence512TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence512TypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence512.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence512</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence512 typedDst = (LongSequence512) destination;
        LongSequence512 typedSrc = (LongSequence512) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 512);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence512 typedSrc = (LongSequence512) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,512);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence512 typedDst = (LongSequence512) dst;
            src.readIntSequence(typedDst.userData, 512);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence512 typedDst = (LongSequence512) sample;
    ...
    protected LongSequence512TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence512TypeCode.VALUE,LongSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence512TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence512TypeCode.VALUE,LongSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
