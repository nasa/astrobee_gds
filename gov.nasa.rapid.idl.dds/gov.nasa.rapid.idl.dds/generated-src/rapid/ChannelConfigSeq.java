...
/**
* A sequence of ChannelConfig instances.
*/
public final class ChannelConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ChannelConfigSeq() {
        super(ChannelConfig.class);
    }

    public ChannelConfigSeq (int initialMaximum) {
        super(ChannelConfig.class, initialMaximum);
    }

    public ChannelConfigSeq (Collection elements) {
        super(ChannelConfig.class, elements);
    }
