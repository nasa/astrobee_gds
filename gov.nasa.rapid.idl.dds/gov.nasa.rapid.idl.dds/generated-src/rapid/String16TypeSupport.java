...
public class String16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String16TypeSupport _singleton
    = new String16TypeSupport();
    ...
    */
    public static String16TypeSupport get_instance() {
        return _singleton;
    }

    public static String16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String16TypeCode.VALUE;
    }

    public Object create_data() {
        return String16.create();
    }
    ...
    * <code>this</code> is not a <code>String16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String16 typedDst = (String16) destination;
        String16 typedSrc = (String16) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String16 typedSrc = (String16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,16);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String16 typedDst = (String16) dst;
            typedDst.userData = src.readString(16);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String16 typedDst = (String16) sample;
    ...
    protected String16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String16TypeCode.VALUE,String16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String16TypeCode.VALUE,String16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
