...
public class MacroCommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroCommand";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroCommandTypeSupport _singleton
    = new MacroCommandTypeSupport();
    ...
    */
    public static MacroCommandTypeSupport get_instance() {
        return _singleton;
    }

    public static MacroCommandTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroCommandTypeCode.VALUE;
    }

    public Object create_data() {
        return MacroCommand.create();
    }
    ...
    * <code>this</code> is not a <code>MacroCommand</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroCommand typedDst = (MacroCommand) destination;
        MacroCommand typedSrc = (MacroCommand) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroCommand typedSrc = (MacroCommand) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.cmdName );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.cmdIdSuffix );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.subsysName );
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.arguments);
        currentAlignment += rapid.ParameterSequence16TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.cmdName,64);

            dst.writeString(typedSrc.cmdIdSuffix,64);

            dst.writeString(typedSrc.subsysName,32);

            rapid.ParameterSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.arguments, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ParameterSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.metaData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroCommand typedDst = (MacroCommand) dst;
            typedDst.clear();      
            try{
                typedDst.cmdName = src.readString(64);
                typedDst.cmdIdSuffix = src.readString(64);
                typedDst.subsysName = src.readString(32);
                typedDst.arguments = (rapid.ParameterSequence16)rapid.ParameterSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.arguments, src, false, true, endpoint_plugin_qos);     
                typedDst.metaData = (rapid.ParameterSequence16)rapid.ParameterSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.metaData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ParameterSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroCommand typedDst = (MacroCommand) sample;
    ...
    int mask) {
        return new MacroCommandDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MacroCommandDataReader(native_reader, listener, mask, this);   
    ...
    protected MacroCommandTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MacroCommandTypeCode.VALUE,MacroCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroCommandTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroCommandTypeCode.VALUE,MacroCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
