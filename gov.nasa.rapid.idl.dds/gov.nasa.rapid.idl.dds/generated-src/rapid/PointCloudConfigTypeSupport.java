...
public class PointCloudConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointCloudConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointCloudConfigTypeSupport _singleton
    = new PointCloudConfigTypeSupport();
    ...
    */
    public static PointCloudConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static PointCloudConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointCloudConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return PointCloudConfig.create();
    }
    ...
    * <code>this</code> is not a <code>PointCloudConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PointCloudConfig typedDst = (PointCloudConfig) destination;
        PointCloudConfig typedSrc = (PointCloudConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.PointSampleXyzModeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.PointSampleAttributeModeTypeSupport.get_instance().get_array_max_size_serialized(endpoint_data, currentAlignment,  (2));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.PointSampleXyzModeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.PointSampleAttributeModeTypeSupport.get_instance().get_array_max_size_serialized(endpoint_data, currentAlignment,  (2));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PointCloudConfig typedSrc = (PointCloudConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.PointSampleXyzModeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.xyzMode);
        for(int i1__ = 0; i1__< 2; ++i1__){

            currentAlignment += rapid.PointSampleAttributeModeTypeSupport.get_instance().get_serialized_sample_size(
                endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.attributesMode[i1__]);
        }

        currentAlignment += rapid.KeyTypeValueSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.attributes);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.PointSampleXyzModeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.xyzMode, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            for(int i1__ = 0; i1__< 2; ++i1__){

                rapid.PointSampleAttributeModeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.attributesMode[i1__], dst, false, encapsulation_id,true,endpoint_plugin_qos);
            }

            rapid.KeyTypeValueSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.attributes, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PointCloudConfig typedDst = (PointCloudConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.xyzMode = (rapid.PointSampleXyzMode)rapid.PointSampleXyzModeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.xyzMode, src, false, true, endpoint_plugin_qos);     
                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.attributesMode[i1__] = (rapid.PointSampleAttributeMode)rapid.PointSampleAttributeModeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.attributesMode[i1__], src, false, true, endpoint_plugin_qos);     
                }

                typedDst.attributes = (rapid.KeyTypeValueSequence16)rapid.KeyTypeValueSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.attributes, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.PointSampleXyzModeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            for(int i1__ = 0; i1__< 2; ++i1__){

                rapid.PointSampleAttributeModeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PointCloudConfig typedDst = (PointCloudConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PointCloudConfig typedDst
        = (PointCloudConfig) instance;
        PointCloudConfig typedSrc
        = (PointCloudConfig) key;
    ...
    */
    ...
    int mask) {
        return new PointCloudConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PointCloudConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected PointCloudConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PointCloudConfigTypeCode.VALUE,PointCloudConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PointCloudConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PointCloudConfigTypeCode.VALUE,PointCloudConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
