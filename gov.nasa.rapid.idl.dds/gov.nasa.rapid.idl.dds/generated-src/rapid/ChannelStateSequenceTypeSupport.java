...
public class ChannelStateSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ChannelStateSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelStateSequenceTypeSupport _singleton
    = new ChannelStateSequenceTypeSupport();
    ...
    */
    public static ChannelStateSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelStateSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelStateSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ChannelStateSequence.create();
    }
    ...
    public Object create_key() {
        return new ChannelStateSequence();
    }
    ...
    public Class get_type() {
        return ChannelStateSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ChannelStateSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ChannelStateSequence typedDst = (ChannelStateSequence) destination;
        ChannelStateSequence typedSrc = (ChannelStateSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelStateTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 100);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelStateTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ChannelStateSequence typedSrc = (ChannelStateSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ChannelStateTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ChannelStateTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,100, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ChannelStateSequence typedDst = (ChannelStateSequence) dst;
            rapid.ChannelStateTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 100, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ChannelStateTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ChannelStateSequence typedDst = (ChannelStateSequence) sample;
    ...
    protected ChannelStateSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelStateSequenceTypeCode.VALUE,ChannelStateSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ChannelStateSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ChannelStateSequenceTypeCode.VALUE,ChannelStateSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
