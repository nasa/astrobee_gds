...
public class MessageTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::Message";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.HeaderTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.HeaderTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += rapid.HeaderTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.hdr);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += rapid.HeaderTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.HeaderTypeSupport.get_instance().serialize(endpoint_data, typedSrc.hdr, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            rapid.HeaderTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.hdr, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.hdr = (rapid.Header)rapid.HeaderTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.hdr, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_key) {
            ...
            typedDst.hdr = (rapid.Header)rapid.HeaderTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.hdr, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.HeaderTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            typedDst.hdr = (rapid.Header)rapid.HeaderTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.hdr, src, false, true, endpoint_plugin_qos);     
    ...
    */
    ...
    protected MessageTypeSupport() {
        ...
        super(TYPE_NAME,true,MessageTypeCode.VALUE,Message.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
