...
/**
* A sequence of NFSeqSequence32 instances.
*/
public final class NFSeqSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public NFSeqSequence32Seq() {
        super(NFSeqSequence32.class);
    }

    public NFSeqSequence32Seq (int initialMaximum) {
        super(NFSeqSequence32.class, initialMaximum);
    }

    public NFSeqSequence32Seq (Collection elements) {
        super(NFSeqSequence32.class, elements);
    }
