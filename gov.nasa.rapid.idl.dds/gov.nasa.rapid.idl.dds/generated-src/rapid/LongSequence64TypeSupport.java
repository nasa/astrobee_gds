...
public class LongSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence64TypeSupport _singleton
    = new LongSequence64TypeSupport();
    ...
    */
    public static LongSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence64.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence64 typedDst = (LongSequence64) destination;
        LongSequence64 typedSrc = (LongSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence64 typedSrc = (LongSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence64 typedDst = (LongSequence64) dst;
            src.readIntSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence64 typedDst = (LongSequence64) sample;
    ...
    protected LongSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence64TypeCode.VALUE,LongSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence64TypeCode.VALUE,LongSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
