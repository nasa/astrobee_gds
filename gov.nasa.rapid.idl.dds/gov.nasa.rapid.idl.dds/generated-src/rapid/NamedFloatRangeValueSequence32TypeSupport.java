...
public class NamedFloatRangeValueSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedFloatRangeValueSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedFloatRangeValueSequence32TypeSupport _singleton
    = new NamedFloatRangeValueSequence32TypeSupport();
    ...
    */
    public static NamedFloatRangeValueSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static NamedFloatRangeValueSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedFloatRangeValueSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return NamedFloatRangeValueSequence32.create();
    }
    ...
    public Object create_key() {
        return new NamedFloatRangeValueSequence32();
    }
    ...
    public Class get_type() {
        return NamedFloatRangeValueSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>NamedFloatRangeValueSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedFloatRangeValueSequence32 typedDst = (NamedFloatRangeValueSequence32) destination;
        NamedFloatRangeValueSequence32 typedSrc = (NamedFloatRangeValueSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedFloatRangeValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedFloatRangeValueSequence32 typedSrc = (NamedFloatRangeValueSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedFloatRangeValueTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedFloatRangeValueSequence32 typedDst = (NamedFloatRangeValueSequence32) dst;
            rapid.NamedFloatRangeValueTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedFloatRangeValueSequence32 typedDst = (NamedFloatRangeValueSequence32) sample;
    ...
    protected NamedFloatRangeValueSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedFloatRangeValueSequence32TypeCode.VALUE,NamedFloatRangeValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedFloatRangeValueSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedFloatRangeValueSequence32TypeCode.VALUE,NamedFloatRangeValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
