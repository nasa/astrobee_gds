...
public class MacroConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroConfigTypeSupport _singleton
    = new MacroConfigTypeSupport();
    ...
    */
    public static MacroConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static MacroConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return MacroConfig.create();
    }
    ...
    * <code>this</code> is not a <code>MacroConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroConfig typedDst = (MacroConfig) destination;
        MacroConfig typedSrc = (MacroConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroCommandSequence128TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += rapid.KeyTypeSequence16TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroCommandSequence128TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += rapid.KeyTypeSequence16TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroConfig typedSrc = (MacroConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.MacroCommandSequence128TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.commands);
        ...
        currentAlignment += rapid.KeyTypeSequence16TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.commandMetaDataSpec);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.name,64);

            rapid.MacroCommandSequence128TypeSupport.get_instance().serialize(endpoint_data, typedSrc.commands, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.KeyTypeValueSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.metaData, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.KeyTypeSequence16TypeSupport.get_instance().serialize(endpoint_data, typedSrc.commandMetaDataSpec, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroConfig typedDst = (MacroConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.name = src.readString(64);
                typedDst.commands = (rapid.MacroCommandSequence128)rapid.MacroCommandSequence128TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.commands, src, false, true, endpoint_plugin_qos);     
                typedDst.metaData = (rapid.KeyTypeValueSequence16)rapid.KeyTypeValueSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.metaData, src, false, true, endpoint_plugin_qos);     
                typedDst.commandMetaDataSpec = (rapid.KeyTypeSequence16)rapid.KeyTypeSequence16TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.commandMetaDataSpec, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.MacroCommandSequence128TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.KeyTypeValueSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.KeyTypeSequence16TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroConfig typedDst = (MacroConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        MacroConfig typedDst
        = (MacroConfig) instance;
        MacroConfig typedSrc
        = (MacroConfig) key;
    ...
    */
    ...
    int mask) {
        return new MacroConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new MacroConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected MacroConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,MacroConfigTypeCode.VALUE,MacroConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroConfigTypeCode.VALUE,MacroConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
