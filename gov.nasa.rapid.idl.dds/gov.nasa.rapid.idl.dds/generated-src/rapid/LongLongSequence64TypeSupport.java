...
public class LongLongSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongLongSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongLongSequence64TypeSupport _singleton
    = new LongLongSequence64TypeSupport();
    ...
    */
    public static LongLongSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static LongLongSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongLongSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return LongLongSequence64.create();
    }
    ...
    public Class get_type() {
        return LongLongSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>LongLongSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongLongSequence64 typedDst = (LongLongSequence64) destination;
        LongLongSequence64 typedSrc = (LongLongSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getSequenceMaxSizeSerialized(currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongLongSequence64 typedSrc = (LongLongSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLongSeq(typedSrc.userData,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongLongSequence64 typedDst = (LongLongSequence64) dst;
            src.readLongSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongLongSequence64 typedDst = (LongLongSequence64) sample;
    ...
    protected LongLongSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongLongSequence64TypeCode.VALUE,LongLongSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongLongSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongLongSequence64TypeCode.VALUE,LongLongSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
