...
/**
* A sequence of ImageMetadata instances.
*/
public final class ImageMetadataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ImageMetadataSeq() {
        super(ImageMetadata.class);
    }

    public ImageMetadataSeq (int initialMaximum) {
        super(ImageMetadata.class, initialMaximum);
    }

    public ImageMetadataSeq (Collection elements) {
        super(ImageMetadata.class, elements);
    }
