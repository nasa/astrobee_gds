...
public class String1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String1KTypeSupport _singleton
    = new String1KTypeSupport();
    ...
    */
    public static String1KTypeSupport get_instance() {
        return _singleton;
    }

    public static String1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String1KTypeCode.VALUE;
    }

    public Object create_data() {
        return String1K.create();
    }
    ...
    * <code>this</code> is not a <code>String1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String1K typedDst = (String1K) destination;
        String1K typedSrc = (String1K) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String1K typedSrc = (String1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String1K typedDst = (String1K) dst;
            typedDst.userData = src.readString(1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String1K typedDst = (String1K) sample;
    ...
    protected String1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String1KTypeCode.VALUE,String1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String1KTypeCode.VALUE,String1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
