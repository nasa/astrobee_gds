...
/**
* A sequence of FileAnnounce instances.
*/
public final class FileAnnounceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileAnnounceSeq() {
        super(FileAnnounce.class);
    }

    public FileAnnounceSeq (int initialMaximum) {
        super(FileAnnounce.class, initialMaximum);
    }

    public FileAnnounceSeq (Collection elements) {
        super(FileAnnounce.class, elements);
    }
