...
/**
* A sequence of SingleQueue instances.
*/
public final class SingleQueueSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SingleQueueSeq() {
        super(SingleQueue.class);
    }

    public SingleQueueSeq (int initialMaximum) {
        super(SingleQueue.class, initialMaximum);
    }

    public SingleQueueSeq (Collection elements) {
        super(SingleQueue.class, elements);
    }
