...
/**
* A sequence of FloatSequence32 instances.
*/
public final class FloatSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence32Seq() {
        super(FloatSequence32.class);
    }

    public FloatSequence32Seq (int initialMaximum) {
        super(FloatSequence32.class, initialMaximum);
    }

    public FloatSequence32Seq (Collection elements) {
        super(FloatSequence32.class, elements);
    }
