...
public class DoubleSequence256TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence256";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence256TypeSupport _singleton
    = new DoubleSequence256TypeSupport();
    ...
    */
    public static DoubleSequence256TypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence256TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence256TypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence256.create();
    }
    ...
    public Class get_type() {
        return DoubleSequence256.class;
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence256</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence256 typedDst = (DoubleSequence256) destination;
        DoubleSequence256 typedSrc = (DoubleSequence256) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence256 typedSrc = (DoubleSequence256) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence256 typedDst = (DoubleSequence256) dst;
            src.readDoubleSequence(typedDst.userData, 256);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence256 typedDst = (DoubleSequence256) sample;
    ...
    protected DoubleSequence256TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence256TypeCode.VALUE,DoubleSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence256TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence256TypeCode.VALUE,DoubleSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
