...
public class ShortSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence128TypeSupport _singleton
    = new ShortSequence128TypeSupport();
    ...
    */
    public static ShortSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence128.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence128 typedDst = (ShortSequence128) destination;
        ShortSequence128 typedSrc = (ShortSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence128 typedSrc = (ShortSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence128 typedDst = (ShortSequence128) dst;
            src.readShortSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence128 typedDst = (ShortSequence128) sample;
    ...
    protected ShortSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence128TypeCode.VALUE,ShortSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence128TypeCode.VALUE,ShortSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
