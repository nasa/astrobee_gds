...
/**
* A sequence of ShortSequence128 instances.
*/
public final class ShortSequence128Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence128Seq() {
        super(ShortSequence128.class);
    }

    public ShortSequence128Seq (int initialMaximum) {
        super(ShortSequence128.class, initialMaximum);
    }

    public ShortSequence128Seq (Collection elements) {
        super(ShortSequence128.class, elements);
    }
