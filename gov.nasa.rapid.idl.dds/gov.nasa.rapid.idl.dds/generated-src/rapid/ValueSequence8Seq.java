...
/**
* A sequence of ValueSequence8 instances.
*/
public final class ValueSequence8Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ValueSequence8Seq() {
        super(ValueSequence8.class);
    }

    public ValueSequence8Seq (int initialMaximum) {
        super(ValueSequence8.class, initialMaximum);
    }

    public ValueSequence8Seq (Collection elements) {
        super(ValueSequence8.class, elements);
    }
