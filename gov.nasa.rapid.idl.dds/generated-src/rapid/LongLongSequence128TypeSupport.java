...
public class LongLongSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongLongSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongLongSequence128TypeSupport _singleton
    = new LongLongSequence128TypeSupport();
    ...
    */
    public static LongLongSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static LongLongSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongLongSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return LongLongSequence128.create();
    }
    ...
    public Object create_key() {
        return new LongLongSequence128();
    }
    ...
    public Class get_type() {
        return LongLongSequence128.class;
    }
    ...
    * <code>this</code> is not a <code>LongLongSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongLongSequence128 typedDst = (LongLongSequence128) destination;
        LongLongSequence128 typedSrc = (LongLongSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getSequenceMaxSizeSerialized(currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getSequenceMaxSizeSerialized(currentAlignment,  0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongLongSequence128 typedSrc = (LongLongSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.LONG.getSequenceSerializedSize(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLongSeq(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongLongSequence128 typedDst = (LongLongSequence128) dst;
            src.readLongSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongLongSequence128 typedDst = (LongLongSequence128) sample;
    ...
    protected LongLongSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongLongSequence128TypeCode.VALUE,LongLongSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongLongSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongLongSequence128TypeCode.VALUE,LongLongSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
