...
public class KeyTypePairTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypePair";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypePairTypeSupport _singleton
    = new KeyTypePairTypeSupport();
    ...
    */
    public static KeyTypePairTypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypePairTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypePairTypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypePair.create();
    }
    ...
    * <code>this</code> is not a <code>KeyTypePair</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypePair typedDst = (KeyTypePair) destination;
        KeyTypePair typedSrc = (KeyTypePair) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypePair typedSrc = (KeyTypePair) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.DataTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypePair typedDst = (KeyTypePair) dst;
            typedDst.clear();      
            try{
                typedDst.key = src.readString(32);
                typedDst.type = (rapid.DataType)rapid.DataTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.DataTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypePair typedDst = (KeyTypePair) sample;
    ...
    int mask) {
        return new KeyTypePairDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new KeyTypePairDataReader(native_reader, listener, mask, this);   
    ...
    protected KeyTypePairTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypePairTypeCode.VALUE,KeyTypePair.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypePairTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypePairTypeCode.VALUE,KeyTypePair.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
