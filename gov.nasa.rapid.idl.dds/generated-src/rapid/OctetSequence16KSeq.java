...
/**
* A sequence of OctetSequence16K instances.
*/
public final class OctetSequence16KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence16KSeq() {
        super(OctetSequence16K.class);
    }

    public OctetSequence16KSeq (int initialMaximum) {
        super(OctetSequence16K.class, initialMaximum);
    }

    public OctetSequence16KSeq (Collection elements) {
        super(OctetSequence16K.class, elements);
    }
