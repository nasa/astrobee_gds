...
/**
* A sequence of MacroState instances.
*/
public final class MacroStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MacroStateSeq() {
        super(MacroState.class);
    }

    public MacroStateSeq (int initialMaximum) {
        super(MacroState.class, initialMaximum);
    }

    public MacroStateSeq (Collection elements) {
        super(MacroState.class, elements);
    }
