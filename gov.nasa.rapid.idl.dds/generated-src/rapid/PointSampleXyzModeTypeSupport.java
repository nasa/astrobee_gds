...
public class PointSampleXyzModeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointSampleXyzMode";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointSampleXyzModeTypeSupport _singleton
    = new PointSampleXyzModeTypeSupport();
    ...
    */
    public static PointSampleXyzModeTypeSupport get_instance() {
        return _singleton;
    }

    public static PointSampleXyzModeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointSampleXyzModeTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return PointSampleXyzMode.class;
    }
    ...
    * <code>this</code> is not a <code>PointSampleXyzMode</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PointSampleXyzMode typedSrc = (PointSampleXyzMode) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PointSampleXyzMode.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PointSampleXyzModeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PointSampleXyzModeTypeCode.VALUE,PointSampleXyzMode.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
