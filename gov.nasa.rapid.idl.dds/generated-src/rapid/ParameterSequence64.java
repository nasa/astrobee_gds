...
public class ParameterSequence64   implements Copyable, Serializable{

    public rapid.ParameterUnionSeq userData =  new rapid.ParameterUnionSeq(64);

    public ParameterSequence64() {

    }
    public ParameterSequence64 (ParameterSequence64 other) {
    ...
    public boolean equals(Object o) {
        ...
        ParameterSequence64 otherObj = (ParameterSequence64)o;
    ...
    * This method could be placed into <code>ParameterSequence64TypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        ParameterSequence64 typedSrc = (ParameterSequence64) src;
        ParameterSequence64 typedDst = this;
    ...
    public String toString(String desc, int indent) {
        ...
        for(int i__ = 0; i__ < userData.size(); ++i__) {
            strBuffer.append(((rapid.ParameterUnion)userData.get(i__)).toString(Integer.toString(i__),indent+2));
        }
