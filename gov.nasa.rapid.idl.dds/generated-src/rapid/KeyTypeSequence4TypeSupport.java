...
public class KeyTypeSequence4TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeSequence4";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeSequence4TypeSupport _singleton
    = new KeyTypeSequence4TypeSupport();
    ...
    */
    public static KeyTypeSequence4TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeSequence4TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeSequence4TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeSequence4.create();
    }
    ...
    * <code>this</code> is not a <code>KeyTypeSequence4</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeSequence4 typedDst = (KeyTypeSequence4) destination;
        KeyTypeSequence4 typedSrc = (KeyTypeSequence4) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypePairTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeSequence4 typedSrc = (KeyTypeSequence4) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypePairTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,4, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeSequence4 typedDst = (KeyTypeSequence4) dst;
            rapid.KeyTypePairTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 4, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeSequence4 typedDst = (KeyTypeSequence4) sample;
    ...
    protected KeyTypeSequence4TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeSequence4TypeCode.VALUE,KeyTypeSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeSequence4TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeSequence4TypeCode.VALUE,KeyTypeSequence4.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
