...
public class FileQueueSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileQueueSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileQueueSampleTypeSupport _singleton
    = new FileQueueSampleTypeSupport();
    ...
    */
    public static FileQueueSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static FileQueueSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileQueueSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return FileQueueSample.create();
    }
    ...
    * <code>this</code> is not a <code>FileQueueSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileQueueSample typedDst = (FileQueueSample) destination;
        FileQueueSample typedSrc = (FileQueueSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.OctetSequence1KTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.OctetSequence1KTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileQueueSample typedSrc = (FileQueueSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.OctetSequence1KTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.chunkData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.chunkId);

            dst.writeInt(typedSrc.numChunks);

            rapid.OctetSequence1KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.chunkData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileQueueSample typedDst = (FileQueueSample) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.chunkId = src.readInt();
                typedDst.numChunks = src.readInt();
                typedDst.chunkData = (rapid.OctetSequence1K)rapid.OctetSequence1KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.chunkData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.OctetSequence1KTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileQueueSample typedDst = (FileQueueSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileQueueSample typedDst
        = (FileQueueSample) instance;
        FileQueueSample typedSrc
        = (FileQueueSample) key;
    ...
    */
    ...
    int mask) {
        return new FileQueueSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileQueueSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected FileQueueSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileQueueSampleTypeCode.VALUE,FileQueueSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileQueueSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileQueueSampleTypeCode.VALUE,FileQueueSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
