...
public class ImageSensorSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ImageSensorSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ImageSensorSampleTypeSupport _singleton
    = new ImageSensorSampleTypeSupport();
    ...
    */
    public static ImageSensorSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static ImageSensorSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ImageSensorSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return ImageSensorSample.create();
    }
    ...
    public Class get_type() {
        return ImageSensorSample.class;
    }
    ...
    * <code>this</code> is not a <code>ImageSensorSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ImageSensorSample typedDst = (ImageSensorSample) destination;
        ImageSensorSample typedSrc = (ImageSensorSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ImageMetadataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (32)+1);
        currentAlignment += rapid.ImageDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ImageMetadataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += rapid.ImageDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ImageSensorSample typedSrc = (ImageSensorSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ImageMetadataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.meta);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.mimeType );
        currentAlignment += rapid.ImageDataTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ImageMetadataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.meta, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.mimeType,32);

            rapid.ImageDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.data, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ImageSensorSample typedDst = (ImageSensorSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.meta = (rapid.ImageMetadata)rapid.ImageMetadataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.meta, src, false, true, endpoint_plugin_qos);     
                typedDst.mimeType = src.readString(32);
                typedDst.data = (rapid.ImageData)rapid.ImageDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.data, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ImageMetadataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            src.skipString();

            rapid.ImageDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ImageSensorSample typedDst = (ImageSensorSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ImageSensorSample typedDst
        = (ImageSensorSample) instance;
        ImageSensorSample typedSrc
        = (ImageSensorSample) key;
    ...
    */
    ...
    int mask) {
        return new ImageSensorSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ImageSensorSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected ImageSensorSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ImageSensorSampleTypeCode.VALUE,ImageSensorSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ImageSensorSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ImageSensorSampleTypeCode.VALUE,ImageSensorSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
