...
/**
* A sequence of QueueAction instances.
*/
public final class QueueActionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public QueueActionSeq() {
        super(QueueAction.class);
    }

    public QueueActionSeq (int initialMaximum) {
        super(QueueAction.class, initialMaximum);
    }

    public QueueActionSeq (Collection elements) {
        super(QueueAction.class, elements);
    }
