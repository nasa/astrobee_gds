...
public class SubsystemTypeSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::SubsystemTypeSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubsystemTypeSequenceTypeSupport _singleton
    = new SubsystemTypeSequenceTypeSupport();
    ...
    */
    public static SubsystemTypeSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static SubsystemTypeSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubsystemTypeSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return SubsystemTypeSequence.create();
    }
    ...
    public Object create_key() {
        return new SubsystemTypeSequence();
    }
    ...
    public Class get_type() {
        return SubsystemTypeSequence.class;
    }
    ...
    * <code>this</code> is not a <code>SubsystemTypeSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubsystemTypeSequence typedDst = (SubsystemTypeSequence) destination;
        SubsystemTypeSequence typedSrc = (SubsystemTypeSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SubsystemTypeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SubsystemTypeTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubsystemTypeSequence typedSrc = (SubsystemTypeSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.SubsystemTypeTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.SubsystemTypeTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubsystemTypeSequence typedDst = (SubsystemTypeSequence) dst;
            rapid.SubsystemTypeTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.SubsystemTypeTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubsystemTypeSequence typedDst = (SubsystemTypeSequence) sample;
    ...
    protected SubsystemTypeSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubsystemTypeSequenceTypeCode.VALUE,SubsystemTypeSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubsystemTypeSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubsystemTypeSequenceTypeCode.VALUE,SubsystemTypeSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
