...
public class NFSeqSequence32   implements Copyable, Serializable{

    public rapid.NamedFloatSequenceSeq userData =  new rapid.NamedFloatSequenceSeq(32);

    public NFSeqSequence32() {

    }
    public NFSeqSequence32 (NFSeqSequence32 other) {
    ...
    public boolean equals(Object o) {
        ...
        NFSeqSequence32 otherObj = (NFSeqSequence32)o;
    ...
    * This method could be placed into <code>NFSeqSequence32TypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        NFSeqSequence32 typedSrc = (NFSeqSequence32) src;
        NFSeqSequence32 typedDst = this;
    ...
    public String toString(String desc, int indent) {
        ...
        for(int i__ = 0; i__ < userData.size(); ++i__) {
            strBuffer.append(((rapid.NamedFloatSequence)userData.get(i__)).toString(Integer.toString(i__),indent+2));
        }
