...
public class FloatSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence128TypeSupport _singleton
    = new FloatSequence128TypeSupport();
    ...
    */
    public static FloatSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence128.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence128 typedDst = (FloatSequence128) destination;
        FloatSequence128 typedSrc = (FloatSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence128 typedSrc = (FloatSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence128 typedDst = (FloatSequence128) dst;
            src.readFloatSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence128 typedDst = (FloatSequence128) sample;
    ...
    protected FloatSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence128TypeCode.VALUE,FloatSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence128TypeCode.VALUE,FloatSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
