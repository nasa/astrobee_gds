...
/**
* A sequence of LongSequence1K instances.
*/
public final class LongSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence1KSeq() {
        super(LongSequence1K.class);
    }

    public LongSequence1KSeq (int initialMaximum) {
        super(LongSequence1K.class, initialMaximum);
    }

    public LongSequence1KSeq (Collection elements) {
        super(LongSequence1K.class, elements);
    }
