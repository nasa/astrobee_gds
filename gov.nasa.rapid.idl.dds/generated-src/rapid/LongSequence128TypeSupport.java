...
public class LongSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence128TypeSupport _singleton
    = new LongSequence128TypeSupport();
    ...
    */
    public static LongSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence128.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence128 typedDst = (LongSequence128) destination;
        LongSequence128 typedSrc = (LongSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence128 typedSrc = (LongSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence128 typedDst = (LongSequence128) dst;
            src.readIntSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence128 typedDst = (LongSequence128) sample;
    ...
    protected LongSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence128TypeCode.VALUE,LongSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence128TypeCode.VALUE,LongSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
