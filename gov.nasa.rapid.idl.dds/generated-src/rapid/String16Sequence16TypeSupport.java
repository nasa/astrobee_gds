...
public class String16Sequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String16Sequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String16Sequence16TypeSupport _singleton
    = new String16Sequence16TypeSupport();
    ...
    */
    public static String16Sequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static String16Sequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String16Sequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return String16Sequence16.create();
    }
    ...
    public Class get_type() {
        return String16Sequence16.class;
    }
    ...
    * <code>this</code> is not a <code>String16Sequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String16Sequence16 typedDst = (String16Sequence16) destination;
        String16Sequence16 typedSrc = (String16Sequence16) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String16Sequence16 typedSrc = (String16Sequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(16),16);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String16Sequence16 typedDst = (String16Sequence16) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String16Sequence16 typedDst = (String16Sequence16) sample;
    ...
    protected String16Sequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String16Sequence16TypeCode.VALUE,String16Sequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String16Sequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String16Sequence16TypeCode.VALUE,String16Sequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
