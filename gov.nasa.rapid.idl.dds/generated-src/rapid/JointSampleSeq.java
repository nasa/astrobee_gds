...
/**
* A sequence of JointSample instances.
*/
public final class JointSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointSampleSeq() {
        super(JointSample.class);
    }

    public JointSampleSeq (int initialMaximum) {
        super(JointSample.class, initialMaximum);
    }

    public JointSampleSeq (Collection elements) {
        super(JointSample.class, elements);
    }
