...
public class String32Sequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String32Sequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String32Sequence32TypeSupport _singleton
    = new String32Sequence32TypeSupport();
    ...
    */
    public static String32Sequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static String32Sequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String32Sequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return String32Sequence32.create();
    }
    ...
    public Class get_type() {
        return String32Sequence32.class;
    }
    ...
    * <code>this</code> is not a <code>String32Sequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String32Sequence32 typedDst = (String32Sequence32) destination;
        String32Sequence32 typedSrc = (String32Sequence32) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String32Sequence32 typedSrc = (String32Sequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(32),32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String32Sequence32 typedDst = (String32Sequence32) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String32Sequence32 typedDst = (String32Sequence32) sample;
    ...
    protected String32Sequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String32Sequence32TypeCode.VALUE,String32Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String32Sequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String32Sequence32TypeCode.VALUE,String32Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
