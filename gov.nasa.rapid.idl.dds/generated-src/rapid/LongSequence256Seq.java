...
/**
* A sequence of LongSequence256 instances.
*/
public final class LongSequence256Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence256Seq() {
        super(LongSequence256.class);
    }

    public LongSequence256Seq (int initialMaximum) {
        super(LongSequence256.class, initialMaximum);
    }

    public LongSequence256Seq (Collection elements) {
        super(LongSequence256.class, elements);
    }
