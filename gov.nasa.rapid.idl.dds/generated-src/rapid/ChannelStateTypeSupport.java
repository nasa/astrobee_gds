...
public class ChannelStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ChannelState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelStateTypeSupport _singleton
    = new ChannelStateTypeSupport();
    ...
    */
    public static ChannelStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelStateTypeCode.VALUE;
    }

    public Object create_data() {
        return ChannelState.create();
    }
    ...
    * <code>this</code> is not a <code>ChannelState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ChannelState typedDst = (ChannelState) destination;
        ChannelState typedSrc = (ChannelState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.SHORT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ChannelState typedSrc = (ChannelState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ChannelStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ChannelStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeLong(typedSrc.queuedDataVolume);

            dst.writeShort(typedSrc.queuedFiles);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ChannelState typedDst = (ChannelState) dst;
            typedDst.clear();      
            try{
                typedDst.status = (rapid.ChannelStatus)rapid.ChannelStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                typedDst.queuedDataVolume = src.readLong();
                typedDst.queuedFiles = src.readShort();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ChannelStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ChannelState typedDst = (ChannelState) sample;
    ...
    int mask) {
        return new ChannelStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ChannelStateDataReader(native_reader, listener, mask, this);   
    ...
    protected ChannelStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelStateTypeCode.VALUE,ChannelState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ChannelStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ChannelStateTypeCode.VALUE,ChannelState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
