...
public class ValueSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ValueSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ValueSequence128TypeSupport _singleton
    = new ValueSequence128TypeSupport();
    ...
    */
    public static ValueSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static ValueSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ValueSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return ValueSequence128.create();
    }
    ...
    * <code>this</code> is not a <code>ValueSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ValueSequence128 typedDst = (ValueSequence128) destination;
        ValueSequence128 typedSrc = (ValueSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ValueSequence128 typedSrc = (ValueSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,128, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ValueSequence128 typedDst = (ValueSequence128) dst;
            rapid.ParameterUnionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 128, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ValueSequence128 typedDst = (ValueSequence128) sample;
    ...
    protected ValueSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValueSequence128TypeCode.VALUE,ValueSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ValueSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ValueSequence128TypeCode.VALUE,ValueSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
