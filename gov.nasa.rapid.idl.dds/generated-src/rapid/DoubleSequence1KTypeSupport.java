...
public class DoubleSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence1KTypeSupport _singleton
    = new DoubleSequence1KTypeSupport();
    ...
    */
    public static DoubleSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence1K typedDst = (DoubleSequence1K) destination;
        DoubleSequence1K typedSrc = (DoubleSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence1K typedSrc = (DoubleSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence1K typedDst = (DoubleSequence1K) dst;
            src.readDoubleSequence(typedDst.userData, 1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence1K typedDst = (DoubleSequence1K) sample;
    ...
    protected DoubleSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence1KTypeCode.VALUE,DoubleSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence1KTypeCode.VALUE,DoubleSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
