...
/**
* A sequence of AgentConfig instances.
*/
public final class AgentConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AgentConfigSeq() {
        super(AgentConfig.class);
    }

    public AgentConfigSeq (int initialMaximum) {
        super(AgentConfig.class, initialMaximum);
    }

    public AgentConfigSeq (Collection elements) {
        super(AgentConfig.class, elements);
    }
