...
public class NamedOptionSetValueSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedOptionSetValueSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedOptionSetValueSequence32TypeSupport _singleton
    = new NamedOptionSetValueSequence32TypeSupport();
    ...
    */
    public static NamedOptionSetValueSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static NamedOptionSetValueSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedOptionSetValueSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return NamedOptionSetValueSequence32.create();
    }
    ...
    public Object create_key() {
        return new NamedOptionSetValueSequence32();
    }
    ...
    public Class get_type() {
        return NamedOptionSetValueSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>NamedOptionSetValueSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedOptionSetValueSequence32 typedDst = (NamedOptionSetValueSequence32) destination;
        NamedOptionSetValueSequence32 typedSrc = (NamedOptionSetValueSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedOptionSetValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedOptionSetValueSequence32 typedSrc = (NamedOptionSetValueSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedOptionSetValueTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedOptionSetValueSequence32 typedDst = (NamedOptionSetValueSequence32) dst;
            rapid.NamedOptionSetValueTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedOptionSetValueSequence32 typedDst = (NamedOptionSetValueSequence32) sample;
    ...
    protected NamedOptionSetValueSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedOptionSetValueSequence32TypeCode.VALUE,NamedOptionSetValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedOptionSetValueSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedOptionSetValueSequence32TypeCode.VALUE,NamedOptionSetValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
