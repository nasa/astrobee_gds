...
public class FileQueueStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileQueueState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileQueueStateTypeSupport _singleton
    = new FileQueueStateTypeSupport();
    ...
    */
    public static FileQueueStateTypeSupport get_instance() {
        return _singleton;
    }

    public static FileQueueStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileQueueStateTypeCode.VALUE;
    }

    public Object create_data() {
        return FileQueueState.create();
    }
    ...
    * <code>this</code> is not a <code>FileQueueState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileQueueState typedDst = (FileQueueState) destination;
        FileQueueState typedSrc = (FileQueueState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ChannelStateSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ChannelStateSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileQueueState typedSrc = (FileQueueState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ChannelStateSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.channels);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.connected);

            dst.writeInt(typedSrc.bandwidth);

            dst.writeInt(typedSrc.prefetchBandwidth);

            rapid.ChannelStateSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.channels, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileQueueState typedDst = (FileQueueState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.connected = src.readBoolean();
                typedDst.bandwidth = src.readInt();
                typedDst.prefetchBandwidth = src.readInt();
                typedDst.channels = (rapid.ChannelStateSequence)rapid.ChannelStateSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.channels, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ChannelStateSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileQueueState typedDst = (FileQueueState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileQueueState typedDst
        = (FileQueueState) instance;
        FileQueueState typedSrc
        = (FileQueueState) key;
    ...
    */
    ...
    int mask) {
        return new FileQueueStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileQueueStateDataReader(native_reader, listener, mask, this);   
    ...
    protected FileQueueStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileQueueStateTypeCode.VALUE,FileQueueState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileQueueStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileQueueStateTypeCode.VALUE,FileQueueState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
