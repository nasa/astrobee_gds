...
public class LongSequence2KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence2K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence2KTypeSupport _singleton
    = new LongSequence2KTypeSupport();
    ...
    */
    public static LongSequence2KTypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence2KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence2KTypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence2K.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence2K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence2K typedDst = (LongSequence2K) destination;
        LongSequence2K typedSrc = (LongSequence2K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 2048);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence2K typedSrc = (LongSequence2K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,2048);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence2K typedDst = (LongSequence2K) dst;
            src.readIntSequence(typedDst.userData, 2048);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence2K typedDst = (LongSequence2K) sample;
    ...
    protected LongSequence2KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence2KTypeCode.VALUE,LongSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence2KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence2KTypeCode.VALUE,LongSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
