...
public class ChannelConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ChannelConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelConfigTypeSupport _singleton
    = new ChannelConfigTypeSupport();
    ...
    */
    public static ChannelConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ChannelConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ChannelConfig typedDst = (ChannelConfig) destination;
        ChannelConfig typedSrc = (ChannelConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ChannelConfig typedSrc = (ChannelConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShort(typedSrc.numTokens);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ChannelConfig typedDst = (ChannelConfig) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.numTokens = src.readShort();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ChannelConfig typedDst = (ChannelConfig) sample;
    ...
    int mask) {
        return new ChannelConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ChannelConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ChannelConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelConfigTypeCode.VALUE,ChannelConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ChannelConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ChannelConfigTypeCode.VALUE,ChannelConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
