...
/**
* A sequence of ChannelStatus instances.
*/
public final class ChannelStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ChannelStatusSeq() {
        super(ChannelStatus.class);
    }

    public ChannelStatusSeq (int initialMaximum) {
        super(ChannelStatus.class, initialMaximum);
    }

    public ChannelStatusSeq (Collection elements) {
        super(ChannelStatus.class, elements);
    }
