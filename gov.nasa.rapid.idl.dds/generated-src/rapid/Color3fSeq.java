...
/**
* A sequence of Color3f instances.
*/
public final class Color3fSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Color3fSeq (int initialMaximum) {
        super(Color3f.class, initialMaximum);
    }

    public Color3fSeq (Collection elements) {
        super(Color3f.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, Color3f.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' Color3f objects (beyond the original size of this object)
