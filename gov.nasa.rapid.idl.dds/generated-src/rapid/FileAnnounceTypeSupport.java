...
public class FileAnnounceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileAnnounce";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileAnnounceTypeSupport _singleton
    = new FileAnnounceTypeSupport();
    ...
    */
    public static FileAnnounceTypeSupport get_instance() {
        return _singleton;
    }

    public static FileAnnounceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileAnnounceTypeCode.VALUE;
    }

    public Object create_data() {
        return FileAnnounce.create();
    }
    ...
    * <code>this</code> is not a <code>FileAnnounce</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileAnnounce typedDst = (FileAnnounce) destination;
        FileAnnounce typedSrc = (FileAnnounce) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileAnnounce typedSrc = (FileAnnounce) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.fileLocator );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.fileLocator,256);

            dst.writeLong(typedSrc.fileSize);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileAnnounce typedDst = (FileAnnounce) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.fileLocator = src.readString(256);
                typedDst.fileSize = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileAnnounce typedDst = (FileAnnounce) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileAnnounce typedDst
        = (FileAnnounce) instance;
        FileAnnounce typedSrc
        = (FileAnnounce) key;
    ...
    */
    ...
    int mask) {
        return new FileAnnounceDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileAnnounceDataReader(native_reader, listener, mask, this);   
    ...
    protected FileAnnounceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileAnnounceTypeCode.VALUE,FileAnnounce.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileAnnounceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileAnnounceTypeCode.VALUE,FileAnnounce.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
