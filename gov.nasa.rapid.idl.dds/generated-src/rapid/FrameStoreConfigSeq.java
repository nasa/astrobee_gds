...
/**
* A sequence of FrameStoreConfig instances.
*/
public final class FrameStoreConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FrameStoreConfigSeq() {
        super(FrameStoreConfig.class);
    }

    public FrameStoreConfigSeq (int initialMaximum) {
        super(FrameStoreConfig.class, initialMaximum);
    }

    public FrameStoreConfigSeq (Collection elements) {
        super(FrameStoreConfig.class, elements);
    }
