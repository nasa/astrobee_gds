...
public class PositionSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PositionSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PositionSampleTypeSupport _singleton
    = new PositionSampleTypeSupport();
    ...
    */
    public static PositionSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static PositionSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PositionSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return PositionSample.create();
    }
    ...
    * <code>this</code> is not a <code>PositionSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PositionSample typedDst = (PositionSample) destination;
        PositionSample typedSrc = (PositionSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ValueSequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ValueSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PositionSample typedSrc = (PositionSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ValueSequence64TypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.velocity, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ValueSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.values, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PositionSample typedDst = (PositionSample) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.velocity = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.velocity, src, false, true, endpoint_plugin_qos);     
                typedDst.values = (rapid.ValueSequence64)rapid.ValueSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.values, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ValueSequence64TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PositionSample typedDst = (PositionSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PositionSample typedDst
        = (PositionSample) instance;
        PositionSample typedSrc
        = (PositionSample) key;
    ...
    */
    ...
    int mask) {
        return new PositionSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PositionSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected PositionSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PositionSampleTypeCode.VALUE,PositionSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PositionSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PositionSampleTypeCode.VALUE,PositionSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
