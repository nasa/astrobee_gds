...
/**
* A sequence of TextMessage instances.
*/
public final class TextMessageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TextMessageSeq() {
        super(TextMessage.class);
    }

    public TextMessageSeq (int initialMaximum) {
        super(TextMessage.class, initialMaximum);
    }

    public TextMessageSeq (Collection elements) {
        super(TextMessage.class, elements);
    }
