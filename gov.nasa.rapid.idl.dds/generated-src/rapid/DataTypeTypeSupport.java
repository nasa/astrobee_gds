...
public class DataTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DataType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataTypeTypeSupport _singleton
    = new DataTypeTypeSupport();
    ...
    */
    public static DataTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static DataTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataTypeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>DataType</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DataType typedSrc = (DataType) src;
    ...
    protected DataTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataTypeTypeCode.VALUE,DataType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
