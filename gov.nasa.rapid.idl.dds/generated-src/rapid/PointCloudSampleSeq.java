...
/**
* A sequence of PointCloudSample instances.
*/
public final class PointCloudSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PointCloudSampleSeq() {
        super(PointCloudSample.class);
    }

    public PointCloudSampleSeq (int initialMaximum) {
        super(PointCloudSample.class, initialMaximum);
    }

    public PointCloudSampleSeq (Collection elements) {
        super(PointCloudSample.class, elements);
    }
