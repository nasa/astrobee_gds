...
/**
* A sequence of StatusType instances.
*/
public final class StatusTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public StatusTypeSeq() {
        super(StatusType.class);
    }

    public StatusTypeSeq (int initialMaximum) {
        super(StatusType.class, initialMaximum);
    }

    public StatusTypeSeq (Collection elements) {
        super(StatusType.class, elements);
    }
