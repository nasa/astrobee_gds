...
/**
* A sequence of Color4f instances.
*/
public final class Color4fSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Color4fSeq (int initialMaximum) {
        super(Color4f.class, initialMaximum);
    }

    public Color4fSeq (Collection elements) {
        super(Color4f.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, Color4f.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' Color4f objects (beyond the original size of this object)
