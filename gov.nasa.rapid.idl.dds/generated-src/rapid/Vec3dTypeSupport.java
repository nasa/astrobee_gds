...
public class Vec3dTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Vec3d";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Vec3dTypeSupport _singleton
    = new Vec3dTypeSupport();
    ...
    */
    public static Vec3dTypeSupport get_instance() {
        return _singleton;
    }

    public static Vec3dTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Vec3dTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Vec3d</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Vec3d typedDst = (Vec3d) destination;
        Vec3d typedSrc = (Vec3d) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (3));
        if (include_encapsulation) {
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeDouble(typedSrc.userData[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Vec3d typedDst = (Vec3d) dst;
            for(int i1__ = 0; i1__< 3; ++i1__){

                typedDst.userData[i1__] = src.readDouble();
            }
    ...
    protected Vec3dTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Vec3dTypeCode.VALUE,Vec3d.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Vec3dTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Vec3dTypeCode.VALUE,Vec3d.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
