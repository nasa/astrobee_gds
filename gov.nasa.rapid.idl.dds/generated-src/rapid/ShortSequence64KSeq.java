...
/**
* A sequence of ShortSequence64K instances.
*/
public final class ShortSequence64KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence64KSeq() {
        super(ShortSequence64K.class);
    }

    public ShortSequence64KSeq (int initialMaximum) {
        super(ShortSequence64K.class, initialMaximum);
    }

    public ShortSequence64KSeq (Collection elements) {
        super(ShortSequence64K.class, elements);
    }
