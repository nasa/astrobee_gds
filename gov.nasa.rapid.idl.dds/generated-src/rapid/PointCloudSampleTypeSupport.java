...
public class PointCloudSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PointCloudSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PointCloudSampleTypeSupport _singleton
    = new PointCloudSampleTypeSupport();
    ...
    */
    public static PointCloudSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static PointCloudSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PointCloudSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return PointCloudSample.create();
    }
    ...
    * <code>this</code> is not a <code>PointCloudSample</code>
    * type.
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.PointSampleSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence128TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.PointSampleSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence128TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PointCloudSample typedSrc = (PointCloudSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.origin);
        currentAlignment += rapid.Vec3dTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.xyzScale);
        currentAlignment += rapid.PointSampleSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.points);
        currentAlignment += rapid.ShortSequence128TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.rowLengths);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.origin, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.Vec3dTypeSupport.get_instance().serialize(endpoint_data, typedSrc.xyzScale, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.PointSampleSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.points, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ShortSequence128TypeSupport.get_instance().serialize(endpoint_data, typedSrc.rowLengths, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PointCloudSample typedDst = (PointCloudSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.origin = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.origin, src, false, true, endpoint_plugin_qos);     
                typedDst.xyzScale = (rapid.Vec3d)rapid.Vec3dTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.xyzScale, src, false, true, endpoint_plugin_qos);     
                typedDst.points = (rapid.PointSampleSequence)rapid.PointSampleSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.points, src, false, true, endpoint_plugin_qos);     
                typedDst.rowLengths = (rapid.ShortSequence128)rapid.ShortSequence128TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rowLengths, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.PointSampleSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ShortSequence128TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PointCloudSample typedDst = (PointCloudSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PointCloudSample typedDst
        = (PointCloudSample) instance;
        PointCloudSample typedSrc
        = (PointCloudSample) key;
    ...
    */
    ...
    int mask) {
        return new PointCloudSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PointCloudSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected PointCloudSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PointCloudSampleTypeCode.VALUE,PointCloudSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PointCloudSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PointCloudSampleTypeCode.VALUE,PointCloudSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
