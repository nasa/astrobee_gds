...
public class ParameterSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ParameterSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ParameterSequence64TypeSupport _singleton
    = new ParameterSequence64TypeSupport();
    ...
    */
    public static ParameterSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static ParameterSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ParameterSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return ParameterSequence64.create();
    }
    ...
    public Object create_key() {
        return new ParameterSequence64();
    }
    ...
    public Class get_type() {
        return ParameterSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>ParameterSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ParameterSequence64 typedDst = (ParameterSequence64) destination;
        ParameterSequence64 typedSrc = (ParameterSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ParameterSequence64 typedSrc = (ParameterSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ParameterSequence64 typedDst = (ParameterSequence64) dst;
            rapid.ParameterUnionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ParameterSequence64 typedDst = (ParameterSequence64) sample;
    ...
    protected ParameterSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ParameterSequence64TypeCode.VALUE,ParameterSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ParameterSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ParameterSequence64TypeCode.VALUE,ParameterSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
