...
public class CommandTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::Command";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.QueueActionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (64)+1);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.QueueActionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.cmdSrc );
        ...
        currentAlignment += rapid.QueueActionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cmdAction);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.targetCmdId );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.cmdSrc,32);
            ...
            rapid.QueueActionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cmdAction, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.targetCmdId,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.cmdSrc = src.readString(32);
                ...
                typedDst.cmdAction = (rapid.QueueAction)rapid.QueueActionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cmdAction, src, false, true, endpoint_plugin_qos);     
                typedDst.targetCmdId = src.readString(64);
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.QueueActionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
    ...
    */
    ...
    protected CommandTypeSupport() {
        ...
        super(TYPE_NAME,true,CommandTypeCode.VALUE,Command.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
