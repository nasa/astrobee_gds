...
/**
* A sequence of Vec2f instances.
*/
public final class Vec2fSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Vec2fSeq (int initialMaximum) {
        super(Vec2f.class, initialMaximum);
    }

    public Vec2fSeq (Collection elements) {
        super(Vec2f.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Vec2f objects (beyond the original size of this object)
