...
/**
* A sequence of FloatSequence64 instances.
*/
public final class FloatSequence64Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence64Seq() {
        super(FloatSequence64.class);
    }

    public FloatSequence64Seq (int initialMaximum) {
        super(FloatSequence64.class, initialMaximum);
    }

    public FloatSequence64Seq (Collection elements) {
        super(FloatSequence64.class, elements);
    }
