...
/**
* A sequence of FloatSequence128 instances.
*/
public final class FloatSequence128Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence128Seq() {
        super(FloatSequence128.class);
    }

    public FloatSequence128Seq (int initialMaximum) {
        super(FloatSequence128.class, initialMaximum);
    }

    public FloatSequence128Seq (Collection elements) {
        super(FloatSequence128.class, elements);
    }
