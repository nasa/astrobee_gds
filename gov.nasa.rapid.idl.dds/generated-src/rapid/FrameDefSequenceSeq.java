...
/**
* A sequence of FrameDefSequence instances.
*/
public final class FrameDefSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FrameDefSequenceSeq() {
        super(FrameDefSequence.class);
    }

    public FrameDefSequenceSeq (int initialMaximum) {
        super(FrameDefSequence.class, initialMaximum);
    }

    public FrameDefSequenceSeq (Collection elements) {
        super(FrameDefSequence.class, elements);
    }
