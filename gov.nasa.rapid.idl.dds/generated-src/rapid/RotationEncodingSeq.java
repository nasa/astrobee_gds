...
/**
* A sequence of RotationEncoding instances.
*/
public final class RotationEncodingSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RotationEncodingSeq() {
        super(RotationEncoding.class);
    }

    public RotationEncodingSeq (int initialMaximum) {
        super(RotationEncoding.class, initialMaximum);
    }

    public RotationEncodingSeq (Collection elements) {
        super(RotationEncoding.class, elements);
    }
