...
/**
* A sequence of Header instances.
*/
public final class HeaderSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HeaderSeq (int initialMaximum) {
        super(Header.class, initialMaximum);
    }

    public HeaderSeq (Collection elements) {
        super(Header.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Header objects (beyond the original size of this object)
