...
public class LongSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence1KTypeSupport _singleton
    = new LongSequence1KTypeSupport();
    ...
    */
    public static LongSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence1K typedDst = (LongSequence1K) destination;
        LongSequence1K typedSrc = (LongSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence1K typedSrc = (LongSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence1K typedDst = (LongSequence1K) dst;
            src.readIntSequence(typedDst.userData, 1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence1K typedDst = (LongSequence1K) sample;
    ...
    protected LongSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence1KTypeCode.VALUE,LongSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence1KTypeCode.VALUE,LongSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
