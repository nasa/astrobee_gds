...
/**
* A sequence of Ack instances.
*/
public final class AckSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AckSeq (int initialMaximum) {
        super(Ack.class, initialMaximum);
    }

    public AckSeq (Collection elements) {
        super(Ack.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Ack objects (beyond the original size of this object)
