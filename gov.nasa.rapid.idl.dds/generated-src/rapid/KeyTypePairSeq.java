...
*/
public final class KeyTypePairSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public KeyTypePairSeq() {
        super(KeyTypePair.class);
    }

    public KeyTypePairSeq (int initialMaximum) {
        super(KeyTypePair.class, initialMaximum);
    }

    public KeyTypePairSeq (Collection elements) {
        super(KeyTypePair.class, elements);
    }
