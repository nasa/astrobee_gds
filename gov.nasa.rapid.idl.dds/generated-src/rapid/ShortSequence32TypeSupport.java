...
public class ShortSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence32TypeSupport _singleton
    = new ShortSequence32TypeSupport();
    ...
    */
    public static ShortSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence32 typedDst = (ShortSequence32) destination;
        ShortSequence32 typedSrc = (ShortSequence32) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence32 typedSrc = (ShortSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence32 typedDst = (ShortSequence32) dst;
            src.readShortSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence32 typedDst = (ShortSequence32) sample;
    ...
    protected ShortSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence32TypeCode.VALUE,ShortSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence32TypeCode.VALUE,ShortSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
