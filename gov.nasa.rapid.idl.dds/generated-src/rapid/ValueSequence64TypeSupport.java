...
public class ValueSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ValueSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ValueSequence64TypeSupport _singleton
    = new ValueSequence64TypeSupport();
    ...
    */
    public static ValueSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static ValueSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ValueSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return ValueSequence64.create();
    }
    ...
    * <code>this</code> is not a <code>ValueSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ValueSequence64 typedDst = (ValueSequence64) destination;
        ValueSequence64 typedSrc = (ValueSequence64) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ValueSequence64 typedSrc = (ValueSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ValueSequence64 typedDst = (ValueSequence64) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ValueSequence64 typedDst = (ValueSequence64) sample;
    ...
    protected ValueSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValueSequence64TypeCode.VALUE,ValueSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ValueSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ValueSequence64TypeCode.VALUE,ValueSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
