...
public class Color3fTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Color3f";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Color3fTypeSupport _singleton
    = new Color3fTypeSupport();
    ...
    */
    public static Color3fTypeSupport get_instance() {
        return _singleton;
    }

    public static Color3fTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Color3fTypeCode.VALUE;
    }

    public Object create_data() {
        return Color3f.create();
    }
    ...
    * <code>this</code> is not a <code>Color3f</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Color3f typedDst = (Color3f) destination;
        Color3f typedSrc = (Color3f) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getArrayMaxSizeSerialized(currentAlignment,  (3));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Color3f typedSrc = (Color3f) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeFloat(typedSrc.userData[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Color3f typedDst = (Color3f) dst;
            for(int i1__ = 0; i1__< 3; ++i1__){

                typedDst.userData[i1__] = src.readFloat();
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Color3f typedDst = (Color3f) sample;
    ...
    protected Color3fTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Color3fTypeCode.VALUE,Color3f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Color3fTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Color3fTypeCode.VALUE,Color3f.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
