...
/**
* A sequence of ValueSequence64 instances.
*/
public final class ValueSequence64Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ValueSequence64Seq() {
        super(ValueSequence64.class);
    }

    public ValueSequence64Seq (int initialMaximum) {
        super(ValueSequence64.class, initialMaximum);
    }

    public ValueSequence64Seq (Collection elements) {
        super(ValueSequence64.class, elements);
    }
