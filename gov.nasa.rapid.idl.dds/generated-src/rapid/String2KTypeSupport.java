...
public class String2KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String2K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String2KTypeSupport _singleton
    = new String2KTypeSupport();
    ...
    */
    public static String2KTypeSupport get_instance() {
        return _singleton;
    }

    public static String2KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String2KTypeCode.VALUE;
    }

    public Object create_data() {
        return String2K.create();
    }
    ...
    * <code>this</code> is not a <code>String2K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String2K typedDst = (String2K) destination;
        String2K typedSrc = (String2K) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String2K typedSrc = (String2K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,2048);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String2K typedDst = (String2K) dst;
            typedDst.userData = src.readString(2048);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String2K typedDst = (String2K) sample;
    ...
    protected String2KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String2KTypeCode.VALUE,String2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String2KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String2KTypeCode.VALUE,String2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
