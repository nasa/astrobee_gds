...
public class ShortSequence2KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence2K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence2KTypeSupport _singleton
    = new ShortSequence2KTypeSupport();
    ...
    */
    public static ShortSequence2KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence2KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence2KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence2K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence2K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence2K typedDst = (ShortSequence2K) destination;
        ShortSequence2K typedSrc = (ShortSequence2K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 2048);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence2K typedSrc = (ShortSequence2K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,2048);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence2K typedDst = (ShortSequence2K) dst;
            src.readShortSequence(typedDst.userData, 2048);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence2K typedDst = (ShortSequence2K) sample;
    ...
    protected ShortSequence2KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence2KTypeCode.VALUE,ShortSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence2KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence2KTypeCode.VALUE,ShortSequence2K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
