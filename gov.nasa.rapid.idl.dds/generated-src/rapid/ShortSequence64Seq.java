...
/**
* A sequence of ShortSequence64 instances.
*/
public final class ShortSequence64Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence64Seq() {
        super(ShortSequence64.class);
    }

    public ShortSequence64Seq (int initialMaximum) {
        super(ShortSequence64.class, initialMaximum);
    }

    public ShortSequence64Seq (Collection elements) {
        super(ShortSequence64.class, elements);
    }
