...
/**
* A sequence of CommandRecord instances.
*/
public final class CommandRecordSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CommandRecordSeq() {
        super(CommandRecord.class);
    }

    public CommandRecordSeq (int initialMaximum) {
        super(CommandRecord.class, initialMaximum);
    }

    public CommandRecordSeq (Collection elements) {
        super(CommandRecord.class, elements);
    }
