...
public class FloatSequence256TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence256";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence256TypeSupport _singleton
    = new FloatSequence256TypeSupport();
    ...
    */
    public static FloatSequence256TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence256TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence256TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence256.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence256</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence256 typedDst = (FloatSequence256) destination;
        FloatSequence256 typedSrc = (FloatSequence256) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence256 typedSrc = (FloatSequence256) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence256 typedDst = (FloatSequence256) dst;
            src.readFloatSequence(typedDst.userData, 256);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence256 typedDst = (FloatSequence256) sample;
    ...
    protected FloatSequence256TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence256TypeCode.VALUE,FloatSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence256TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence256TypeCode.VALUE,FloatSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
