...
public class String256Sequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String256Sequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String256Sequence64TypeSupport _singleton
    = new String256Sequence64TypeSupport();
    ...
    */
    public static String256Sequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static String256Sequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String256Sequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return String256Sequence64.create();
    }
    ...
    public Object create_key() {
        return new String256Sequence64();
    }
    ...
    public Class get_type() {
        return String256Sequence64.class;
    }
    ...
    * <code>this</code> is not a <code>String256Sequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String256Sequence64 typedDst = (String256Sequence64) destination;
        String256Sequence64 typedSrc = (String256Sequence64) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String256Sequence64 typedSrc = (String256Sequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(256),64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String256Sequence64 typedDst = (String256Sequence64) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String256Sequence64 typedDst = (String256Sequence64) sample;
    ...
    protected String256Sequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String256Sequence64TypeCode.VALUE,String256Sequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String256Sequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String256Sequence64TypeCode.VALUE,String256Sequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
