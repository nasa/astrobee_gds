...
public class ShortSequence4KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence4K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence4KTypeSupport _singleton
    = new ShortSequence4KTypeSupport();
    ...
    */
    public static ShortSequence4KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence4KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence4KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence4K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence4K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence4K typedDst = (ShortSequence4K) destination;
        ShortSequence4K typedSrc = (ShortSequence4K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 4096);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence4K typedSrc = (ShortSequence4K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,4096);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence4K typedDst = (ShortSequence4K) dst;
            src.readShortSequence(typedDst.userData, 4096);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence4K typedDst = (ShortSequence4K) sample;
    ...
    protected ShortSequence4KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence4KTypeCode.VALUE,ShortSequence4K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence4KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence4KTypeCode.VALUE,ShortSequence4K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
