...
public class FileQueueEntryStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileQueueEntryState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileQueueEntryStateTypeSupport _singleton
    = new FileQueueEntryStateTypeSupport();
    ...
    */
    public static FileQueueEntryStateTypeSupport get_instance() {
        return _singleton;
    }

    public static FileQueueEntryStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileQueueEntryStateTypeCode.VALUE;
    }

    public Object create_data() {
        return FileQueueEntryState.create();
    }
    ...
    public Object create_key() {
        return new FileQueueEntryState();
    }
    ...
    public Class get_type() {
        return FileQueueEntryState.class;
    }
    ...
    * <code>this</code> is not a <code>FileQueueEntryState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileQueueEntryState typedDst = (FileQueueEntryState) destination;
        FileQueueEntryState typedSrc = (FileQueueEntryState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FileTransferStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FileTransferStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileQueueEntryState typedSrc = (FileQueueEntryState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.fileUuid );
        currentAlignment += rapid.FileTransferStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.fileUuid,64);

            rapid.FileTransferStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.chunksSent);

            dst.writeInt(typedSrc.numChunks);

            dst.writeLong(typedSrc.submissionTime);

            dst.writeFloat(typedSrc.priority);

            dst.writeShort(typedSrc.channelId);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileQueueEntryState typedDst = (FileQueueEntryState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.fileUuid = src.readString(64);
                typedDst.status = (rapid.FileTransferStatus)rapid.FileTransferStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                typedDst.chunksSent = src.readInt();
                typedDst.numChunks = src.readInt();
                typedDst.submissionTime = src.readLong();
                typedDst.priority = src.readFloat();
                typedDst.channelId = src.readShort();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.FileTransferStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileQueueEntryState typedDst = (FileQueueEntryState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileQueueEntryState typedDst
        = (FileQueueEntryState) instance;
        FileQueueEntryState typedSrc
        = (FileQueueEntryState) key;
    ...
    */
    ...
    int mask) {
        return new FileQueueEntryStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileQueueEntryStateDataReader(native_reader, listener, mask, this);   
    ...
    protected FileQueueEntryStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileQueueEntryStateTypeCode.VALUE,FileQueueEntryState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileQueueEntryStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileQueueEntryStateTypeCode.VALUE,FileQueueEntryState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
