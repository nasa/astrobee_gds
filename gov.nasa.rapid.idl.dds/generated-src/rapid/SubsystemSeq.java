...
/**
* A sequence of Subsystem instances.
*/
public final class SubsystemSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SubsystemSeq (int initialMaximum) {
        super(Subsystem.class, initialMaximum);
    }

    public SubsystemSeq (Collection elements) {
        super(Subsystem.class, elements);
    }
