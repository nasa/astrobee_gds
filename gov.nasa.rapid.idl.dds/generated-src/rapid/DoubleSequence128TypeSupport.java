...
public class DoubleSequence128TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::DoubleSequence128";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DoubleSequence128TypeSupport _singleton
    = new DoubleSequence128TypeSupport();
    ...
    */
    public static DoubleSequence128TypeSupport get_instance() {
        return _singleton;
    }

    public static DoubleSequence128TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DoubleSequence128TypeCode.VALUE;
    }

    public Object create_data() {
        return DoubleSequence128.create();
    }
    ...
    public Class get_type() {
        return DoubleSequence128.class;
    }
    ...
    * <code>this</code> is not a <code>DoubleSequence128</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DoubleSequence128 typedDst = (DoubleSequence128) destination;
        DoubleSequence128 typedSrc = (DoubleSequence128) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getSequenceMaxSizeSerialized(currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DoubleSequence128 typedSrc = (DoubleSequence128) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDoubleSeq(typedSrc.userData,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DoubleSequence128 typedDst = (DoubleSequence128) dst;
            src.readDoubleSequence(typedDst.userData, 128);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DoubleSequence128 typedDst = (DoubleSequence128) sample;
    ...
    protected DoubleSequence128TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DoubleSequence128TypeCode.VALUE,DoubleSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DoubleSequence128TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DoubleSequence128TypeCode.VALUE,DoubleSequence128.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
