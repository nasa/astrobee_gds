...
/**
* A sequence of Transform3D instances.
*/
public final class Transform3DSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Transform3DSeq() {
        super(Transform3D.class);
    }

    public Transform3DSeq (int initialMaximum) {
        super(Transform3D.class, initialMaximum);
    }

    public Transform3DSeq (Collection elements) {
        super(Transform3D.class, elements);
    }
