...
public class QueueActionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::QueueAction";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final QueueActionTypeSupport _singleton
    = new QueueActionTypeSupport();
    ...
    */
    public static QueueActionTypeSupport get_instance() {
        return _singleton;
    }

    public static QueueActionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return QueueActionTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>QueueAction</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        QueueAction typedSrc = (QueueAction) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = QueueAction.valueOf(ordinal);
            if (dst == null) {
    ...
    protected QueueActionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,QueueActionTypeCode.VALUE,QueueAction.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
