...
/**
* A sequence of QueueState instances.
*/
public final class QueueStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public QueueStateSeq() {
        super(QueueState.class);
    }

    public QueueStateSeq (int initialMaximum) {
        super(QueueState.class, initialMaximum);
    }

    public QueueStateSeq (Collection elements) {
        super(QueueState.class, elements);
    }
