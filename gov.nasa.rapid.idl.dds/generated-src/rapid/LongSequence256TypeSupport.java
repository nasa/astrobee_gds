...
public class LongSequence256TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::LongSequence256";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LongSequence256TypeSupport _singleton
    = new LongSequence256TypeSupport();
    ...
    */
    public static LongSequence256TypeSupport get_instance() {
        return _singleton;
    }

    public static LongSequence256TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LongSequence256TypeCode.VALUE;
    }

    public Object create_data() {
        return LongSequence256.create();
    }
    ...
    * <code>this</code> is not a <code>LongSequence256</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LongSequence256 typedDst = (LongSequence256) destination;
        LongSequence256 typedSrc = (LongSequence256) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getSequenceMaxSizeSerialized(currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LongSequence256 typedSrc = (LongSequence256) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeIntSeq(typedSrc.userData,256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LongSequence256 typedDst = (LongSequence256) dst;
            src.readIntSequence(typedDst.userData, 256);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LongSequence256 typedDst = (LongSequence256) sample;
    ...
    protected LongSequence256TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongSequence256TypeCode.VALUE,LongSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LongSequence256TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LongSequence256TypeCode.VALUE,LongSequence256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
