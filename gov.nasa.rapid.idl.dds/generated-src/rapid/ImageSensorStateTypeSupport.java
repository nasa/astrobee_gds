...
public class ImageSensorStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ImageSensorState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ImageSensorStateTypeSupport _singleton
    = new ImageSensorStateTypeSupport();
    ...
    */
    public static ImageSensorStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ImageSensorStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ImageSensorStateTypeCode.VALUE;
    }

    public Object create_data() {
        return ImageSensorState.create();
    }
    ...
    * <code>this</code> is not a <code>ImageSensorState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ImageSensorState typedDst = (ImageSensorState) destination;
        ImageSensorState typedSrc = (ImageSensorState) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ImageSensorState typedSrc = (ImageSensorState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ImageSensorState typedDst = (ImageSensorState) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ImageSensorState typedDst = (ImageSensorState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ImageSensorState typedDst
        = (ImageSensorState) instance;
        ImageSensorState typedSrc
        = (ImageSensorState) key;
    ...
    */
    ...
    int mask) {
        return new ImageSensorStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ImageSensorStateDataReader(native_reader, listener, mask, this);   
    ...
    protected ImageSensorStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ImageSensorStateTypeCode.VALUE,ImageSensorState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ImageSensorStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ImageSensorStateTypeCode.VALUE,ImageSensorState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
