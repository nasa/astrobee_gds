...
/**
* A sequence of ImageSensorState instances.
*/
public final class ImageSensorStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ImageSensorStateSeq() {
        super(ImageSensorState.class);
    }

    public ImageSensorStateSeq (int initialMaximum) {
        super(ImageSensorState.class, initialMaximum);
    }

    public ImageSensorStateSeq (Collection elements) {
        super(ImageSensorState.class, elements);
    }
