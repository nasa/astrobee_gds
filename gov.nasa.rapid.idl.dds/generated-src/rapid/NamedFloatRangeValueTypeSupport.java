...
public class NamedFloatRangeValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedFloatRangeValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedFloatRangeValueTypeSupport _singleton
    = new NamedFloatRangeValueTypeSupport();
    ...
    */
    public static NamedFloatRangeValueTypeSupport get_instance() {
        return _singleton;
    }

    public static NamedFloatRangeValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedFloatRangeValueTypeCode.VALUE;
    }

    public Object create_data() {
        return NamedFloatRangeValue.create();
    }
    ...
    public Object create_key() {
        return new NamedFloatRangeValue();
    }
    ...
    public Class get_type() {
        return NamedFloatRangeValue.class;
    }
    ...
    * <code>this</code> is not a <code>NamedFloatRangeValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedFloatRangeValue typedDst = (NamedFloatRangeValue) destination;
        NamedFloatRangeValue typedSrc = (NamedFloatRangeValue) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FloatRangeValueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FloatRangeValueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedFloatRangeValue typedSrc = (NamedFloatRangeValue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.FloatRangeValueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.range);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.FloatRangeValueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.range, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedFloatRangeValue typedDst = (NamedFloatRangeValue) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(16);
                typedDst.range = (rapid.FloatRangeValue)rapid.FloatRangeValueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.range, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.FloatRangeValueTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedFloatRangeValue typedDst = (NamedFloatRangeValue) sample;
    ...
    int mask) {
        return new NamedFloatRangeValueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NamedFloatRangeValueDataReader(native_reader, listener, mask, this);   
    ...
    protected NamedFloatRangeValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedFloatRangeValueTypeCode.VALUE,NamedFloatRangeValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedFloatRangeValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedFloatRangeValueTypeCode.VALUE,NamedFloatRangeValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
