...
public class PositionConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::PositionConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PositionConfigTypeSupport _singleton
    = new PositionConfigTypeSupport();
    ...
    */
    public static PositionConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static PositionConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PositionConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return PositionConfig.create();
    }
    ...
    * <code>this</code> is not a <code>PositionConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PositionConfig typedDst = (PositionConfig) destination;
        PositionConfig typedSrc = (PositionConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PositionConfig typedSrc = (PositionConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.frameName );
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.poseEncoding);
        currentAlignment += rapid.RotationEncodingTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.velocityEncoding);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.frameName,128);

            rapid.RotationEncodingTypeSupport.get_instance().serialize(endpoint_data, typedSrc.poseEncoding, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.RotationEncodingTypeSupport.get_instance().serialize(endpoint_data, typedSrc.velocityEncoding, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PositionConfig typedDst = (PositionConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.frameName = src.readString(128);
                typedDst.poseEncoding = (rapid.RotationEncoding)rapid.RotationEncodingTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.poseEncoding, src, false, true, endpoint_plugin_qos);     
                typedDst.velocityEncoding = (rapid.RotationEncoding)rapid.RotationEncodingTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.velocityEncoding, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.RotationEncodingTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PositionConfig typedDst = (PositionConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PositionConfig typedDst
        = (PositionConfig) instance;
        PositionConfig typedSrc
        = (PositionConfig) key;
    ...
    */
    ...
    int mask) {
        return new PositionConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PositionConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected PositionConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PositionConfigTypeCode.VALUE,PositionConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PositionConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PositionConfigTypeCode.VALUE,PositionConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
