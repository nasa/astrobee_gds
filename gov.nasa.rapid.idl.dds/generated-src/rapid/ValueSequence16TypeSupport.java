...
public class ValueSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ValueSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ValueSequence16TypeSupport _singleton
    = new ValueSequence16TypeSupport();
    ...
    */
    public static ValueSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static ValueSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ValueSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return ValueSequence16.create();
    }
    ...
    * <code>this</code> is not a <code>ValueSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ValueSequence16 typedDst = (ValueSequence16) destination;
        ValueSequence16 typedSrc = (ValueSequence16) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ValueSequence16 typedSrc = (ValueSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ValueSequence16 typedDst = (ValueSequence16) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ValueSequence16 typedDst = (ValueSequence16) sample;
    ...
    protected ValueSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValueSequence16TypeCode.VALUE,ValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ValueSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ValueSequence16TypeCode.VALUE,ValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
