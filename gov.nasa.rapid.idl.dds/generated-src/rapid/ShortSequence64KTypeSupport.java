...
public class ShortSequence64KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence64K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence64KTypeSupport _singleton
    = new ShortSequence64KTypeSupport();
    ...
    */
    public static ShortSequence64KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence64KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence64KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence64K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence64K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence64K typedDst = (ShortSequence64K) destination;
        ShortSequence64K typedSrc = (ShortSequence64K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 65536);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence64K typedSrc = (ShortSequence64K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,65536);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence64K typedDst = (ShortSequence64K) dst;
            src.readShortSequence(typedDst.userData, 65536);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence64K typedDst = (ShortSequence64K) sample;
    ...
    protected ShortSequence64KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence64KTypeCode.VALUE,ShortSequence64K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence64KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence64KTypeCode.VALUE,ShortSequence64K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
