...
/**
* A sequence of PositionConfig instances.
*/
public final class PositionConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PositionConfigSeq() {
        super(PositionConfig.class);
    }

    public PositionConfigSeq (int initialMaximum) {
        super(PositionConfig.class, initialMaximum);
    }

    public PositionConfigSeq (Collection elements) {
        super(PositionConfig.class, elements);
    }
