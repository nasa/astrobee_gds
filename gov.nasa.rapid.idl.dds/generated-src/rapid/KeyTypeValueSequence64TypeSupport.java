...
public class KeyTypeValueSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueSequence64TypeSupport _singleton
    = new KeyTypeValueSequence64TypeSupport();
    ...
    */
    public static KeyTypeValueSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueSequence64.create();
    }
    ...
    public Object create_key() {
        return new KeyTypeValueSequence64();
    }
    ...
    public Class get_type() {
        return KeyTypeValueSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueSequence64 typedDst = (KeyTypeValueSequence64) destination;
        KeyTypeValueSequence64 typedSrc = (KeyTypeValueSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueSequence64 typedSrc = (KeyTypeValueSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueSequence64 typedDst = (KeyTypeValueSequence64) dst;
            rapid.KeyTypeValueTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueSequence64 typedDst = (KeyTypeValueSequence64) sample;
    ...
    protected KeyTypeValueSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueSequence64TypeCode.VALUE,KeyTypeValueSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueSequence64TypeCode.VALUE,KeyTypeValueSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
