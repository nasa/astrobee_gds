...
public class KeyTypeValueSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueSequence32TypeSupport _singleton
    = new KeyTypeValueSequence32TypeSupport();
    ...
    */
    public static KeyTypeValueSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueSequence32.create();
    }
    ...
    public Object create_key() {
        return new KeyTypeValueSequence32();
    }
    ...
    public Class get_type() {
        return KeyTypeValueSequence32.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueSequence32 typedDst = (KeyTypeValueSequence32) destination;
        KeyTypeValueSequence32 typedSrc = (KeyTypeValueSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.KeyTypeValueTripleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueSequence32 typedSrc = (KeyTypeValueSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.KeyTypeValueTripleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueSequence32 typedDst = (KeyTypeValueSequence32) dst;
            rapid.KeyTypeValueTripleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueSequence32 typedDst = (KeyTypeValueSequence32) sample;
    ...
    protected KeyTypeValueSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueSequence32TypeCode.VALUE,KeyTypeValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueSequence32TypeCode.VALUE,KeyTypeValueSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
