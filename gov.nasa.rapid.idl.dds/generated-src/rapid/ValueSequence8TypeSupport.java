...
public class ValueSequence8TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ValueSequence8";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ValueSequence8TypeSupport _singleton
    = new ValueSequence8TypeSupport();
    ...
    */
    public static ValueSequence8TypeSupport get_instance() {
        return _singleton;
    }

    public static ValueSequence8TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ValueSequence8TypeCode.VALUE;
    }

    public Object create_data() {
        return ValueSequence8.create();
    }
    ...
    * <code>this</code> is not a <code>ValueSequence8</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ValueSequence8 typedDst = (ValueSequence8) destination;
        ValueSequence8 typedSrc = (ValueSequence8) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ValueSequence8 typedSrc = (ValueSequence8) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ValueSequence8 typedDst = (ValueSequence8) dst;
            rapid.ParameterUnionTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ValueSequence8 typedDst = (ValueSequence8) sample;
    ...
    protected ValueSequence8TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValueSequence8TypeCode.VALUE,ValueSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ValueSequence8TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ValueSequence8TypeCode.VALUE,ValueSequence8.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
