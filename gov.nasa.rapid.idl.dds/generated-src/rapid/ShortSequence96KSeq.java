...
/**
* A sequence of ShortSequence96K instances.
*/
public final class ShortSequence96KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence96KSeq() {
        super(ShortSequence96K.class);
    }

    public ShortSequence96KSeq (int initialMaximum) {
        super(ShortSequence96K.class, initialMaximum);
    }

    public ShortSequence96KSeq (Collection elements) {
        super(ShortSequence96K.class, elements);
    }
