...
/**
* A sequence of CommandConfig instances.
*/
public final class CommandConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CommandConfigSeq() {
        super(CommandConfig.class);
    }

    public CommandConfigSeq (int initialMaximum) {
        super(CommandConfig.class, initialMaximum);
    }

    public CommandConfigSeq (Collection elements) {
        super(CommandConfig.class, elements);
    }
