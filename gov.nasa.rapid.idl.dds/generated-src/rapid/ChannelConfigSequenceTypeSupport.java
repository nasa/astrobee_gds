...
public class ChannelConfigSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ChannelConfigSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelConfigSequenceTypeSupport _singleton
    = new ChannelConfigSequenceTypeSupport();
    ...
    */
    public static ChannelConfigSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelConfigSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelConfigSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ChannelConfigSequence.create();
    }
    ...
    public Object create_key() {
        return new ChannelConfigSequence();
    }
    ...
    public Class get_type() {
        return ChannelConfigSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ChannelConfigSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ChannelConfigSequence typedDst = (ChannelConfigSequence) destination;
        ChannelConfigSequence typedSrc = (ChannelConfigSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ChannelConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ChannelConfigSequence typedSrc = (ChannelConfigSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ChannelConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ChannelConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ChannelConfigSequence typedDst = (ChannelConfigSequence) dst;
            rapid.ChannelConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ChannelConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ChannelConfigSequence typedDst = (ChannelConfigSequence) sample;
    ...
    protected ChannelConfigSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelConfigSequenceTypeCode.VALUE,ChannelConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ChannelConfigSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ChannelConfigSequenceTypeCode.VALUE,ChannelConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
