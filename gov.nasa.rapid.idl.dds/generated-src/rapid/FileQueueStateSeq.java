...
/**
* A sequence of FileQueueState instances.
*/
public final class FileQueueStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileQueueStateSeq() {
        super(FileQueueState.class);
    }

    public FileQueueStateSeq (int initialMaximum) {
        super(FileQueueState.class, initialMaximum);
    }

    public FileQueueStateSeq (Collection elements) {
        super(FileQueueState.class, elements);
    }
