...
public class ShortSequence128KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence128K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence128KTypeSupport _singleton
    = new ShortSequence128KTypeSupport();
    ...
    */
    public static ShortSequence128KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence128KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence128KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence128K.create();
    }
    ...
    public Class get_type() {
        return ShortSequence128K.class;
    }
    ...
    * <code>this</code> is not a <code>ShortSequence128K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence128K typedDst = (ShortSequence128K) destination;
        ShortSequence128K typedSrc = (ShortSequence128K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 131072);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence128K typedSrc = (ShortSequence128K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,131072);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence128K typedDst = (ShortSequence128K) dst;
            src.readShortSequence(typedDst.userData, 131072);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence128K typedDst = (ShortSequence128K) sample;
    ...
    protected ShortSequence128KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence128KTypeCode.VALUE,ShortSequence128K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence128KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence128KTypeCode.VALUE,ShortSequence128K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
