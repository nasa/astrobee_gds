...
/**
* A sequence of ShortSequence32K instances.
*/
public final class ShortSequence32KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence32KSeq() {
        super(ShortSequence32K.class);
    }

    public ShortSequence32KSeq (int initialMaximum) {
        super(ShortSequence32K.class, initialMaximum);
    }

    public ShortSequence32KSeq (Collection elements) {
        super(ShortSequence32K.class, elements);
    }
