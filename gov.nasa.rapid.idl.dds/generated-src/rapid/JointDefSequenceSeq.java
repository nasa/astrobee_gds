...
/**
* A sequence of JointDefSequence instances.
*/
public final class JointDefSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointDefSequenceSeq() {
        super(JointDefSequence.class);
    }

    public JointDefSequenceSeq (int initialMaximum) {
        super(JointDefSequence.class, initialMaximum);
    }

    public JointDefSequenceSeq (Collection elements) {
        super(JointDefSequence.class, elements);
    }
