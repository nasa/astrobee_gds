...
/**
* A sequence of LongSequence128 instances.
*/
public final class LongSequence128Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence128Seq() {
        super(LongSequence128.class);
    }

    public LongSequence128Seq (int initialMaximum) {
        super(LongSequence128.class, initialMaximum);
    }

    public LongSequence128Seq (Collection elements) {
        super(LongSequence128.class, elements);
    }
