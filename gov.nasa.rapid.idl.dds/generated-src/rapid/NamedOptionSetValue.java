...
public class NamedOptionSetValue   implements Copyable, Serializable{

    public String name=  "" ; /* maximum length = (16) */
    public rapid.OptionSetValue option = (rapid.OptionSetValue)rapid.OptionSetValue.create();

    public NamedOptionSetValue() {

    }
    public NamedOptionSetValue (NamedOptionSetValue other) {
    ...
    public boolean equals(Object o) {
        ...
        NamedOptionSetValue otherObj = (NamedOptionSetValue)o;

        if(!name.equals(otherObj.name)) {
            return false;
        }
        if(!option.equals(otherObj.option)) {
            return false;
        }
    ...
    * This method could be placed into <code>NamedOptionSetValueTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        NamedOptionSetValue typedSrc = (NamedOptionSetValue) src;
        NamedOptionSetValue typedDst = this;

        typedDst.name = typedSrc.name;
        typedDst.option = (rapid.OptionSetValue) typedDst.option.copy_from(typedSrc.option);
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append(option.toString("option ", indent+1));
