...
public class FloatSequence512TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence512";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence512TypeSupport _singleton
    = new FloatSequence512TypeSupport();
    ...
    */
    public static FloatSequence512TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence512TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence512TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence512.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence512</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence512 typedDst = (FloatSequence512) destination;
        FloatSequence512 typedSrc = (FloatSequence512) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 512);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence512 typedSrc = (FloatSequence512) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.FLOAT.getSequenceSerializedSize(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,512);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence512 typedDst = (FloatSequence512) dst;
            src.readFloatSequence(typedDst.userData, 512);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence512 typedDst = (FloatSequence512) sample;
    ...
    protected FloatSequence512TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence512TypeCode.VALUE,FloatSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence512TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence512TypeCode.VALUE,FloatSequence512.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
