...
public class NamedOptionSetValueSequence16TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedOptionSetValueSequence16";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedOptionSetValueSequence16TypeSupport _singleton
    = new NamedOptionSetValueSequence16TypeSupport();
    ...
    */
    public static NamedOptionSetValueSequence16TypeSupport get_instance() {
        return _singleton;
    }

    public static NamedOptionSetValueSequence16TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedOptionSetValueSequence16TypeCode.VALUE;
    }

    public Object create_data() {
        return NamedOptionSetValueSequence16.create();
    }
    ...
    public Object create_key() {
        return new NamedOptionSetValueSequence16();
    }
    ...
    public Class get_type() {
        return NamedOptionSetValueSequence16.class;
    }
    ...
    * <code>this</code> is not a <code>NamedOptionSetValueSequence16</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedOptionSetValueSequence16 typedDst = (NamedOptionSetValueSequence16) destination;
        NamedOptionSetValueSequence16 typedSrc = (NamedOptionSetValueSequence16) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedOptionSetValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 16);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.NamedOptionSetValueTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedOptionSetValueSequence16 typedSrc = (NamedOptionSetValueSequence16) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.NamedOptionSetValueTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.NamedOptionSetValueTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,16, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedOptionSetValueSequence16 typedDst = (NamedOptionSetValueSequence16) dst;
            rapid.NamedOptionSetValueTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 16, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.NamedOptionSetValueTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedOptionSetValueSequence16 typedDst = (NamedOptionSetValueSequence16) sample;
    ...
    protected NamedOptionSetValueSequence16TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedOptionSetValueSequence16TypeCode.VALUE,NamedOptionSetValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedOptionSetValueSequence16TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedOptionSetValueSequence16TypeCode.VALUE,NamedOptionSetValueSequence16.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
