...
/**
* A sequence of FloatSequence256 instances.
*/
public final class FloatSequence256Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence256Seq() {
        super(FloatSequence256.class);
    }

    public FloatSequence256Seq (int initialMaximum) {
        super(FloatSequence256.class, initialMaximum);
    }

    public FloatSequence256Seq (Collection elements) {
        super(FloatSequence256.class, elements);
    }
