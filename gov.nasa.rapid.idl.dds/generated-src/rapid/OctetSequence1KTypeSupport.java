...
public class OctetSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence1KTypeSupport _singleton
    = new OctetSequence1KTypeSupport();
    ...
    */
    public static OctetSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence1K typedDst = (OctetSequence1K) destination;
        OctetSequence1K typedSrc = (OctetSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence1K typedSrc = (OctetSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence1K typedDst = (OctetSequence1K) dst;
            src.readByteSequence(typedDst.userData, 1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence1K typedDst = (OctetSequence1K) sample;
    ...
    protected OctetSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence1KTypeCode.VALUE,OctetSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence1KTypeCode.VALUE,OctetSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
