...
public class FloatSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence1KTypeSupport _singleton
    = new FloatSequence1KTypeSupport();
    ...
    */
    public static FloatSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence1K typedDst = (FloatSequence1K) destination;
        FloatSequence1K typedSrc = (FloatSequence1K) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence1K typedSrc = (FloatSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence1K typedDst = (FloatSequence1K) dst;
            src.readFloatSequence(typedDst.userData, 1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence1K typedDst = (FloatSequence1K) sample;
    ...
    protected FloatSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence1KTypeCode.VALUE,FloatSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence1KTypeCode.VALUE,FloatSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
