...
public class String128Sequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String128Sequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String128Sequence64TypeSupport _singleton
    = new String128Sequence64TypeSupport();
    ...
    */
    public static String128Sequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static String128Sequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String128Sequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return String128Sequence64.create();
    }
    ...
    public Object create_key() {
        return new String128Sequence64();
    }
    ...
    public Class get_type() {
        return String128Sequence64.class;
    }
    ...
    * <code>this</code> is not a <code>String128Sequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String128Sequence64 typedDst = (String128Sequence64) destination;
        String128Sequence64 typedSrc = (String128Sequence64) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String128Sequence64 typedSrc = (String128Sequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(128),64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String128Sequence64 typedDst = (String128Sequence64) dst;
            src.readStringSequence(typedDst.userData, 64);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String128Sequence64 typedDst = (String128Sequence64) sample;
    ...
    protected String128Sequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String128Sequence64TypeCode.VALUE,String128Sequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String128Sequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String128Sequence64TypeCode.VALUE,String128Sequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
