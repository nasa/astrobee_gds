...
/**
* A sequence of FloatSequence1K instances.
*/
public final class FloatSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence1KSeq() {
        super(FloatSequence1K.class);
    }

    public FloatSequence1KSeq (int initialMaximum) {
        super(FloatSequence1K.class, initialMaximum);
    }

    public FloatSequence1KSeq (Collection elements) {
        super(FloatSequence1K.class, elements);
    }
