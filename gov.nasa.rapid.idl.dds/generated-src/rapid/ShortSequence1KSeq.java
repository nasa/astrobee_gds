...
/**
* A sequence of ShortSequence1K instances.
*/
public final class ShortSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence1KSeq() {
        super(ShortSequence1K.class);
    }

    public ShortSequence1KSeq (int initialMaximum) {
        super(ShortSequence1K.class, initialMaximum);
    }

    public ShortSequence1KSeq (Collection elements) {
        super(ShortSequence1K.class, elements);
    }
