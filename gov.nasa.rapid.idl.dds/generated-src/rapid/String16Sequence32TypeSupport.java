...
public class String16Sequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String16Sequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String16Sequence32TypeSupport _singleton
    = new String16Sequence32TypeSupport();
    ...
    */
    public static String16Sequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static String16Sequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String16Sequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return String16Sequence32.create();
    }
    ...
    public Class get_type() {
        return String16Sequence32.class;
    }
    ...
    * <code>this</code> is not a <code>String16Sequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String16Sequence32 typedDst = (String16Sequence32) destination;
        String16Sequence32 typedSrc = (String16Sequence32) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String16Sequence32 typedSrc = (String16Sequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(16),32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String16Sequence32 typedDst = (String16Sequence32) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String16Sequence32 typedDst = (String16Sequence32) sample;
    ...
    protected String16Sequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String16Sequence32TypeCode.VALUE,String16Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String16Sequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String16Sequence32TypeCode.VALUE,String16Sequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
