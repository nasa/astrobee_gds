...
/**
* A sequence of ValueSequence32 instances.
*/
public final class ValueSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ValueSequence32Seq() {
        super(ValueSequence32.class);
    }

    public ValueSequence32Seq (int initialMaximum) {
        super(ValueSequence32.class, initialMaximum);
    }

    public ValueSequence32Seq (Collection elements) {
        super(ValueSequence32.class, elements);
    }
