...
public class FloatSequence32TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatSequence32";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatSequence32TypeSupport _singleton
    = new FloatSequence32TypeSupport();
    ...
    */
    public static FloatSequence32TypeSupport get_instance() {
        return _singleton;
    }

    public static FloatSequence32TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatSequence32TypeCode.VALUE;
    }

    public Object create_data() {
        return FloatSequence32.create();
    }
    ...
    * <code>this</code> is not a <code>FloatSequence32</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatSequence32 typedDst = (FloatSequence32) destination;
        FloatSequence32 typedSrc = (FloatSequence32) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatSequence32 typedSrc = (FloatSequence32) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloatSeq(typedSrc.userData,32);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatSequence32 typedDst = (FloatSequence32) dst;
            src.readFloatSequence(typedDst.userData, 32);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatSequence32 typedDst = (FloatSequence32) sample;
    ...
    protected FloatSequence32TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatSequence32TypeCode.VALUE,FloatSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatSequence32TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatSequence32TypeCode.VALUE,FloatSequence32.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
