...
public class String256TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::String256";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final String256TypeSupport _singleton
    = new String256TypeSupport();
    ...
    */
    public static String256TypeSupport get_instance() {
        return _singleton;
    }

    public static String256TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return String256TypeCode.VALUE;
    }

    public Object create_data() {
        return String256.create();
    }
    ...
    * <code>this</code> is not a <code>String256</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        String256 typedDst = (String256) destination;
        String256 typedSrc = (String256) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        String256 typedSrc = (String256) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            String256 typedDst = (String256) dst;
            typedDst.userData = src.readString(256);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            String256 typedDst = (String256) sample;
    ...
    protected String256TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,String256TypeCode.VALUE,String256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected String256TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,String256TypeCode.VALUE,String256.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
