...
public class OctetSequence32KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence32K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence32KTypeSupport _singleton
    = new OctetSequence32KTypeSupport();
    ...
    */
    public static OctetSequence32KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence32KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence32KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence32K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence32K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence32K typedDst = (OctetSequence32K) destination;
        OctetSequence32K typedSrc = (OctetSequence32K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 32768);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence32K typedSrc = (OctetSequence32K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,32768);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence32K typedDst = (OctetSequence32K) dst;
            src.readByteSequence(typedDst.userData, 32768);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence32K typedDst = (OctetSequence32K) sample;
    ...
    protected OctetSequence32KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence32KTypeCode.VALUE,OctetSequence32K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence32KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence32KTypeCode.VALUE,OctetSequence32K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
