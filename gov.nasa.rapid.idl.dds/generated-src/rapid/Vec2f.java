...
public class Vec2f   implements Copyable, Serializable{

    public float [] userData=  new float [2];
    ...
    * This method could be placed into <code>Vec2fTypeSupport</code>
