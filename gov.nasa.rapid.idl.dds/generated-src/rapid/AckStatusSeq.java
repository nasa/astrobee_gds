...
/**
* A sequence of AckStatus instances.
*/
public final class AckStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AckStatusSeq() {
        super(AckStatus.class);
    }

    public AckStatusSeq (int initialMaximum) {
        super(AckStatus.class, initialMaximum);
    }

    public AckStatusSeq (Collection elements) {
        super(AckStatus.class, elements);
    }
