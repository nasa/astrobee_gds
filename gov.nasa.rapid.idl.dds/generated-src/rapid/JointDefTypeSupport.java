...
public class JointDefTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::JointDef";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointDefTypeSupport _singleton
    = new JointDefTypeSupport();
    ...
    */
    public static JointDefTypeSupport get_instance() {
        return _singleton;
    }

    public static JointDefTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointDefTypeCode.VALUE;
    }

    public Object create_data() {
        return JointDef.create();
    }
    ...
    * <code>this</code> is not a <code>JointDef</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        JointDef typedDst = (JointDef) destination;
        JointDef typedSrc = (JointDef) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        JointDef typedSrc = (JointDef) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.dof );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.dof,64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            JointDef typedDst = (JointDef) dst;
            typedDst.clear();      
            try{
                typedDst.frameName = src.readString(128);
                typedDst.dof = src.readString(64);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            JointDef typedDst = (JointDef) sample;
    ...
    int mask) {
        return new JointDefDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new JointDefDataReader(native_reader, listener, mask, this);   
    ...
    protected JointDefTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,JointDefTypeCode.VALUE,JointDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected JointDefTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,JointDefTypeCode.VALUE,JointDef.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
