...
public class FrameDefSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FrameDefSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FrameDefSequenceTypeSupport _singleton
    = new FrameDefSequenceTypeSupport();
    ...
    */
    public static FrameDefSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static FrameDefSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FrameDefSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return FrameDefSequence.create();
    }
    ...
    * <code>this</code> is not a <code>FrameDefSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FrameDefSequence typedDst = (FrameDefSequence) destination;
        FrameDefSequence typedSrc = (FrameDefSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FrameDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.FrameDefTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FrameDefSequence typedSrc = (FrameDefSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.FrameDefTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.FrameDefTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,256, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FrameDefSequence typedDst = (FrameDefSequence) dst;
            rapid.FrameDefTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 256, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.FrameDefTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FrameDefSequence typedDst = (FrameDefSequence) sample;
    ...
    protected FrameDefSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FrameDefSequenceTypeCode.VALUE,FrameDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FrameDefSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FrameDefSequenceTypeCode.VALUE,FrameDefSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
