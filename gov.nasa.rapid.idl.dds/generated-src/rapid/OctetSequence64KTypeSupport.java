...
public class OctetSequence64KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence64K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence64KTypeSupport _singleton
    = new OctetSequence64KTypeSupport();
    ...
    */
    public static OctetSequence64KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence64KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence64KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence64K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence64K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence64K typedDst = (OctetSequence64K) destination;
        OctetSequence64K typedSrc = (OctetSequence64K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 65536);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence64K typedSrc = (OctetSequence64K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,65536);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence64K typedDst = (OctetSequence64K) dst;
            src.readByteSequence(typedDst.userData, 65536);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence64K typedDst = (OctetSequence64K) sample;
    ...
    protected OctetSequence64KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence64KTypeCode.VALUE,OctetSequence64K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence64KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence64KTypeCode.VALUE,OctetSequence64K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
