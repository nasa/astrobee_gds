...
public class ThermalInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ThermalInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThermalInfoSampleTypeSupport _singleton
    = new ThermalInfoSampleTypeSupport();
    ...
    */
    public static ThermalInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static ThermalInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThermalInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return ThermalInfoSample.create();
    }
    ...
    public Class get_type() {
        return ThermalInfoSample.class;
    }
    ...
    * <code>this</code> is not a <code>ThermalInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ThermalInfoSample typedDst = (ThermalInfoSample) destination;
        ThermalInfoSample typedSrc = (ThermalInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ThermalInfoSample typedSrc = (ThermalInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ThermalInfoSample typedDst = (ThermalInfoSample) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ThermalInfoSample typedDst = (ThermalInfoSample) sample;
    ...
    int mask) {
        return new ThermalInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ThermalInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected ThermalInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThermalInfoSampleTypeCode.VALUE,ThermalInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ThermalInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ThermalInfoSampleTypeCode.VALUE,ThermalInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
