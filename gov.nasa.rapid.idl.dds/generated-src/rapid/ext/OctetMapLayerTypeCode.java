...
public class  OctetMapLayerTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("data", false, (short)-1,  false,(TypeCode) rapid.OctetSequence128KTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("rapid::ext::OctetMapLayer",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
