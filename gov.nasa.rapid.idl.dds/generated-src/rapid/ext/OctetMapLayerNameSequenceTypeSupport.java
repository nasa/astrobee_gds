...
public class OctetMapLayerNameSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::OctetMapLayerNameSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetMapLayerNameSequenceTypeSupport _singleton
    = new OctetMapLayerNameSequenceTypeSupport();
    ...
    */
    public static OctetMapLayerNameSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetMapLayerNameSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetMapLayerNameSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetMapLayerNameSequence.create();
    }
    ...
    public Object create_key() {
        return new OctetMapLayerNameSequence();
    }
    ...
    public Class get_type() {
        return OctetMapLayerNameSequence.class;
    }
    ...
    * <code>this</code> is not a <code>OctetMapLayerNameSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetMapLayerNameSequence typedDst = (OctetMapLayerNameSequence) destination;
        OctetMapLayerNameSequence typedSrc = (OctetMapLayerNameSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (32)+1,((rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetMapLayerNameSequence typedSrc = (OctetMapLayerNameSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(32),(rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetMapLayerNameSequence typedDst = (OctetMapLayerNameSequence) dst;
            src.readStringSequence(typedDst.userData, (rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE));
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetMapLayerNameSequence typedDst = (OctetMapLayerNameSequence) sample;
    ...
    protected OctetMapLayerNameSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetMapLayerNameSequenceTypeCode.VALUE,OctetMapLayerNameSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetMapLayerNameSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetMapLayerNameSequenceTypeCode.VALUE,OctetMapLayerNameSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
