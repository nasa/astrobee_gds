...
public class ShortMapLayerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ShortMapLayer";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortMapLayerTypeSupport _singleton
    = new ShortMapLayerTypeSupport();
    ...
    */
    public static ShortMapLayerTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortMapLayerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortMapLayerTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortMapLayer.create();
    }
    ...
    * <code>this</code> is not a <code>ShortMapLayer</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortMapLayer typedDst = (ShortMapLayer) destination;
        ShortMapLayer typedSrc = (ShortMapLayer) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortMapLayer typedSrc = (ShortMapLayer) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ShortSequence128KTypeSupport.get_instance().serialize(endpoint_data, typedSrc.data, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortMapLayer typedDst = (ShortMapLayer) dst;
            typedDst.clear();      
            try{
                typedDst.offset = src.readDouble();
                typedDst.scale = src.readFloat();
                typedDst.density = src.readShort();
                typedDst.data = (rapid.ShortSequence128K)rapid.ShortSequence128KTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.data, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortMapLayer typedDst = (ShortMapLayer) sample;
    ...
    int mask) {
        return new ShortMapLayerDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ShortMapLayerDataReader(native_reader, listener, mask, this);   
    ...
    protected ShortMapLayerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortMapLayerTypeCode.VALUE,ShortMapLayer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortMapLayerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortMapLayerTypeCode.VALUE,ShortMapLayer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
