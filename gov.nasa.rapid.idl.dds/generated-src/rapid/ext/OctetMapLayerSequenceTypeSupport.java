...
public class OctetMapLayerSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::OctetMapLayerSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetMapLayerSequenceTypeSupport _singleton
    = new OctetMapLayerSequenceTypeSupport();
    ...
    */
    public static OctetMapLayerSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetMapLayerSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetMapLayerSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetMapLayerSequence.create();
    }
    ...
    public Object create_key() {
        return new OctetMapLayerSequence();
    }
    ...
    public Class get_type() {
        return OctetMapLayerSequence.class;
    }
    ...
    * <code>this</code> is not a <code>OctetMapLayerSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetMapLayerSequence typedDst = (OctetMapLayerSequence) destination;
        OctetMapLayerSequence typedSrc = (OctetMapLayerSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.OctetMapLayerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.OctetMapLayerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetMapLayerSequence typedSrc = (OctetMapLayerSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.OctetMapLayerTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.OctetMapLayerTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetMapLayerSequence typedDst = (OctetMapLayerSequence) dst;
            rapid.ext.OctetMapLayerTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, (rapid.ext.NAVMAP_NUM_OCTET_LAYERS.VALUE), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.OctetMapLayerTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetMapLayerSequence typedDst = (OctetMapLayerSequence) sample;
    ...
    protected OctetMapLayerSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetMapLayerSequenceTypeCode.VALUE,OctetMapLayerSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetMapLayerSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetMapLayerSequenceTypeCode.VALUE,OctetMapLayerSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
