...
/**
* A sequence of SingleSegment instances.
*/
public final class SingleSegmentSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SingleSegmentSeq() {
        super(SingleSegment.class);
    }

    public SingleSegmentSeq (int initialMaximum) {
        super(SingleSegment.class, initialMaximum);
    }

    public SingleSegmentSeq (Collection elements) {
        super(SingleSegment.class, elements);
    }
