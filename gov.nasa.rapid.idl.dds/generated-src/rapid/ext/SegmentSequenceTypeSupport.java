...
public class SegmentSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::SegmentSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SegmentSequenceTypeSupport _singleton
    = new SegmentSequenceTypeSupport();
    ...
    */
    public static SegmentSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static SegmentSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SegmentSequenceTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SegmentSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SegmentSequence typedDst = (SegmentSequence) destination;
        SegmentSequence typedSrc = (SegmentSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SingleSegmentTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SingleSegmentTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SegmentSequence typedSrc = (SegmentSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.SingleSegmentTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.SingleSegmentTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SegmentSequence typedDst = (SegmentSequence) dst;
            rapid.ext.SingleSegmentTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.SingleSegmentTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SegmentSequence typedDst = (SegmentSequence) sample;
    ...
    protected SegmentSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SegmentSequenceTypeCode.VALUE,SegmentSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SegmentSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SegmentSequenceTypeCode.VALUE,SegmentSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
