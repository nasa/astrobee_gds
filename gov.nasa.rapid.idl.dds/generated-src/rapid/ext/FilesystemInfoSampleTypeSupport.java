...
public class FilesystemInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::FilesystemInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FilesystemInfoSampleTypeSupport _singleton
    = new FilesystemInfoSampleTypeSupport();
    ...
    */
    public static FilesystemInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static FilesystemInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FilesystemInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return FilesystemInfoSample.create();
    }
    ...
    public Object create_key() {
        return new FilesystemInfoSample();
    }
    ...
    public Class get_type() {
        return FilesystemInfoSample.class;
    }
    ...
    * <code>this</code> is not a <code>FilesystemInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FilesystemInfoSample typedDst = (FilesystemInfoSample) destination;
        FilesystemInfoSample typedSrc = (FilesystemInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FilesystemInfoSample typedSrc = (FilesystemInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.used);

            dst.writeLong(typedSrc.available);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FilesystemInfoSample typedDst = (FilesystemInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.used = src.readLong();
                typedDst.available = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FilesystemInfoSample typedDst = (FilesystemInfoSample) sample;
    ...
    int mask) {
        return new FilesystemInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FilesystemInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected FilesystemInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FilesystemInfoSampleTypeCode.VALUE,FilesystemInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FilesystemInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FilesystemInfoSampleTypeCode.VALUE,FilesystemInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
