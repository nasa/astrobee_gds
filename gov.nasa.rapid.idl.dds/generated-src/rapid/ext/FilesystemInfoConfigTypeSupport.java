...
public class FilesystemInfoConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::FilesystemInfoConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FilesystemInfoConfigTypeSupport _singleton
    = new FilesystemInfoConfigTypeSupport();
    ...
    */
    public static FilesystemInfoConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static FilesystemInfoConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FilesystemInfoConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return FilesystemInfoConfig.create();
    }
    ...
    public Object create_key() {
        return new FilesystemInfoConfig();
    }
    ...
    public Class get_type() {
        return FilesystemInfoConfig.class;
    }
    ...
    * <code>this</code> is not a <code>FilesystemInfoConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FilesystemInfoConfig typedDst = (FilesystemInfoConfig) destination;
        FilesystemInfoConfig typedSrc = (FilesystemInfoConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FilesystemInfoConfig typedSrc = (FilesystemInfoConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.capacity);

            dst.writeString(typedSrc.name,64);

            dst.writeLong(typedSrc.availableLow);

            dst.writeLong(typedSrc.availableCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FilesystemInfoConfig typedDst = (FilesystemInfoConfig) dst;
            typedDst.clear();      
            try{
                typedDst.capacity = src.readLong();
                typedDst.name = src.readString(64);
                typedDst.availableLow = src.readLong();
                typedDst.availableCritical = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FilesystemInfoConfig typedDst = (FilesystemInfoConfig) sample;
    ...
    int mask) {
        return new FilesystemInfoConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FilesystemInfoConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected FilesystemInfoConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FilesystemInfoConfigTypeCode.VALUE,FilesystemInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FilesystemInfoConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FilesystemInfoConfigTypeCode.VALUE,FilesystemInfoConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
