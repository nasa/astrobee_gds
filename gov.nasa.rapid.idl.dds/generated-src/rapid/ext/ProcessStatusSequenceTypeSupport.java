...
public class ProcessStatusSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessStatusSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessStatusSequenceTypeSupport _singleton
    = new ProcessStatusSequenceTypeSupport();
    ...
    */
    public static ProcessStatusSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessStatusSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessStatusSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessStatusSequence.create();
    }
    ...
    public Object create_key() {
        return new ProcessStatusSequence();
    }
    ...
    public Class get_type() {
        return ProcessStatusSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ProcessStatusSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessStatusSequence typedDst = (ProcessStatusSequence) destination;
        ProcessStatusSequence typedSrc = (ProcessStatusSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessStatusTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessStatusTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessStatusSequence typedSrc = (ProcessStatusSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.ProcessStatusTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.ProcessStatusTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessStatusSequence typedDst = (ProcessStatusSequence) dst;
            rapid.ext.ProcessStatusTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ProcessStatusTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessStatusSequence typedDst = (ProcessStatusSequence) sample;
    ...
    protected ProcessStatusSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessStatusSequenceTypeCode.VALUE,ProcessStatusSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessStatusSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessStatusSequenceTypeCode.VALUE,ProcessStatusSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
