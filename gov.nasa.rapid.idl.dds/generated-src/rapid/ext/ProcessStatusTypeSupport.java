...
public class ProcessStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessStatusTypeSupport _singleton
    = new ProcessStatusTypeSupport();
    ...
    */
    public static ProcessStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ProcessStatus</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ProcessStatus typedSrc = (ProcessStatus) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ProcessStatus.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ProcessStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessStatusTypeCode.VALUE,ProcessStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
