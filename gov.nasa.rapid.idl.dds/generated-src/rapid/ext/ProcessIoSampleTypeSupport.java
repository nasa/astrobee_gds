...
public class ProcessIoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessIoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessIoSampleTypeSupport _singleton
    = new ProcessIoSampleTypeSupport();
    ...
    */
    public static ProcessIoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessIoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessIoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessIoSample.create();
    }
    ...
    * <code>this</code> is not a <code>ProcessIoSample</code>
    * type.
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessIoStreamTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (1024)+1);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.ProcessIoStreamTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessIoSample typedSrc = (ProcessIoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.ProcessIoStreamTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.stream);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.line );
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.ProcessIoStreamTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.processIdx);

            rapid.ext.ProcessIoStreamTypeSupport.get_instance().serialize(endpoint_data, typedSrc.stream, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.lineNumber);

            dst.writeString(typedSrc.line,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            dst.writeInt(typedSrc.processIdx);
            rapid.ext.ProcessIoStreamTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.stream, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessIoSample typedDst = (ProcessIoSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.processIdx = src.readInt();
                typedDst.stream = (rapid.ext.ProcessIoStream)rapid.ext.ProcessIoStreamTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.stream, src, false, true, endpoint_plugin_qos);     
                typedDst.lineNumber = src.readInt();
                typedDst.line = src.readString(1024);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_key) {
            ...
            typedDst.processIdx = src.readInt();
            typedDst.stream = (rapid.ext.ProcessIoStream)rapid.ext.ProcessIoStreamTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.stream, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ProcessIoStreamTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessIoSample typedDst = (ProcessIoSample) sample;
            ...
            typedDst.stream = (rapid.ext.ProcessIoStream)rapid.ext.ProcessIoStreamTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.stream, src, false, true, endpoint_plugin_qos);     
    ...
    */
    ...
    Object instance,
    Object key) {
        ProcessIoSample typedDst
        = (ProcessIoSample) instance;
        ProcessIoSample typedSrc
        = (ProcessIoSample) key;
    ...
    */
    ...
    int mask) {
        return new ProcessIoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ProcessIoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected ProcessIoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ProcessIoSampleTypeCode.VALUE,ProcessIoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessIoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessIoSampleTypeCode.VALUE,ProcessIoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
