...
/**
* A sequence of MemoryInfoSample instances.
*/
public final class MemoryInfoSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MemoryInfoSampleSeq() {
        super(MemoryInfoSample.class);
    }

    public MemoryInfoSampleSeq (int initialMaximum) {
        super(MemoryInfoSample.class, initialMaximum);
    }

    public MemoryInfoSampleSeq (Collection elements) {
        super(MemoryInfoSample.class, elements);
    }
