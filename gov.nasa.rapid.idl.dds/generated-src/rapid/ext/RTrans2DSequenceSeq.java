...
/**
* A sequence of RTrans2DSequence instances.
*/
public final class RTrans2DSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RTrans2DSequenceSeq() {
        super(RTrans2DSequence.class);
    }

    public RTrans2DSequenceSeq (int initialMaximum) {
        super(RTrans2DSequence.class, initialMaximum);
    }

    public RTrans2DSequenceSeq (Collection elements) {
        super(RTrans2DSequence.class, elements);
    }
