...
public class WifiInfoSampleSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::WifiInfoSampleSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WifiInfoSampleSequenceTypeSupport _singleton
    = new WifiInfoSampleSequenceTypeSupport();
    ...
    */
    public static WifiInfoSampleSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static WifiInfoSampleSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WifiInfoSampleSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return WifiInfoSampleSequence.create();
    }
    ...
    public Object create_key() {
        return new WifiInfoSampleSequence();
    }
    ...
    public Class get_type() {
        return WifiInfoSampleSequence.class;
    }
    ...
    * <code>this</code> is not a <code>WifiInfoSampleSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WifiInfoSampleSequence typedDst = (WifiInfoSampleSequence) destination;
        WifiInfoSampleSequence typedSrc = (WifiInfoSampleSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.WifiInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.WifiInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WifiInfoSampleSequence typedSrc = (WifiInfoSampleSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.WifiInfoSampleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.WifiInfoSampleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WifiInfoSampleSequence typedDst = (WifiInfoSampleSequence) dst;
            rapid.ext.WifiInfoSampleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.WifiInfoSampleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WifiInfoSampleSequence typedDst = (WifiInfoSampleSequence) sample;
    ...
    protected WifiInfoSampleSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WifiInfoSampleSequenceTypeCode.VALUE,WifiInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WifiInfoSampleSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WifiInfoSampleSequenceTypeCode.VALUE,WifiInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
