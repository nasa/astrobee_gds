...
public class VEStopConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::VEStopConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final VEStopConfigTypeSupport _singleton
    = new VEStopConfigTypeSupport();
    ...
    */
    public static VEStopConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static VEStopConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return VEStopConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return VEStopConfig.create();
    }
    ...
    * <code>this</code> is not a <code>VEStopConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        VEStopConfig typedDst = (VEStopConfig) destination;
        VEStopConfig typedSrc = (VEStopConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        VEStopConfig typedSrc = (VEStopConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.evaluationInterval);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            VEStopConfig typedDst = (VEStopConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.evaluationInterval = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            VEStopConfig typedDst = (VEStopConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        VEStopConfig typedDst
        = (VEStopConfig) instance;
        VEStopConfig typedSrc
        = (VEStopConfig) key;
    ...
    */
    ...
    int mask) {
        return new VEStopConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new VEStopConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected VEStopConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,VEStopConfigTypeCode.VALUE,VEStopConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected VEStopConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,VEStopConfigTypeCode.VALUE,VEStopConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
