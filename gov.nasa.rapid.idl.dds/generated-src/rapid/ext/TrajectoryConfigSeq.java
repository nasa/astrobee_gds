...
/**
* A sequence of TrajectoryConfig instances.
*/
public final class TrajectoryConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TrajectoryConfigSeq() {
        super(TrajectoryConfig.class);
    }

    public TrajectoryConfigSeq (int initialMaximum) {
        super(TrajectoryConfig.class, initialMaximum);
    }

    public TrajectoryConfigSeq (Collection elements) {
        super(TrajectoryConfig.class, elements);
    }
