...
public class ShortMapLayerNameSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ShortMapLayerNameSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortMapLayerNameSequenceTypeSupport _singleton
    = new ShortMapLayerNameSequenceTypeSupport();
    ...
    */
    public static ShortMapLayerNameSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortMapLayerNameSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortMapLayerNameSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortMapLayerNameSequence.create();
    }
    ...
    public Object create_key() {
        return new ShortMapLayerNameSequence();
    }
    ...
    public Class get_type() {
        return ShortMapLayerNameSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ShortMapLayerNameSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortMapLayerNameSequence typedDst = (ShortMapLayerNameSequence) destination;
        ShortMapLayerNameSequence typedSrc = (ShortMapLayerNameSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (32)+1,((rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortMapLayerNameSequence typedSrc = (ShortMapLayerNameSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(32),(rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortMapLayerNameSequence typedDst = (ShortMapLayerNameSequence) dst;
            src.readStringSequence(typedDst.userData, (rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE));
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortMapLayerNameSequence typedDst = (ShortMapLayerNameSequence) sample;
    ...
    protected ShortMapLayerNameSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortMapLayerNameSequenceTypeCode.VALUE,ShortMapLayerNameSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortMapLayerNameSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortMapLayerNameSequenceTypeCode.VALUE,ShortMapLayerNameSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
