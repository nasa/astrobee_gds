...
public class RTrans2DMetaTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RTrans2DMeta";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RTrans2DMetaTypeSupport _singleton
    = new RTrans2DMetaTypeSupport();
    ...
    */
    public static RTrans2DMetaTypeSupport get_instance() {
        return _singleton;
    }

    public static RTrans2DMetaTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RTrans2DMetaTypeCode.VALUE;
    }

    public Object create_data() {
        return RTrans2DMeta.create();
    }
    ...
    * <code>this</code> is not a <code>RTrans2DMeta</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RTrans2DMeta typedDst = (RTrans2DMeta) destination;
        RTrans2DMeta typedSrc = (RTrans2DMeta) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.RTransMetaSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ext.RTransMetaSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RTrans2DMeta typedSrc = (RTrans2DMeta) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ext.RTransMetaSequenceTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.x);

            dst.writeFloat(typedSrc.y);

            dst.writeFloat(typedSrc.theta);

            rapid.ext.RTransMetaSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.meta, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RTrans2DMeta typedDst = (RTrans2DMeta) dst;
            typedDst.clear();      
            try{
                typedDst.x = src.readFloat();
                typedDst.y = src.readFloat();
                typedDst.theta = src.readFloat();
                typedDst.meta = (rapid.ext.RTransMetaSequence)rapid.ext.RTransMetaSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.meta, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.RTransMetaSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RTrans2DMeta typedDst = (RTrans2DMeta) sample;
    ...
    int mask) {
        return new RTrans2DMetaDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RTrans2DMetaDataReader(native_reader, listener, mask, this);   
    ...
    protected RTrans2DMetaTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RTrans2DMetaTypeCode.VALUE,RTrans2DMeta.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RTrans2DMetaTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RTrans2DMetaTypeCode.VALUE,RTrans2DMeta.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
