...
public class ShortMapLayerSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ShortMapLayerSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortMapLayerSequenceTypeSupport _singleton
    = new ShortMapLayerSequenceTypeSupport();
    ...
    */
    public static ShortMapLayerSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortMapLayerSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortMapLayerSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortMapLayerSequence.create();
    }
    ...
    public Object create_key() {
        return new ShortMapLayerSequence();
    }
    ...
    public Class get_type() {
        return ShortMapLayerSequence.class;
    }
    ...
    * <code>this</code> is not a <code>ShortMapLayerSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortMapLayerSequence typedDst = (ShortMapLayerSequence) destination;
        ShortMapLayerSequence typedSrc = (ShortMapLayerSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ShortMapLayerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ShortMapLayerTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortMapLayerSequence typedSrc = (ShortMapLayerSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.ShortMapLayerTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.ShortMapLayerTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,(rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortMapLayerSequence typedDst = (ShortMapLayerSequence) dst;
            rapid.ext.ShortMapLayerTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, (rapid.ext.NAVMAP_NUM_SHORT_LAYERS.VALUE), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ShortMapLayerTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortMapLayerSequence typedDst = (ShortMapLayerSequence) sample;
    ...
    protected ShortMapLayerSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortMapLayerSequenceTypeCode.VALUE,ShortMapLayerSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortMapLayerSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortMapLayerSequenceTypeCode.VALUE,ShortMapLayerSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
