...
public class BatteryInfoConfigTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "rapid::ext::BatteryInfoConfig";
    ...
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.percentageLow);

            dst.writeByte(typedSrc.percentageCritical);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.percentageLow = src.readByte();
                typedDst.percentageCritical = src.readByte();
