...
/**
* A sequence of NavMapConfig instances.
*/
public final class NavMapConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public NavMapConfigSeq() {
        super(NavMapConfig.class);
    }

    public NavMapConfigSeq (int initialMaximum) {
        super(NavMapConfig.class, initialMaximum);
    }

    public NavMapConfigSeq (Collection elements) {
        super(NavMapConfig.class, elements);
    }
