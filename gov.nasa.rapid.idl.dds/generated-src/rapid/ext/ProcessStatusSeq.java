...
/**
* A sequence of ProcessStatus instances.
*/
public final class ProcessStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProcessStatusSeq() {
        super(ProcessStatus.class);
    }

    public ProcessStatusSeq (int initialMaximum) {
        super(ProcessStatus.class, initialMaximum);
    }

    public ProcessStatusSeq (Collection elements) {
        super(ProcessStatus.class, elements);
    }
