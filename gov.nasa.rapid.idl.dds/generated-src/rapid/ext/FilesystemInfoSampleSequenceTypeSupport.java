...
public class FilesystemInfoSampleSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::FilesystemInfoSampleSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FilesystemInfoSampleSequenceTypeSupport _singleton
    = new FilesystemInfoSampleSequenceTypeSupport();
    ...
    */
    public static FilesystemInfoSampleSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static FilesystemInfoSampleSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FilesystemInfoSampleSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return FilesystemInfoSampleSequence.create();
    }
    ...
    public Object create_key() {
        return new FilesystemInfoSampleSequence();
    }
    ...
    public Class get_type() {
        return FilesystemInfoSampleSequence.class;
    }
    ...
    * <code>this</code> is not a <code>FilesystemInfoSampleSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FilesystemInfoSampleSequence typedDst = (FilesystemInfoSampleSequence) destination;
        FilesystemInfoSampleSequence typedSrc = (FilesystemInfoSampleSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FilesystemInfoSampleSequence typedSrc = (FilesystemInfoSampleSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FilesystemInfoSampleSequence typedDst = (FilesystemInfoSampleSequence) dst;
            rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.FilesystemInfoSampleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FilesystemInfoSampleSequence typedDst = (FilesystemInfoSampleSequence) sample;
    ...
    protected FilesystemInfoSampleSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FilesystemInfoSampleSequenceTypeCode.VALUE,FilesystemInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FilesystemInfoSampleSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FilesystemInfoSampleSequenceTypeCode.VALUE,FilesystemInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
