...
public class TrajectoryConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::TrajectoryConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TrajectoryConfigTypeSupport _singleton
    = new TrajectoryConfigTypeSupport();
    ...
    */
    public static TrajectoryConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static TrajectoryConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TrajectoryConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return TrajectoryConfig.create();
    }
    ...
    * <code>this</code> is not a <code>TrajectoryConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TrajectoryConfig typedDst = (TrajectoryConfig) destination;
        TrajectoryConfig typedSrc = (TrajectoryConfig) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TrajectoryConfig typedSrc = (TrajectoryConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TrajectoryConfig typedDst = (TrajectoryConfig) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TrajectoryConfig typedDst = (TrajectoryConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TrajectoryConfig typedDst
        = (TrajectoryConfig) instance;
        TrajectoryConfig typedSrc
        = (TrajectoryConfig) key;
    ...
    */
    ...
    int mask) {
        return new TrajectoryConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TrajectoryConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected TrajectoryConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TrajectoryConfigTypeCode.VALUE,TrajectoryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TrajectoryConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TrajectoryConfigTypeCode.VALUE,TrajectoryConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
