...
public class NetTrafficInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::NetTrafficInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NetTrafficInfoSampleTypeSupport _singleton
    = new NetTrafficInfoSampleTypeSupport();
    ...
    */
    public static NetTrafficInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static NetTrafficInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NetTrafficInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return NetTrafficInfoSample.create();
    }
    ...
    public Object create_key() {
        return new NetTrafficInfoSample();
    }
    ...
    public Class get_type() {
        return NetTrafficInfoSample.class;
    }
    ...
    * <code>this</code> is not a <code>NetTrafficInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NetTrafficInfoSample typedDst = (NetTrafficInfoSample) destination;
        NetTrafficInfoSample typedSrc = (NetTrafficInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NetTrafficInfoSample typedSrc = (NetTrafficInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.rx);

            dst.writeInt(typedSrc.tx);

            dst.writeInt(typedSrc.rxErrors);

            dst.writeInt(typedSrc.txErrors);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NetTrafficInfoSample typedDst = (NetTrafficInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.rx = src.readInt();
                typedDst.tx = src.readInt();
                typedDst.rxErrors = src.readInt();
                typedDst.txErrors = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NetTrafficInfoSample typedDst = (NetTrafficInfoSample) sample;
    ...
    int mask) {
        return new NetTrafficInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NetTrafficInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected NetTrafficInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NetTrafficInfoSampleTypeCode.VALUE,NetTrafficInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NetTrafficInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NetTrafficInfoSampleTypeCode.VALUE,NetTrafficInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
