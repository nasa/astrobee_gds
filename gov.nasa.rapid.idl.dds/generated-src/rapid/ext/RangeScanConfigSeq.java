...
/**
* A sequence of RangeScanConfig instances.
*/
public final class RangeScanConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RangeScanConfigSeq() {
        super(RangeScanConfig.class);
    }

    public RangeScanConfigSeq (int initialMaximum) {
        super(RangeScanConfig.class, initialMaximum);
    }

    public RangeScanConfigSeq (Collection elements) {
        super(RangeScanConfig.class, elements);
    }
