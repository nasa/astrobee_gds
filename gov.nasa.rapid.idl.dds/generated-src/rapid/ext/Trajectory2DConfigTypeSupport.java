...
public class Trajectory2DConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::Trajectory2DConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Trajectory2DConfigTypeSupport _singleton
    = new Trajectory2DConfigTypeSupport();
    ...
    */
    public static Trajectory2DConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static Trajectory2DConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Trajectory2DConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return Trajectory2DConfig.create();
    }
    ...
    public Class get_type() {
        return Trajectory2DConfig.class;
    }
    ...
    * <code>this</code> is not a <code>Trajectory2DConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Trajectory2DConfig typedDst = (Trajectory2DConfig) destination;
        Trajectory2DConfig typedSrc = (Trajectory2DConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.KeyTypeSequence4TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.KeyTypeSequence4TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Trajectory2DConfig typedSrc = (Trajectory2DConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.trajectoryInterp);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.KeyTypeSequence4TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.trajectoryMetaKeys);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().serialize(endpoint_data, typedSrc.trajectoryInterp, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeLong(typedSrc.samplingInterval);

            rapid.KeyTypeSequence4TypeSupport.get_instance().serialize(endpoint_data, typedSrc.trajectoryMetaKeys, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Trajectory2DConfig typedDst = (Trajectory2DConfig) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.trajectoryInterp = (rapid.ext.RTrans2DInterpretation)rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trajectoryInterp, src, false, true, endpoint_plugin_qos);     
                typedDst.samplingInterval = src.readLong();
                typedDst.trajectoryMetaKeys = (rapid.KeyTypeSequence4)rapid.KeyTypeSequence4TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trajectoryMetaKeys, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.RTrans2DInterpretationTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            src.skipLong();

            rapid.KeyTypeSequence4TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Trajectory2DConfig typedDst = (Trajectory2DConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        Trajectory2DConfig typedDst
        = (Trajectory2DConfig) instance;
        Trajectory2DConfig typedSrc
        = (Trajectory2DConfig) key;
    ...
    */
    ...
    int mask) {
        return new Trajectory2DConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new Trajectory2DConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected Trajectory2DConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,Trajectory2DConfigTypeCode.VALUE,Trajectory2DConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Trajectory2DConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Trajectory2DConfigTypeCode.VALUE,Trajectory2DConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
