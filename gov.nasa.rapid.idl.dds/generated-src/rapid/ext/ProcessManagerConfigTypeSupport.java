...
public class ProcessManagerConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessManagerConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessManagerConfigTypeSupport _singleton
    = new ProcessManagerConfigTypeSupport();
    ...
    */
    public static ProcessManagerConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessManagerConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessManagerConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessManagerConfig.create();
    }
    ...
    public Class get_type() {
        return ProcessManagerConfig.class;
    }
    ...
    * <code>this</code> is not a <code>ProcessManagerConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessManagerConfig typedDst = (ProcessManagerConfig) destination;
        ProcessManagerConfig typedSrc = (ProcessManagerConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessManagerConfig typedSrc = (ProcessManagerConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.configName );
        currentAlignment += rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.processes);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.configName,64);

            rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.processes, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessManagerConfig typedDst = (ProcessManagerConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.configName = src.readString(64);
                typedDst.processes = (rapid.ext.ProcessConfigSequence)rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.processes, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.ProcessConfigSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessManagerConfig typedDst = (ProcessManagerConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ProcessManagerConfig typedDst
        = (ProcessManagerConfig) instance;
        ProcessManagerConfig typedSrc
        = (ProcessManagerConfig) key;
    ...
    */
    ...
    int mask) {
        return new ProcessManagerConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ProcessManagerConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected ProcessManagerConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ProcessManagerConfigTypeCode.VALUE,ProcessManagerConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessManagerConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessManagerConfigTypeCode.VALUE,ProcessManagerConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
