...
public class WifiInfoConfigSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::WifiInfoConfigSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WifiInfoConfigSequenceTypeSupport _singleton
    = new WifiInfoConfigSequenceTypeSupport();
    ...
    */
    public static WifiInfoConfigSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static WifiInfoConfigSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WifiInfoConfigSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return WifiInfoConfigSequence.create();
    }
    ...
    public Object create_key() {
        return new WifiInfoConfigSequence();
    }
    ...
    public Class get_type() {
        return WifiInfoConfigSequence.class;
    }
    ...
    * <code>this</code> is not a <code>WifiInfoConfigSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WifiInfoConfigSequence typedDst = (WifiInfoConfigSequence) destination;
        WifiInfoConfigSequence typedSrc = (WifiInfoConfigSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.WifiInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.WifiInfoConfigTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WifiInfoConfigSequence typedSrc = (WifiInfoConfigSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.WifiInfoConfigTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.WifiInfoConfigTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,8, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WifiInfoConfigSequence typedDst = (WifiInfoConfigSequence) dst;
            rapid.ext.WifiInfoConfigTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 8, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.WifiInfoConfigTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WifiInfoConfigSequence typedDst = (WifiInfoConfigSequence) sample;
    ...
    protected WifiInfoConfigSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WifiInfoConfigSequenceTypeCode.VALUE,WifiInfoConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WifiInfoConfigSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WifiInfoConfigSequenceTypeCode.VALUE,WifiInfoConfigSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
