...
public class Transform3DSequence64TypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::Transform3DSequence64";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Transform3DSequence64TypeSupport _singleton
    = new Transform3DSequence64TypeSupport();
    ...
    */
    public static Transform3DSequence64TypeSupport get_instance() {
        return _singleton;
    }

    public static Transform3DSequence64TypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Transform3DSequence64TypeCode.VALUE;
    }

    public Object create_data() {
        return Transform3DSequence64.create();
    }
    ...
    public Object create_key() {
        return new Transform3DSequence64();
    }
    ...
    public Class get_type() {
        return Transform3DSequence64.class;
    }
    ...
    * <code>this</code> is not a <code>Transform3DSequence64</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Transform3DSequence64 typedDst = (Transform3DSequence64) destination;
        Transform3DSequence64 typedSrc = (Transform3DSequence64) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Transform3DSequence64 typedSrc = (Transform3DSequence64) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.Transform3DTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Transform3DTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,64, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Transform3DSequence64 typedDst = (Transform3DSequence64) dst;
            rapid.Transform3DTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 64, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.Transform3DTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Transform3DSequence64 typedDst = (Transform3DSequence64) sample;
    ...
    protected Transform3DSequence64TypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Transform3DSequence64TypeCode.VALUE,Transform3DSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Transform3DSequence64TypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Transform3DSequence64TypeCode.VALUE,Transform3DSequence64.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
