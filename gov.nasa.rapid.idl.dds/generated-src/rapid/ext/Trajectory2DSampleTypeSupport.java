...
public class Trajectory2DSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::Trajectory2DSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Trajectory2DSampleTypeSupport _singleton
    = new Trajectory2DSampleTypeSupport();
    ...
    */
    public static Trajectory2DSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static Trajectory2DSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Trajectory2DSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return Trajectory2DSample.create();
    }
    ...
    public Class get_type() {
        return Trajectory2DSample.class;
    }
    ...
    * <code>this</code> is not a <code>Trajectory2DSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Trajectory2DSample typedDst = (Trajectory2DSample) destination;
        Trajectory2DSample typedSrc = (Trajectory2DSample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Trajectory2DSample typedSrc = (Trajectory2DSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.RTrans2DSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.trajectory);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.Transform3DTypeSupport.get_instance().serialize(endpoint_data, typedSrc.origin, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.RTrans2DSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.trajectory, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Trajectory2DSample typedDst = (Trajectory2DSample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.origin = (rapid.Transform3D)rapid.Transform3DTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.origin, src, false, true, endpoint_plugin_qos);     
                typedDst.trajectory = (rapid.ext.RTrans2DSequence)rapid.ext.RTrans2DSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trajectory, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.RTrans2DSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Trajectory2DSample typedDst = (Trajectory2DSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        Trajectory2DSample typedDst
        = (Trajectory2DSample) instance;
        Trajectory2DSample typedSrc
        = (Trajectory2DSample) key;
    ...
    */
    ...
    int mask) {
        return new Trajectory2DSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new Trajectory2DSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected Trajectory2DSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,Trajectory2DSampleTypeCode.VALUE,Trajectory2DSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Trajectory2DSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Trajectory2DSampleTypeCode.VALUE,Trajectory2DSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
