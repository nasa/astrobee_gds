...
/**
* A sequence of ProcessIoSample instances.
*/
public final class ProcessIoSampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProcessIoSampleSeq() {
        super(ProcessIoSample.class);
    }

    public ProcessIoSampleSeq (int initialMaximum) {
        super(ProcessIoSample.class, initialMaximum);
    }

    public ProcessIoSampleSeq (Collection elements) {
        super(ProcessIoSample.class, elements);
    }
