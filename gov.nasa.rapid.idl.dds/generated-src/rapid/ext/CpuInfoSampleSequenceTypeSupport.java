...
public class CpuInfoSampleSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::CpuInfoSampleSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CpuInfoSampleSequenceTypeSupport _singleton
    = new CpuInfoSampleSequenceTypeSupport();
    ...
    */
    public static CpuInfoSampleSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static CpuInfoSampleSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CpuInfoSampleSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return CpuInfoSampleSequence.create();
    }
    ...
    public Object create_key() {
        return new CpuInfoSampleSequence();
    }
    ...
    public Class get_type() {
        return CpuInfoSampleSequence.class;
    }
    ...
    * <code>this</code> is not a <code>CpuInfoSampleSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CpuInfoSampleSequence typedDst = (CpuInfoSampleSequence) destination;
        CpuInfoSampleSequence typedSrc = (CpuInfoSampleSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.CpuInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 32);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.CpuInfoSampleTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CpuInfoSampleSequence typedSrc = (CpuInfoSampleSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.CpuInfoSampleTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.CpuInfoSampleTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,32, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CpuInfoSampleSequence typedDst = (CpuInfoSampleSequence) dst;
            rapid.ext.CpuInfoSampleTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 32, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.CpuInfoSampleTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CpuInfoSampleSequence typedDst = (CpuInfoSampleSequence) sample;
    ...
    protected CpuInfoSampleSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CpuInfoSampleSequenceTypeCode.VALUE,CpuInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CpuInfoSampleSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CpuInfoSampleSequenceTypeCode.VALUE,CpuInfoSampleSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
