...
public class RangeScanConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RangeScanConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RangeScanConfigTypeSupport _singleton
    = new RangeScanConfigTypeSupport();
    ...
    */
    public static RangeScanConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static RangeScanConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RangeScanConfigTypeCode.VALUE;
    }

    public Object create_data() {
        return RangeScanConfig.create();
    }
    ...
    * <code>this</code> is not a <code>RangeScanConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RangeScanConfig typedDst = (RangeScanConfig) destination;
        RangeScanConfig typedSrc = (RangeScanConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.RangeScanDirectionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ext.RangeScanDirectionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RangeScanConfig typedSrc = (RangeScanConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.referenceFrame );
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scanLengths);
        currentAlignment += rapid.ext.RangeScanDirectionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scanDirection);
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scanAzimuth);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ShortSequence64TypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scanElevation);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.referenceFrame,128);

            rapid.ShortSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.scanLengths, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ext.RangeScanDirectionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scanDirection, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.ShortSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.scanAzimuth, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.scanAzimuthScale);

            rapid.ShortSequence64TypeSupport.get_instance().serialize(endpoint_data, typedSrc.scanElevation, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeFloat(typedSrc.scanElevationScale);

            dst.writeFloat(typedSrc.rangeScale);

            dst.writeFloat(typedSrc.intensityScale);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RangeScanConfig typedDst = (RangeScanConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.referenceFrame = src.readString(128);
                typedDst.scanLengths = (rapid.ShortSequence64)rapid.ShortSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scanLengths, src, false, true, endpoint_plugin_qos);     
                typedDst.scanDirection = (rapid.ext.RangeScanDirection)rapid.ext.RangeScanDirectionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scanDirection, src, false, true, endpoint_plugin_qos);     
                typedDst.scanAzimuth = (rapid.ShortSequence64)rapid.ShortSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scanAzimuth, src, false, true, endpoint_plugin_qos);     
                typedDst.scanAzimuthScale = src.readFloat();
                typedDst.scanElevation = (rapid.ShortSequence64)rapid.ShortSequence64TypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scanElevation, src, false, true, endpoint_plugin_qos);     
                typedDst.scanElevationScale = src.readFloat();
                typedDst.rangeScale = src.readFloat();
                typedDst.intensityScale = src.readFloat();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ShortSequence64TypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.ext.RangeScanDirectionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RangeScanConfig typedDst = (RangeScanConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RangeScanConfig typedDst
        = (RangeScanConfig) instance;
        RangeScanConfig typedSrc
        = (RangeScanConfig) key;
    ...
    */
    ...
    int mask) {
        return new RangeScanConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RangeScanConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected RangeScanConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RangeScanConfigTypeCode.VALUE,RangeScanConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RangeScanConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RangeScanConfigTypeCode.VALUE,RangeScanConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
