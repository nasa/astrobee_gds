...
/**
* A sequence of VEStopState instances.
*/
public final class VEStopStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public VEStopStateSeq() {
        super(VEStopState.class);
    }

    public VEStopStateSeq (int initialMaximum) {
        super(VEStopState.class, initialMaximum);
    }

    public VEStopStateSeq (Collection elements) {
        super(VEStopState.class, elements);
    }
