...
/**
* A sequence of WifiInfoConfig instances.
*/
public final class WifiInfoConfigSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WifiInfoConfigSeq() {
        super(WifiInfoConfig.class);
    }

    public WifiInfoConfigSeq (int initialMaximum) {
        super(WifiInfoConfig.class, initialMaximum);
    }

    public WifiInfoConfigSeq (Collection elements) {
        super(WifiInfoConfig.class, elements);
    }
