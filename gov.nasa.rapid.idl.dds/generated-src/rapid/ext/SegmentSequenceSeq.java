...
/**
* A sequence of SegmentSequence instances.
*/
public final class SegmentSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SegmentSequenceSeq() {
        super(SegmentSequence.class);
    }

    public SegmentSequenceSeq (int initialMaximum) {
        super(SegmentSequence.class, initialMaximum);
    }

    public SegmentSequenceSeq (Collection elements) {
        super(SegmentSequence.class, elements);
    }
