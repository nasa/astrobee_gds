...
public class ProcessManagerStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::ProcessManagerState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessManagerStateTypeSupport _singleton
    = new ProcessManagerStateTypeSupport();
    ...
    */
    public static ProcessManagerStateTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessManagerStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessManagerStateTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessManagerState.create();
    }
    ...
    public Class get_type() {
        return ProcessManagerState.class;
    }
    ...
    * <code>this</code> is not a <code>ProcessManagerState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessManagerState typedDst = (ProcessManagerState) destination;
        ProcessManagerState typedSrc = (ProcessManagerState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        /** status sequence corresponds with ProcessManagerConfig.processes sequence */
        currentAlignment += rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessManagerState typedSrc = (ProcessManagerState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        /** status sequence corresponds with ProcessManagerConfig.processes sequence */
        currentAlignment += rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.processStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.processStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessManagerState typedDst = (ProcessManagerState) dst;
            typedDst.clear();      
            ...
            try{
                /** status sequence corresponds with ProcessManagerConfig.processes sequence */
                typedDst.processStatus = (rapid.ext.ProcessStatusSequence)rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.processStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            /** status sequence corresponds with ProcessManagerConfig.processes sequence */
            rapid.ext.ProcessStatusSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessManagerState typedDst = (ProcessManagerState) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ProcessManagerState typedDst
        = (ProcessManagerState) instance;
        ProcessManagerState typedSrc
        = (ProcessManagerState) key;
    ...
    */
    ...
    int mask) {
        return new ProcessManagerStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ProcessManagerStateDataReader(native_reader, listener, mask, this);   
    ...
    protected ProcessManagerStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ProcessManagerStateTypeCode.VALUE,ProcessManagerState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessManagerStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessManagerStateTypeCode.VALUE,ProcessManagerState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
