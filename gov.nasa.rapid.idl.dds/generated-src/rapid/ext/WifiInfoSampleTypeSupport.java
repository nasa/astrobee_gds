...
public class WifiInfoSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::WifiInfoSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WifiInfoSampleTypeSupport _singleton
    = new WifiInfoSampleTypeSupport();
    ...
    */
    public static WifiInfoSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static WifiInfoSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WifiInfoSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return WifiInfoSample.create();
    }
    ...
    * <code>this</code> is not a <code>WifiInfoSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WifiInfoSample typedDst = (WifiInfoSample) destination;
        WifiInfoSample typedSrc = (WifiInfoSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WifiInfoSample typedSrc = (WifiInfoSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.linkQuality);

            dst.writeInt(typedSrc.signalLevel);

            dst.writeInt(typedSrc.noiseLevel);

            dst.writeFloat(typedSrc.frequency);

            dst.writeFloat(typedSrc.bitrate);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WifiInfoSample typedDst = (WifiInfoSample) dst;
            typedDst.clear();      
            try{
                typedDst.linkQuality = src.readInt();
                typedDst.signalLevel = src.readInt();
                typedDst.noiseLevel = src.readInt();
                typedDst.frequency = src.readFloat();
                typedDst.bitrate = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WifiInfoSample typedDst = (WifiInfoSample) sample;
    ...
    int mask) {
        return new WifiInfoSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WifiInfoSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected WifiInfoSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WifiInfoSampleTypeCode.VALUE,WifiInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WifiInfoSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WifiInfoSampleTypeCode.VALUE,WifiInfoSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
