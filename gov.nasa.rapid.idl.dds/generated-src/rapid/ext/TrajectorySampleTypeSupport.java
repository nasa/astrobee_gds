...
public class TrajectorySampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::TrajectorySample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TrajectorySampleTypeSupport _singleton
    = new TrajectorySampleTypeSupport();
    ...
    */
    public static TrajectorySampleTypeSupport get_instance() {
        return _singleton;
    }

    public static TrajectorySampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TrajectorySampleTypeCode.VALUE;
    }

    public Object create_data() {
        return TrajectorySample.create();
    }
    ...
    * <code>this</code> is not a <code>TrajectorySample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TrajectorySample typedDst = (TrajectorySample) destination;
        TrajectorySample typedSrc = (TrajectorySample) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SegmentSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.SegmentSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TrajectorySample typedSrc = (TrajectorySample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.SegmentSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.geometricSegments);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.SegmentSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.geometricSegments, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TrajectorySample typedDst = (TrajectorySample) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.geometricSegments = (rapid.ext.SegmentSequence)rapid.ext.SegmentSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.geometricSegments, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.SegmentSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TrajectorySample typedDst = (TrajectorySample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TrajectorySample typedDst
        = (TrajectorySample) instance;
        TrajectorySample typedSrc
        = (TrajectorySample) key;
    ...
    */
    ...
    int mask) {
        return new TrajectorySampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TrajectorySampleDataReader(native_reader, listener, mask, this);   
    ...
    protected TrajectorySampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TrajectorySampleTypeCode.VALUE,TrajectorySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TrajectorySampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TrajectorySampleTypeCode.VALUE,TrajectorySample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
