...
public class RTrans2DSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ext::RTrans2DSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RTrans2DSequenceTypeSupport _singleton
    = new RTrans2DSequenceTypeSupport();
    ...
    */
    public static RTrans2DSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static RTrans2DSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RTrans2DSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return RTrans2DSequence.create();
    }
    ...
    * <code>this</code> is not a <code>RTrans2DSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RTrans2DSequence typedDst = (RTrans2DSequence) destination;
        RTrans2DSequence typedSrc = (RTrans2DSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DMetaTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 512);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ext.RTrans2DMetaTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RTrans2DSequence typedSrc = (RTrans2DSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.ext.RTrans2DMetaTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.ext.RTrans2DMetaTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,512, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RTrans2DSequence typedDst = (RTrans2DSequence) dst;
            rapid.ext.RTrans2DMetaTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 512, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ext.RTrans2DMetaTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RTrans2DSequence typedDst = (RTrans2DSequence) sample;
    ...
    protected RTrans2DSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RTrans2DSequenceTypeCode.VALUE,RTrans2DSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RTrans2DSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RTrans2DSequenceTypeCode.VALUE,RTrans2DSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
