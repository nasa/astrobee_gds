...
/**
* A sequence of MacroInfo instances.
*/
public final class MacroInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MacroInfoSeq() {
        super(MacroInfo.class);
    }

    public MacroInfoSeq (int initialMaximum) {
        super(MacroInfo.class, initialMaximum);
    }

    public MacroInfoSeq (Collection elements) {
        super(MacroInfo.class, elements);
    }
