...
public class NamedOptionSetValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::NamedOptionSetValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final NamedOptionSetValueTypeSupport _singleton
    = new NamedOptionSetValueTypeSupport();
    ...
    */
    public static NamedOptionSetValueTypeSupport get_instance() {
        return _singleton;
    }

    public static NamedOptionSetValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return NamedOptionSetValueTypeCode.VALUE;
    }

    public Object create_data() {
        return NamedOptionSetValue.create();
    }
    ...
    public Object create_key() {
        return new NamedOptionSetValue();
    }
    ...
    public Class get_type() {
        return NamedOptionSetValue.class;
    }
    ...
    * <code>this</code> is not a <code>NamedOptionSetValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        NamedOptionSetValue typedDst = (NamedOptionSetValue) destination;
        NamedOptionSetValue typedSrc = (NamedOptionSetValue) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.OptionSetValueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.OptionSetValueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        NamedOptionSetValue typedSrc = (NamedOptionSetValue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.OptionSetValueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.option);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.OptionSetValueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.option, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            NamedOptionSetValue typedDst = (NamedOptionSetValue) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(16);
                typedDst.option = (rapid.OptionSetValue)rapid.OptionSetValueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.option, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.OptionSetValueTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            NamedOptionSetValue typedDst = (NamedOptionSetValue) sample;
    ...
    int mask) {
        return new NamedOptionSetValueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new NamedOptionSetValueDataReader(native_reader, listener, mask, this);   
    ...
    protected NamedOptionSetValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,NamedOptionSetValueTypeCode.VALUE,NamedOptionSetValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected NamedOptionSetValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,NamedOptionSetValueTypeCode.VALUE,NamedOptionSetValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
