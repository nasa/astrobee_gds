...
/**
* A sequence of LongSequence2K instances.
*/
public final class LongSequence2KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LongSequence2KSeq() {
        super(LongSequence2K.class);
    }

    public LongSequence2KSeq (int initialMaximum) {
        super(LongSequence2K.class, initialMaximum);
    }

    public LongSequence2KSeq (Collection elements) {
        super(LongSequence2K.class, elements);
    }
