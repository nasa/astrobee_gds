...
*/
public final class ShortSequence32Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShortSequence32Seq() {
        super(ShortSequence32.class);
    }

    public ShortSequence32Seq (int initialMaximum) {
        super(ShortSequence32.class, initialMaximum);
    }

    public ShortSequence32Seq (Collection elements) {
        super(ShortSequence32.class, elements);
    }
