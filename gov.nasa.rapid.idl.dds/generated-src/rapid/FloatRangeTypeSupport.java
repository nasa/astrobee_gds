...
public class FloatRangeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FloatRange";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FloatRangeTypeSupport _singleton
    = new FloatRangeTypeSupport();
    ...
    */
    public static FloatRangeTypeSupport get_instance() {
        return _singleton;
    }

    public static FloatRangeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FloatRangeTypeCode.VALUE;
    }

    public Object create_data() {
        return FloatRange.create();
    }
    ...
    * <code>this</code> is not a <code>FloatRange</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FloatRange typedDst = (FloatRange) destination;
        FloatRange typedSrc = (FloatRange) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FloatRange typedSrc = (FloatRange) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FloatRange typedDst = (FloatRange) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FloatRange typedDst = (FloatRange) sample;
    ...
    int mask) {
        return new FloatRangeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FloatRangeDataReader(native_reader, listener, mask, this);   
    ...
    protected FloatRangeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FloatRangeTypeCode.VALUE,FloatRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FloatRangeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FloatRangeTypeCode.VALUE,FloatRange.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
