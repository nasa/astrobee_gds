...
public class FileQueueReceiverSampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::FileQueueReceiverSample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileQueueReceiverSampleTypeSupport _singleton
    = new FileQueueReceiverSampleTypeSupport();
    ...
    */
    public static FileQueueReceiverSampleTypeSupport get_instance() {
        return _singleton;
    }

    public static FileQueueReceiverSampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileQueueReceiverSampleTypeCode.VALUE;
    }

    public Object create_data() {
        return FileQueueReceiverSample.create();
    }
    ...
    public Object create_key() {
        return new FileQueueReceiverSample();
    }
    ...
    public Class get_type() {
        return FileQueueReceiverSample.class;
    }
    ...
    * <code>this</code> is not a <code>FileQueueReceiverSample</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileQueueReceiverSample typedDst = (FileQueueReceiverSample) destination;
        FileQueueReceiverSample typedSrc = (FileQueueReceiverSample) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileQueueReceiverSample typedSrc = (FileQueueReceiverSample) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.bufferedChunks);

            dst.writeInt(typedSrc.processedChunks);

            dst.writeInt(typedSrc.completedFiles);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileQueueReceiverSample typedDst = (FileQueueReceiverSample) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.bufferedChunks = src.readInt();
                typedDst.processedChunks = src.readInt();
                typedDst.completedFiles = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileQueueReceiverSample typedDst = (FileQueueReceiverSample) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileQueueReceiverSample typedDst
        = (FileQueueReceiverSample) instance;
        FileQueueReceiverSample typedSrc
        = (FileQueueReceiverSample) key;
    ...
    */
    ...
    int mask) {
        return new FileQueueReceiverSampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileQueueReceiverSampleDataReader(native_reader, listener, mask, this);   
    ...
    protected FileQueueReceiverSampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileQueueReceiverSampleTypeCode.VALUE,FileQueueReceiverSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileQueueReceiverSampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileQueueReceiverSampleTypeCode.VALUE,FileQueueReceiverSample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
