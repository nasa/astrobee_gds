...
public class SubsystemTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::SubsystemType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubsystemTypeTypeSupport _singleton
    = new SubsystemTypeTypeSupport();
    ...
    */
    public static SubsystemTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static SubsystemTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubsystemTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return SubsystemType.create();
    }
    ...
    * <code>this</code> is not a <code>SubsystemType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubsystemType typedDst = (SubsystemType) destination;
        SubsystemType typedSrc = (SubsystemType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandDefSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.CommandDefSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubsystemType typedSrc = (SubsystemType) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.CommandDefSequenceTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.CommandDefSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.commands, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubsystemType typedDst = (SubsystemType) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(32);
                typedDst.commands = (rapid.CommandDefSequence)rapid.CommandDefSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.commands, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.CommandDefSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubsystemType typedDst = (SubsystemType) sample;
    ...
    int mask) {
        return new SubsystemTypeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SubsystemTypeDataReader(native_reader, listener, mask, this);   
    ...
    protected SubsystemTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubsystemTypeTypeCode.VALUE,SubsystemType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubsystemTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubsystemTypeTypeCode.VALUE,SubsystemType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
