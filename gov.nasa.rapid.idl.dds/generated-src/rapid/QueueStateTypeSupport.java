...
public class QueueStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::QueueState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final QueueStateTypeSupport _singleton
    = new QueueStateTypeSupport();
    ...
    */
    public static QueueStateTypeSupport get_instance() {
        return _singleton;
    }

    public static QueueStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return QueueStateTypeCode.VALUE;
    }

    public Object create_data() {
        return QueueState.create();
    }
    ...
    * <code>this</code> is not a <code>QueueState</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        QueueState typedDst = (QueueState) destination;
        QueueState typedSrc = (QueueState) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        QueueState typedSrc = (QueueState) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.pending);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.active);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.completed);
        currentAlignment += rapid.SingleQueueTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.sent);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.SingleQueueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.pending, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.SingleQueueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.active, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.SingleQueueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.completed, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.SingleQueueTypeSupport.get_instance().serialize(endpoint_data, typedSrc.sent, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            QueueState typedDst = (QueueState) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.pending = (rapid.SingleQueue)rapid.SingleQueueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.pending, src, false, true, endpoint_plugin_qos);     
                typedDst.active = (rapid.SingleQueue)rapid.SingleQueueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.active, src, false, true, endpoint_plugin_qos);     
                typedDst.completed = (rapid.SingleQueue)rapid.SingleQueueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.completed, src, false, true, endpoint_plugin_qos);     
                typedDst.sent = (rapid.SingleQueue)rapid.SingleQueueTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.sent, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.SingleQueueTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            QueueState typedDst = (QueueState) sample;
    ...
    */
    ...
    int mask) {
        return new QueueStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new QueueStateDataReader(native_reader, listener, mask, this);   
    ...
    protected QueueStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,QueueStateTypeCode.VALUE,QueueState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected QueueStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,QueueStateTypeCode.VALUE,QueueState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
