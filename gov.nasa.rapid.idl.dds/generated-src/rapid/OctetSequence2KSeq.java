...
/**
* A sequence of OctetSequence2K instances.
*/
public final class OctetSequence2KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence2KSeq() {
        super(OctetSequence2K.class);
    }

    public OctetSequence2KSeq (int initialMaximum) {
        super(OctetSequence2K.class, initialMaximum);
    }

    public OctetSequence2KSeq (Collection elements) {
        super(OctetSequence2K.class, elements);
    }
