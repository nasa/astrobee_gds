...
/**
* A sequence of DoubleSequence1K instances.
*/
public final class DoubleSequence1KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DoubleSequence1KSeq() {
        super(DoubleSequence1K.class);
    }

    public DoubleSequence1KSeq (int initialMaximum) {
        super(DoubleSequence1K.class, initialMaximum);
    }

    public DoubleSequence1KSeq (Collection elements) {
        super(DoubleSequence1K.class, elements);
    }
