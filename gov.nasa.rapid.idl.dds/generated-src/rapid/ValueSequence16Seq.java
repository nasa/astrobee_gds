...
/**
* A sequence of ValueSequence16 instances.
*/
public final class ValueSequence16Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ValueSequence16Seq() {
        super(ValueSequence16.class);
    }

    public ValueSequence16Seq (int initialMaximum) {
        super(ValueSequence16.class, initialMaximum);
    }

    public ValueSequence16Seq (Collection elements) {
        super(ValueSequence16.class, elements);
    }
