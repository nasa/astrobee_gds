...
public class MacroInfoSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::MacroInfoSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MacroInfoSequenceTypeSupport _singleton
    = new MacroInfoSequenceTypeSupport();
    ...
    */
    public static MacroInfoSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static MacroInfoSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MacroInfoSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return MacroInfoSequence.create();
    }
    ...
    public Class get_type() {
        return MacroInfoSequence.class;
    }
    ...
    * <code>this</code> is not a <code>MacroInfoSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MacroInfoSequence typedDst = (MacroInfoSequence) destination;
        MacroInfoSequence typedSrc = (MacroInfoSequence) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 128);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.MacroInfoTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MacroInfoSequence typedSrc = (MacroInfoSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.MacroInfoTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.MacroInfoTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,128, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MacroInfoSequence typedDst = (MacroInfoSequence) dst;
            rapid.MacroInfoTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, 128, endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.MacroInfoTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MacroInfoSequence typedDst = (MacroInfoSequence) sample;
    ...
    protected MacroInfoSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MacroInfoSequenceTypeCode.VALUE,MacroInfoSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MacroInfoSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MacroInfoSequenceTypeCode.VALUE,MacroInfoSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
