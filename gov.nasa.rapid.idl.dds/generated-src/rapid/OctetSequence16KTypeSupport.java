...
public class OctetSequence16KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::OctetSequence16K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OctetSequence16KTypeSupport _singleton
    = new OctetSequence16KTypeSupport();
    ...
    */
    public static OctetSequence16KTypeSupport get_instance() {
        return _singleton;
    }

    public static OctetSequence16KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OctetSequence16KTypeCode.VALUE;
    }

    public Object create_data() {
        return OctetSequence16K.create();
    }
    ...
    * <code>this</code> is not a <code>OctetSequence16K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OctetSequence16K typedDst = (OctetSequence16K) destination;
        OctetSequence16K typedSrc = (OctetSequence16K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 16384);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OctetSequence16K typedSrc = (OctetSequence16K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.userData,16384);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OctetSequence16K typedDst = (OctetSequence16K) dst;
            src.readByteSequence(typedDst.userData, 16384);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OctetSequence16K typedDst = (OctetSequence16K) sample;
    ...
    protected OctetSequence16KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OctetSequence16KTypeCode.VALUE,OctetSequence16K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OctetSequence16KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OctetSequence16KTypeCode.VALUE,OctetSequence16K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
