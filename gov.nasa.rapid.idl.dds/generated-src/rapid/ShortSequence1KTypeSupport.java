...
public class ShortSequence1KTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::ShortSequence1K";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShortSequence1KTypeSupport _singleton
    = new ShortSequence1KTypeSupport();
    ...
    */
    public static ShortSequence1KTypeSupport get_instance() {
        return _singleton;
    }

    public static ShortSequence1KTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShortSequence1KTypeCode.VALUE;
    }

    public Object create_data() {
        return ShortSequence1K.create();
    }
    ...
    * <code>this</code> is not a <code>ShortSequence1K</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ShortSequence1K typedDst = (ShortSequence1K) destination;
        ShortSequence1K typedSrc = (ShortSequence1K) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 1024);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ShortSequence1K typedSrc = (ShortSequence1K) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeShortSeq(typedSrc.userData,1024);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ShortSequence1K typedDst = (ShortSequence1K) dst;
            src.readShortSequence(typedDst.userData, 1024);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ShortSequence1K typedDst = (ShortSequence1K) sample;
    ...
    protected ShortSequence1KTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ShortSequence1KTypeCode.VALUE,ShortSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ShortSequence1KTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ShortSequence1KTypeCode.VALUE,ShortSequence1K.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
