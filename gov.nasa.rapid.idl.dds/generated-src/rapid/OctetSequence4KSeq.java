...
/**
* A sequence of OctetSequence4K instances.
*/
public final class OctetSequence4KSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OctetSequence4KSeq() {
        super(OctetSequence4K.class);
    }

    public OctetSequence4KSeq (int initialMaximum) {
        super(OctetSequence4K.class, initialMaximum);
    }

    public OctetSequence4KSeq (Collection elements) {
        super(OctetSequence4K.class, elements);
    }
