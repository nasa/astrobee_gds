...
public class KeyTypeValueTripleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::KeyTypeValueTriple";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final KeyTypeValueTripleTypeSupport _singleton
    = new KeyTypeValueTripleTypeSupport();
    ...
    */
    public static KeyTypeValueTripleTypeSupport get_instance() {
        return _singleton;
    }

    public static KeyTypeValueTripleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return KeyTypeValueTripleTypeCode.VALUE;
    }

    public Object create_data() {
        return KeyTypeValueTriple.create();
    }
    ...
    public Class get_type() {
        return KeyTypeValueTriple.class;
    }
    ...
    * <code>this</code> is not a <code>KeyTypeValueTriple</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        KeyTypeValueTriple typedDst = (KeyTypeValueTriple) destination;
        KeyTypeValueTriple typedSrc = (KeyTypeValueTriple) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        /** Place-holder to keep binary layout of the struct backward compatible. Data type should be set in ParameterUnion */
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        KeyTypeValueTriple typedSrc = (KeyTypeValueTriple) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.key );
        /** Place-holder to keep binary layout of the struct backward compatible. Data type should be set in ParameterUnion */
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += rapid.ParameterUnionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.value);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.key,32);
            /** Place-holder to keep binary layout of the struct backward compatible. Data type should be set in ParameterUnion */

            dst.writeInt(typedSrc.padding);

            rapid.ParameterUnionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.value, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            KeyTypeValueTriple typedDst = (KeyTypeValueTriple) dst;
            typedDst.clear();      
            try{
                typedDst.key = src.readString(32);
                /** Place-holder to keep binary layout of the struct backward compatible. Data type should be set in ParameterUnion */
                typedDst.padding = src.readInt();
                typedDst.value = (rapid.ParameterUnion)rapid.ParameterUnionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.value, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.ParameterUnionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            KeyTypeValueTriple typedDst = (KeyTypeValueTriple) sample;
    ...
    int mask) {
        return new KeyTypeValueTripleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new KeyTypeValueTripleDataReader(native_reader, listener, mask, this);   
    ...
    protected KeyTypeValueTripleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,KeyTypeValueTripleTypeCode.VALUE,KeyTypeValueTriple.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected KeyTypeValueTripleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,KeyTypeValueTripleTypeCode.VALUE,KeyTypeValueTriple.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
