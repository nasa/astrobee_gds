...
/**
* A sequence of FloatSequence512 instances.
*/
public final class FloatSequence512Seq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FloatSequence512Seq() {
        super(FloatSequence512.class);
    }

    public FloatSequence512Seq (int initialMaximum) {
        super(FloatSequence512.class, initialMaximum);
    }

    public FloatSequence512Seq (Collection elements) {
        super(FloatSequence512.class, elements);
    }
