...
public class CommandConfigTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::CommandConfig";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CommandConfigTypeSupport _singleton
    = new CommandConfigTypeSupport();
    ...
    */
    public static CommandConfigTypeSupport get_instance() {
        return _singleton;
    }

    public static CommandConfigTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CommandConfigTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CommandConfig</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CommandConfig typedDst = (CommandConfig) destination;
        CommandConfig typedSrc = (CommandConfig) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SubsystemTypeSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SubsystemSequenceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.SubsystemTypeSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += rapid.SubsystemSequenceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CommandConfig typedSrc = (CommandConfig) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += rapid.SubsystemTypeSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.availableSubsystemTypes);
        currentAlignment += rapid.SubsystemSequenceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.availableSubsystems);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            rapid.SubsystemTypeSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.availableSubsystemTypes, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.SubsystemSequenceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.availableSubsystems, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CommandConfig typedDst = (CommandConfig) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.availableSubsystemTypes = (rapid.SubsystemTypeSequence)rapid.SubsystemTypeSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.availableSubsystemTypes, src, false, true, endpoint_plugin_qos);     
                typedDst.availableSubsystems = (rapid.SubsystemSequence)rapid.SubsystemSequenceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.availableSubsystems, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.SubsystemTypeSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            rapid.SubsystemSequenceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CommandConfig typedDst = (CommandConfig) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        CommandConfig typedDst
        = (CommandConfig) instance;
        CommandConfig typedSrc
        = (CommandConfig) key;
    ...
    */
    ...
    int mask) {
        return new CommandConfigDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CommandConfigDataReader(native_reader, listener, mask, this);   
    ...
    protected CommandConfigTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,CommandConfigTypeCode.VALUE,CommandConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CommandConfigTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CommandConfigTypeCode.VALUE,CommandConfig.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
