...
/**
* A reader for the Message user type.
*/
public class MessageDataReader extends DataReaderImpl {
    ...
    public void read_next_sample(Message received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(Message received_data, SampleInfo sample_info) {
