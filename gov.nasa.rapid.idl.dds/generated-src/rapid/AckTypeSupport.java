...
public class AckTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rapid::Ack";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AckTypeSupport _singleton
    = new AckTypeSupport();
    ...
    */
    public static AckTypeSupport get_instance() {
        return _singleton;
    }

    public static AckTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AckTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Ack</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Ack typedDst = (Ack) destination;
        Ack typedSrc = (Ack) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.AckCompletedStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += rapid.AckCompletedStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.cmdId );
        ...
        currentAlignment += rapid.AckCompletedStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.completedStatus);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.message );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.cmdId,64);

            rapid.AckStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            rapid.AckCompletedStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.completedStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.message,128);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.cmdId = src.readString(64);
                typedDst.status = (rapid.AckStatus)rapid.AckStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                typedDst.completedStatus = (rapid.AckCompletedStatus)rapid.AckCompletedStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.completedStatus, src, false, true, endpoint_plugin_qos);     
                typedDst.message = src.readString(128);
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            rapid.AckCompletedStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
    ...
    */
    ...
    int mask) {
        return new AckDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new AckDataReader(native_reader, listener, mask, this);   
    ...
    protected AckTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,AckTypeCode.VALUE,Ack.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AckTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AckTypeCode.VALUE,Ack.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
