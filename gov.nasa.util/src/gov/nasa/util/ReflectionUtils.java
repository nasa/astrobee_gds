...
public class ReflectionUtils {
	...
	public static Field getField(Class<?> clazz, String fieldName) {
		List<Object> key = Arrays.asList(new Object[] { clazz, fieldName });
	...
	public static void set(Object target, String fieldName, Object value) {
		...
		synchronized (field) {
			try {
				...
				logger.error("That's un-possible!", e);
			} finally {
				field.setAccessible(oldAccessibility);
			}
		}
	...
	public static Method getMethod(Class<?> clazz, String methodName, Object... arguments) {
		List<Object> key = Arrays.asList(new Object[] { clazz, methodName, getClassNames(arguments) });
	...
	@SuppressWarnings("unchecked")
	public static <T> T invokeStatic(Class<? extends Object> clazz, String methodName, Object... arguments) {
		return (T) invoke(clazz, null, methodName, arguments);
	}

	private static Object invoke(Class<? extends Object> clazz, Object target, String methodName, Object... arguments) {
		Method method = getMethod(clazz, methodName, arguments);
		if (method == null)
			throw new IllegalArgumentException("Unable to find method " + methodName + "(" + getClassNames(arguments) + ")"
					+ " in class hierarchy of " + clazz);
