...
public class RectangularPyramid extends Mesh {
     ...
     */
    public RectangularPyramid(final String name, final double width, final double length, final double height) {
        super(name);
        _width = width;
        _length = length;
        _height = height;
    ...
    private void setVertexData() {
        ...
        final Vector3 vert0 = new Vector3(-_width / 2, -_height / 2, -_length / 2);
        final Vector3 vert1 = new Vector3(_width / 2, -_height / 2, -_length / 2);
        final Vector3 vert2 = new Vector3(_width / 2, -_height / 2, _length / 2);
        final Vector3 vert3 = new Vector3(-_width / 2, -_height / 2, _length / 2);
