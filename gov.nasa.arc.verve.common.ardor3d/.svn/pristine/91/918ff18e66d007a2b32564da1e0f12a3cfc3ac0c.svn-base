...
public class MeasureLine extends Node {
     ...
     * @param name
     */
    public MeasureLine(String name) {
        super(name);
        m_frame.setIdentity();
        ...
        //RenderBucketType rbt = RenderBucketType.Skip;
        RenderBucketType rbt = RenderBucketType.PostBucket;
        ...
        m_line.getSceneHints().setRenderBucketType(rbt);
        ...
        m_distText.getSceneHints().setRenderBucketType(rbt);
        ...
        m_pickText.getSceneHints().setRenderBucketType(rbt);
        ...
        m_lastText.getSceneHints().setRenderBucketType(rbt);
        ...
        m_distText.setRenderState(zs);
        m_pickText.setRenderState(zs);
        m_lastText.setRenderState(zs);
        ...
        getSceneHints().setRenderBucketType(rbt);
