...
public abstract class AbstractCamControl implements CenterOfInterestCamera, InterestPointListener {
    ...
    protected boolean                 m_noFollowCenterOnSelect = false;
    ...
    /**
     * adjust near/far planes based on distance from target
     * @param distance
     */
    protected void adjustNearFarPlanes(double distance) {
        ...
        //System.out.println("(AbstractCamControl.java:354) near["+near+"] far["+far+"]");
    }
