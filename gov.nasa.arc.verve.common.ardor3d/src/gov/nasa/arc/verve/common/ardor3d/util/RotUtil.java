...
public class RotUtil {
    ...
    public static Vector3 toEuler(Order order, ReadOnlyMatrix3 rot, Vector3 rpyStore) {
        switch(order) {
        case XYZ: return toEulerXYZ(rot, rpyStore);
        case XZY: return toEulerXZY(rot, rpyStore);
        case YXZ: return toEulerYXZ(rot, rpyStore);
        case YZX: return toEulerYZX(rot, rpyStore);
        case ZXY: return toEulerZXY(rot, rpyStore);
        case ZYX: return toEulerZYX(rot, rpyStore);
        }
        return null;
    }
    ...
    //----------------------------------------------------------------------------
    public static Matrix3 toMatrix(Order order, ReadOnlyVector3 angles, Matrix3 retVal) {
        switch(order) {
        case XYZ: return toMatrixXYZ(angles, retVal);
        case XZY: return toMatrixXZY(angles, retVal);
        case YXZ: return toMatrixYXZ(angles, retVal);
        case YZX: return toMatrixYZX(angles, retVal);
        case ZXY: return toMatrixZXY(angles, retVal);
        case ZYX: return toMatrixZYX(angles, retVal);
        }
        return null;
    }
    ...
    public static Matrix3 toMatrixZXY(ReadOnlyVector3 angles, Matrix3 retVal) {
        if(retVal == null) {
            retVal = new Matrix3();
        }
        double s1,c1;
