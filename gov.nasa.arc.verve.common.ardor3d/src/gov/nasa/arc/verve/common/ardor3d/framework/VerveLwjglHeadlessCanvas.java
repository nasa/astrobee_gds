...
public class VerveLwjglHeadlessCanvas {
    private static final Logger logger = Logger.getLogger(VerveLwjglHeadlessCanvas.class);
    ...
    public void draw() {
        ...
        // XXX FIXME XXX
        // THIS CALL IS CAUSING JVM TO CRASH
        logger.error("FIXME!!! THE FOLLOWING CALL CAUSES JVM TO CRASH");
        logger.error("it happens when GL11.glFlush() is called, so check context initialization");
