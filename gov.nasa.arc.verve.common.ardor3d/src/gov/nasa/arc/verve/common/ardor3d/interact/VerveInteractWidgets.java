...
public class VerveInteractWidgets {
    ...
    public static final String RotXYZ       	       = "RotXYZ";
     ...
     * @return
     */
    public static VerveCompoundInteractWidget newRotXYZWidget() {
        final float l = 0.4f;
        final float h = 0.8f;
        final VerveCompoundInteractWidget widget = new VerveCompoundInteractWidget(RotXYZ)
        .withRotateXAxis(new ColorRGBA(h, l, l, 0.5f), 1.5f, 0.3f) 
        .withRotateYAxis(new ColorRGBA(l, h, l, 0.5f), 1.5f, 0.3f) 
        .withRotateZAxis(new ColorRGBA(l, l, h, 0.5f), 1.5f, 0.3f) 
        .withRingTexture(s_rotHandleTex)
